...
export function Capabilities() {
  return (
    <section className="py-12 sm:py-16 md:py-20 lg:py-12 sm:py-16 md:py-20 lg:py-12 sm:py-16 lg:py-24 bg-[#0a0e3d] text-white">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-x-16 gap-y-12">
          {capabilities.map((cap, index) => (
            <motion.div
              ...
              className="group"
            >
              <h3 className="text-2xl font-bold mb-4 group-hover:text-[#00d4ff] transition-colors">{cap.title}</h3>
              <p className="text-gray-300 leading-relaxed mb-4">
                {cap.description}
              </p>
              <Link href={cap.link}>
                <span className="text-[#00d4ff] hover:text-white transition-colors inline-flex items-center gap-2 font-semibold">
