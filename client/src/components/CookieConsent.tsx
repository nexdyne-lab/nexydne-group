                ...
                <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
                  ...
                  <div className="flex flex-col sm:flex-row gap-3 lg:flex-shrink-0">
                    <button
                      ...
                      className="px-6 py-3 bg-base text-white font-semibold rounded-lg hover:bg-base transition-all duration-200 text-sm md:text-base whitespace-nowrap shadow-lg hover:shadow-xl"
                    >
                      Accept Cookies
                    </button>
                    <button
              ...
              <div className="p-6 md:p-8">
                ...
                <div className="flex flex-col sm:flex-row gap-3 pt-4 border-t border-border">
                  ...
                  <button
                    ...
                    className="px-6 py-3 bg-base text-white font-semibold rounded-lg hover:bg-base transition-all duration-200 text-sm md:text-base shadow-lg hover:shadow-xl"
                  >
                    Save preferences
                  </button>
                </div>
