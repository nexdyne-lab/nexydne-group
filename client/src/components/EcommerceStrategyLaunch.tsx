  ...
  const phases = [
    {
      ...
      description:
        "Most ecommerce launches fail in the brief, not the build. We size the addressable market for the category, geography, or product line under consideration — demand signals, competitive intensity, channel structure, regulatory friction — and map where the operator can credibly compete. The output is a defensible go / no-go memo with sized opportunity bands, not a deck of optimistic charts.",
    },
    {
      name: "Ecommerce model design",
      description:
        "We design the commercial model — direct-to-consumer, marketplace, hybrid, B2B portal, subscription — that matches the category economics and the operator's existing distribution. Pricing, fulfillment, returns, customer service, and channel-conflict policy are decided up-front so the launch does not relitigate every question in week three.",
    },
    {
      name: "Technology stack selection",
      description:
        "Stack choices — storefront platform, OMS, ERP, PIM, payment, tax, fraud, fulfillment integrations — are made against a written requirements brief, not a vendor pitch. We weigh time-to-launch, total cost of ownership, integration burden, and team capability, then issue a selection memo the steering committee can defend in writing.",
    },
    {
      name: "Launch operations design",
      description:
        "We design the operating model the day one team needs: org chart, RACI, customer-service SOPs, fulfillment SLAs, marketing calendar, escalation paths. Soft-launch and hard-launch milestones are sequenced with measurable readiness gates so the program ships when it is ready, not when the calendar runs out.",
    },
    {
      name: "Growth scaling",
      description:
        "Post-launch we wire the metrics, dashboards, and review cadence that turn an initial launch into a compounding program. Acquisition channels, retention motions, merchandising tests, and assortment expansion are paced against a written scaling plan with quarterly value milestones.",
    },
  ];
  ...
  const deliverables = [
    {
      ...
      description:
        "Sized addressable-market study covering demand, competitive intensity, channel structure, and regulatory friction — with a defensible go / no-go memo for the steering committee.",
    },
    {
      name: "Ecommerce business model",
      description:
        "Documented commercial model — DTC, marketplace, hybrid, subscription, or B2B portal — with pricing, fulfillment, returns, and channel-conflict policy decided up-front.",
    },
    {
      name: "Technology stack recommendation",
      description:
        "Written selection memo across storefront, OMS, ERP, PIM, payment, tax, fraud, and fulfillment integrations — scored on time-to-launch, TCO, and integration burden.",
    },
    {
      name: "Launch playbook",
      description:
        "Day-zero through day-ninety operating playbook covering org, RACI, SOPs, SLAs, marketing calendar, soft-launch and hard-launch readiness gates.",
    },
    {
      name: "Growth metrics and dashboard",
      description:
        "Production-grade dashboard wiring acquisition, conversion, retention, merchandising, and contribution-margin metrics — with the quarterly review cadence the leadership team uses to steer.",
    },
    {
      name: "Operating model",
      description:
        "End-to-end operating-model document covering org design, vendor governance, escalation paths, and the scaling plan that takes the launch from week-one to year-two.",
    },
  ];
  ...
  return (
    <div className="min-h-screen bg-white font-sans text-charcoal">
      <SEO
        ...
        description="Launch ecommerce strategies for new categories, geographies, or product lines — opportunity sizing, model design, stack selection, launch operations, and the scaling plan that compounds."
      ...
      <section className="bg-white py-24 md:py-32">
        <div className="container px-6 sm:px-8 md:px-12 lg:px-16">
          ...
          >
            ...
            >
              Ecommerce launches fail upstream of the build. Win the strategy and the platform follows.
            </h3>
            <div className="space-y-6">
              <p className="text-base md:text-lg text-charcoal/80 leading-[1.65] max-w-[60ch]">
                Most ecommerce launches we are brought in to recover did not fail because the team picked the wrong storefront. They failed because the operator had not decided whether the channel was a brand asset, a growth engine, or a margin defense — and the build relitigated that decision for eighteen months. The leaders who launch cleanly write the strategy first and let the technology catch up.
              </p>
              <p className="text-base md:text-lg text-charcoal/80 leading-[1.65] max-w-[60ch]">
                We design the commercial model — DTC, marketplace, hybrid, subscription, B2B — against the category economics, the existing distribution, and the operator's appetite for channel conflict. Then we run the platform selection, the operating model, and the scaling plan as a single program rather than three workstreams that find each other in week sixteen.
              </p>
            </div>
          </motion.div>
        </div>
        ...
        <div className="container px-6 sm:px-8 md:px-12 lg:px-16">
          ...
          >
            ...
            <h3
              ...
              style={{ fontWeight: 500, letterSpacing: "-0.02em" }}
            >
              A five-phase approach from market sizing to scaled operation.
            </h3>
            <p className="text-base md:text-lg text-charcoal/80 leading-[1.65] max-w-[60ch] mt-6">
              Each phase is timeboxed and produces a tangible artifact. Most engagements run sixteen to twenty-six weeks from sizing to a live, scaled, instrumented channel.
            </p>
          </motion.div>
        ...
        <div className="container px-6 sm:px-8 md:px-12 lg:px-16">
          ...
          >
            ...
            <h3
              ...
              style={{ fontWeight: 500, letterSpacing: "-0.02em" }}
            >
              When the strategy is decided up-front, the launch compounds.
            </h3>
          </motion.div>
            ...
            <div className="grid md:grid-cols-2 gap-12 lg:gap-16 items-start">
              ...
              >
                <p className="text-base md:text-lg text-white/80 leading-[1.65] mb-8 max-w-[52ch]">
                  We work with leaders who want their next ecommerce launch to clear contribution targets in year one rather than year three. The conversation starts with the strategy, not the platform.
                </p>
