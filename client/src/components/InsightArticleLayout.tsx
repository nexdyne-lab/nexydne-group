  ...
  return (
    <div className="min-h-screen bg-white text-charcoal font-sans">
            ...
            >
              <div className="sticky top-32 space-y-8">
                ...
                <div className="bg-subtle rounded-lg p-4 sm:p-5 md:p-4 sm:p-5 md:p-6">
                  <h3 className="text-sm font-bold uppercase tracking-wider text-charcoal/50 mb-4">Share this article</h3>
                ...
                {/* Quick Navigation */}
                <div className="border border-charcoal/10 rounded-lg p-4 sm:p-5 md:p-4 sm:p-5 md:p-6">
                  <h3 className="text-sm font-bold uppercase tracking-wider text-charcoal/50 mb-4">Explore More</h3>
                  <div className="space-y-3">
                    <Link href="/insights" className="flex items-center justify-between text-charcoal hover:text-primary transition-colors group">
                      <span className="text-sm font-medium">All Insights</span>
                      <ArrowRight className="w-3 h-3 sm:w-4 sm:h-4 group-hover:translate-x-1 transition-transform" />
                    </Link>
                    <Link href="/capabilities" className="flex items-center justify-between text-charcoal hover:text-primary transition-colors group">
                      <span className="text-sm font-medium">Our Capabilities</span>
                      <ArrowRight className="w-3 h-3 sm:w-4 sm:h-4 group-hover:translate-x-1 transition-transform" />
                    </Link>
                    <Link href="/cases" className="flex items-center justify-between text-charcoal hover:text-primary transition-colors group">
      ...
      {relatedInsights.length > 0 && (
        <section className="py-10 sm:py-14 md:py-16 lg:py-12 sm:py-16 md:py-20 lg:py-12 sm:py-16 md:py-20 lg:py-12 sm:py-16 lg:py-24 bg-subtle">
          <div className="container px-4 md:px-8 lg:px-12">
