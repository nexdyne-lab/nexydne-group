            ...
            {!isComplete ? (
              <div className="animate-in fade-in slide-in-from-right-4 duration-500">
                <div className="mb-5 sm:mb-6 md:mb-5 sm:mb-6 md:mb-8">
                  <span className="text-secondary text-sm font-bold tracking-wider uppercase">Question {currentStep + 1} of {questions.length}</span>
              ...
              <div className="text-center animate-in fade-in zoom-in duration-500">
                ...
                <p className="text-muted-foreground/50 mb-5 sm:mb-6 md:mb-5 sm:mb-6 md:mb-8 max-w-lg mx-auto">
