      ...
      <div className="flex flex-col lg:flex-row w-full">
        ...
        <div className="relative w-full lg:w-[45%] min-h-[50vh] lg:min-h-[70vh] bg-white">
          ...
          <div className="relative z-10 h-full flex items-center px-8 sm:px-12 md:px-16 lg:px-12 xl:px-16 py-20 lg:py-0">
            ...
            >
              {/* Welcome badge */}
              <span className="inline-block text-muted-foreground text-[11px] font-medium tracking-[0.3em] uppercase mb-6">
        ...
        <div className="relative w-full lg:w-[55%] flex flex-col">
          {/* Image Carousel Area */}
          <div className="relative w-full h-[40vh] lg:h-[50vh] bg-subtle">
          ...
          <div className="bg-subtle py-6 px-4 lg:px-6">
                ...
                >
                  <Link href={insight.link}>
                    <div className="group bg-white p-4 h-full border border-border hover:border-secondary hover:shadow-md transition-all duration-300 cursor-pointer">
                      ...
                      {/* Title */}
                      <h3 className="text-sm font-semibold text-charcoal leading-snug mb-2 group-hover:text-secondary transition-colors line-clamp-2">
                        {insight.title}
                      </h3>
                      
                      {/* Read More Link */}
                      <div className="flex items-center gap-1 text-xs font-medium text-muted-foreground group-hover:text-secondary transition-colors">
                        <span>Read more</span>
