import { RelatedItem } from "@/components/RelatedContent";

export const dataRelatedItems: RelatedItem[] = [
  {
    type: "Article",
...
export const aiRelatedItems: RelatedItem[] = [
  {
    type: "Article",
...
export const digitalRelatedItems: RelatedItem[] = [
  {
    type: "Article",
...
export const strategyRelatedItems: RelatedItem[] = [
  {
    type: "Article",
