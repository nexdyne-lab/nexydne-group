...
export default function About() {
  ...
  return (
    <div className="min-h-screen bg-white text-charcoal">
      ...
      <PageHero
        eyebrow="ABOUT NEXDYNE"
        title="About NexDyne"
        subtitle="We accelerate intelligent and sustainable growth, partnering with bold leaders to transform businesses and create lasting impact."
        ...
        <div className="container px-4 sm:px-6 md:px-12">
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
            {aboutLinks.map((link, index) => (
              ...
              >
                <Link href={link.href}>
                  <a className="group block p-4 hover:bg-subtle transition-colors h-full">
                    <h3 className="text-charcoal mb-1 group-hover:text-primary-hover transition-colors text-sm">
                      {link.title}
                    </h3>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
              ...
              >
                ...
                {/* Floating Label */}
                <div className="absolute -bottom-6 -right-6 text-white px-6 py-4">
                  <div className="text-xs font-medium text-secondary mb-1">Our Foundation</div>
                  <div className="text-xl">Built for Impact</div>
                </div>
              </motion.div>
        ...
        <div className="container px-4 md:px-6">
          ...
          <div className="grid md:grid-cols-2 xl:grid-cols-4 gap-6">
            {values.map((value, index) => (
              ...
              >
                <div className="bg-white border border-border h-full overflow-hidden transition-shadow duration-300">
                  {/* Image */}
