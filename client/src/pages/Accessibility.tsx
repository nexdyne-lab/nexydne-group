      ...
      <section className="bg-white pt-32 pb-16 border-b border-gray-100">
        <div className="container px-4 sm:px-6 md:px-12">
          <div className="max-w-4xl">
            <h1 className="text-3xl sm:text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl text-[#051C2C] tracking-tight mb-3 eb-garamond">
            ...
            <main className="lg:col-span-9 max-w-3xl">
              <div className="prose prose-lg prose-gray max-w-none">
                ...
                <section id="feedback" className="scroll-mt-32 mb-6 sm:mb-8 md:mb-12">
                  ...
                  <div className="bg-[#051C2C]/5 border border-[#051C2C]/10 rounded-lg p-4 sm:p-5 md:p-6 mt-6">
                    <h3 className="text-lg font-semibold text-[#051C2C] mb-3">
                ...
                <section id="contact" className="scroll-mt-32 mb-6 sm:mb-8 md:mb-12">
                  ...
                  <div className="bg-gray-50 p-4 sm:p-5 md:p-6 rounded-lg">
                    ...
                    <p className="text-gray-700 mb-2">
                      Email: <a href="mailto:accessibility@nexdyne.com" className="text-[#0077B5] hover:underline">accessibility@nexdyne.com</a>
                    </p>
                    <p className="text-gray-700">
                      You may also use our <Link href="/contact" className="text-[#0077B5] hover:underline">Contact Form</Link> to reach us.
                    </p>
                  </div>
