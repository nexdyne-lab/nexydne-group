        ...
        <div className="container max-w-5xl">
          ...
          <div className="mt-16 pt-8 border-t border-border">
            <div className="flex items-start gap-4 sm:p-5 md:p-6">
              ...
              <div>
                <p className="font-semibold text-charcoal text-lg">Michael Torres</p>
                <p className="text-muted-foreground mb-3">Senior Consultant, Digital Transformation</p>
            ...
            <a href="/cases/healthcare-patient-engagement" className="group">
              <div className="bg-white border border-border rounded-lg overflow-hidden hover:shadow-xl transition-shadow">
                ...
                <div className="p-4 sm:p-5 md:p-6">
                  <p className="text-xs font-semibold tracking-wider uppercase mb-2 text-muted-foreground">HEALTHCARE</p>
