          ...
          <div className="flex flex-col justify-center min-h-[56vh] py-24 lg:py-28">
            ...
            >
              ...
              <div className="flex items-center gap-3 mb-6">
                ...
                <span className="text-[12px] font-semibold uppercase tracking-[0.18em] text-muted-foreground">Investment Readiness</span>
              </div>

              <h1 className="text-charcoal font-bold tracking-[-0.035em] leading-[1.0] text-[clamp(2.4rem,5.4vw,4.2rem)]">
                Capital Raising & Investment Readiness
              </h1>
          ...
          <div className="grid md:grid-cols-2 gap-16 lg:gap-8 sm:gap-6 sm:p-6 sm:p-8 md:p-12 lg:gap-8 sm:gap-6 sm:p-8 md:p-12 lg:gap-24 items-center">
            ...
            >
              ...
              <div className="space-y-6 text-lg text-charcoal/70 leading-relaxed">
                ...
                <p>
                  NexDyne provides the <strong className="text-charcoal font-semibold">Investment Readiness Infrastructure</strong> that positions your company for successful capital raises. We build the analytical foundation, narrative framework, and due diligence materials that institutional investors expect.
                </p>
              </div>
              ...
              <div className="relative rounded-xl sm:rounded-2xl overflow-hidden shadow-xl sm:shadow-xl sm:shadow-2xl">
                ...
                <div className="absolute bottom-0 left-0 p-4 sm:p-6 md:p-8">
                  <div className="text-charcoal">
                    ...
                    <div className="text-muted-foreground">Where preparation meets opportunity.</div>
                  </div>
                </div>
              </div>
            </motion.div>
