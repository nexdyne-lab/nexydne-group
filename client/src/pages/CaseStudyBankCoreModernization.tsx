        ...
        <div className="container px-4 sm:px-6 md:px-12 relative z-10">
          ...
          >
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 sm:p-6 md:p-8 border-t border-white/10 pt-8 mt-8">
              <div>
                <div className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-serif font-bold text-primary mb-1">4x</div>
                <div className="text-sm text-white/60 uppercase tracking-wider">Feature Velocity</div>
              </div>
              <div>
                <div className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-serif font-bold text-primary mb-1">40%</div>
                <div className="text-sm text-white/60 uppercase tracking-wider">OpEx Savings</div>
              </div>
              <div>
                <div className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-serif font-bold text-primary mb-1">99.99%</div>
                <div className="text-sm text-white/60 uppercase tracking-wider">Uptime</div>
              </div>
              <div>
                <div className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-serif font-bold text-primary mb-1">6 Mo</div>
