        ...
        <div className="container px-4 sm:px-6 md:px-12 relative z-10">
          ...
          >
            ...
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-serif font-bold tracking-tight text-white leading-[1.05] mb-5 sm:mb-3 md:mb-4">
              Legacy Core Banking Migration to <span className="text-[#0077B5]">Cloud Microservices</span>
            </h1>
            
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 sm:p-6 md:p-8 border-t border-white/10 pt-8 mt-8">
              <div>
                <div className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-serif font-bold text-[#0077B5] mb-1">4x</div>
                <div className="text-sm text-white/60 uppercase tracking-wider">Feature Velocity</div>
              </div>
              <div>
                <div className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-serif font-bold text-[#0077B5] mb-1">40%</div>
                <div className="text-sm text-white/60 uppercase tracking-wider">OpEx Savings</div>
              </div>
              <div>
                <div className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-serif font-bold text-[#0077B5] mb-1">99.99%</div>
                <div className="text-sm text-white/60 uppercase tracking-wider">Uptime</div>
              </div>
              <div>
                <div className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-serif font-bold text-[#0077B5] mb-1">6 Mo</div>
          ...
          >
            ...
            <div className="flex items-center justify-center space-x-4">
              ...
              <div className="text-left">
                <div className="text-[#051C2C] font-bold">Robert Chen</div>
                <div className="text-[#0077B5] text-sm font-medium">CTO, Regional Banking Group</div>
              </div>
            </div>
          </motion.div>
        </div>
