          ...
          >
            <div className="max-w-[920px]">
              ...
              <h1 className="text-charcoal font-bold tracking-[-0.035em] leading-[1.05] text-[clamp(2.2rem,4.8vw,3.8rem)]">
                Transforming compliance and KYC processing at a major US bank
              </h1>
        ...
        <div className="container px-4 sm:px-6 md:px-12 max-w-5xl">
          ...
          >
            ...
            <div className="text-base text-charcoal">
              ...
              <div className="text-muted-foreground">Chief Compliance Officer</div>
            </div>
          </motion.div>
        </div>
      </section>
        ...
        <div className="container px-4 sm:px-6 md:px-12 max-w-5xl">
          ...
          >
            ...
            <div className="text-base text-charcoal">
              ...
              <div className="text-muted-foreground">Head of Financial Crime Compliance</div>
            </div>
          </motion.div>
        </div>
      </section>
