        ...
        <div className="container relative z-10 px-4 md:px-12">
          ...
          >
            ...
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-7xl font-serif font-bold tracking-tight leading-[1.05] mb-5 sm:mb-3 md:mb-4">
              Transforming compliance and <span className="text-[#0077B5]">KYC processing</span> at a major US bank
            </h1>
      ...
      <section className="py-10 sm:py-12 lg:py-16 bg-white text-[#051C2C]">
        <div className="container px-4 sm:px-6 md:px-12 max-w-4xl">
          <div className="prose prose-lg max-w-none">
            ...
            <h3 className="text-2xl font-serif font-bold text-[#051C2C] mt-12 mb-6">Intelligent document processing</h3>
            <p className="text-base leading-relaxed text-[#051C2C]/70 mb-6">
            ...
            <h3 className="text-2xl font-serif font-bold text-[#051C2C] mt-12 mb-6">Automated risk assessment</h3>
            <p className="text-base leading-relaxed text-[#051C2C]/70 mb-6">
            ...
            <h3 className="text-2xl font-serif font-bold text-[#051C2C] mt-12 mb-6">Regulatory reporting automation</h3>
            <p className="text-base leading-relaxed text-[#051C2C]/70">
      ...
      <section className="py-10 sm:py-12 lg:py-16 bg-white text-[#051C2C]">
        <div className="container px-4 sm:px-6 md:px-12 max-w-4xl">
          <div className="prose prose-lg max-w-none">
            ...
            <h3 className="text-2xl font-serif font-bold text-[#051C2C] mt-12 mb-6">Operational efficiency</h3>
            <p className="text-base leading-relaxed text-[#051C2C]/70 mb-6">
            ...
            <h3 className="text-2xl font-serif font-bold text-[#051C2C] mt-12 mb-6">Accuracy and risk management</h3>
            <p className="text-base leading-relaxed text-[#051C2C]/70 mb-6">
            ...
            <h3 className="text-2xl font-serif font-bold text-[#051C2C] mt-12 mb-6">Customer experience</h3>
            <p className="text-base leading-relaxed text-[#051C2C]/70 mb-6">
            ...
            <h3 className="text-2xl font-serif font-bold text-[#051C2C] mt-12 mb-6">Strategic positioning</h3>
            <p className="text-base leading-relaxed text-[#051C2C]/70">
