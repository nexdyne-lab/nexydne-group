      ...
      <section className="py-10 sm:py-12 lg:py-16 bg-white text-charcoal">
        <div className="container px-4 sm:px-6 md:px-12 max-w-4xl">
          <div className="prose prose-lg max-w-none">
            ...
            <h3 className="text-2xl text-charcoal mt-12 mb-6">Automated knowledge capture</h3>
            <p className="text-base leading-relaxed text-charcoal/70 mb-6">
            ...
            <h3 className="text-2xl text-charcoal mt-12 mb-6">Intelligent search and discovery</h3>
            <p className="text-base leading-relaxed text-charcoal/70 mb-6">
            ...
            <h3 className="text-2xl text-charcoal mt-12 mb-6">Proposal acceleration</h3>
            <p className="text-base leading-relaxed text-charcoal/70 mb-6">
            ...
            <h3 className="text-2xl text-charcoal mt-12 mb-6">Change management and adoption</h3>
            <p className="text-base leading-relaxed text-charcoal/70">
      ...
      <section className="py-10 sm:py-12 lg:py-16 bg-white text-charcoal">
        <div className="container px-4 sm:px-6 md:px-12 max-w-4xl">
          <div className="prose prose-lg max-w-none">
            ...
            <h3 className="text-2xl text-charcoal mt-12 mb-6">Research and analysis efficiency</h3>
            <p className="text-base leading-relaxed text-charcoal/70 mb-6">
            ...
            <h3 className="text-2xl text-charcoal mt-12 mb-6">Proposal development and win rates</h3>
            <p className="text-base leading-relaxed text-charcoal/70 mb-6">
            ...
            <h3 className="text-2xl text-charcoal mt-12 mb-6">Knowledge retention and institutional learning</h3>
            <p className="text-base leading-relaxed text-charcoal/70 mb-6">
