        ...
        <div className="container relative z-10 px-4 md:px-12">
          ...
          >
            ...
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-7xl font-serif font-bold tracking-tight leading-[1.05] mb-5 sm:mb-3 md:mb-4">
              Executive dashboards for <span className="text-[#0077B5]">clarity</span>
            </h1>
          ...
          >
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 mt-12 p-4 sm:p-6 md:p-8 bg-[#051C2C]/5 rounded-lg sm:rounded-xl">
              <div>
                ...
                <div className="text-[#051C2C] font-medium">Professional Services</div>
              </div>
              <div>
                <div className="text-sm font-semibold text-[#0077B5] mb-2">Company Size</div>
                <div className="text-[#051C2C] font-medium">150 consultants</div>
              </div>
              <div>
                <div className="text-sm font-semibold text-[#0077B5] mb-2">Annual Revenue</div>
                <div className="text-[#051C2C] font-medium">$32M</div>
              </div>
            </div>
          </motion.div>
        </div>
      ...
      <section className="py-10 sm:py-12 lg:py-16 bg-white text-[#051C2C]">
        <div className="container px-4 sm:px-6 md:px-12 max-w-4xl">
          <div className="space-y-8">
            <div>
              <h3 className="text-xl font-serif font-bold text-[#051C2C] mb-4">Information overload paralyzed decision-making</h3>
              <p className="text-[#051C2C]/70 leading-relaxed">
            ...
            <div>
              <h3 className="text-xl font-serif font-bold text-[#051C2C] mb-4">No clear narrative or priorities</h3>
              <p className="text-[#051C2C]/70 leading-relaxed">
            ...
            <div>
              <h3 className="text-xl font-serif font-bold text-[#051C2C] mb-4">Static reports couldn't answer follow-up questions</h3>
              <p className="text-[#051C2C]/70 leading-relaxed">
        ...
        <div className="container px-4 sm:px-6 md:px-12 max-w-4xl">
          ...
          <div className="space-y-12">
            ...
            <div className="flex gap-4">
              ...
              <div>
                <h3 className="text-xl font-serif font-bold text-[#051C2C] mb-4 flex items-center gap-3">
                  <Eye className="w-5 h-5 sm:w-6 sm:h-6 text-[#0077B5]" />
            ...
            <div className="flex gap-4">
              ...
              <div>
                <h3 className="text-xl font-serif font-bold text-[#051C2C] mb-4 flex items-center gap-3">
                  <Users className="w-5 h-5 sm:w-6 sm:h-6 text-[#0077B5]" />
      ...
      <section className="py-10 sm:py-12 lg:py-16 bg-white text-[#051C2C]">
        <div className="container px-4 sm:px-6 md:px-12 max-w-4xl">
          <div className="space-y-8">
            <div>
              ...
              <div className="grid md:grid-cols-2 gap-4">
                <div className="p-4 sm:p-5 md:p-6 bg-[#051C2C]/5 rounded-lg sm:rounded-xl">
                  <div className="text-3xl font-serif font-bold text-[#051C2C] mb-2">90 min</div>
                  <div className="text-sm text-[#051C2C]/60">Average meeting length (down from 3-4 hours)</div>
                </div>
                <div className="p-4 sm:p-5 md:p-6 bg-[#051C2C]/5 rounded-lg sm:rounded-xl">
                  <div className="text-3xl font-serif font-bold text-[#051C2C] mb-2">60%</div>
                  <div className="text-sm text-[#051C2C]/60">Improvement in meeting efficiency</div>
                </div>
              </div>
            </div>
            ...
            <div>
              <h3 className="text-xl font-serif font-bold text-[#051C2C] mb-4 flex items-center gap-3">
                <TrendingUp className="w-5 h-5 sm:w-6 sm:h-6 text-[#0077B5]" />
              ...
              <div className="p-4 sm:p-5 md:p-6 bg-[#051C2C]/5 rounded-lg sm:rounded-xl">
                <div className="text-3xl font-serif font-bold text-[#051C2C] mb-2">75%</div>
                <div className="text-sm text-[#051C2C]/60">Faster issue-to-decision cycle (15 days vs. 60 days)</div>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="p-4 sm:p-5 md:p-6 bg-[#051C2C]/5 rounded-lg sm:rounded-xl">
                <div className="text-3xl font-serif font-bold text-[#051C2C] mb-2">8 pts</div>
                <div className="text-sm text-[#051C2C]/60">Increase in average consultant utilization rate</div>
              </div>
            </div>
          </div>
        </div>
