...
import { ArrowLeft, CheckCircle2, ArrowRight, Database, Shield, Users, Download } from "lucide-react";
        ...
        <div className="container px-4 sm:px-6 md:px-12 relative z-10">
          ...
          >
            ...
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-serif font-bold tracking-tight text-white leading-[1.05] mb-5 sm:mb-3 md:mb-4">
              Unifying Patient Data Across <span className="text-[#0077B5]">12 Hospital Locations</span>
            </h1>
            
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 sm:p-6 md:p-8 border-t border-white/10 pt-8 mt-8">
              <div>
                <div className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-serif font-bold text-[#0077B5] mb-1">100%</div>
                <div className="text-sm text-white/60 uppercase tracking-wider">Data Accuracy</div>
              </div>
              <div>
                <div className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-serif font-bold text-[#0077B5] mb-1">30%</div>
                <div className="text-sm text-white/60 uppercase tracking-wider">Admin Time Saved</div>
              </div>
              <div>
                <div className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-serif font-bold text-[#0077B5] mb-1">Real-time</div>
                <div className="text-sm text-white/60 uppercase tracking-wider">Patient Insights</div>
              </div>
              <div>
                <div className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-serif font-bold text-[#0077B5] mb-1">HIPAA</div>
          ...
          >
            ...
            <div className="flex items-center justify-center space-x-4">
              ...
              <div className="text-left">
                <div className="text-[#051C2C] font-bold">Dr. Sarah Jenkins</div>
                <div className="text-[#0077B5] text-sm font-medium">Chief Medical Officer</div>
              </div>
            </div>
          </motion.div>
        </div>
