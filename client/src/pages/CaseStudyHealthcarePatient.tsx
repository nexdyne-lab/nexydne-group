        ...
        <div className="container relative z-10 px-4 md:px-12">
          ...
          >
            ...
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-7xl font-serif font-bold tracking-tight leading-[1.05] mb-5 sm:mb-3 md:mb-4">
              Building an AI-powered <span className="text-[#0077B5]">patient engagement</span> platform
            </h1>
      ...
      <section className="py-10 sm:py-12 lg:py-16 bg-white text-[#051C2C]">
        <div className="container px-4 sm:px-6 md:px-12 max-w-4xl">
          <div className="prose prose-lg max-w-none">
            ...
            <h3 className="text-2xl font-serif font-bold text-[#051C2C] mt-12 mb-6">Understanding patient needs</h3>
            <p className="text-base leading-relaxed text-[#051C2C]/70 mb-6">
            ...
            <h3 className="text-2xl font-serif font-bold text-[#051C2C] mt-12 mb-6">Platform architecture</h3>
            <p className="text-base leading-relaxed text-[#051C2C]/70 mb-6">
            ...
            <h3 className="text-2xl font-serif font-bold text-[#051C2C] mt-12 mb-6">Phased implementation</h3>
            <p className="text-base leading-relaxed text-[#051C2C]/70">
      ...
      <section className="py-10 sm:py-12 lg:py-16 bg-white text-[#051C2C]">
        <div className="container px-4 sm:px-6 md:px-12 max-w-4xl">
          <div className="prose prose-lg max-w-none">
            ...
            <h3 className="text-2xl font-serif font-bold text-[#051C2C] mt-12 mb-6">Patient satisfaction and engagement</h3>
            <p className="text-base leading-relaxed text-[#051C2C]/70 mb-6">
            ...
            <h3 className="text-2xl font-serif font-bold text-[#051C2C] mt-12 mb-6">Clinical outcomes</h3>
            <p className="text-base leading-relaxed text-[#051C2C]/70 mb-6">
