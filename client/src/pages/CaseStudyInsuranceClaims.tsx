          ...
          >
            <div className="max-w-[920px]">
              <div className="flex items-center gap-3 mb-6">
                ...
                <span className="text-[12px] font-semibold uppercase tracking-[0.18em] text-muted-foreground">Case Study · Insurance</span>
              </div>
              <h1 className="text-charcoal font-bold tracking-[-0.035em] leading-[1.05] text-[clamp(2.2rem,4.8vw,3.8rem)]">
                Accelerating claims processing by 68%
              </h1>
              ...
              challenge="A mid-market property and casualty insurer was hemorrhaging customer satisfaction over its claims experience. Average cycle time from first notice of loss to claim closure had stretched to 14 days for routine auto and homeowner claims, with complex losses taking 30+ days. Adjusters were drowning in document review — police reports, repair estimates, photos, medical records — and most of their time was spent extracting data, cross-referencing policies, and updating multiple systems rather than making coverage decisions or talking with claimants. NPS had fallen below industry benchmarks, and loss ratios were creeping upward as fraud signals were missed under volume pressure. The carrier's leadership team recognized that the next generation of customers expected app-based, near-real-time claims handling, and that the carrier's incumbent advantage in distribution would erode if the experience continued to lag direct-to-consumer competitors."
              solution="NexDyne implemented an end-to-end intelligent claims automation platform spanning intake, triage, and adjudication. We began by mapping the full claims journey for auto, homeowner, and small commercial lines, identifying decision points where automation could safely replace manual review. The platform ingests first-notice-of-loss submissions across web, mobile, and call-center channels, uses computer vision to assess damage from claimant-uploaded photos, applies coverage rules to determine eligibility, and produces settlement recommendations for adjuster sign-off — or full straight-through processing for low-complexity claims that meet defined criteria. Fraud detection models score every claim against the carrier's historical fraud patterns and SIU referral data, surfacing high-risk cases for investigator review before payment. Integration with the policy administration and payment systems lets approved claims pay out within hours, and a claimant-facing tracker provides real-time status updates. Rollout was phased by line of business, with adjuster co-design sessions ensuring the automation augmented rather than displaced expertise."
              results={[
                "68% faster claims processing cycle time, reducing average closure to under 5 days",
                "+35 point increase in Net Promoter Score among claimants who used the new experience",
                "92% of routine claims processed without human intervention, freeing adjusters for complex losses",
                "Loss-ratio improvement from better fraud detection and consistent rule application"
              ]}
              variant="hero"
                />
              </div>
        ...
        <div className="container px-4 sm:px-6 md:px-12 max-w-5xl">
          ...
          >
            ...
            <div className="text-base text-charcoal">
              ...
              <div className="text-muted-foreground">Chief Claims Officer</div>
            </div>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-10 sm:py-12 lg:py-16 bg-white text-charcoal">
        <div className="container px-4 sm:px-6 md:px-12 max-w-4xl">
          <div className="prose prose-lg max-w-none">
            ...
            <h3 className="text-2xl font-semibold text-charcoal mt-12 mb-6">Straight-through processing for routine claims</h3>
            <p className="text-base leading-relaxed text-charcoal/70 mb-6">
            ...
            <h3 className="text-2xl font-semibold text-charcoal mt-12 mb-6">Adjuster productivity tools</h3>
            <p className="text-base leading-relaxed text-charcoal/70 mb-6">
            ...
            <h3 className="text-2xl font-semibold text-charcoal mt-12 mb-6">Compliance and quality assurance</h3>
            <p className="text-base leading-relaxed text-charcoal/70">
        ...
        <div className="container px-4 sm:px-6 md:px-12 max-w-5xl">
          ...
          >
            ...
            <div className="text-base text-charcoal">
              ...
              <div className="text-muted-foreground">Senior Claims Manager</div>
            </div>
          </motion.div>
        </div>
      </section>
