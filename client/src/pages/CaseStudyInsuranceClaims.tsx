        ...
        <div className="container relative z-10 px-4 md:px-12">
          ...
          >
            ...
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-7xl font-serif font-bold tracking-tight leading-[1.05] mb-5 sm:mb-3 md:mb-4">
              Accelerating claims processing by <span className="text-[#0077B5]">68%</span>
            </h1>
      ...
      <section className="py-10 sm:py-12 lg:py-16 bg-white text-[#051C2C]">
        <div className="container px-4 sm:px-6 md:px-12 max-w-4xl">
          <div className="prose prose-lg max-w-none">
            ...
            <h3 className="text-2xl font-serif font-bold text-[#051C2C] mt-12 mb-6">Automated intake and triage</h3>
            <p className="text-base leading-relaxed text-[#051C2C]/70 mb-6">
            ...
            <h3 className="text-2xl font-serif font-bold text-[#051C2C] mt-12 mb-6">Straight-through processing for routine claims</h3>
            <p className="text-base leading-relaxed text-[#051C2C]/70 mb-6">
            ...
            <h3 className="text-2xl font-serif font-bold text-[#051C2C] mt-12 mb-6">Adjuster productivity tools</h3>
            <p className="text-base leading-relaxed text-[#051C2C]/70 mb-6">
            ...
            <h3 className="text-2xl font-serif font-bold text-[#051C2C] mt-12 mb-6">Compliance and quality assurance</h3>
            <p className="text-base leading-relaxed text-[#051C2C]/70">
      ...
      <section className="py-10 sm:py-12 lg:py-16 bg-white text-[#051C2C]">
        <div className="container px-4 sm:px-6 md:px-12 max-w-4xl">
          <div className="prose prose-lg max-w-none">
            ...
            <h3 className="text-2xl font-serif font-bold text-[#051C2C] mt-12 mb-6">Processing speed and efficiency</h3>
            <p className="text-base leading-relaxed text-[#051C2C]/70 mb-6">
            ...
            <h3 className="text-2xl font-serif font-bold text-[#051C2C] mt-12 mb-6">Customer satisfaction and retention</h3>
            <p className="text-base leading-relaxed text-[#051C2C]/70 mb-6">
            ...
            <h3 className="text-2xl font-serif font-bold text-[#051C2C] mt-12 mb-6">Fraud detection and loss control</h3>
            <p className="text-base leading-relaxed text-[#051C2C]/70 mb-6">
