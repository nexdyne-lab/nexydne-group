      ...
      <section className="py-10 sm:py-12 lg:py-16 bg-white text-charcoal">
        <div className="container px-4 sm:px-6 md:px-12 max-w-4xl">
          <div className="prose prose-lg max-w-none">
            ...
            <h3 className="text-2xl text-charcoal mt-12 mb-6">Automated intake and triage</h3>
            <p className="text-base leading-relaxed text-charcoal/70 mb-6">
            ...
            <h3 className="text-2xl text-charcoal mt-12 mb-6">Straight-through processing for routine claims</h3>
            <p className="text-base leading-relaxed text-charcoal/70 mb-6">
            ...
            <h3 className="text-2xl text-charcoal mt-12 mb-6">Adjuster productivity tools</h3>
            <p className="text-base leading-relaxed text-charcoal/70 mb-6">
            ...
            <h3 className="text-2xl text-charcoal mt-12 mb-6">Compliance and quality assurance</h3>
            <p className="text-base leading-relaxed text-charcoal/70">
      ...
      <section className="py-10 sm:py-12 lg:py-16 bg-white text-charcoal">
        <div className="container px-4 sm:px-6 md:px-12 max-w-4xl">
          <div className="prose prose-lg max-w-none">
            ...
            <h3 className="text-2xl text-charcoal mt-12 mb-6">Processing speed and efficiency</h3>
            <p className="text-base leading-relaxed text-charcoal/70 mb-6">
            ...
            <h3 className="text-2xl text-charcoal mt-12 mb-6">Customer satisfaction and retention</h3>
            <p className="text-base leading-relaxed text-charcoal/70 mb-6">
            ...
            <h3 className="text-2xl text-charcoal mt-12 mb-6">Fraud detection and loss control</h3>
            <p className="text-base leading-relaxed text-charcoal/70 mb-6">
            ...
            <h3 className="text-2xl text-charcoal mt-12 mb-6">Financial performance</h3>
            <p className="text-base leading-relaxed text-charcoal/70">
