      ...
      <section className="py-10 sm:py-12 lg:py-16 bg-white text-charcoal">
        <div className="container px-4 sm:px-6 md:px-12 max-w-4xl">
          <div className="prose prose-lg max-w-none">
            ...
            <h3 className="text-2xl text-charcoal mt-12 mb-6">Discovery and requirements</h3>
            <p className="text-base leading-relaxed text-charcoal/70 mb-6">
            ...
            <h3 className="text-2xl text-charcoal mt-12 mb-6">Platform development</h3>
            <p className="text-base leading-relaxed text-charcoal/70 mb-6">
            ...
            <h3 className="text-2xl text-charcoal mt-12 mb-6">Phased rollout and training</h3>
            <p className="text-base leading-relaxed text-charcoal/70">
      ...
      <section className="py-10 sm:py-12 lg:py-16 bg-white text-charcoal">
        <div className="container px-4 sm:px-6 md:px-12 max-w-4xl">
          <div className="prose prose-lg max-w-none">
            ...
            <h3 className="text-2xl text-charcoal mt-12 mb-6">Quality and risk management</h3>
            <p className="text-base leading-relaxed text-charcoal/70 mb-6">
            ...
            <h3 className="text-2xl text-charcoal mt-12 mb-6">Client satisfaction and revenue</h3>
            <p className="text-base leading-relaxed text-charcoal/70 mb-6">
            ...
            <h3 className="text-2xl text-charcoal mt-12 mb-6">Attorney development</h3>
            <p className="text-base leading-relaxed text-charcoal/70">
