          ...
          >
            <div className="max-w-[920px]">
              ...
              <h1 className="text-charcoal font-bold tracking-[-0.035em] leading-[1.05] text-[clamp(2.2rem,4.8vw,3.8rem)]">
                Transforming contract review for a leading US law firm
              </h1>
        ...
        <div className="container px-4 sm:px-6 md:px-12 max-w-5xl">
          ...
          >
            ...
            <div className="text-base text-charcoal">
              ...
              <div className="text-muted-foreground">Managing Partner, Corporate & Commercial Practice</div>
            </div>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-10 sm:py-12 lg:py-16 bg-white text-charcoal">
        <div className="container px-4 sm:px-6 md:px-12 max-w-4xl">
          <div className="prose prose-lg max-w-none">
            ...
            <h3 className="text-2xl font-semibold text-charcoal mt-12 mb-6">Discovery and requirements</h3>
            <p className="text-base leading-relaxed text-charcoal/70 mb-6">
            ...
            <h3 className="text-2xl font-semibold text-charcoal mt-12 mb-6">Platform development</h3>
            <p className="text-base leading-relaxed text-charcoal/70 mb-6">
            ...
            <h3 className="text-2xl font-semibold text-charcoal mt-12 mb-6">Phased rollout and training</h3>
            <p className="text-base leading-relaxed text-charcoal/70">
        ...
        <div className="container px-4 sm:px-6 md:px-12 max-w-5xl">
          ...
          >
            ...
            <div className="text-base text-charcoal">
              ...
              <div className="text-muted-foreground">Senior Associate, M&A and Corporate Finance</div>
            </div>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-10 sm:py-12 lg:py-16 bg-white text-charcoal">
        <div className="container px-4 sm:px-6 md:px-12 max-w-4xl">
          <div className="prose prose-lg max-w-none">
            ...
            <h3 className="text-2xl font-semibold text-charcoal mt-12 mb-6">Quality and risk management</h3>
            <p className="text-base leading-relaxed text-charcoal/70 mb-6">
            ...
            <h3 className="text-2xl font-semibold text-charcoal mt-12 mb-6">Client satisfaction and revenue</h3>
            <p className="text-base leading-relaxed text-charcoal/70 mb-6">
            ...
            <h3 className="text-2xl font-semibold text-charcoal mt-12 mb-6">Attorney development</h3>
            <p className="text-base leading-relaxed text-charcoal/70">
      ...
      <section className="py-12 sm:py-16 md:py-24 lg:py-32 bg-white text-charcoal">
        <div className="container px-4 sm:px-6 md:px-12">
          ...
          <div className="text-center mt-16">
            <Link href="/cases">
              <Button variant="outline" className="border-border text-charcoal hover:bg-charcoal/10 px-5 sm:px-6 md:px-8 py-4 sm:py-5 md:py-6 text-base font-semibold transition-all">
