      ...
      <section className="py-10 sm:py-12 lg:py-16 bg-white text-charcoal">
        <div className="container px-4 sm:px-6 md:px-12 max-w-4xl">
          <div className="prose prose-lg max-w-none">
            ...
            <h3 className="text-2xl text-charcoal mt-12 mb-6">Intelligent document processing and classification</h3>
            <p className="text-base leading-relaxed text-charcoal/70 mb-6">
            ...
            <h3 className="text-2xl text-charcoal mt-12 mb-6">AI-assisted legal research and precedent analysis</h3>
            <p className="text-base leading-relaxed text-charcoal/70 mb-6">
            ...
            <h3 className="text-2xl text-charcoal mt-12 mb-6">Automated brief and motion analysis</h3>
            <p className="text-base leading-relaxed text-charcoal/70 mb-6">
            ...
            <h3 className="text-2xl text-charcoal mt-12 mb-6">Security and privilege protection</h3>
            <p className="text-base leading-relaxed text-charcoal/70">
      ...
      <section className="py-10 sm:py-12 lg:py-16 bg-white text-charcoal">
        <div className="container px-4 sm:px-6 md:px-12 max-w-4xl">
          <div className="prose prose-lg max-w-none">
            ...
            <h3 className="text-2xl text-charcoal mt-12 mb-6">Research efficiency and attorney productivity</h3>
            <p className="text-base leading-relaxed text-charcoal/70 mb-6">
            ...
            <h3 className="text-2xl text-charcoal mt-12 mb-6">Case outcomes and client satisfaction</h3>
            <p className="text-base leading-relaxed text-charcoal/70 mb-6">
            ...
            <h3 className="text-2xl text-charcoal mt-12 mb-6">Economic model transformation</h3>
            <p className="text-base leading-relaxed text-charcoal/70 mb-6">
            ...
            <h3 className="text-2xl text-charcoal mt-12 mb-6">Competitive positioning and growth</h3>
            <p className="text-base leading-relaxed text-charcoal/70">
