        ...
        <div className="container relative z-10 px-4 md:px-12">
          ...
          >
            ...
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-7xl font-serif font-bold tracking-tight leading-[1.05] mb-5 sm:mb-3 md:mb-4">
              Predictive revenue models for <span className="text-[#0077B5]">35%</span> better accuracy
            </h1>
      ...
      <section className="py-10 sm:py-12 lg:py-16 bg-white text-[#051C2C]">
        <div className="container px-4 sm:px-6 md:px-12 max-w-4xl">
          ...
          >
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:p-5 md:p-6 mt-12 p-4 sm:p-6 md:p-8 bg-[#051C2C]/5 rounded-lg sm:rounded-xl">
              <div>
                <div className="text-sm font-semibold text-[#0077B5] mb-2">Industry</div>
                <div className="text-[#051C2C] font-medium">B2B SaaS</div>
              </div>
              <div>
              ...
              <div>
                ...
                <div className="text-[#051C2C] font-medium">$28M ARR</div>
              </div>
            </div>
          </motion.div>
        </div>
      ...
      <section className="py-10 sm:py-12 lg:py-16 bg-white text-[#051C2C]">
        <div className="container px-4 sm:px-6 md:px-12 max-w-4xl">
          <div className="space-y-8">
            <div>
              <h3 className="text-xl font-serif font-bold text-[#051C2C] mb-4">Static budgets couldn't keep pace with growth</h3>
              <p className="text-[#051C2C]/70 leading-relaxed">
            ...
            <div>
              <h3 className="text-xl font-serif font-bold text-[#051C2C] mb-4">Disconnected data sources created blind spots</h3>
              <p className="text-[#051C2C]/70 leading-relaxed">
            ...
            <div>
              <h3 className="text-xl font-serif font-bold text-[#051C2C] mb-4">No visibility into leading indicators</h3>
              <p className="text-[#051C2C]/70 leading-relaxed">
            ...
            <div className="flex gap-4 sm:p-6 md:p-8">
              ...
              <div>
                <h3 className="text-xl font-serif font-bold text-[#051C2C] mb-4 flex items-center gap-3">
                  <Database className="w-5 h-5 sm:w-6 sm:h-6 text-[#0077B5]" />
        ...
        <div className="container px-4 sm:px-6 md:px-12 max-w-4xl">
          <div className="space-y-8">
            <div>
              ...
              <div className="grid md:grid-cols-2 gap-4">
                <div className="p-4 sm:p-5 md:p-6 bg-[#051C2C]/5 rounded-lg sm:rounded-xl">
                  <div className="text-3xl font-serif font-bold text-[#051C2C] mb-2">95%</div>
                  <div className="text-sm text-[#051C2C]/60">13-week forecast accuracy (up from 70%)</div>
                </div>
                <div className="p-4 sm:p-5 md:p-6 bg-[#051C2C]/5 rounded-lg sm:rounded-xl">
                  <div className="text-3xl font-serif font-bold text-[#051C2C] mb-2">±5%</div>
                  <div className="text-sm text-[#051C2C]/60">Quarterly revenue variance (down from ±25%)</div>
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="p-4 sm:p-5 md:p-6 bg-[#051C2C]/5 rounded-lg sm:rounded-xl">
                <div className="text-3xl font-serif font-bold text-[#051C2C] mb-2">$2.4M</div>
                <div className="text-sm text-[#051C2C]/60">Additional ARR captured through proactive territory management</div>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="p-4 sm:p-5 md:p-6 bg-[#051C2C]/5 rounded-lg sm:rounded-xl">
                ...
                <div className="text-sm text-[#051C2C]/60">Reduction in time spent on manual reporting and reconciliation</div>
              </div>
            </div>
          </div>
        </div>
