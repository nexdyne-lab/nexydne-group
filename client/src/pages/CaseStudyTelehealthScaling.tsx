      ...
      <section className="py-10 sm:py-12 lg:py-16 bg-white text-charcoal">
        <div className="container px-4 sm:px-6 md:px-12 max-w-4xl">
          <div className="prose prose-lg max-w-none">
            ...
            <h3 className="text-2xl text-charcoal mt-12 mb-6">Intelligent scheduling and capacity management</h3>
            <p className="text-base leading-relaxed text-charcoal/70 mb-6">
            ...
            <h3 className="text-2xl text-charcoal mt-12 mb-6">Automated insurance verification and prior authorization</h3>
            <p className="text-base leading-relaxed text-charcoal/70 mb-6">
            ...
            <h3 className="text-2xl text-charcoal mt-12 mb-6">Clinical documentation assistance</h3>
            <p className="text-base leading-relaxed text-charcoal/70 mb-6">
            ...
            <h3 className="text-2xl text-charcoal mt-12 mb-6">Care coordination and follow-up automation</h3>
            <p className="text-base leading-relaxed text-charcoal/70">
      ...
      <section className="py-10 sm:py-12 lg:py-16 bg-white text-charcoal">
        <div className="container px-4 sm:px-6 md:px-12 max-w-4xl">
          <div className="prose prose-lg max-w-none">
            ...
            <h3 className="text-2xl text-charcoal mt-12 mb-6">Operational scalability and efficiency</h3>
            <p className="text-base leading-relaxed text-charcoal/70 mb-6">
            ...
            <h3 className="text-2xl text-charcoal mt-12 mb-6">Patient access and satisfaction</h3>
            <p className="text-base leading-relaxed text-charcoal/70 mb-6">
            ...
            <h3 className="text-2xl text-charcoal mt-12 mb-6">Provider satisfaction and retention</h3>
            <p className="text-base leading-relaxed text-charcoal/70 mb-6">
            ...
            <h3 className="text-2xl text-charcoal mt-12 mb-6">Financial performance and strategic positioning</h3>
            <p className="text-base leading-relaxed text-charcoal/70">
            ...
            {[
              ...
              >
                <Link href={item.link} className="group block h-full">
                  <div className="aspect-[4/3] overflow-hidden mb-6 rounded-lg sm: relative bg-white/5">
                    <img
                      src={item.image}
                      alt={item.title}
