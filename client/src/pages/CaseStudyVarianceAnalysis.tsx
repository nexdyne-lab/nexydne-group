...
import { ArrowRight, ArrowLeft, Clock, Zap, FileText, CheckCircle, Download } from 'lucide-react';
...
export default function CaseStudyVarianceAnalysis() {
  return (
    <div className="min-h-screen bg-[#051C2C] text-white selection:bg-[#0077B5] selection:text-white">
        ...
        <div className="container relative z-10 px-4 md:px-12">
          ...
          >
            ...
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-7xl font-serif font-bold tracking-tight leading-[1.05] mb-5 sm:mb-3 md:mb-4">
              Automating variance analysis for <span className="text-[#0077B5]">67%</span> faster close
            </h1>
      ...
      <section className="py-10 sm:py-12 lg:py-16 bg-white text-[#051C2C]">
        <div className="container px-4 sm:px-6 md:px-12 max-w-4xl">
          ...
          >
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 mt-12 p-4 sm:p-6 md:p-8 bg-[#051C2C]/5 rounded-lg sm:rounded-xl">
              <div>
                <div className="text-sm font-semibold text-[#0077B5] mb-2">Industry</div>
                <div className="text-[#051C2C] font-medium">Logistics & Warehousing</div>
              </div>
              <div>
                <div className="text-sm font-semibold text-[#0077B5] mb-2">Company Size</div>
                <div className="text-[#051C2C] font-medium">220 employees</div>
              </div>
              <div>
                <div className="text-sm font-semibold text-[#0077B5] mb-2">Annual Revenue</div>
      ...
      <section className="py-10 sm:py-12 lg:py-16 bg-white text-[#051C2C]">
        <div className="container px-4 sm:px-6 md:px-12 max-w-4xl">
          <div className="space-y-8">
            <div>
              <h3 className="text-xl font-serif font-bold text-[#051C2C] mb-4">Manual variance analysis consumed weeks each month</h3>
              <p className="text-[#051C2C]/70 leading-relaxed">
            ...
            <div>
              <h3 className="text-xl font-serif font-bold text-[#051C2C] mb-4">Inconsistent analysis across business units</h3>
              <p className="text-[#051C2C]/70 leading-relaxed">
            ...
            <div>
              <h3 className="text-xl font-serif font-bold text-[#051C2C] mb-4">Errors and reconciliation issues created distrust</h3>
              <p className="text-[#051C2C]/70 leading-relaxed">
      ...
      <section className="py-10 sm:py-12 lg:py-16 bg-white text-[#051C2C]">
        <div className="container px-4 sm:px-6 md:px-12 max-w-4xl">
          <p className="text-xl text-[#051C2C]/80 leading-relaxed mb-6 sm:mb-8 md:mb-12">
          ...
          <div className="space-y-12">
            ...
            <div className="flex gap-4">
              ...
              <div>
                <h3 className="text-xl font-serif font-bold text-[#051C2C] mb-4 flex items-center gap-3">
                  <Zap className="w-5 h-5 sm:w-6 sm:h-6 text-[#0077B5]" />
                ...
                <ul className="space-y-2 text-[#051C2C]/70">
                  <li className="flex items-start gap-2">
                    <ArrowRight className="w-4 h-4 sm:w-5 sm:h-5 text-[#0077B5] flex-shrink-0 mt-0.5" />
            ...
            <div className="flex gap-4">
              ...
              <div>
                <h3 className="text-xl font-serif font-bold text-[#051C2C] mb-4 flex items-center gap-3">
                  <FileText className="w-5 h-5 sm:w-6 sm:h-6 text-[#0077B5]" />
      ...
      <section className="py-10 sm:py-12 lg:py-16 bg-white text-[#051C2C]">
        <div className="container px-4 sm:px-6 md:px-12 max-w-4xl">
          <div className="space-y-8">
            <div>
              <h3 className="text-xl font-serif font-bold text-[#051C2C] mb-4 flex items-center gap-3">
                <Clock className="w-5 h-5 sm:w-6 sm:h-6 text-[#0077B5]" />
              ...
              <div className="grid md:grid-cols-2 gap-4">
                <div className="p-4 sm:p-5 md:p-6 bg-[#051C2C]/5 rounded-lg sm:rounded-xl">
                  <div className="text-3xl font-serif font-bold text-[#051C2C] mb-2">5 days</div>
                  <div className="text-sm text-[#051C2C]/60">Close-to-report time (down from 15 days)</div>
                </div>
                <div className="p-4 sm:p-5 md:p-6 bg-[#051C2C]/5 rounded-lg sm:rounded-xl">
                  <div className="text-3xl font-serif font-bold text-[#051C2C] mb-2">120 hrs</div>
                  <div className="text-sm text-[#051C2C]/60">Finance team hours saved per month</div>
                </div>
              </div>
            </div>
            ...
            <div>
              <h3 className="text-xl font-serif font-bold text-[#051C2C] mb-4 flex items-center gap-3">
                <CheckCircle className="w-5 h-5 sm:w-6 sm:h-6 text-[#0077B5]" />
              ...
              <div className="p-4 sm:p-5 md:p-6 bg-[#051C2C]/5 rounded-lg sm:rounded-xl">
                <div className="text-3xl font-serif font-bold text-[#051C2C] mb-2">90%</div>
                <div className="text-sm text-[#051C2C]/60">Reduction in manual errors and reconciliation issues</div>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="p-4 sm:p-5 md:p-6 bg-[#051C2C]/5 rounded-lg sm:rounded-xl">
                <div className="text-3xl font-serif font-bold text-[#051C2C] mb-2">3x</div>
                <div className="text-sm text-[#051C2C]/60">Increase in time spent on strategic analysis vs. routine reporting</div>
              </div>
            </div>
          </div>
        </div>
            ...
            {[
              ...
              >
                <Link href={item.link} className="group block h-full">
                  <div className="aspect-[16/9] overflow-hidden mb-6 rounded-lg sm:rounded-xl relative bg-white/5">
                    <img
                      src={item.image}
                      alt={item.title}
