      ...
      <section className="relative w-full bg-background overflow-hidden">
        ...
        <div className="relative mx-auto max-w-[1400px] px-6 sm:px-8 md:px-12 lg:px-16 xl:px-20">
          ...
          <motion.div
            ...
            className="flex flex-col justify-center min-h-[50vh] py-20 lg:py-24"
          >
            <div className="max-w-[920px]">
              <div className="flex items-center gap-3 mb-6">
                <span className="block h-[3px] w-9 bg-primary" />
                <span className="text-[12px] font-semibold uppercase tracking-[0.18em] text-muted-foreground">Case Study · Financial Services</span>
              </div>
              <h1 className="text-charcoal font-bold tracking-[-0.035em] leading-[1.05] text-[clamp(2.2rem,4.8vw,3.8rem)]">
                Client onboarding from weeks to 3 days
              </h1>
              ...
              challenge="A fast-growing wealth management firm was losing prospective clients during onboarding. The firm's brand promised a high-touch advisory experience, but new-client onboarding routinely took 6-8 weeks: paper-based account applications, manual KYC and source-of-funds verification, advisor-by-advisor compliance review, and back-office reconciliation across the firm's custodian and portfolio-management systems. Compliance officers were producing manual workpapers to demonstrate SEC and FINRA compliance, and the operations team flagged a steady stream of rework when applications arrived incomplete. Advisors were spending up to 25% of their time chasing paperwork rather than advising clients, prospect drop-off during onboarding had crossed 15%, and the COO had set an aggressive target of cutting onboarding time to under one week to support the firm's planned doubling of advisor headcount over the next 24 months."
              solution="NexDyne deployed a digital onboarding and compliance automation platform that reshaped the new-client experience from a paper-and-spreadsheet workflow into an end-to-end digital journey. We started with detailed mapping of the existing onboarding process across all four advisor pods and the central operations team, identifying the steps with the highest cycle time and rework. The platform combines a digital, mobile-friendly client intake — with progressive disclosure, e-signature, and integrated identity verification — with automated KYC and source-of-funds verification against external data sources. A compliance workflow engine routes each application through the firm's policy with full audit trails, and integrations with the firm's custodian, portfolio-management, and CRM systems eliminate the manual rekeying that consumed back-office capacity. Advisors get a real-time pipeline view that shows where every prospect is in onboarding and what their next action is. Rollout was phased by advisor pod with embedded operations partners ensuring quality and adoption, and we ran in parallel with the legacy process for the first 60 days to verify equivalence before fully cutting over."
              results={[
                "83% faster client onboarding, reducing the average from 6-8 weeks to under one week",
                "100% compliance with SEC and FINRA requirements, validated by internal and external audit",
                "45% increase in new client capacity per advisor without adding operations headcount",
                "Prospect drop-off during onboarding dropped from 15% to under 4%"
              ]}
              variant="hero"
                />
              </div>
        ...
        <div className="container px-4 sm:px-6 md:px-12 max-w-4xl">
          <div className="prose prose-lg max-w-none">
            <p className="text-xl leading-relaxed text-charcoal/80 mb-6">
              A Boston-based wealth management firm managed assets for high-net-worth individuals and families with a team of 180 employees. While the firm's investment performance and client service were excellent, the onboarding process for new clients was cumbersome and slow, creating friction that cost the firm business and frustrated advisors.
            </p>
        ...
        <div className="container px-4 sm:px-6 md:px-12 max-w-5xl">
          ...
          >
            ...
            <div className="text-base text-charcoal">
              ...
              <div className="text-muted-foreground">Managing Partner</div>
            </div>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-10 sm:py-12 lg:py-16 bg-white text-charcoal">
        <div className="container px-4 sm:px-6 md:px-12 max-w-4xl">
          <div className="prose prose-lg max-w-none">
            ...
            <h3 className="text-2xl font-semibold text-charcoal mt-12 mb-6">Automated compliance verification and KYC</h3>
            <p className="text-base leading-relaxed text-charcoal/70 mb-6">
            ...
            <h3 className="text-2xl font-semibold text-charcoal mt-12 mb-6">Intelligent account setup and funding</h3>
            <p className="text-base leading-relaxed text-charcoal/70 mb-6">
            ...
            <h3 className="text-2xl font-semibold text-charcoal mt-12 mb-6">Advisor collaboration and oversight</h3>
            <p className="text-base leading-relaxed text-charcoal/70">
        ...
        <div className="container px-4 sm:px-6 md:px-12 max-w-5xl">
          ...
          >
            ...
            <div className="text-base text-charcoal">
              ...
              <div className="text-muted-foreground">Chief Operating Officer</div>
            </div>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-10 sm:py-12 lg:py-16 bg-white text-charcoal">
        <div className="container px-4 sm:px-6 md:px-12 max-w-4xl">
          <div className="prose prose-lg max-w-none">
            ...
            <h3 className="text-2xl font-semibold text-charcoal mt-12 mb-6">Onboarding speed and client experience</h3>
            <p className="text-base leading-relaxed text-charcoal/70 mb-6">
            ...
            <h3 className="text-2xl font-semibold text-charcoal mt-12 mb-6">Operational capacity and efficiency</h3>
            <p className="text-base leading-relaxed text-charcoal/70 mb-6">
            ...
            <h3 className="text-2xl font-semibold text-charcoal mt-12 mb-6">Growth and strategic positioning</h3>
            <p className="text-base leading-relaxed text-charcoal/70">
              The platform paid for itself inside the first year through increased client acquisition, operational time savings, and avoided compliance costs. More strategically, it enabled the firm to compete effectively for younger high-net-worth clients who expected digital experiences. Assets under management grew roughly 25% over the measurement period, with 42% of new assets from clients under age 50 versus 18% previously. The firm's ability to combine sophisticated investment management with modern client experience became a key differentiator in competitive situations. Management views the platform as foundational infrastructure that will support a near-doubling of assets under management without proportional increases in operations staff.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 sm:py-16 md:py-24 lg:py-32 bg-background border-t border-border">
        <div className="container px-4 sm:px-6 md:px-12">
            ...
            {[
              ...
              >
                <Link href={item.link} className="group block h-full">
                  <div className="aspect-[4/3] overflow-hidden mb-6 rounded-md relative bg-charcoal/5">
                    <img
                      src={item.image}
                      alt={item.title}
          ...
          <div className="text-center mt-16">
            <Link href="/cases">
              <Button variant="outline" className="border-border text-charcoal hover:bg-charcoal/5 hover:border-primary px-5 sm:px-6 md:px-8 py-4 sm:py-5 md:py-6 text-base font-semibold transition-colors bg-transparent">
