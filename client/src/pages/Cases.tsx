...
export default function Cases() {
  ...
  const caseStudies = [
    { id: "aerospace-digital-engineering", title: "How a global aircraft maker brought new programs to market 40% faster", industry: "Aerospace & Defense", metric: "40%", image: "/images/industries/aero-rocket.jpg", description: "An aerospace and defense supplier was losing years and heavy cost overruns to problems found late in testing. Connecting its engineering work end to end changed the economics of every program." },
    { id: "supply-chain-visibility", title: "98% fleet readiness for a defense prime by getting ahead of demand", industry: "Aerospace & Defense", metric: "98%", image: "/images/cases/supply-chain-visibility-hero.jpg", description: "A defense sustainment provider was grounding aircraft for want of parts while spare inventory sat in the wrong warehouses. Anticipating demand instead of reacting to it lifted readiness and freed capital at the same time." },
    { id: "logistics-optimization", title: "Halving surprise aircraft groundings for a major airline", industry: "Aerospace & Defense", metric: "50%", image: "/images/industries/ops-monitors-dark.jpg", description: "Every unexpected grounding cost a regional carrier dearly — and a plane full of disrupted passengers. Reading the signals its aircraft were already sending let the airline fix problems on its own schedule, not the fault's." },
    { id: "automotive-ev-transition", title: "Retooling a supplier line for electric-vehicle parts", industry: "Automotive", metric: "45%", image: "/images/cases/automotive-ev-transition-hero.jpg", description: "A components maker had to convert an existing line to electric-vehicle parts while its old business still had to ship every day. Treating the switch as an engineering problem, not a scramble, changed the economics of the launch." },
    { id: "automotive-connected-vehicle", title: "Turning connected-vehicle data into fewer warranty claims", industry: "Automotive", metric: "30%", image: "/images/cases/automotive-connected-vehicle-hero.jpg", description: "A vehicle manufacturer was already collecting data from the vehicles it sold, but doing almost nothing with it. Reading those signals cut its warranty bill and opened a service business it had never had before." },
    { id: "automotive-supply-resilience", title: "De-risking parts supply and recall traceability for a supplier", industry: "Automotive", metric: "80%", image: "/images/cases/automotive-supply-resilience-hero.jpg", description: "A supplier kept losing production when a single chip or component ran short, and when a quality issue surfaced it could not tell exactly which parts were affected. Getting ahead of supply and knowing where every part went changed both." },
    { id: "consumer-electronics-demand-optimization", title: "Cutting Excess Stock for a Consumer Electronics Brand", industry: "Consumer Products", metric: "40%", image: "/images/cases/consumer-electronics-demand-optimization-hero.jpg", description: "Every new product had to be ordered before anyone knew how it would sell — and by the time demand was clear, the model was already halfway to retirement. Learning from similar products changed those odds." },
    { id: "food-beverage-demand-forecasting", title: "Sharper Demand Forecasting for a Food and Beverage Maker", industry: "Consumer Products", metric: "30%", image: "/images/cases/food-beverage-demand-forecasting-hero.jpg", description: "The same misread on demand produced two problems at once — perfectly good product thrown away, and shelves empty when customers came looking. A better read on demand eased both." },
    { id: "retail-assortment-optimization", title: "Tailoring Store Assortments Lifts a Retailer's Sales", industry: "Consumer Products", metric: "12%", image: "/images/cases/retail-assortment-optimization-hero.jpg", description: "Every store carried the same products regardless of who shopped there — so items that flew off the shelves in one neighbourhood gathered dust in another. Matching the range to the customer changed that." },
    { id: "university-student-success", title: "Helping 18% more students reach graduation", industry: "Education", metric: "18%", image: "/images/cases/university-student-success-hero.jpg", description: "A regional public university was losing capable students long before they earned a degree — usually before anyone noticed they were struggling. Seeing trouble early, and reaching out in time, changed the odds for thousands of them." },
    ...
    { id: "bank-cross-sell", title: "Turning single accounts into real relationships", industry: "Financial Services", metric: "40% more products per customer", image: "/images/cases/bank-cross-sell-hero.jpg", description: "A regional bank held years of insight about its customers, but it sat locked in separate systems that never spoke to one another. Bringing it into one view let the bank serve people at the moments that mattered." },
    { id: "wealth-onboarding", title: "Cutting wealth onboarding from weeks to days", industry: "Financial Services", metric: "60%", image: "/images/cases/wealth-onboarding-hero.jpg", description: "A wealth manager built its name on personal service, then made every new client begin with three weeks of paperwork. Rebuilding that first experience freed advisers to do what clients actually pay them for." },
    { id: "healthcare-transformation", title: "Unifying scattered patient data to improve outcomes 35%", industry: "Healthcare", metric: "35%", image: "/images/cases/healthcare-transformation-hero.jpg", description: "The system had spent years digitising its records, yet its clinicians still could not see the whole patient. Bringing that information together — and putting it in front of the care team when it mattered — changed the quality of care it could deliver." },
    { id: "healthcare-readmission", title: "Cutting avoidable readmissions by 42% with better prediction", industry: "Healthcare", metric: "42%", image: "/images/cases/healthcare-readmission-hero.jpg", description: "The network was paying steep penalties for patients who returned within weeks of going home. Learning to tell — before a patient left — who was genuinely at risk let its care teams put their effort where it would do the most good." },
    { id: "healthcare-revenue-cycle", title: "How a Health System Started Collecting What It Was Already Owed", industry: "Healthcare", metric: "45% fewer rejected claims", image: "/case-healthcare-team.5797392b.jpg", description: "The system was doing the work but not being paid for all of it — claims rejected by insurers, payments dragging out for weeks, staff redoing work that should have been right the first time. Fixing how it billed and collected turned that leak into recovered revenue." },
    { id: "insurance-ai-underwriting", title: "Quoting Commercial Business in a Day, Not a Week", industry: "Insurance", metric: "40%", image: "/images/cases/insurance-ai-underwriting-hero.jpg", description: "A commercial lines carrier was losing broker business because it was slow to quote. Letting software handle the routine risks — and freeing underwriters for the hard ones — turned speed into an advantage." },
    { id: "insurance-claims-automation", title: "Settling Straightforward Claims in Hours, Not Weeks", industry: "Insurance", metric: "60%", image: "/images/cases/insurance-claims-automation-hero.jpg", description: "A property and casualty carrier was settling even simple claims in two weeks while nimbler rivals paid in hours. Handling the routine claims automatically freed adjusters for the cases that needed them." },
    { id: "insurance-digital-distribution", title: "Turning a Call-Center Insurer Into a Digital One", industry: "Insurance", metric: "50%", image: "/images/cases/insurance-digital-distribution-hero.jpg", description: "A regional carrier still ran on phone calls and paper forms while newer rivals sold and served entirely online. Rebuilding its digital channels let customers do for themselves what they used to have to call about." },
    ...
    { id: "semiconductor-quality-prediction", title: "Catching chip defects weeks before they appear", industry: "Manufacturing", metric: "92%", image: "/images/cases/semiconductor-quality-prediction-hero.jpg", description: "A semiconductor manufacturer was scrapping batch after batch of finished silicon because flaws only revealed themselves at the very end of a process hundreds of steps long. Reading the warning signs early turned quality from a post-mortem into a forecast." },
    { id: "industrial-connected-products", title: "Building a Recurring Services Business on Machines Already Sold", industry: "Manufacturing", metric: "2,700 machines on connected services", image: "/images/capabilities/cap-battery-factory.jpg", description: "An industrial equipment manufacturer earned lumpy, one-off revenue from the machines it sold and lost sight of them the moment they shipped. Staying connected to that installed base turned it into a steady, higher-margin services business." },
    { id: "pe-industrial-transformation", title: "How a Fund Added Seven Points of EBITDA Margin at an Industrial Manufacturer", industry: "Private Equity", metric: "7 pts EBITDA margin", image: "/images/cases/pe-industrial-transformation-hero.jpg", description: "A private equity fund had bought a solid industrial business that had quietly stopped getting better. A focused program of operational improvement changed the trajectory of the hold — and the return." },
    { id: "pe-healthcare-diligence", title: "Cutting healthcare diligence time by 40%", industry: "Private Equity", metric: "40%", image: "/images/cases/pe-healthcare-diligence-hero.jpg", description: "A private equity fund saw far more healthcare deals than it could properly assess. A faster, more consistent way to run commercial diligence let it move quickly on the right ones — and walk away from the wrong ones with conviction." },
    { id: "pe-distribution-digital", title: "Standing up a carved-out distributor in six months", industry: "Private Equity", metric: "6 Months", image: "/images/cases/pe-distribution-digital-hero.jpg", description: "A private equity fund bought a distribution business that was deeply tangled up in its former parent. Standing it up on its own — new systems included — quickly, cleanly and without disrupting customers was the whole game." },
    ...
    { id: "government-benefits-modernization", title: "Getting benefits to residents weeks sooner at a county agency", industry: "Public Sector", metric: "50%", image: "/images/cases/government-benefits-modernization-hero.jpg", description: "Deciding a single application meant a caseworker gathering documents and checking records by hand for hours. Letting software handle the routine paperwork freed staff to spend their time on the people who needed them most." },
    { id: "fashion-retail-digital-transformation", title: "Growing a fashion retailer's online sales by 85%", industry: "Retail", metric: "85%", image: "/images/cases/fashion-retail-digital-transformation-hero.jpg", description: "A well-known apparel chain was losing a generation of digital-first shoppers to online-only rivals. Bringing its stores and website together into a single experience changed how — and how much — its customers bought." },
    { id: "grocery-demand-forecasting", title: "Cutting a grocer's fresh-food waste by a third", industry: "Retail", metric: "35%", image: "/images/cases/grocery-demand-forecasting-hero.jpg", description: "A well-run grocery chain was throwing away fresh food in some stores while running out of the same items in others. Learning to predict demand store by store turned a costly guessing game into something close to a science." },
    ...
    { id: "telecom-customer-experience", title: "Cutting a regional carrier's churn by 40%", industry: "Technology, Media & Telecom", metric: "40%", image: "/images/cases/telecom-customer-experience-hero.jpg", description: "A mobile carrier was losing customers faster than its competitors and only found out they were unhappy after they had already decided to leave. Seeing trouble coming — and acting on it early — turned defection into loyalty." },
    { id: "warehouse-optimization", title: "Lifting warehouse productivity 45% for a regional distributor", industry: "Transportation & Logistics", metric: "45%", image: "/images/cases/warehouse-optimization-hero.jpg", description: "A distributor's warehouses were built for pallets, not the single-item online orders now flooding in — and every peak meant hiring workers it could not find. Rethinking how work moved through the buildings changed the economics of fulfillment." },
    ...
    { id: "hotel-revenue-transformation", title: "Lifting hotel revenue per room by 18%", industry: "Travel & Hospitality", metric: "18%", image: "/images/cases/hotel-revenue-transformation-hero.jpg", description: "A hotel group was pricing its rooms by hand and leaving money on the table almost every night. Letting prices respond to real demand, property by property, changed the economics of the whole portfolio." },
    { id: "airline-loyalty-redesign", title: "Reviving a regional airline's loyalty program", industry: "Travel & Hospitality", metric: "40%", image: "/images/cases/airline-loyalty-redesign-hero.jpg", description: "A regional airline had millions of loyalty members but only a fraction who still cared. Making the rewards fit the traveler — not the other way round — turned a dormant program into a reason to keep flying." },
    { id: "hotel-guest-experience", title: "Restoring personal service across a hotel group", industry: "Travel & Hospitality", metric: "+25pts", image: "/images/cases/hotel-guest-experience-hero.jpg", description: "An upscale hotel group had built its name on knowing its guests — and was quietly losing that as it grew. Giving every property one clear view of each guest brought the personal touch back at scale." },
