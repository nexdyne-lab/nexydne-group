          ...
          <div className="grid lg:grid-cols-12 gap-6 sm:gap-8 lg:gap-12">
            ...
            <aside className="lg:col-span-3">
              <div className="lg:sticky lg:top-32">
                <h2 className="text-xs font-semibold uppercase tracking-[0.15em] text-gray-400 mb-4">
                  Contents
                </h2>
                <nav className="space-y-2">
                  {sections.map((section) => (
                    <a
                      key={section.id}
                      href={`#${section.id}`}
                      className="block text-sm text-gray-600 hover:text-[#0077B5] transition-colors py-1"
                    >
                      {section.title}
                    </a>
                  ))}
            ...
            <main className="lg:col-span-9 max-w-3xl">
              <div className="prose prose-lg prose-gray max-w-none">
                ...
                <section id="what-are-cookies" className="scroll-mt-32 mb-6 sm:mb-8 md:mb-12">
                  <h2 className="text-2xl font-serif font-bold text-[#051C2C] mb-4">
                    What Are Cookies
                  </h2>
                ...
                <section id="types" className="scroll-mt-32 mb-6 sm:mb-8 md:mb-12">
                  ...
                  <div className="space-y-6">
                    {cookieTypes.map((cookie, index) => (
                      <div key={index} className="border border-gray-200 rounded-lg p-4 sm:p-5 md:p-6">
                        <div className="flex items-center justify-between mb-3">
                          <h3 className="text-lg font-semibold text-[#051C2C]">
                            {cookie.name}
                          </h3>
                        ...
                        <div>
                          <span className="text-xs font-semibold uppercase tracking-wide text-gray-400">Examples:</span>
                ...
                <section id="managing" className="scroll-mt-32 mb-6 sm:mb-8 md:mb-12">
                  ...
                  <h3 className="text-lg font-semibold text-[#051C2C] mt-6 mb-3">
                    Browser Settings
                  </h3>
                  <p className="text-gray-700 leading-relaxed mb-4">
                  ...
                  <ul className="list-disc pl-6 space-y-2 text-gray-700 mb-6">
                    <li><a href="https://support.google.com/chrome/answer/95647" target="_blank" rel="noopener noreferrer" className="text-[#0077B5] hover:underline">Google Chrome</a></li>
                    <li><a href="https://support.mozilla.org/en-US/kb/cookies-information-websites-store-on-your-computer" target="_blank" rel="noopener noreferrer" className="text-[#0077B5] hover:underline">Mozilla Firefox</a></li>
                    <li><a href="https://support.apple.com/guide/safari/manage-cookies-sfri11471/mac" target="_blank" rel="noopener noreferrer" className="text-[#0077B5] hover:underline">Apple Safari</a></li>
                    <li><a href="https://support.microsoft.com/en-us/microsoft-edge/delete-cookies-in-microsoft-edge-63947406-40ac-c3b8-57b9-2a946a29ae09" target="_blank" rel="noopener noreferrer" className="text-[#0077B5] hover:underline">Microsoft Edge</a></li>
                  </ul>
                  ...
                  <ul className="list-disc pl-6 space-y-2 text-gray-700">
                    <li><a href="https://optout.networkadvertising.org/" target="_blank" rel="noopener noreferrer" className="text-[#0077B5] hover:underline">Network Advertising Initiative (NAI)</a></li>
                    <li><a href="https://optout.aboutads.info/" target="_blank" rel="noopener noreferrer" className="text-[#0077B5] hover:underline">Digital Advertising Alliance (DAA)</a></li>
                    <li><a href="https://www.youronlinechoices.eu/" target="_blank" rel="noopener noreferrer" className="text-[#0077B5] hover:underline">European Interactive Digital Advertising Alliance (EDAA)</a></li>
                  </ul>
                ...
                <section id="contact" className="scroll-mt-32 mb-6 sm:mb-8 md:mb-12">
                  ...
                  <div className="bg-gray-50 p-4 sm:p-5 md:p-6 rounded-lg">
                    ...
                    <p className="text-gray-700 mb-2">
                      Email: <a href="mailto:privacy@nexdyne.com" className="text-[#0077B5] hover:underline">privacy@nexdyne.com</a>
                    </p>
                    <p className="text-gray-700">
                      For more information about how we handle your personal data, please see our <Link href="/privacy-policy" className="text-[#0077B5] hover:underline">Privacy Policy</Link>.
                    </p>
                  </div>
                </section>
