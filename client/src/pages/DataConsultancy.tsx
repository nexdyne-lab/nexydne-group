  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="container max-w-6xl">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4 sm:p-6 md:p-8">
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold mb-3 text-gray-900">Accelerate delivery</h3>
            ...
            <div className="text-center">
              <div className="inline-flex items-center justify-center w-16 h-16 bg-blue-100 rounded-full mb-6">
                <Award className="w-8 h-8 text-[#2D5BFF]" />
              </div>
              <h3 className="text-xl font-bold mb-3 text-gray-900">Certified expertise</h3>
              <p className="text-gray-700 leading-relaxed">
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold mb-3 text-gray-900">Flexible scaling</h3>
              <p className="text-gray-700 leading-relaxed">
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold mb-3 text-gray-900">Knowledge transfer</h3>
              <p className="text-gray-700 leading-relaxed">
      ...
      <section className="py-12 sm:py-16 md:py-20 lg:py-12 sm:py-16 md:py-20 lg:py-12 sm:py-16 lg:py-24 bg-gray-50">
        <div className="container max-w-5xl">
          <div className="mb-6 sm:mb-8 md:mb-12">
            <p className="text-sm font-semibold tracking-widest uppercase mb-4 text-gray-500">Understanding Data Consultancy</p>
          ...
          <div className="bg-white border-l-4 border-[#2D5BFF] p-4 sm:p-6 md:p-8">
            ...
            <p className="font-semibold text-gray-900">CTO, SaaS Company</p>
          </div>
        </div>
      </section>
        ...
        <div className="container max-w-5xl">
          ...
          <div className="space-y-12">
            <div className="flex gap-4 sm:p-6 md:p-8">
              ...
              <div>
                <h3 className="text-2xl font-bold mb-4 text-gray-900">Understand & Plan</h3>
                <p className="text-gray-700 leading-relaxed">
            ...
            <div className="flex gap-4 sm:p-6 md:p-8">
              ...
              <div>
                <h3 className="text-2xl font-bold mb-4 text-gray-900">Execute & Deliver</h3>
                <p className="text-gray-700 leading-relaxed">
            ...
            <div className="flex gap-4 sm:p-6 md:p-8">
              ...
              <div>
                <h3 className="text-2xl font-bold mb-4 text-gray-900">Transfer & Enable</h3>
                <p className="text-gray-700 leading-relaxed">
      ...
      <section className="py-12 sm:py-16 md:py-20 lg:py-12 sm:py-16 md:py-20 lg:py-12 sm:py-16 lg:py-24 bg-gray-50">
        <div className="container max-w-6xl">
          <div className="text-center mb-8 sm:mb-12 md:mb-16">
            <p className="text-sm font-semibold tracking-widest uppercase mb-4 text-gray-500">Areas of Expertise</p>
            <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-gray-900">
          ...
          <div className="grid md:grid-cols-2 gap-4 sm:p-6 md:p-8">
            <div className="bg-white p-4 sm:p-6 md:p-8 border-2 border-gray-200">
              <h3 className="text-2xl font-bold mb-4 text-gray-900">Data Architecture & Strategy</h3>
              <p className="text-gray-700 leading-relaxed">
            ...
            <div className="bg-white p-4 sm:p-6 md:p-8 border-2 border-gray-200">
              <h3 className="text-2xl font-bold mb-4 text-gray-900">Data Engineering & Pipelines</h3>
              <p className="text-gray-700 leading-relaxed">
            ...
            <div className="bg-white p-4 sm:p-6 md:p-8 border-2 border-gray-200">
              <h3 className="text-2xl font-bold mb-4 text-gray-900">Cloud Data Platforms</h3>
              <p className="text-gray-700 leading-relaxed">
            ...
            <div className="bg-white p-4 sm:p-6 md:p-8 border-2 border-gray-200">
              <h3 className="text-2xl font-bold mb-4 text-gray-900">Analytics & Business Intelligence</h3>
              <p className="text-gray-700 leading-relaxed">
            ...
            <div className="bg-white p-4 sm:p-6 md:p-8 border-2 border-gray-200">
              <h3 className="text-2xl font-bold mb-4 text-gray-900">Data Science & Machine Learning</h3>
              <p className="text-gray-700 leading-relaxed">
            ...
            <div className="bg-white p-4 sm:p-6 md:p-8 border-2 border-gray-200">
              <h3 className="text-2xl font-bold mb-4 text-gray-900">Data Governance & Quality</h3>
              <p className="text-gray-700 leading-relaxed">
