  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="container max-w-6xl">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4 sm:p-6 md:p-8">
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold mb-3 text-charcoal">One version of truth</h3>
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold mb-3 text-charcoal">Compliance assured</h3>
              <p className="text-charcoal/80 leading-relaxed">
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold mb-3 text-charcoal">Controlled access</h3>
              <p className="text-charcoal/80 leading-relaxed">
      ...
      <section className="py-12 sm:py-16 md:py-20 lg:py-12 sm:py-16 md:py-20 lg:py-12 sm:py-16 lg:py-24 bg-subtle">
        <div className="container max-w-5xl">
          <div className="mb-6 sm:mb-8 md:mb-12">
            <p className="text-sm font-semibold tracking-widest uppercase mb-4 text-muted-foreground">Understanding Data Governance</p>
          ...
          <div className="bg-white border-l-4 border-primary p-4 sm:p-6 md:p-8">
            ...
            <p className="font-semibold text-charcoal">VP of Operations, Retail Company</p>
          </div>
        </div>
      </section>
        ...
        <div className="container max-w-5xl">
          ...
          <div className="space-y-12">
            <div className="flex gap-4 sm:p-6 md:p-8">
              ...
              <div>
                <h3 className="text-2xl font-bold mb-4 text-charcoal">Assess & Design Framework</h3>
                <p className="text-charcoal/80 leading-relaxed">
            ...
            <div className="flex gap-4 sm:p-6 md:p-8">
              ...
              <div>
                <h3 className="text-2xl font-bold mb-4 text-charcoal">Implement Controls & Tools</h3>
                <p className="text-charcoal/80 leading-relaxed">
            ...
            <div className="flex gap-4 sm:p-6 md:p-8">
              ...
              <div>
                <h3 className="text-2xl font-bold mb-4 text-charcoal">Enable & Sustain</h3>
                <p className="text-charcoal/80 leading-relaxed">
      ...
      <section className="py-12 sm:py-16 md:py-20 lg:py-12 sm:py-16 md:py-20 lg:py-12 sm:py-16 lg:py-24 bg-subtle">
        <div className="container max-w-6xl">
          <div className="text-center mb-8 sm:mb-12 md:mb-16">
            <p className="text-sm font-semibold tracking-widest uppercase mb-4 text-muted-foreground">Governance Pillars</p>
            <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-charcoal">
          ...
          <div className="grid md:grid-cols-2 gap-4 sm:p-6 md:p-8">
            <div className="bg-white p-4 sm:p-6 md:p-8 border-2 border-border">
              <h3 className="text-2xl font-bold mb-4 text-charcoal">Data Quality Management</h3>
              <p className="text-charcoal/80 leading-relaxed">
            ...
            <div className="bg-white p-4 sm:p-6 md:p-8 border-2 border-border">
              <h3 className="text-2xl font-bold mb-4 text-charcoal">Data Security & Privacy</h3>
              <p className="text-charcoal/80 leading-relaxed">
            ...
            <div className="bg-white p-4 sm:p-6 md:p-8 border-2 border-border">
              <h3 className="text-2xl font-bold mb-4 text-charcoal">Data Ownership & Stewardship</h3>
              <p className="text-charcoal/80 leading-relaxed">
            ...
            <div className="bg-white p-4 sm:p-6 md:p-8 border-2 border-border">
              <h3 className="text-2xl font-bold mb-4 text-charcoal">Metadata & Data Catalog</h3>
              <p className="text-charcoal/80 leading-relaxed">
            ...
            <div className="bg-white p-4 sm:p-6 md:p-8 border-2 border-border">
              <h3 className="text-2xl font-bold mb-4 text-charcoal">Data Lifecycle Management</h3>
              <p className="text-charcoal/80 leading-relaxed">
            ...
            <div className="bg-white p-4 sm:p-6 md:p-8 border-2 border-border">
              <h3 className="text-2xl font-bold mb-4 text-charcoal">Change Management & Training</h3>
              <p className="text-charcoal/80 leading-relaxed">
