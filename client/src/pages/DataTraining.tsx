  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="py-12 sm:py-16 md:py-20 lg:py-12 sm:py-16 md:py-20 lg:py-12 sm:py-16 lg:py-24 bg-subtle">
        <div className="container max-w-5xl">
          <div className="mb-6 sm:mb-8 md:mb-12">
            <p className="text-sm font-semibold tracking-widest uppercase mb-4 text-muted-foreground">Understanding Data Training</p>
          ...
          <div className="bg-white border-l-4 border-primary p-4 sm:p-6 md:p-8">
            ...
            <p className="font-semibold text-charcoal">Director of Analytics, Healthcare Company</p>
          </div>
        </div>
      </section>
        ...
        <div className="container max-w-5xl">
          ...
          <div className="space-y-12">
            <div className="flex gap-4 sm:p-6 md:p-8">
              ...
              <div>
                <h3 className="text-2xl font-bold mb-4 text-charcoal">Assess Needs & Design</h3>
                <p className="text-charcoal/80 leading-relaxed">
            ...
            <div className="flex gap-4 sm:p-6 md:p-8">
              ...
              <div>
                <h3 className="text-2xl font-bold mb-4 text-charcoal">Deliver Hands-On Training</h3>
                <p className="text-charcoal/80 leading-relaxed">
            ...
            <div className="flex gap-4 sm:p-6 md:p-8">
              ...
              <div>
                <h3 className="text-2xl font-bold mb-4 text-charcoal">Support & Reinforce</h3>
                <p className="text-charcoal/80 leading-relaxed">
      ...
      <section className="py-12 sm:py-16 md:py-20 lg:py-12 sm:py-16 md:py-20 lg:py-12 sm:py-16 lg:py-24 bg-subtle">
        <div className="container max-w-6xl">
          <div className="text-center mb-8 sm:mb-12 md:mb-16">
            <p className="text-sm font-semibold tracking-widest uppercase mb-4 text-muted-foreground">Training Programs</p>
            <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-charcoal">
          ...
          <div className="grid md:grid-cols-2 gap-4 sm:p-6 md:p-8">
            <div className="bg-white p-4 sm:p-6 md:p-8 border-2 border-border">
              <h3 className="text-2xl font-bold mb-4 text-charcoal">Data Fundamentals for Business Users</h3>
              <p className="text-charcoal/80 leading-relaxed">
            ...
            <div className="bg-white p-4 sm:p-6 md:p-8 border-2 border-border">
              <h3 className="text-2xl font-bold mb-4 text-charcoal">SQL & Database Essentials</h3>
              <p className="text-charcoal/80 leading-relaxed">
            ...
            <div className="bg-white p-4 sm:p-6 md:p-8 border-2 border-border">
              <h3 className="text-2xl font-bold mb-4 text-charcoal">Data Visualization & Dashboards</h3>
              <p className="text-charcoal/80 leading-relaxed">
            ...
            <div className="bg-white p-4 sm:p-6 md:p-8 border-2 border-border">
              <h3 className="text-2xl font-bold mb-4 text-charcoal">Python for Data Analysis</h3>
              <p className="text-charcoal/80 leading-relaxed">
            ...
            <div className="bg-white p-4 sm:p-6 md:p-8 border-2 border-border">
              <h3 className="text-2xl font-bold mb-4 text-charcoal">Data Engineering Fundamentals</h3>
              <p className="text-charcoal/80 leading-relaxed">
            ...
            <div className="bg-white p-4 sm:p-6 md:p-8 border-2 border-border">
              <h3 className="text-2xl font-bold mb-4 text-charcoal">Advanced Analytics & Statistics</h3>
              <p className="text-charcoal/80 leading-relaxed">
