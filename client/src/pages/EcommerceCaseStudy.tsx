        ...
        <div className="container">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 sm:p-6 md:p-8">
            <div className="text-center">
              ...
              <div className="text-4xl font-bold text-slate-900 mb-2">83%</div>
            ...
            <div className="text-center">
              ...
              <div className="text-4xl font-bold text-slate-900 mb-2">4.2hrs</div>
              <div className="text-slate-600">Avg. processing time</div>
            </div>
            <div className="text-center">
              <div className="inline-flex items-center justify-center w-16 h-16 bg-green-100 rounded-full mb-4">
                <DollarSign className="w-8 h-8 text-green-600" />
              </div>
              <div className="text-4xl font-bold text-slate-900 mb-2">$580K</div>
            ...
            <div className="text-center">
              ...
              <div className="text-4xl font-bold text-slate-900 mb-2">12,000+</div>
              <div className="text-slate-600">Daily orders</div>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-6">
              <div className="bg-white p-4 sm:p-5 md:p-6 rounded-lg border border-slate-200">
                <h3 className="text-xl font-semibold text-slate-900 mb-3">Fragmented order management across platforms</h3>
              ...
              <div className="bg-white p-4 sm:p-5 md:p-6 rounded-lg border border-slate-200">
                <h3 className="text-xl font-semibold text-slate-900 mb-3">Inventory sync delays causing overselling</h3>
                <p className="text-slate-600">
              ...
              <div className="bg-white p-4 sm:p-5 md:p-6 rounded-lg border border-slate-200">
                <h3 className="text-xl font-semibold text-slate-900 mb-3">Manual picking and packing errors</h3>
                <p className="text-slate-600">
              ...
              <div className="bg-white p-4 sm:p-5 md:p-6 rounded-lg border border-slate-200">
                <h3 className="text-xl font-semibold text-slate-900 mb-3">No visibility into fulfillment bottlenecks</h3>
                <p className="text-slate-600">
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-6">
              <div className="border-l-4 border-blue-500 pl-6">
                <h3 className="text-xl font-semibold text-slate-900 mb-3">Unified order management hub</h3>
                <p className="text-slate-600">
              ...
              <div className="border-l-4 border-blue-500 pl-6">
                <h3 className="text-xl font-semibold text-slate-900 mb-3">Real-time inventory synchronization</h3>
                <p className="text-slate-600">
              ...
              <div className="border-l-4 border-blue-500 pl-6">
                <h3 className="text-xl font-semibold text-slate-900 mb-3">Intelligent pick-path optimization</h3>
                <p className="text-slate-600">
              ...
              <div className="border-l-4 border-blue-500 pl-6">
                <h3 className="text-xl font-semibold text-slate-900 mb-3">Predictive fulfillment analytics</h3>
                <p className="text-slate-600">
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-4 sm:p-6 md:p-8 mb-6 sm:mb-8 md:mb-12">
              ...
              <div className="bg-white p-4 sm:p-6 md:p-8 rounded-lg border border-slate-200">
                ...
                <div className="text-lg font-semibold text-slate-900 mb-2">Avg. processing time</div>
                <p className="text-slate-600">
              ...
              <div className="bg-white p-4 sm:p-6 md:p-8 rounded-lg border border-slate-200">
                <div className="text-5xl font-bold text-green-600 mb-2">$580K</div>
              ...
              <div className="bg-white p-4 sm:p-6 md:p-8 rounded-lg border border-slate-200">
                ...
                <div className="text-lg font-semibold text-slate-900 mb-2">Daily orders</div>
                <p className="text-slate-600">
