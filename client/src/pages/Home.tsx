    ...
    <div className="min-h-screen bg-white text-charcoal">
            ...
            <div className="flex flex-col sm:flex-row sm:items-baseline gap-6 sm:gap-10">
              ...
              <div className="flex flex-wrap items-baseline gap-x-8 gap-y-3 sm:gap-x-10">
                <Link href="/capabilities/artificial-intelligence">
                  <span className="text-[13px] font-semibold uppercase tracking-[0.1em] text-charcoal border-b border-transparent hover:border-primary hover:text-primary transition-colors cursor-pointer pb-1">Artificial Intelligence</span>
                </Link>
                <Link href="/capabilities/technology">
                  <span className="text-[13px] font-semibold uppercase tracking-[0.1em] text-charcoal border-b border-transparent hover:border-primary hover:text-primary transition-colors cursor-pointer pb-1">Technology</span>
                </Link>
                <Link href="/capabilities/growth-marketing-sales">
                  <span className="text-[13px] font-semibold uppercase tracking-[0.1em] text-charcoal border-b border-transparent hover:border-primary hover:text-primary transition-colors cursor-pointer pb-1">Growth &amp; Marketing</span>
                </Link>
                <Link href="/insights/ceo-guide-data-modernization">
                  <span className="text-[13px] font-semibold uppercase tracking-[0.1em] text-charcoal border-b border-transparent hover:border-primary hover:text-primary transition-colors cursor-pointer pb-1">CEO Agenda</span>
                </Link>
              </div>
            </div>
          </div>
      ...
      <section className="w-full">
        <div className="grid grid-cols-1 lg:grid-cols-2 min-h-[440px] md:min-h-[560px]">
          ...
          >
            <span className="text-[11px] font-semibold uppercase tracking-[0.2em] text-charcoal/60 mb-5 block">AI &amp; Technology</span>
            ...
            <div className="flex flex-col sm:flex-row sm:items-center gap-6 sm:gap-8">
              <Link href="/capabilities/ai-technology-consulting">
                <span className="inline-block px-8 py-3 bg-primary text-primary-foreground font-semibold text-[13px] tracking-[0.1em] uppercase hover:bg-primary-hover transition-colors cursor-pointer">Explore Our AI Solutions</span>
              </Link>
              <Link href="/capabilities">
                <span className="text-[13px] font-semibold uppercase tracking-[0.1em] text-charcoal border-b border-charcoal/40 hover:border-primary hover:text-primary transition-colors cursor-pointer pb-1">Our Capabilities</span>
              </Link>
            </div>
          </motion.div>
        </div>
      ...
      <section className="py-20 md:py-24 bg-white">
        <div className="px-6 sm:px-8 md:px-12 lg:px-16">
          <div className="max-w-4xl mb-14 md:mb-16">
            <span className="block text-[11px] font-semibold uppercase tracking-[0.2em] text-charcoal/60 mb-5">Our Solutions</span>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-10 md:gap-12 lg:gap-14">
            {[
              { title: "Intelligent Process Optimization", description: "We help organizations transform manual operations into autonomous systems, eliminating bottlenecks and accelerating execution.", link: "/solutions/intelligent-process-optimization", image: "https://files.manuscdn.com/user_upload_by_module/session_file/310419663032212491/aPMHiULHxWrZFekS.png" },
              { title: "Data-Driven Customer Intelligence", description: "We help organizations unlock deep customer insights through advanced analytics, predicting behavior and driving loyalty at scale.", link: "/solutions/data-driven-customer-intelligence", image: "https://files.manuscdn.com/user_upload_by_module/session_file/310419663032212491/TZWlVXiZjPvjowkn.png" },
              { title: "Scalable Enterprise Transformation", description: "We help organizations modernize their core technology stack, building cloud-native infrastructure that scales with ambition.", link: "/solutions/scalable-enterprise-transformation", image: "https://files.manuscdn.com/user_upload_by_module/session_file/310419663032212491/bHjSZiUFqOwbpAdw.png" },
              { title: "Accelerating Business Growth", description: "We help organizations launch new digital products and channels, driving revenue through e-commerce and digital innovation.", link: "/solutions/accelerating-business-growth", image: "https://files.manuscdn.com/user_upload_by_module/session_file/310419663032212491/sgqzveAkMmuHhDhb.png" }
            ].map((solution, i) => (
              <motion.div
                key={i}
                initial={{ opacity: 0, y: 20 }}
                ...
                className="group"
              >
                <Link href={solution.link} className="block outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2">
                  <div className="cursor-pointer">
                    <div className="aspect-[16/10] overflow-hidden bg-subtle">
                      <img src={solution.image} alt={solution.title} className="w-full h-full object-cover group-hover:scale-[1.02] transition-transform duration-500" />
                    </div>
      ...
      <section className="py-20 md:py-24 bg-subtle">
        <div className="px-6 sm:px-8 md:px-12 lg:px-16">
          <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-6 mb-14 md:mb-16">
            ...
            <Link href="/insights">
              <span className="inline-block text-[13px] font-semibold uppercase tracking-[0.1em] text-charcoal border-b border-charcoal/40 hover:border-primary hover:text-primary transition-colors cursor-pointer pb-1">View All Insights</span>
            </Link>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 md:gap-12">
              ...
              <Link href="/insights/mid-market-ai-guide">
                <div className="cursor-pointer">
                  <div className="aspect-[16/10] overflow-hidden bg-white">
                    <img src="/images/insight-ai-midmarket.jpg" alt="How Mid-Market Companies Are Winning with AI" className="w-full h-full object-cover group-hover:scale-[1.02] transition-transform duration-500" />
                  </div>
                  <div className="pt-6 md:pt-7">
            ...
            <div className="flex flex-col gap-8 md:gap-10">
              {[
                { title: "5 Signs Your Business Is Ready for Digital Transformation", description: "Key indicators that signal it's time to modernize your operations and technology stack.", category: "Digital Strategy", link: "/insights/digital-transformation-readiness", image: "/images/insight-digital-transform.jpg" },
                { title: "Scaling Operations Without Breaking the Bank", description: "Cost-effective strategies for mid-market companies looking to grow efficiently.", category: "Operations", link: "/insights/scaling-operations", image: "/images/insight-scaling-ops.jpg" },
                { title: "Customer Intelligence for Growing Businesses", description: "How to build data-driven customer insights that drive retention and revenue.", category: "Customer Strategy", link: "/insights/customer-intelligence", image: "/images/insight-customer-intel.jpg" }
              ].map((article, i) => (
                <motion.div
                  key={i}
                  initial={{ opacity: 0, y: 20 }}
      ...
      <section className="py-20 md:py-24 bg-white border-t border-charcoal/10">
        <div className="px-6 sm:px-8 md:px-12 lg:px-16">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-start">
            <div>
              <span className="block text-[11px] font-semibold uppercase tracking-[0.2em] text-charcoal/60 mb-5">Contact</span>
              ...
              <div className="space-y-5">
                <label className="block text-sm text-charcoal/70">I would like to speak with your team about:</label>
                <select
            ...
            <div>
              ...
              <div className="mb-8">
                <label htmlFor="contact-email" className="block text-sm text-charcoal/70 mb-2">Your email</label>
                <input
                  id="contact-email"
                  type="email"
      ...
      <section className="w-full">
        <div className="grid grid-cols-1 lg:grid-cols-2 min-h-[440px] md:min-h-[520px]">
          ...
          >
            <span className="text-[11px] font-semibold uppercase tracking-[0.2em] text-charcoal/60 mb-5 block">NexDyne Careers</span>
            <h2 className="text-3xl sm:text-4xl md:text-[2.5rem] text-charcoal leading-[1.15] mb-6" style={{ fontWeight: 500, letterSpacing: "-0.02em" }}>
            ...
            <div className="flex flex-col sm:flex-row sm:items-center gap-6 sm:gap-8">
              <Link href="/careers">
                <span className="inline-block px-8 py-3 bg-primary text-primary-foreground font-semibold text-[13px] tracking-[0.1em] uppercase hover:bg-primary-hover transition-colors cursor-pointer">Explore NexDyne Careers</span>
              </Link>
              <Link href="/careers">
                <span className="text-[13px] font-semibold uppercase tracking-[0.1em] text-charcoal border-b border-charcoal/40 hover:border-primary hover:text-primary transition-colors cursor-pointer pb-1">Apply Today</span>
              </Link>
            </div>
          </motion.div>
