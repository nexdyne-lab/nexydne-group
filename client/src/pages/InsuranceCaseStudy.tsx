        ...
        <div className="container">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <div className="text-center">
              ...
              <div className="text-slate-600">Auto-adjudication rate</div>
            </div>
            <div className="text-center">
              <div className="inline-flex items-center justify-center w-16 h-16 bg-green-100 rounded-full mb-4">
                <DollarSign className="w-8 h-8 text-green-600" />
              </div>
              <div className="text-4xl font-bold text-slate-900 mb-2">$1.8M</div>
            ...
            <div className="text-center">
              ...
              <div className="text-slate-600">Claims per year</div>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-6">
              <div className="bg-white p-4 sm:p-5 md:p-6 rounded-lg border border-slate-200">
                <h3 className="text-xl font-semibold text-slate-900 mb-3">Manual document processing</h3>
              ...
              <div className="bg-white p-4 sm:p-5 md:p-6 rounded-lg border border-slate-200">
                <h3 className="text-xl font-semibold text-slate-900 mb-3">Inconsistent adjudication decisions</h3>
                <p className="text-slate-600">
              ...
              <div className="bg-white p-4 sm:p-5 md:p-6 rounded-lg border border-slate-200">
                <h3 className="text-xl font-semibold text-slate-900 mb-3">Fraud detection gaps</h3>
                <p className="text-slate-600">
              ...
              <div className="bg-white p-4 sm:p-5 md:p-6 rounded-lg border border-slate-200">
                <h3 className="text-xl font-semibold text-slate-900 mb-3">Customer communication delays</h3>
                <p className="text-slate-600">
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-6">
              <div className="border-l-4 border-blue-500 pl-6">
                <h3 className="text-xl font-semibold text-slate-900 mb-3">Intelligent document processing</h3>
                <p className="text-slate-600">
              ...
              <div className="border-l-4 border-blue-500 pl-6">
                <h3 className="text-xl font-semibold text-slate-900 mb-3">Automated adjudication engine</h3>
                <p className="text-slate-600">
              ...
              <div className="border-l-4 border-blue-500 pl-6">
                <h3 className="text-xl font-semibold text-slate-900 mb-3">ML-powered fraud detection</h3>
                <p className="text-slate-600">
              ...
              <div className="border-l-4 border-blue-500 pl-6">
                <h3 className="text-xl font-semibold text-slate-900 mb-3">Proactive customer communication</h3>
                <p className="text-slate-600">
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-4 mb-6 sm:mb-8 md:mb-12">
              <div className="bg-white p-4 sm:p-6 md:p-8 rounded-lg border border-slate-200">
                ...
                <div className="text-lg font-semibold text-slate-900 mb-2">Faster processing</div>
                <p className="text-slate-600">
              ...
              <div className="bg-white p-4 sm:p-6 md:p-8 rounded-lg border border-slate-200">
                ...
                <div className="text-lg font-semibold text-slate-900 mb-2">Auto-adjudication rate</div>
                <p className="text-slate-600">
              ...
              <div className="bg-white p-4 sm:p-6 md:p-8 rounded-lg border border-slate-200">
                <div className="text-5xl font-bold text-green-600 mb-2">$1.8M</div>
              ...
              <div className="bg-white p-4 sm:p-6 md:p-8 rounded-lg border border-slate-200">
                ...
                <div className="text-lg font-semibold text-slate-900 mb-2">Fraud detection improvement</div>
                <p className="text-slate-600">
            ...
            <div className="bg-slate-50 p-6 sm:p-8 md:p-12 rounded-xl sm:rounded-2xl border border-slate-200">
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <div className="text-slate-600">Chief Claims Officer, Southeastern Mutual Insurance</div>
                </div>
              </div>
            </div>
          </div>
