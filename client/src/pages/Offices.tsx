...
export default function Offices() {
  return (
    <div className="min-h-screen bg-subtle text-charcoal">
      <SEO title="Our Office | NexDyne Consulting Group" description="NexDyne is based in Grand Rapids, Michigan—serving clients across the US and beyond with the same standards and governance in every engagement." canonical="/offices" />
      <Navigation />
        ...
        <div className="container px-4 sm:px-6 md:px-12">
          <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-start">
            ...
            <motion.div {...fadeUp} transition={{ ...fadeUp.transition, delay: 0.15 }}>
              ...
              <h2 className="nx-h2 text-charcoal mt-3 mb-2">{office.city}</h2>
              <p className="inline-flex items-center gap-2 text-[11px] font-semibold uppercase tracking-[0.12em] text-primary border border-primary/40 px-2 py-0.5 mb-8">Headquarters</p>
      ...
      <section className="nx-section bg-charcoal text-white">
        <div className="container px-4 sm:px-6 md:px-12">
          <motion.div {...fadeUp} className="max-w-3xl">
            <h2 className="nx-h2 text-white mb-5">Get in touch.</h2>
            ...
            <div className="flex flex-col sm:flex-row gap-5">
              ...
              <Link href="/careers">
                <span className="inline-block px-8 py-4 border border-white/25 text-white text-[13px] font-semibold uppercase tracking-[0.12em] hover:bg-white/10 transition-colors cursor-pointer">Join our team</span>
              </Link>
            </div>
          </motion.div>
        </div>
