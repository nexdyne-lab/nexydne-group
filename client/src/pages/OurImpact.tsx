...
export default function OurImpact() {
  ...
  return (
    <div className="min-h-screen bg-white font-sans text-[#333]">
      ...
      <section className="relative min-h-[60vh] flex items-center pt-16 overflow-hidden bg-[#051c2c]">
        {/* Background Image */}
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {impactAreas.map((area, index) => (
              <motion.a
                ...
                className="group flex flex-col items-center text-center p-6 hover:bg-gray-50 transition-colors rounded-lg cursor-pointer"
              >
                <area.icon className="w-8 h-8 text-[#0052cc] mb-3 group-hover:scale-110 transition-transform" />
        ...
        <div className="container px-4 sm:px-6 md:px-12">
          <div className="max-w-6xl mx-auto">
            <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
              ...
              >
                <div className="inline-flex items-center gap-2 bg-[#0052cc]/10 text-[#0052cc] px-4 py-2 rounded-full text-sm font-medium mb-6">
                ...
                <div className="grid grid-cols-2 gap-6">
                  <div className="border-l-4 border-[#0052cc] pl-4">
                    <div className="text-2xl sm:text-3xl md:text-4xl font-bold text-[#0052cc]">2,400+</div>
                    <p className="text-gray-600 mt-1">Professionals trained across client organizations</p>
                  </div>
                  <div className="border-l-4 border-[#0052cc] pl-4">
                    <div className="text-2xl sm:text-3xl md:text-4xl font-bold text-[#0052cc]">91%</div>
                    <p className="text-gray-600 mt-1">Employee retention reflecting our commitment</p>
                  </div>
                </div>
              </motion.div>
              ...
              >
                <GraduationCap className="w-10 h-10 text-[#0052cc] mb-6" />
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-500 text-sm">Mid-Market SaaS Company</p>
                  </div>
                </div>
              </motion.div>
            </div>
      ...
      {/* Community Impact */}
      <section id="community" className="py-20 md:py-28 bg-[#f5f5f5]">
        <div className="container px-4 sm:px-6 md:px-12">
          <div className="max-w-6xl mx-auto">
            <motion.div
              initial={{ opacity: 0, y: 30 }}
            ...
            <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6 lg:gap-8">
              ...
              >
                <div className="w-14 h-14 bg-[#0052cc]/10 rounded-lg flex items-center justify-center mb-6">
                  <Building2 className="w-7 h-7 text-[#0052cc]" />
                </div>
                <h3 className="text-xl font-semibold text-gray-900 mb-3">Leveling the Playing Field</h3>
              ...
              >
                ...
                <h3 className="text-xl font-semibold text-gray-900 mb-3">Job Creation</h3>
                <p className="text-gray-600 leading-relaxed">
              ...
              >
                <div className="w-14 h-14 bg-[#0052cc]/10 rounded-lg flex items-center justify-center mb-6">
                  <Globe className="w-7 h-7 text-[#0052cc]" />
                </div>
            ...
            <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
              ...
              >
                ...
                <div className="absolute -bottom-6 -right-6 bg-white shadow-lg p-6 max-w-[200px]">
                  <div className="text-4xl font-bold text-[#0052cc] mb-2">43%</div>
                  <p className="text-sm text-gray-600">Reduction in carbon footprint of our deployed models</p>
                </div>
              </motion.div>
              ...
              >
                ...
                <div className="space-y-4">
                  <div className="flex items-start gap-4">
                    ...
                    <p className="text-gray-700">Supply chain optimization reducing transportation emissions</p>
                  </div>
                  <div className="flex items-start gap-4">
                    <div className="w-2 h-2 bg-[#0052cc] rounded-full mt-2 flex-shrink-0" />
                    <p className="text-gray-700">Demand forecasting minimizing overproduction and waste</p>
                  </div>
                  <div className="flex items-start gap-4">
                    <div className="w-2 h-2 bg-[#0052cc] rounded-full mt-2 flex-shrink-0" />
                    <p className="text-gray-700">Energy consumption modeling identifying efficiency opportunities</p>
                  </div>
                </div>
              </motion.div>
            </div>
      ...
      {/* Social Good Impact */}
      <section id="social-good" className="py-20 md:py-28 bg-[#051c2c] text-white">
        <div className="container px-4 sm:px-6 md:px-12">
          <div className="max-w-6xl mx-auto">
            <motion.div
              initial={{ opacity: 0, y: 30 }}
            ...
            <div className="grid sm:grid-cols-2 gap-4 sm:gap-6 lg:gap-8 mb-16">
              ...
              >
                <Lightbulb className="w-10 h-10 text-[#00d4ff] mb-4" />
                ...
                <div className="flex items-baseline gap-2">
                  <span className="text-4xl font-bold text-[#00d4ff]">12,000+</span>
              ...
              <motion.div
                ...
                className="bg-white/5 backdrop-blur-sm border border-white/10 p-8"
              >
                <Heart className="w-10 h-10 text-[#00d4ff] mb-4" />
                ...
                <div className="flex items-baseline gap-2">
                  <span className="text-4xl font-bold text-[#00d4ff]">1,200</span>
