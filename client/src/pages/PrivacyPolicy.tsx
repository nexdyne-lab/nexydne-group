              ...
              <div className="prose prose-lg prose-gray max-w-none">
                ...
                <section id="cookies" className="scroll-mt-32 mb-6 sm:mb-8 md:mb-12">
                  ...
                  <p className="text-gray-700 leading-relaxed mt-4">
                    You can manage your cookie preferences through our <Link href="/cookies" className="text-[#0077B5] hover:underline">Cookie Preferences</Link> page or through your browser settings.
                  </p>
                </section>
