        ...
        <div className="container px-4 sm:px-6 md:px-12 relative z-10">
          ...
          >
            ...
            <h1 className="text-3xl sm:text-4xl md:text-6xl lg:text-7xl xl:text-8xl font-serif font-bold tracking-tight text-white leading-[1.05] mb-5 sm:mb-3 md:mb-4 eb-garamond">
              ...
              <span className="text-[#0077B5]">& Digitization</span>
            </h1>
          ...
          <div className="grid md:grid-cols-2 gap-16 lg:gap-8 sm:gap-6 sm:p-6 sm:p-8 md:p-12 lg:gap-8 sm:gap-6 sm:p-8 md:p-12 lg:gap-24 items-center">
            ...
            >
              ...
              <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-serif font-bold leading-tight mb-5 sm:mb-6 md:mb-8">
                ...
                <span className="text-[#0077B5]">killing your growth.</span>
              </h2>
              ...
              <div className="space-y-6 text-lg text-[#051C2C]/70 leading-relaxed">
                ...
                <p>
                  NexDyne brings <strong className="text-[#051C2C] font-semibold">intelligent automation expertise</strong> that transforms how organizations operate. We deploy solutions that eliminate manual bottlenecks, connect disconnected systems, and free your team to focus on strategic work.
                </p>
              </div>
              ...
              <div className="pt-8 grid grid-cols-2 gap-4 sm:p-5 md:p-6">
                <div className="p-4 sm:p-5 md:p-6 bg-[#051C2C]/5 rounded-lg sm:rounded-xl">
                  <div className="text-4xl font-serif font-bold text-[#0077B5] mb-2">40-60%</div>
                  <p className="text-sm text-[#051C2C]/60 uppercase tracking-wider">Labor Cost Reduction</p>
                </div>
                <div className="p-4 sm:p-5 md:p-6 bg-[#051C2C]/5 rounded-lg sm:rounded-xl">
                  <div className="text-4xl font-serif font-bold text-[#0077B5] mb-2">85-90%</div>
                  <p className="text-sm text-[#051C2C]/60 uppercase tracking-wider">Error Elimination</p>
                </div>
              </div>
            </motion.div>
            ...
            >
              <div className="p-4 sm:p-6 md:p-8 bg-[#051C2C]/5 rounded-lg sm:rounded-xl">
                <div className="text-4xl font-serif font-bold text-[#0077B5] mb-2">2-3×</div>
                <div className="text-sm text-[#051C2C]/60">Volume capacity increase</div>
              </div>
              <div className="p-4 sm:p-6 md:p-8 bg-[#051C2C]/5 rounded-lg sm:rounded-xl">
                <div className="text-4xl font-serif font-bold text-[#0077B5] mb-2">70%</div>
                <div className="text-sm text-[#051C2C]/60">Processing time reduction</div>
              </div>
