      ...
      <section className="pt-32 pb-16 bg-white border-b border-slate-200">
        <div className="container">
          <div className="max-w-4xl">
            <h1 className="text-5xl md:text-6xl font-normal text-slate-900 mb-3 leading-tight eb-garamond">
          ...
          <div className="max-w-6xl mx-auto">
            <div className="grid lg:grid-cols-12 gap-12 items-start">
              <div className="lg:col-span-4">
                <h2 className="text-3xl md:text-4xl font-serif font-normal text-slate-900 sticky top-32">
                  Our Purpose
                </h2>
              </div>
              <div className="lg:col-span-8">
                <p className="text-2xl font-medium text-slate-800 mb-8 leading-relaxed">
            ...
            <div className="grid lg:grid-cols-12 gap-12 items-start">
              ...
              <div className="lg:col-span-8">
                ...
                <div className="grid sm:grid-cols-2 gap-6 mt-12">
                  <div className="border-l-2 border-[#0052cc] pl-6">
                    <h3 className="font-semibold text-slate-900 mb-2">Predictive Insights</h3>
                    <p className="text-slate-600">Delivering intelligence that illuminates hidden patterns in business operations</p>
                  </div>
                  <div className="border-l-2 border-[#0052cc] pl-6">
                    <h3 className="font-semibold text-slate-900 mb-2">Adaptive Systems</h3>
                    <p className="text-slate-600">Building solutions that evolve with our clients' growth trajectories</p>
                  </div>
                  <div className="border-l-2 border-[#0052cc] pl-6">
                    <h3 className="font-semibold text-slate-900 mb-2">Knowledge Transfer</h3>
                    <p className="text-slate-600">Transferring capabilities that outlast our engagements</p>
                  </div>
                  <div className="border-l-2 border-[#0052cc] pl-6">
                    <h3 className="font-semibold text-slate-900 mb-2">Excellence Culture</h3>
                    <p className="text-slate-600">Cultivating an environment where curiosity, rigor, and collaboration drive success</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="space-y-0">
              ...
              <div className="grid lg:grid-cols-12 gap-8 py-12 border-t border-slate-200">
                <div className="lg:col-span-4">
                  <span className="text-sm font-semibold text-[#0052cc] uppercase tracking-wider">01</span>
                  <h3 className="text-2xl font-semibold text-slate-900 mt-2">Intelligence with Purpose</h3>
                </div>
                <div className="lg:col-span-8">
              ...
              <div className="grid lg:grid-cols-12 gap-8 py-12 border-t border-slate-200">
                <div className="lg:col-span-4">
                  <span className="text-sm font-semibold text-[#0052cc] uppercase tracking-wider">02</span>
                  <h3 className="text-2xl font-semibold text-slate-900 mt-2">Clarity Through Complexity</h3>
                </div>
                <div className="lg:col-span-8">
                  <p className="text-slate-700 leading-relaxed mb-4">
              ...
              <div className="grid lg:grid-cols-12 gap-8 py-12 border-t border-slate-200">
                <div className="lg:col-span-4">
                  <span className="text-sm font-semibold text-[#0052cc] uppercase tracking-wider">03</span>
                  <h3 className="text-2xl font-semibold text-slate-900 mt-2">Partnership Over Transactions</h3>
                </div>
                <div className="lg:col-span-8">
                  <p className="text-slate-700 leading-relaxed mb-4">
              ...
              <div className="grid lg:grid-cols-12 gap-8 py-12 border-t border-slate-200">
                <div className="lg:col-span-4">
                  <span className="text-sm font-semibold text-[#0052cc] uppercase tracking-wider">04</span>
                  <h3 className="text-2xl font-semibold text-slate-900 mt-2">Relentless Curiosity</h3>
                </div>
                <div className="lg:col-span-8">
                  <p className="text-slate-700 leading-relaxed mb-4">
              ...
              <div className="grid lg:grid-cols-12 gap-8 py-12 border-t border-slate-200">
                <div className="lg:col-span-4">
                  <span className="text-sm font-semibold text-[#0052cc] uppercase tracking-wider">05</span>
                  <h3 className="text-2xl font-semibold text-slate-900 mt-2">Integrity in Every Interaction</h3>
                </div>
                <div className="lg:col-span-8">
                  <p className="text-slate-700 leading-relaxed mb-4">
              ...
              <div className="grid lg:grid-cols-12 gap-8 py-12 border-t border-slate-200">
                <div className="lg:col-span-4">
                  <span className="text-sm font-semibold text-[#0052cc] uppercase tracking-wider">06</span>
                  <h3 className="text-2xl font-semibold text-slate-900 mt-2">Excellence Through Diversity</h3>
                </div>
                <div className="lg:col-span-8">
                  <p className="text-slate-700 leading-relaxed mb-4">
        ...
        <div className="container">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link href="/contact">
                <button className="px-8 py-4 bg-[#0052cc] text-white font-semibold rounded hover:bg-[#0047b3] transition-colors inline-flex items-center gap-2">
