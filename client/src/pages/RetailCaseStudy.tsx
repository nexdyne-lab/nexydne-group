        ...
        <div className="container">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <div className="text-center">
              ...
              <div className="text-slate-600">Carrying cost reduction</div>
            </div>
            <div className="text-center">
              <div className="inline-flex items-center justify-center w-16 h-16 bg-blue-100 rounded-full mb-4">
              ...
              <div className="text-slate-600">Fewer stockouts</div>
            </div>
            <div className="text-center">
            ...
            <div className="text-center">
              ...
              <div className="text-slate-600">Store locations</div>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-6">
              <div className="bg-white p-4 sm:p-5 md:p-6 rounded-lg border border-slate-200">
                <h3 className="text-xl font-semibold text-slate-900 mb-3">Fragmented inventory visibility</h3>
              ...
              <div className="bg-white p-4 sm:p-5 md:p-6 rounded-lg border border-slate-200">
                <h3 className="text-xl font-semibold text-slate-900 mb-3">Seasonal demand unpredictability</h3>
                <p className="text-slate-600">
              ...
              <div className="bg-white p-4 sm:p-5 md:p-6 rounded-lg border border-slate-200">
                <h3 className="text-xl font-semibold text-slate-900 mb-3">Manual allocation decisions</h3>
                <p className="text-slate-600">
              ...
              <div className="bg-white p-4 sm:p-5 md:p-6 rounded-lg border border-slate-200">
                <h3 className="text-xl font-semibold text-slate-900 mb-3">E-commerce integration gaps</h3>
                <p className="text-slate-600">
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-6">
              <div className="border-l-4 border-blue-500 pl-6">
                <h3 className="text-xl font-semibold text-slate-900 mb-3">Unified inventory platform</h3>
                <p className="text-slate-600">
              ...
              <div className="border-l-4 border-blue-500 pl-6">
                <h3 className="text-xl font-semibold text-slate-900 mb-3">AI demand forecasting</h3>
                <p className="text-slate-600">
              ...
              <div className="border-l-4 border-blue-500 pl-6">
                <h3 className="text-xl font-semibold text-slate-900 mb-3">Automated allocation engine</h3>
                <p className="text-slate-600">
              ...
              <div className="border-l-4 border-blue-500 pl-6">
                <h3 className="text-xl font-semibold text-slate-900 mb-3">Omnichannel inventory pool</h3>
                <p className="text-slate-600">
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-4 mb-6 sm:mb-8 md:mb-12">
              <div className="bg-white p-4 sm:p-6 md:p-8 rounded-lg border border-slate-200">
                ...
                <div className="text-lg font-semibold text-slate-900 mb-2">Carrying cost reduction</div>
                <p className="text-slate-600">
              ...
              <div className="bg-white p-4 sm:p-6 md:p-8 rounded-lg border border-slate-200">
                ...
                <div className="text-lg font-semibold text-slate-900 mb-2">Stockout reduction</div>
                <p className="text-slate-600">
              ...
              <div className="bg-white p-4 sm:p-6 md:p-8 rounded-lg border border-slate-200">
                <div className="text-5xl font-bold text-green-600 mb-2">$2.1M</div>
              ...
              <div className="bg-white p-4 sm:p-6 md:p-8 rounded-lg border border-slate-200">
                ...
                <div className="text-lg font-semibold text-slate-900 mb-2">Online order fulfillment</div>
                <p className="text-slate-600">
            ...
            <div className="bg-slate-50 p-6 sm:p-8 md:p-12 rounded-xl sm:rounded-2xl border border-slate-200">
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <div className="text-slate-600">VP of Operations, HomeStyle Goods</div>
                </div>
              </div>
            </div>
          </div>
