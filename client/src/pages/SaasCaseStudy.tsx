        ...
        <div className="container">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 sm:p-6 md:p-8">
            ...
            <div className="text-center">
              ...
              <div className="text-4xl font-bold text-slate-900 mb-2">26hrs</div>
            ...
            <div className="text-center">
              ...
              <div className="text-4xl font-bold text-slate-900 mb-2">$420K</div>
            ...
            <div className="text-center">
              ...
              <div className="text-slate-600">Quarterly customers</div>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-6">
              <div className="bg-white p-4 sm:p-5 md:p-6 rounded-lg border border-slate-200">
                <h3 className="text-xl font-semibold text-slate-900 mb-3">Manual account provisioning delays</h3>
              ...
              <div className="bg-white p-4 sm:p-5 md:p-6 rounded-lg border border-slate-200">
                <h3 className="text-xl font-semibold text-slate-900 mb-3">Inconsistent onboarding experiences</h3>
                <p className="text-slate-600">
              ...
              <div className="bg-white p-4 sm:p-5 md:p-6 rounded-lg border border-slate-200">
                <h3 className="text-xl font-semibold text-slate-900 mb-3">Data migration bottlenecks</h3>
                <p className="text-slate-600">
              ...
              <div className="bg-white p-4 sm:p-5 md:p-6 rounded-lg border border-slate-200">
                <h3 className="text-xl font-semibold text-slate-900 mb-3">Revenue recognition delays</h3>
                <p className="text-slate-600">
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-6">
              <div className="border-l-4 border-blue-500 pl-6">
                <h3 className="text-xl font-semibold text-slate-900 mb-3">Automated account provisioning</h3>
                <p className="text-slate-600">
              ...
              <div className="border-l-4 border-blue-500 pl-6">
                <h3 className="text-xl font-semibold text-slate-900 mb-3">Intelligent data migration engine</h3>
                <p className="text-slate-600">
              ...
              <div className="border-l-4 border-blue-500 pl-6">
                <h3 className="text-xl font-semibold text-slate-900 mb-3">Personalized onboarding workflows</h3>
                <p className="text-slate-600">
              ...
              <div className="border-l-4 border-blue-500 pl-6">
                <h3 className="text-xl font-semibold text-slate-900 mb-3">Real-time onboarding analytics</h3>
                <p className="text-slate-600">
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-4 sm:p-6 md:p-8 mb-6 sm:mb-8 md:mb-12">
              <div className="bg-white p-4 sm:p-6 md:p-8 rounded-lg border border-slate-200">
                ...
                <div className="text-lg font-semibold text-slate-900 mb-2">Faster onboarding</div>
                <p className="text-slate-600">
              ...
              <div className="bg-white p-4 sm:p-6 md:p-8 rounded-lg border border-slate-200">
                ...
                <div className="text-lg font-semibold text-slate-900 mb-2">Setup time</div>
                <p className="text-slate-600">
              ...
              <div className="bg-white p-4 sm:p-6 md:p-8 rounded-lg border border-slate-200">
                <div className="text-5xl font-bold text-green-600 mb-2">$420K</div>
              ...
              <div className="bg-white p-4 sm:p-6 md:p-8 rounded-lg border border-slate-200">
                ...
                <div className="text-lg font-semibold text-slate-900 mb-2">Quarterly customers</div>
                <p className="text-slate-600">
