          ...
          <div className="grid md:grid-cols-2 gap-16 lg:gap-8 sm:gap-6 sm:p-6 sm:p-8 md:p-12 lg:gap-8 sm:gap-6 sm:p-8 md:p-12 lg:gap-24 items-center">
            ...
            >
              ...
              <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-serif font-bold leading-tight mb-5 sm:mb-6 md:mb-8">
                ...
                <span className="text-[#0077B5]">performance.</span>
              </h2>
              ...
              <div className="space-y-6 text-lg text-[#051C2C]/70 leading-relaxed">
                ...
                <p>
                  NexDyne brings <strong className="text-[#051C2C] font-semibold">end-to-end supply chain expertise</strong> that transforms complexity into competitive advantage. We combine strategic thinking with operational excellence to build supply chains that are resilient, efficient, and responsive.
                </p>
              </div>
              ...
              <div className="pt-8 grid grid-cols-2 gap-4 sm:p-5 md:p-6">
                <div className="p-4 sm:p-5 md:p-6 bg-[#051C2C]/5 rounded-lg sm:rounded-xl">
                  ...
                  <p className="text-sm text-[#051C2C]/60 uppercase tracking-wider">Cost Reduction</p>
                </div>
                <div className="p-4 sm:p-5 md:p-6 bg-[#051C2C]/5 rounded-lg sm:rounded-xl">
                  <div className="text-4xl font-serif font-bold text-[#0077B5] mb-2">40-60%</div>
                  <p className="text-sm text-[#051C2C]/60 uppercase tracking-wider">Inventory Optimization</p>
                </div>
              </div>
            </motion.div>
            ...
            >
              <div className="p-4 sm:p-6 md:p-8 bg-[#051C2C]/5 rounded-lg sm:rounded-xl">
                <div className="text-4xl font-serif font-bold text-[#0077B5] mb-2">25-45%</div>
                <div className="text-sm text-[#051C2C]/60">Lead time reduction</div>
              </div>
              <div className="p-4 sm:p-6 md:p-8 bg-[#051C2C]/5 rounded-lg sm:rounded-xl">
                <div className="text-4xl font-serif font-bold text-[#0077B5] mb-2">30-50%</div>
                <div className="text-sm text-[#051C2C]/60">Supplier performance improvement</div>
              </div>
