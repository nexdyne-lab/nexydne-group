...
const teamMembers = [
  {
    ...
    specialization: "Leads digital transformation initiatives for Fortune 500 companies and high-growth companies across the Northeast",
