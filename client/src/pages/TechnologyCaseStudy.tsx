        ...
        <div className="container">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <div className="text-center">
              ...
              <div className="text-4xl font-bold text-charcoal mb-2">40%</div>
            ...
            <div className="text-center">
              ...
              <div className="text-4xl font-bold text-charcoal mb-2">12x</div>
              <div className="text-muted-foreground">Deployment frequency</div>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-6">
              <div className="bg-white p-4 sm:p-5 md:p-6 rounded-lg border border-slate-200">
                <h3 className="text-xl font-semibold text-charcoal mb-3">Manual deployment bottlenecks</h3>
              ...
              <div className="bg-white p-4 sm:p-5 md:p-6 rounded-lg border border-slate-200">
                <h3 className="text-xl font-semibold text-charcoal mb-3">Environment inconsistencies</h3>
                <p className="text-muted-foreground">
              ...
              <div className="bg-white p-4 sm:p-5 md:p-6 rounded-lg border border-slate-200">
                <h3 className="text-xl font-semibold text-charcoal mb-3">Reactive incident management</h3>
                <p className="text-muted-foreground">
              ...
              <div className="bg-white p-4 sm:p-5 md:p-6 rounded-lg border border-slate-200">
                <h3 className="text-xl font-semibold text-charcoal mb-3">Infrastructure cost sprawl</h3>
                <p className="text-muted-foreground">
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-6">
              <div className="border-l-4 border-blue-500 pl-6">
                <h3 className="text-xl font-semibold text-charcoal mb-3">Infrastructure as Code</h3>
                <p className="text-muted-foreground">
              ...
              <div className="border-l-4 border-blue-500 pl-6">
                <h3 className="text-xl font-semibold text-charcoal mb-3">Automated CI/CD pipeline</h3>
                <p className="text-muted-foreground">
              ...
              <div className="border-l-4 border-blue-500 pl-6">
                <h3 className="text-xl font-semibold text-charcoal mb-3">Unified observability platform</h3>
                <p className="text-muted-foreground">
              ...
              <div className="border-l-4 border-blue-500 pl-6">
                <h3 className="text-xl font-semibold text-charcoal mb-3">Cloud cost optimization</h3>
                <p className="text-muted-foreground">
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-4 mb-6 sm:mb-8 md:mb-12">
              ...
              <div className="bg-white p-4 sm:p-6 md:p-8 rounded-lg border border-slate-200">
                ...
                <div className="text-lg font-semibold text-charcoal mb-2">Deployment frequency</div>
                <p className="text-muted-foreground">
          ...
          <div className="max-w-4xl mx-auto">
            <div className="bg-slate-50 p-6 sm:p-8 md:p-12 rounded-xl sm:rounded-2xl border border-slate-200">
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  <div className="font-semibold text-charcoal">James Chen</div>
                  <div className="text-muted-foreground">CTO, WorkflowPro Technologies</div>
                </div>
              </div>
            </div>
          </div>
