            ...
            <main className="lg:col-span-9 max-w-3xl">
              <div className="prose prose-lg prose-gray max-w-none">
                ...
                <section id="acceptance" className="scroll-mt-32 mb-6 sm:mb-8 md:mb-12">
                  ...
                  <p className="text-gray-700 leading-relaxed mb-4">
                    By accessing or using our Services, you agree to be bound by these Terms and our <Link href="/privacy-policy" className="text-[#0077B5] hover:underline">Privacy Policy</Link>. If you do not agree to these Terms, you may not access or use our Services.
                  </p>
                ...
                <section id="contact" className="scroll-mt-32 mb-6 sm:mb-8 md:mb-12">
                  ...
                  <div className="bg-gray-50 p-4 sm:p-5 md:p-6 rounded-lg">
                    ...
                    <p className="text-gray-700 mb-2">
                      Email: <a href="mailto:legal@nexdyne.com" className="text-[#0077B5] hover:underline">legal@nexdyne.com</a>
                    </p>
