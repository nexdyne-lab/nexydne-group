...
const whitepapers: Record<string, {
  ...
  "intelligent-automation-guide": {
    ...
    coverImage: "/images/capabilities/cap-conference-data.jpg",
    readTime: "25 min",
    pages: 32,
  ...
  "data-modernization-playbook": {
    ...
    coverImage: "/images/industries/meeting-topview.jpg",
    readTime: "30 min",
    pages: 40,
  ...
  "manufacturing-digital-transformation": {
    ...
    coverImage: "/images/capabilities/cap-data-bars.jpg",
    readTime: "35 min",
    pages: 45,
  ...
  "healthcare-automation-guide": {
    ...
    coverImage: "/images/capabilities/cap-presenting-graphs.jpg",
    readTime: "28 min",
    pages: 36,
  ...
  "financial-services-ai": {
    ...
    coverImage: "/images/industries/advisor-charts.jpg",
    readTime: "32 min",
    pages: 42,
  ...
  "retail-customer-intelligence": {
    ...
    coverImage: "/images/capabilities/cap-celebrate.jpg",
    readTime: "26 min",
    pages: 34,
