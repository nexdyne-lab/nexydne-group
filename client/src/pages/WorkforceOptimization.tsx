          ...
          <div className="flex flex-col justify-center min-h-[56vh] py-24 lg:py-28">
            ...
            >
              <div className="flex items-center gap-3 mb-6">
                ...
                <span className="text-[12px] font-semibold uppercase tracking-[0.18em] text-muted-foreground">Operations / Workforce</span>
              </div>
          ...
          <div className="grid md:grid-cols-2 gap-16 lg:gap-8 sm:gap-6 sm:p-6 sm:p-8 md:p-12 lg:gap-8 sm:gap-6 sm:p-8 md:p-12 lg:gap-24 items-center">
            ...
            >
              ...
              <div className="space-y-6 text-lg text-charcoal/70 leading-relaxed">
                ...
                <p>
                  NexDyne brings <strong className="text-charcoal font-semibold">strategic workforce expertise</strong> that transforms how organizations attract, develop, and retain talent. We design workforce strategies that align people capabilities with business objectives.
                </p>
              </div>
              ...
              <div className="pt-8 grid grid-cols-2 gap-4 sm:p-5 md:p-6">
                <div className="p-4 sm:p-5 md:p-6 bg-charcoal/5 rounded-lg sm:rounded-xl">
                  ...
                  <p className="text-sm text-charcoal/60 uppercase tracking-wider">Productivity Improvement</p>
                </div>
                <div className="p-4 sm:p-5 md:p-6 bg-charcoal/5 rounded-lg sm:rounded-xl">
                  <div className="text-4xl font-bold text-primary mb-2">30-50%</div>
                  <p className="text-sm text-charcoal/60 uppercase tracking-wider">Turnover Reduction</p>
                </div>
              </div>
            </motion.div>
            ...
            >
              <div className="p-4 sm:p-6 md:p-8 bg-charcoal/5 rounded-lg sm:rounded-xl">
                ...
                <div className="text-sm text-charcoal/60">Engagement increase</div>
              </div>
              <div className="p-4 sm:p-6 md:p-8 bg-charcoal/5 rounded-lg sm:rounded-xl">
                <div className="text-4xl font-bold text-primary mb-2">15-25%</div>
                <div className="text-sm text-charcoal/60">Labor cost optimization</div>
              </div>
        ...
        items={[
          {
            ...
            image: "/images/insights/hiring-for-builders-hero.jpg"
          },
          {
