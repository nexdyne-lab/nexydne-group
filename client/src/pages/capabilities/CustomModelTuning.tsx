      ...
      <section className="relative pt-24 pb-20 overflow-hidden">
        ...
        <div className="container mx-auto px-4 md:px-12 relative z-20">
          ...
          >
            ...
            <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-muted-foreground max-w-2xl leading-relaxed mb-10">
      ...
      <section className="py-12 sm:py-16 md:py-24 lg:py-32 bg-white text-charcoal">
        <div className="container mx-auto px-4 md:px-12">
          ...
          >
            ...
            <h2 className="nx-h2 mb-6">What we do</h2>
      ...
      <section className="py-12 sm:py-16 md:py-24 lg:py-32 bg-background">
        <div className="container mx-auto px-4 md:px-12">
          ...
          >
            ...
            <h2 className="nx-h2 text-charcoal mb-6">Why tune your own models?</h2>
          ...
          <div className="grid md:grid-cols-2 gap-8 sm:gap-12 lg:gap-16 items-center">
            ...
            >
              ...
              <div className="mt-8 grid grid-cols-2 gap-4 sm:p-5 md:p-6">
                <div className="p-4 sm:p-5 md:p-6 rounded-lg bg-charcoal/5">
      ...
      <section className="py-12 sm:py-16 md:py-24 lg:py-32 bg-background">
        <div className="container mx-auto px-4 md:px-12">
          ...
          >
            ...
            <h2 className="nx-h2 text-charcoal mb-6">How Custom Model Tuning is changing industries</h2>
          </motion.div>
      ...
      <section className="py-12 sm:py-16 md:py-24 lg:py-32 bg-white text-charcoal">
        <div className="container mx-auto px-4 md:px-12">
          ...
          >
            ...
            <h2 className="nx-h2 mb-6">Precision Engineering for AI</h2>
          ...
          <div className="grid md:grid-cols-2 gap-8 sm:gap-12 lg:gap-16">
              ...
              <div className="space-y-8">
                {[
                  ...
                  <div key={i} className="flex gap-4 sm:p-5 md:p-6 group">
                    ...
                    <div>
                      <h4 className="text-xl font-bold text-charcoal mb-2 group-hover:text-primary transition-colors">{step.title}</h4>
            ...
            >
              ...
              <div className="absolute bottom-0 left-0 p-8 md:p-12">
                <div className="bg-white/10 backdrop-blur-md border border-border p-4 sm:p-5 md:p-6 rounded-lg sm:rounded-xl">
                  <h4 className="text-charcoal font-bold text-lg mb-2">Open Source Power</h4>
