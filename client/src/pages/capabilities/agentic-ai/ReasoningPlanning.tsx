// TODO: confirm Reasoning & Planning Frameworks content with Agentic AI practice lead before publish.
...
export default function ReasoningPlanning() {
  return (
    <ServiceDetailTemplate
      ...
      serviceName="Reasoning & Planning Frameworks"
      serviceSlug="reasoning-planning"
      heroSubtitle="Implement advanced reasoning capabilities using chain-of-thought, tree-of-thought, and ReAct patterns for complex decision-making. Our team brings engineering depth, design sensibility, and operating-model rigor to make this capability durable, measurable, and trusted across your business."
      heroImage="/images/capabilities/cap-chess.jpg"
      heroFocal="55% 55%"
      experienceStats={[
        // TODO: confirm with practice lead before publish
        { number: "40+", label: "Reasoning & Planning Frameworks engagements delivered" },
        // TODO: confirm with practice lead before publish
      ...
      challenge="Most teams underestimate how hard it is to translate reasoning & planning frameworks from a slide deck into a production-grade capability that other people in the business actually trust and use. The result is pilots that work in isolation, models that quietly drift, and roadmaps that never quite turn into operating reality."
      opportunity="Done well, reasoning & planning frameworks compounds — every iteration improves accuracy, lowers cost, and unlocks new use cases that were previously out of reach. Our Agentic AI team brings the engineering rigor, design sensibility, and change management muscle needed to move from one-off project to durable, scaling capability."
      approachPillars={[
        // TODO: confirm pillar copy with practice lead before publish
        {
          step: "01",
          title: "Diagnose the real problem",
          body: "We start with the operating reality, not the technology. Where is value leaking, where is risk concentrated, where do your people lose hours? That is where reasoning & planning frameworks earns its keep.",
        },
        // TODO: confirm pillar copy with practice lead before publish
        {
          step: "02",
      ...
      outcomes={[
        ...
        "A clear, prioritized roadmap that ties reasoning & planning frameworks to specific business outcomes leadership has signed off on.",
        // TODO: confirm outcomes with practice lead before publish
