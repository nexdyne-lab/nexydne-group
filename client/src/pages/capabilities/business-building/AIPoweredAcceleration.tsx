              ...
              >
                ...
                <div className="space-y-10">
                  <div className="border-l-4 border-primary pl-8">
                    <h3 className="text-xl font-semibold text-charcoal mb-4">Phase 1: Intelligence Foundation (Weeks 1-4)</h3>
                  ...
                  <div className="border-l-4 border-primary pl-8">
                    <h3 className="text-xl font-semibold text-charcoal mb-4">Phase 2: Predictive Deployment (Weeks 5-8)</h3>
                    <p className="text-charcoal/70 leading-relaxed mb-4">
            ...
            <div className="space-y-8">
              ...
              <div>
                ...
                <div className="bg-subtle p-4 sm:p-5 md:p-6 rounded-lg border-l-4 border-primary">
                  ...
                  <p className="text-sm text-charcoal/50 mt-4 font-semibold">— VP of Strategy, B2B Software Company</p>
                </div>
              </div>
            </div>
          </motion.div>
      ...
      <section className="dz-section bg-white">
        <div className="container px-4 md:px-8 lg:px-12">
          <motion.div
            ...
            transition={{ duration: 0.6 }}
          >
            <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold text-charcoal mb-6 sm:mb-8 md:mb-12 eb-garamond">Technical Infrastructure</h2>
            
            <div className="grid md:grid-cols-2 gap-12">
              <div className="space-y-6">
                <h3 className="text-xl font-semibold text-charcoal">AI & Machine Learning Stack</h3>
              ...
              <div className="space-y-6">
                <h3 className="text-xl font-semibold text-charcoal">Data & Integration Layer</h3>
                <ul className="space-y-3 text-charcoal/70">
                  <li className="flex items-start gap-3">
                    <span className="text-primary mt-1">•</span>
