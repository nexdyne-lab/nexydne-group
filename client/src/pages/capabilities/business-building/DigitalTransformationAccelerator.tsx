              ...
              >
                ...
                <div className="space-y-10">
                  <div className="border-l-4 border-primary pl-8">
                    <h3 className="text-xl font-semibold text-charcoal mb-4">Phase 1: Architecture Assessment (Weeks 1-3)</h3>
                  ...
                  <div className="border-l-4 border-primary pl-8">
                    <h3 className="text-xl font-semibold text-charcoal mb-4">Phase 2: Foundation Build (Weeks 4-12)</h3>
                    <p className="text-charcoal/70 leading-relaxed mb-4">
                  ...
                  <div className="border-l-4 border-primary pl-8">
                    <h3 className="text-xl font-semibold text-charcoal mb-4">Phase 3: Capability Migration (Weeks 13-24)</h3>
                    <p className="text-charcoal/70 leading-relaxed mb-4">
                  ...
                  <div className="border-l-4 border-primary pl-8">
                    <h3 className="text-xl font-semibold text-charcoal mb-4">Phase 4: Optimization & Governance (Ongoing)</h3>
                    <p className="text-charcoal/70 leading-relaxed mb-4">
      ...
      <section className="dz-section bg-white">
        <div className="container px-4 md:px-8 lg:px-12">
          <motion.div
            ...
            transition={{ duration: 0.6 }}
          >
            <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold text-charcoal mb-6 sm:mb-8 md:mb-12 eb-garamond">Technology Ecosystem</h2>
            
            <div className="grid md:grid-cols-2 gap-12">
              <div className="group">
                <h3 className="text-xl font-semibold text-charcoal mb-6 group-hover:text-primary transition-colors">Cloud Platforms</h3>
              ...
              <div className="group">
                <h3 className="text-xl font-semibold text-charcoal mb-6 group-hover:text-primary transition-colors">Data Platforms</h3>
                <div className="space-y-3 text-charcoal/70">
              ...
              <div className="group">
                <h3 className="text-xl font-semibold text-charcoal mb-6 group-hover:text-primary transition-colors">Integration Technologies</h3>
                <div className="space-y-3 text-charcoal/70">
              ...
              <div className="group">
                <h3 className="text-xl font-semibold text-charcoal mb-6 group-hover:text-primary transition-colors">DevOps & Monitoring</h3>
                <div className="space-y-3 text-charcoal/70">
