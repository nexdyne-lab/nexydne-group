          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20">
            ...
            >
              <div className="lg:sticky lg:top-32">
                <h3 className="text-2xl md:text-3xl font-serif font-bold text-[#1A1A1A] mb-6">The Reinvention Trap</h3>
            ...
            <div className="lg:col-span-8 space-y-16">
              ...
              >
                ...
                <div className="grid md:grid-cols-2 gap-x-12 gap-y-16">
                  <div className="group">
                    <h3 className="text-base sm:text-lg md:text-xl lg:text-2xl font-serif font-bold text-[#1A1A1A] mb-4 group-hover:text-[#0077B5] transition-colors">Industry-Specific Playbooks</h3>
                  ...
                  <div className="group">
                    <h3 className="text-base sm:text-lg md:text-xl lg:text-2xl font-serif font-bold text-[#1A1A1A] mb-4 group-hover:text-[#0077B5] transition-colors">Growth Strategy Templates</h3>
                    <p className="text-[#1A1A1A]/70 leading-relaxed">
                  ...
                  <div className="group">
                    <h3 className="text-base sm:text-lg md:text-xl lg:text-2xl font-serif font-bold text-[#1A1A1A] mb-4 group-hover:text-[#0077B5] transition-colors">Best Practice Repositories</h3>
                    <p className="text-[#1A1A1A]/70 leading-relaxed">
                  ...
                  <div className="group">
                    <h3 className="text-base sm:text-lg md:text-xl lg:text-2xl font-serif font-bold text-[#1A1A1A] mb-4 group-hover:text-[#0077B5] transition-colors">Transformation Roadmaps</h3>
                    <p className="text-[#1A1A1A]/70 leading-relaxed">
              ...
              <motion.div
                ...
                className="space-y-12"
              >
                <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold text-[#1A1A1A] eb-garamond">Methodology Framework</h2>
                
                <div className="space-y-10">
                  <div className="border-l-4 border-[#0077B5] pl-8">
                    <h3 className="text-xl font-semibold text-[#1A1A1A] mb-4">Phase 1: Context Assessment (Week 1)</h3>
                  ...
                  <div className="border-l-4 border-[#0077B5] pl-8">
                    <h3 className="text-xl font-semibold text-[#1A1A1A] mb-4">Phase 2: Framework Deployment (Weeks 2-4)</h3>
                    <p className="text-[#1A1A1A]/70 leading-relaxed mb-4">
                  ...
                  <div className="border-l-4 border-[#0077B5] pl-8">
                    <h3 className="text-xl font-semibold text-[#1A1A1A] mb-4">Phase 3: Optimization & Knowledge Transfer (Weeks 5-6)</h3>
                    <p className="text-[#1A1A1A]/70 leading-relaxed mb-4">
          ...
          >
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:p-6 md:p-8 mb-6 sm:mb-8 md:mb-12">
              <div className="text-center">
                <div className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-serif font-bold text-[#0077B5] mb-2">3 Weeks</div>
                <p className="text-sm text-[#1A1A1A]/50 uppercase tracking-wider font-medium">Strategy Development Time</p>
              </div>
              <div className="text-center">
                <div className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-serif font-bold text-[#0077B5] mb-2">60%</div>
                <p className="text-sm text-[#1A1A1A]/50 uppercase tracking-wider font-medium">Faster Time to Market</p>
              </div>
              <div className="text-center">
                <div className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-serif font-bold text-[#0077B5] mb-2">$3.2M</div>
                <p className="text-sm text-[#1A1A1A]/50 uppercase tracking-wider font-medium">First-Year Revenue</p>
              </div>
            </div>
            ...
            <div className="space-y-8">
              ...
              <div>
                ...
                <div className="bg-[#F5F5F5] p-4 sm:p-5 md:p-6 rounded-lg border-l-4 border-[#0077B5]">
                  ...
                  <p className="text-sm text-[#1A1A1A]/50 mt-4 font-semibold">— CEO, Regional Logistics Company</p>
                </div>
              </div>
            </div>
          </motion.div>
      ...
      <section className="dz-section bg-white">
        <div className="container px-4 md:px-8 lg:px-12">
          <motion.div
            ...
            transition={{ duration: 0.6 }}
          >
            <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold text-[#1A1A1A] mb-6 sm:mb-8 md:mb-12 eb-garamond">Playbook Library</h2>
            
            <div className="grid md:grid-cols-2 gap-4 sm:p-6 md:p-8">
              <div className="bg-[#F5F5F5] p-4 sm:p-6 md:p-8 rounded-lg group hover:shadow-lg transition-shadow">
                <h3 className="text-xl font-semibold text-[#1A1A1A] mb-6 group-hover:text-[#0077B5] transition-colors">Market Entry & Expansion</h3>
                <ul className="space-y-3 text-[#1A1A1A]/70">
                  <li className="flex items-start gap-3">
                    <CheckCircle2 className="w-4 h-4 sm:w-5 sm:h-5 text-[#0077B5] mt-0.5 shrink-0" />
              ...
              <div className="bg-[#F5F5F5] p-4 sm:p-6 md:p-8 rounded-lg group hover:shadow-lg transition-shadow">
                <h3 className="text-xl font-semibold text-[#1A1A1A] mb-6 group-hover:text-[#0077B5] transition-colors">Product & Service Launch</h3>
                <ul className="space-y-3 text-[#1A1A1A]/70">
                  <li className="flex items-start gap-3">
                    <CheckCircle2 className="w-4 h-4 sm:w-5 sm:h-5 text-[#0077B5] mt-0.5 shrink-0" />
              ...
              <div className="bg-[#F5F5F5] p-4 sm:p-6 md:p-8 rounded-lg group hover:shadow-lg transition-shadow">
                <h3 className="text-xl font-semibold text-[#1A1A1A] mb-6 group-hover:text-[#0077B5] transition-colors">Operational Scaling</h3>
                <ul className="space-y-3 text-[#1A1A1A]/70">
                  <li className="flex items-start gap-3">
                    <CheckCircle2 className="w-4 h-4 sm:w-5 sm:h-5 text-[#0077B5] mt-0.5 shrink-0" />
              ...
              <div className="bg-[#F5F5F5] p-4 sm:p-6 md:p-8 rounded-lg group hover:shadow-lg transition-shadow">
                <h3 className="text-xl font-semibold text-[#1A1A1A] mb-6 group-hover:text-[#0077B5] transition-colors">Growth Marketing</h3>
                <ul className="space-y-3 text-[#1A1A1A]/70">
                  <li className="flex items-start gap-3">
                    <CheckCircle2 className="w-4 h-4 sm:w-5 sm:h-5 text-[#0077B5] mt-0.5 shrink-0" />
