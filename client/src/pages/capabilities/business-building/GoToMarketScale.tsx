          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20">
            ...
            >
              <div className="lg:sticky lg:top-32">
                <h3 className="text-2xl md:text-3xl font-serif font-bold text-[#1A1A1A] mb-6">The Distribution Gap</h3>
            ...
            <div className="lg:col-span-8 space-y-16">
              ...
              >
                ...
                <div className="grid md:grid-cols-2 gap-x-12 gap-y-16">
                  <div className="group">
                    <h3 className="text-base sm:text-lg md:text-xl lg:text-2xl font-serif font-bold text-[#1A1A1A] mb-4 group-hover:text-[#0077B5] transition-colors">Partnership Ecosystem Development</h3>
                  ...
                  <div className="group">
                    <h3 className="text-base sm:text-lg md:text-xl lg:text-2xl font-serif font-bold text-[#1A1A1A] mb-4 group-hover:text-[#0077B5] transition-colors">Channel Optimization Frameworks</h3>
                    <p className="text-[#1A1A1A]/70 leading-relaxed">
                  ...
                  <div className="group">
                    <h3 className="text-base sm:text-lg md:text-xl lg:text-2xl font-serif font-bold text-[#1A1A1A] mb-4 group-hover:text-[#0077B5] transition-colors">Demand Generation Systems</h3>
                    <p className="text-[#1A1A1A]/70 leading-relaxed">
                  ...
                  <div className="group">
                    <h3 className="text-base sm:text-lg md:text-xl lg:text-2xl font-serif font-bold text-[#1A1A1A] mb-4 group-hover:text-[#0077B5] transition-colors">Sales Acceleration Methodologies</h3>
                    <p className="text-[#1A1A1A]/70 leading-relaxed">
              ...
              >
                ...
                <div className="space-y-10">
                  <div className="border-l-4 border-[#0077B5] pl-8">
                    <h3 className="text-xl font-semibold text-[#1A1A1A] mb-4">Phase 1: Market & Channel Assessment (Weeks 1-2)</h3>
                  ...
                  <div className="border-l-4 border-[#0077B5] pl-8">
                    <h3 className="text-xl font-semibold text-[#1A1A1A] mb-4">Phase 2: Partnership & Channel Development (Weeks 3-8)</h3>
                    <p className="text-[#1A1A1A]/70 leading-relaxed mb-4">
          ...
          >
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:p-6 md:p-8 mb-6 sm:mb-8 md:mb-12">
              <div className="text-center">
                <div className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-serif font-bold text-[#0077B5] mb-2">8 Weeks</div>
                <p className="text-sm text-[#1A1A1A]/50 uppercase tracking-wider font-medium">Partner Network Activation</p>
              </div>
              <div className="text-center">
                <div className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-serif font-bold text-[#0077B5] mb-2">65%</div>
                <p className="text-sm text-[#1A1A1A]/50 uppercase tracking-wider font-medium">Reduction in CAC</p>
              </div>
              <div className="text-center">
                <div className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-serif font-bold text-[#0077B5] mb-2">$4.8M</div>
                <p className="text-sm text-[#1A1A1A]/50 uppercase tracking-wider font-medium">Partner-Sourced Revenue (Year 1)</p>
              </div>
            </div>
            ...
            <div className="space-y-8">
              ...
              <div>
                ...
                <div className="bg-[#F5F5F5] p-4 sm:p-5 md:p-6 rounded-lg border-l-4 border-[#0077B5]">
                  ...
                  <p className="text-sm text-[#1A1A1A]/50 mt-4 font-semibold">— Chief Revenue Officer, B2B SaaS Company</p>
                </div>
              </div>
            </div>
          </motion.div>
