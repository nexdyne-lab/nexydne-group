          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20">
            ...
            >
              <div className="lg:sticky lg:top-32">
                <h3 className="text-2xl md:text-3xl font-serif font-bold text-[#1A1A1A] mb-6">The Measurement Gap</h3>
            ...
            <div className="lg:col-span-8 space-y-16">
              ...
              >
                ...
                <div className="grid md:grid-cols-2 gap-x-12 gap-y-16">
                  <div className="group">
                    <h3 className="text-base sm:text-lg md:text-xl lg:text-2xl font-serif font-bold text-[#1A1A1A] mb-4 group-hover:text-[#0077B5] transition-colors">Industry Benchmarking</h3>
                  ...
                  <div className="group">
                    <h3 className="text-base sm:text-lg md:text-xl lg:text-2xl font-serif font-bold text-[#1A1A1A] mb-4 group-hover:text-[#0077B5] transition-colors">Maturity Assessments</h3>
                    <p className="text-[#1A1A1A]/70 leading-relaxed">
                  ...
                  <div className="group">
                    <h3 className="text-base sm:text-lg md:text-xl lg:text-2xl font-serif font-bold text-[#1A1A1A] mb-4 group-hover:text-[#0077B5] transition-colors">ROI Modeling & Business Cases</h3>
                    <p className="text-[#1A1A1A]/70 leading-relaxed">
                  ...
                  <div className="group">
                    <h3 className="text-base sm:text-lg md:text-xl lg:text-2xl font-serif font-bold text-[#1A1A1A] mb-4 group-hover:text-[#0077B5] transition-colors">KPI Framework Design</h3>
                    <p className="text-[#1A1A1A]/70 leading-relaxed">
              ...
              >
                ...
                <div className="space-y-10">
                  <div className="border-l-4 border-[#0077B5] pl-8">
                    <h3 className="text-xl font-semibold text-[#1A1A1A] mb-4">Phase 1: Baseline Assessment (Weeks 1-3)</h3>
                  ...
                  <div className="border-l-4 border-[#0077B5] pl-8">
                    <h3 className="text-xl font-semibold text-[#1A1A1A] mb-4">Phase 2: Framework Development (Weeks 4-6)</h3>
                    <p className="text-[#1A1A1A]/70 leading-relaxed mb-4">
                  ...
                  <div className="border-l-4 border-[#0077B5] pl-8">
                    <h3 className="text-xl font-semibold text-[#1A1A1A] mb-4">Phase 3: Deployment & Training (Weeks 7-9)</h3>
                    <p className="text-[#1A1A1A]/70 leading-relaxed mb-4">
                  ...
                  <div className="border-l-4 border-[#0077B5] pl-8">
                    <h3 className="text-xl font-semibold text-[#1A1A1A] mb-4">Phase 4: Continuous Improvement (Ongoing)</h3>
                    <p className="text-[#1A1A1A]/70 leading-relaxed mb-4">
          ...
          >
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:p-6 md:p-8">
              <div className="bg-white p-4 sm:p-6 md:p-8 rounded-lg">
                <div className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-serif font-bold text-[#0077B5] mb-4">25-40%</div>
                <div className="text-lg font-semibold text-[#1A1A1A] mb-2">Performance Improvement</div>
              ...
              <div className="bg-white p-4 sm:p-6 md:p-8 rounded-lg">
                <div className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-serif font-bold text-[#0077B5] mb-4">60%</div>
                <div className="text-lg font-semibold text-[#1A1A1A] mb-2">Faster Decision Cycles</div>
                <p className="text-[#1A1A1A]/70">
              ...
              <div className="bg-white p-4 sm:p-6 md:p-8 rounded-lg">
                ...
                <div className="text-lg font-semibold text-[#1A1A1A] mb-2">Investment ROI Accuracy</div>
                <p className="text-[#1A1A1A]/70">
      ...
      <section className="dz-section bg-white">
        <div className="container px-4 md:px-8 lg:px-12">
          <motion.div
            ...
            transition={{ duration: 0.6 }}
          >
            <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold text-[#1A1A1A] mb-6 sm:mb-8 md:mb-12 eb-garamond">Benchmark Coverage</h2>
            
            <div className="grid md:grid-cols-2 gap-12">
              <div className="group">
                <h3 className="text-xl font-semibold text-[#1A1A1A] mb-6 group-hover:text-[#0077B5] transition-colors">Operational Metrics</h3>
              ...
              <div className="group">
                <h3 className="text-xl font-semibold text-[#1A1A1A] mb-6 group-hover:text-[#0077B5] transition-colors">Financial Performance</h3>
                <div className="space-y-3 text-[#1A1A1A]/70">
              ...
              <div className="group">
                <h3 className="text-xl font-semibold text-[#1A1A1A] mb-6 group-hover:text-[#0077B5] transition-colors">Customer Metrics</h3>
                <div className="space-y-3 text-[#1A1A1A]/70">
              ...
              <div className="group">
                <h3 className="text-xl font-semibold text-[#1A1A1A] mb-6 group-hover:text-[#0077B5] transition-colors">Technology & Innovation</h3>
                <div className="space-y-3 text-[#1A1A1A]/70">
