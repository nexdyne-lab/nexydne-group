// TODO: David — confirm Opportunity Identification content with Digital Venture Launch practice lead before publish.
...
export default function OpportunityIdentification() {
  return (
    <ServiceDetailTemplate
      ...
      approachPillars={[
        // TODO: confirm pillar copy with practice lead before publish
        {
          ...
          body: "We start with the operating reality, not the technology. Where is value leaking, where is risk concentrated, where do your people lose hours? That is where opportunity identification earns its keep.",
        },
        // TODO: confirm pillar copy with practice lead before publish
        {
          step: "02",
      ...
      outcomes={[
        ...
        "A clear, prioritized roadmap that ties opportunity identification to specific business outcomes leadership has signed off on.",
        // TODO: confirm outcomes with practice lead before publish
