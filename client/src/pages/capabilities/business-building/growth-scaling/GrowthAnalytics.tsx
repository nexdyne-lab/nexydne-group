// TODO: David — confirm Growth Analytics content with Growth & Scaling practice lead before publish.
...
export default function GrowthAnalytics() {
  return (
    <ServiceDetailTemplate
      ...
      opportunity="Done well, growth analytics compounds — every iteration sharpens the operating model, lowers cost, and unlocks the next set of decisions leadership has been deferring. Our Growth & Scaling team brings the engineering rigor, design sensibility, and change-management muscle needed to move from one-off project to durable capability your team can keep evolving."
      approachPillars={[
