// TODO: David — confirm Innovation Stage-Gate Governance content with Rapid Innovation & Testing practice lead before publish.
...
export default function StageGateGovernance() {
  return (
    <ServiceDetailTemplate
      ...
      outcomes={[
        ...
        "A clear, prioritized roadmap that ties innovation stage-gate governance to specific business outcomes leadership has signed off on.",
        // TODO: confirm outcomes with practice lead before publish
