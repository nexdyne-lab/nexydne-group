    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="bg-black text-white pt-32 pb-20">
        <div className="container max-w-4xl">
          <Link href="/capabilities/business-building/case-studies" className="inline-flex items-center text-sm text-gray-400 hover:text-white mb-8 transition-colors">
      ...
      <article className="py-16">
        <div className="container max-w-3xl">
          <div className="prose prose-lg max-w-none">
            ...
            <h3 className="text-2xl font-bold text-gray-900 mt-10 mb-4">Phase 1: Discovery and Design (Weeks 1-8)</h3>
            ...
            <h3 className="text-2xl font-bold text-gray-900 mt-10 mb-4">Phase 2: MVP Development (Weeks 9-20)</h3>
            ...
            <h3 className="text-2xl font-bold text-gray-900 mt-10 mb-4">Phase 3: Pilot Launch (Weeks 21-28)</h3>
            ...
            <h3 className="text-2xl font-bold text-gray-900 mt-10 mb-4">Phase 4: Scale and Optimize (Months 7-18)</h3>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Link href="/cases/global-retailer-ecommerce" className="group">
              <div className="bg-white p-6 h-full hover:shadow-lg transition-shadow">
                <span className="text-xs font-semibold text-[#00d4ff] uppercase tracking-wider">RETAIL</span>
            ...
            <Link href="/case-studies/saas-category-leadership" className="group">
              <div className="bg-white p-6 h-full hover:shadow-lg transition-shadow">
                <span className="text-xs font-semibold text-[#00d4ff] uppercase tracking-wider">SAAS</span>
                <h3 className="text-lg font-bold text-gray-900 mt-3 mb-2 group-hover:text-[#0077B5] transition-colors">
      ...
      <section className="py-16 bg-white">
        <div className="container max-w-4xl text-center">
          <h2 className="text-3xl font-bold text-gray-900 mb-4 eb-garamond">Ready to Build Your Digital Venture?</h2>
