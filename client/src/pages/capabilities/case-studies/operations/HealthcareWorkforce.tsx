...
export function HealthcareWorkforce() {
  return (
    <IndustryCaseStudyTemplate
      ...
      seoDescription="A home-health company spent 72% of revenue on labor with clinicians driving 35% of the day and 35% turnover. Scheduling optimization lifted productivity 28% and cut overtime 15%."
      ...
      subtitle="A home-health services company optimized staffing with geographic routing, redesigned territories, and mobile documentation — improving clinician productivity 28%, cutting overtime 15%, and reducing turnover 22%."
      heroImage="/case-medical-collaboration.9602cc8c.jpg"
      metrics={[
        { value: "28%", label: "Productivity Gain" },
        { value: "15%", label: "Overtime Reduction" },
        { value: "< 20%", label: "Of the Day Spent Driving" },
        { value: "22%", label: "Turnover Reduction" }
      ]}
      clientContextTitle="Labor Eating the Business"
      clientContextIntro="A 190-employee healthcare services company provides home health, hospice, and personal care across a three-state region with 150 field clinicians. Labor costs consumed 72% of revenue — well above benchmark — and overtime had become chronic, with some staff working 50+ hours a week."
