    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="bg-black text-white pt-32 pb-20">
        <div className="container max-w-4xl">
          <Link href="/capabilities/technology/case-studies" className="inline-flex items-center text-sm text-gray-400 hover:text-white mb-8 transition-colors">
      ...
      <article className="py-16">
        <div className="container max-w-3xl">
          <div className="prose prose-lg max-w-none">
            <h2 className="text-3xl font-bold text-gray-900 mt-8 mb-6 eb-garamond">The Challenge</h2>
            ...
            <h2 className="text-3xl font-bold text-gray-900 mt-12 mb-6 eb-garamond">Our Approach</h2>
            ...
            <h3 className="text-2xl font-bold text-gray-900 mt-10 mb-4">Phase 1: Assessment and Stabilization (Months 1-4)</h3>
            ...
            <h3 className="text-2xl font-bold text-gray-900 mt-10 mb-4">Phase 2: Foundation Modernization (Months 5-12)</h3>
            ...
            <h3 className="text-2xl font-bold text-gray-900 mt-10 mb-4">Phase 3: Application Migration (Months 13-20)</h3>
            ...
            <h3 className="text-2xl font-bold text-gray-900 mt-10 mb-4">Phase 4: Optimization and Enablement (Months 21-24)</h3>
            ...
            <h2 className="text-3xl font-bold text-gray-900 mt-12 mb-6 eb-garamond">The Results</h2>
            ...
            <h2 className="text-3xl font-bold text-gray-900 mt-12 mb-6 eb-garamond">Key Success Factors</h2>
      ...
      <section className="py-16 bg-[#f8f8f7]">
        <div className="container max-w-6xl">
          <h2 className="text-2xl font-bold text-gray-900 mb-8 eb-garamond">Related Case Studies</h2>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Link href="/cases/healthcare-cloud-migration" className="group">
              <div className="bg-white p-6 h-full hover:shadow-lg transition-shadow">
                <span className="text-xs font-semibold text-[#00d4ff] uppercase tracking-wider">HEALTHCARE</span>
            ...
            <Link href="/cases/bank-core-modernization" className="group">
              <div className="bg-white p-6 h-full hover:shadow-lg transition-shadow">
                <span className="text-xs font-semibold text-[#00d4ff] uppercase tracking-wider">FINANCIAL SERVICES</span>
                <h3 className="text-lg font-bold text-gray-900 mt-3 mb-2 group-hover:text-[#0077B5] transition-colors">
            ...
            <Link href="/cases/manufacturing-erp-modernization" className="group">
              <div className="bg-white p-6 h-full hover:shadow-lg transition-shadow">
                <span className="text-xs font-semibold text-[#00d4ff] uppercase tracking-wider">MANUFACTURING</span>
                <h3 className="text-lg font-bold text-gray-900 mt-3 mb-2 group-hover:text-[#0077B5] transition-colors">
      ...
      <section className="py-16 bg-white">
        <div className="container max-w-4xl text-center">
          <h2 className="text-3xl font-bold text-gray-900 mb-4 eb-garamond">Ready to Modernize Your Technology?</h2>
