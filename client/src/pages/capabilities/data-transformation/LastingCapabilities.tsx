          ...
          <div className="grid md:grid-cols-2 gap-8 sm:gap-12 lg:gap-16 items-center">
            <div>
              <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold mb-6 leading-tight eb-garamond">
                ...
                <span className="text-slate-400">Not just a data platform.</span>
              </h2>
            ...
            <div className="relative">
              <div className="absolute -inset-4 bg-gradient-to-r from-[#00d4ff]/20 to-pink-500/20 rounded-xl sm:rounded-2xl blur-2xl opacity-50"></div>
                ...
                <div className="space-y-8">
                  <div className="flex items-center justify-between border-b border-white/10 pb-4">
                    <div>
                      ...
                      <div className="text-xs text-slate-500">vs. Industry Avg: 30%</div>
                    </div>
                    <Share2 className="w-8 h-8 text-[#00d4ff]" />
                  </div>
                  <div className="flex items-center justify-between border-b border-white/10 pb-4">
                    <div>
                      <div className="text-sm text-slate-400 mb-1">Retention Improvement</div>
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      <div className="text-sm text-slate-400 mb-1">Certifications Earned</div>
                ...
                <Card className="h-full bg-[#0a0e3d] border-white/10 group-hover:bg-white transition-all duration-300 relative overflow-hidden">
                  <CardContent className="p-4 sm:p-6 md:p-8 h-full flex flex-col">
                    <div className="w-12 h-12 rounded-full bg-white/5 flex items-center justify-center mb-6 group-hover:bg-slate-100 transition-colors duration-300">
                      <GraduationCap className="w-6 h-6 text-[#00d4ff] group-hover:text-[#2352ff] transition-colors duration-300" />
                    </div>
