...
import { ArrowRight, Users, TrendingUp, BarChart3, Target, Award, Briefcase } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-white font-sans text-[#051C2C] selection:bg-[#0077B5] selection:text-white">
      <SEO 
        ...
        description="Build high-performing sales organizations. We help you optimize sales processes, develop capabilities, and create incentive structures that drive sustainable revenue growth."
        canonical="/capabilities/growth-marketing-sales/sales-excellence"
      />
      <Navigation />
        ...
        <div className="container px-4 md:px-12 grid md:grid-cols-2 gap-8 items-center">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-white/70 leading-relaxed max-w-2xl mb-10">
              Build high-performing sales organizations. We help you optimize sales processes, develop capabilities, and create incentive structures that drive sustainable revenue growth.
            </p>
      ...
      <section className="py-20 bg-white border-b border-gray-200">
        <div className="container px-4 md:px-12">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              { metric: "300+", label: "sales transformations delivered globally" },
              { metric: "25%", label: "average improvement in sales productivity" },
              { metric: "15%", label: "typical increase in win rates" }
            ].map((item, index) => (
              <motion.div
                key={index}
                initial={{ opacity: 0, y: 20 }}
          ...
          <div className="grid md:grid-cols-2 gap-16 items-start">
            ...
            >
              <h2 className="text-4xl md:text-5xl font-bold text-[#051C2C] leading-tight eb-garamond">
                Sales excellence is built, not bought.
              </h2>
            </motion.div>
            ...
            >
              <p>
                High-performing sales organizations don't happen by accident. They're the result of deliberate investment in the right processes, capabilities, and incentives. Yet most companies struggle to achieve consistent sales performance across their teams.
              </p>
              <p>
                The gap between top performers and average performers in most sales organizations is enormous—often 3-5x in productivity. Closing this gap requires a systematic approach that addresses not just skills, but also processes, tools, and management practices.
              </p>
              <p>
                We help companies build sales capabilities that drive sustainable growth. From sales strategy and process design to capability building and performance management, we create the foundation for sales excellence.
              </p>
              <ul className="space-y-3 mt-6">
                <li className="flex items-start gap-3">
                  <span className="w-2 h-2 rounded-full bg-[#06b6d4] mt-2 flex-shrink-0"></span>
                  <span>Sales process optimization and methodology</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="w-2 h-2 rounded-full bg-[#06b6d4] mt-2 flex-shrink-0"></span>
                  <span>Sales capability development and training</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="w-2 h-2 rounded-full bg-[#06b6d4] mt-2 flex-shrink-0"></span>
                  <span>Incentive design and performance management</span>
                </li>
              </ul>
            </motion.div>
          </div>
        ...
        <div className="container px-4 md:px-12">
          ...
          >
            ...
            <h2 className="text-4xl md:text-5xl font-bold eb-garamond">
              Building sales organizations that win
            </h2>
          </motion.div>
            ...
            {[
              {
                ...
                description: "We analyze sales performance across dimensions—win rates, cycle times, productivity, and coverage. We identify root causes of underperformance and prioritize improvement opportunities."
              },
              {
                title: "Design the model",
                description: "We design sales models that align with your go-to-market strategy. We define roles, processes, and coverage models that maximize effectiveness and efficiency."
              },
              {
                title: "Build capabilities",
                description: "We develop sales capabilities through training, coaching, and tools. We implement performance management systems that sustain improvement over time."
              }
            ].map((item, index) => (
              <motion.div
                key={index}
        ...
        <div className="container px-4 md:px-12">
          ...
          >
            ...
            <h2 className="text-4xl md:text-5xl font-bold text-[#051C2C] mb-6 eb-garamond">
              Our Sales Excellence Capabilities
            </h2>
            <p className="text-xl text-[#051C2C]/60 max-w-2xl">
              Comprehensive sales services from strategy to execution.
            </p>
          </motion.div>
            ...
            {[
              {
                ...
                description: "Develop go-to-market strategies that drive growth. Define target segments, value propositions, and channel strategies."
              },
              {
                icon: Briefcase,
                title: "Sales Process",
                description: "Design and implement sales processes that improve win rates. Build methodologies that guide reps through complex sales cycles."
              },
              {
                icon: Users,
                title: "Sales Organization",
                description: "Design sales organizations that maximize coverage and effectiveness. Define roles, territories, and team structures."
              },
              {
                icon: Award,
                title: "Sales Capability",
                description: "Build sales capabilities through training and coaching. Develop skills in prospecting, discovery, negotiation, and closing."
              },
              {
                icon: BarChart3,
                title: "Sales Analytics",
                description: "Build analytics capabilities that drive sales performance. Implement forecasting, pipeline management, and performance dashboards."
              },
              {
                icon: TrendingUp,
                title: "Incentive Design",
                description: "Design compensation and incentive programs that drive behavior. Align incentives with strategic priorities and performance goals."
              }
            ].map((item, index) => (
              <motion.div
                key={index}
            ...
            {[
              {
                ...
                title: "Sales transformation drives 30% improvement in productivity and 20% increase in win rates",
                description: "A B2B technology company was struggling with inconsistent sales performance. We redesigned their sales process, implemented new tools, and built capability through coaching. Productivity improved 30% and win rates increased 20% within 12 months.",
                image: "https://images.unsplash.com/photo-1552664730-d307ca884978?auto=format&fit=crop&q=80"
              },
              {
                category: "INDUSTRIAL DISTRIBUTION",
                title: "Sales organization redesign unlocks $50M in new revenue",
                description: "An industrial distributor had misaligned sales coverage that left growth opportunities untapped. We redesigned the sales organization, reallocated resources, and implemented new incentives. The changes unlocked $50M in incremental annual revenue.",
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-16 gap-6">
            ...
            >
              ...
              <p className="text-xl text-[#051C2C]/60 mt-4">
                Expert perspectives on sales excellence.
              </p>
            </motion.div>
            ...
            {[
              {
                ...
                readTime: "6 min read",
                title: "The Anatomy of High-Performing Sales Teams",
                description: "What separates top-performing sales organizations from the rest, and how to build those capabilities.",
                link: "/insights/high-performing-sales"
              },
              {
                category: "Sales Process",
                readTime: "5 min read",
                title: "Designing Sales Processes That Win",
                description: "How to build sales methodologies that guide reps through complex B2B sales cycles.",
                link: "/insights/sales-process-design"
              },
              {
                category: "Incentives",
                readTime: "7 min read",
                title: "Getting Sales Incentives Right",
                description: "How to design compensation programs that drive the right behaviors and outcomes.",
                link: "/insights/sales-incentives"
              }
            ].map((insight, index) => (
              <motion.div
                key={index}
            ...
            {[
              {
                ...
                description: "Unlock hidden value through strategic pricing. Optimize pricing strategies and improve monetization.",
        ...
        <div className="container px-4 md:px-12 text-center">
          ...
          >
            <h2 className="text-4xl md:text-5xl font-bold text-white mb-6 eb-garamond">
              Ready to build a high-performing sales organization?
            </h2>
            <p className="text-xl text-white/80 max-w-2xl mx-auto mb-10">
              Let's discuss how sales excellence can drive sustainable growth for your business.
            </p>
            <Link href="/contact">
