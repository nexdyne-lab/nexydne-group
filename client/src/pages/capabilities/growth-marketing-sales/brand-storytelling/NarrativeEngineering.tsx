// TODO: confirm Narrative Engineering content with Brand & Storytelling practice lead before publish.
...
export default function NarrativeEngineering() {
  return (
    <ServiceDetailTemplate
      ...
      serviceName="Narrative Engineering"
      serviceSlug="narrative-engineering"
      heroSubtitle="A structured methodology for extracting the core technical truth of a product and reconstructing it as a compelling market narrative. We align product truth with market need to create defensible positioning."
      heroImage="/images/capabilities/cap-woman-motion.jpg"
      heroFocal="55% 50%"
      experienceStats={[
        // TODO: confirm with practice lead before publish
        { number: "40+", label: "Narrative Engineering engagements delivered" },
        // TODO: confirm with practice lead before publish
      ...
      challenge="Most mid-market teams underestimate how hard it is to translate narrative engineering from a one-off project into a repeatable, production-grade capability the rest of the business actually trusts. Pilots stall in isolation, ownership scatters, and the value case quietly drifts back to the slide deck it started from."
      // TODO: confirm opportunity framing with practice lead before publish
      opportunity="Done well, narrative engineering compounds — every iteration sharpens the operating model, lowers cost, and unlocks the next set of decisions leadership has been deferring. Our Brand & Storytelling team brings the strategy, design, data, and change-management muscle needed to move from one-off project to durable capability your team can keep evolving."
      approachPillars={[
        // TODO: confirm pillar copy with practice lead before publish
        {
          step: "01",
          title: "Diagnose the real problem",
          body: "We start with the operating reality, not the technology. Where is value leaking, where is risk concentrated, where do your people lose hours? That is where narrative engineering earns its keep.",
        },
        // TODO: confirm pillar copy with practice lead before publish
        {
          step: "02",
      ...
      outcomes={[
        ...
        "A clear, prioritized roadmap that ties narrative engineering to specific business outcomes leadership has signed off on.",
        // TODO: confirm outcomes with practice lead before publish
