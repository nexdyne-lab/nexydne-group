// TODO: confirm Customer Research content with Brand Strategy practice lead before publish.
...
export default function CustomerResearch() {
  return (
    <ServiceDetailTemplate
      ...
      serviceName="Customer Research"
      serviceSlug="customer-research"
      heroSubtitle="Understand what drives customer decisions through qualitative and quantitative research. Build segmentation and persona frameworks."
      heroImage="/images/capabilities/cap-diverse-team.jpg"
      heroFocal="50% 45%"
      experienceStats={[
        // TODO: confirm with practice lead before publish
        { number: "40+", label: "Customer Research engagements delivered" },
        // TODO: confirm with practice lead before publish
      ...
      challenge="Most mid-market teams underestimate how hard it is to translate customer research from a one-off project into a repeatable, production-grade capability the rest of the business actually trusts. Pilots stall in isolation, ownership scatters, and the value case quietly drifts back to the slide deck it started from."
      // TODO: confirm opportunity framing with practice lead before publish
      opportunity="Done well, customer research compounds — every iteration sharpens the operating model, lowers cost, and unlocks the next set of decisions leadership has been deferring. Our Brand Strategy team brings the strategy, design, data, and change-management muscle needed to move from one-off project to durable capability your team can keep evolving."
      approachPillars={[
        // TODO: confirm pillar copy with practice lead before publish
        {
          step: "01",
          title: "Diagnose the real problem",
          body: "We start with the operating reality, not the technology. Where is value leaking, where is risk concentrated, where do your people lose hours? That is where customer research earns its keep.",
        },
        // TODO: confirm pillar copy with practice lead before publish
        {
          step: "02",
      ...
      outcomes={[
        ...
        "A clear, prioritized roadmap that ties customer research to specific business outcomes leadership has signed off on.",
        // TODO: confirm outcomes with practice lead before publish
