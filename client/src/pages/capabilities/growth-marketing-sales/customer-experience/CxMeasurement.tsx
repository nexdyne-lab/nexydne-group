// TODO: confirm CX Measurement content with Customer Experience practice lead before publish.
...
export default function CxMeasurement() {
  return (
    <ServiceDetailTemplate
      ...
      serviceName="CX Measurement"
      serviceSlug="cx-measurement"
      heroSubtitle="Build measurement systems that drive action. Implement NPS, CSAT, and other metrics with closed-loop feedback processes."
      heroImage="https://images.unsplash.com/photo-1521737852567-6949f3f9f2b5?w=1600&q=80"
      experienceStats={[
        // TODO: confirm with practice lead before publish
        { number: "40+", label: "CX Measurement engagements delivered" },
        // TODO: confirm with practice lead before publish
      ...
      challenge="Most mid-market teams underestimate how hard it is to translate cx measurement from a one-off project into a repeatable, production-grade capability the rest of the business actually trusts. Pilots stall in isolation, ownership scatters, and the value case quietly drifts back to the slide deck it started from."
      // TODO: confirm opportunity framing with practice lead before publish
      opportunity="Done well, cx measurement compounds — every iteration sharpens the operating model, lowers cost, and unlocks the next set of decisions leadership has been deferring. Our Customer Experience team brings the strategy, design, data, and change-management muscle needed to move from one-off project to durable capability your team can keep evolving."
      approachPillars={[
        // TODO: confirm pillar copy with practice lead before publish
        {
          step: "01",
          title: "Diagnose the real problem",
          body: "We start with the operating reality, not the technology. Where is value leaking, where is risk concentrated, where do your people lose hours? That is where cx measurement earns its keep.",
        },
        // TODO: confirm pillar copy with practice lead before publish
        {
          step: "02",
      ...
      outcomes={[
        ...
        "A clear, prioritized roadmap that ties cx measurement to specific business outcomes leadership has signed off on.",
        // TODO: confirm outcomes with practice lead before publish
