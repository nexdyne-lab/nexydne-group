      ...
      <main className="container mx-auto px-4 py-16">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 sm:gap-12 lg:gap-16">
          ...
          <div className="lg:col-span-8 space-y-12">
            ...
            {/* Key Focus Areas */}
            <section>
              <h2 className="text-2xl font-bold text-slate-900 mb-5 sm:mb-6 md:mb-8 eb-garamond">Building Iconic Brands</h2>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:p-6 md:p-8">
                <div className="bg-white p-4 sm:p-5 md:p-6 rounded-sm border border-slate-100 shadow-sm hover:shadow-md transition-shadow">
                  ...
                  <h3 className="text-lg font-bold text-slate-900 mb-3">Brand Purpose & Vision</h3>
                ...
                <div className="bg-white p-4 sm:p-5 md:p-6 rounded-sm border border-slate-100 shadow-sm hover:shadow-md transition-shadow">
                  ...
                  <h3 className="text-lg font-bold text-slate-900 mb-3">Identity & Design</h3>
                  <p className="text-slate-600">
                ...
                <div className="bg-white p-4 sm:p-5 md:p-6 rounded-sm border border-slate-100 shadow-sm hover:shadow-md transition-shadow">
                  ...
                  <h3 className="text-lg font-bold text-slate-900 mb-3">Messaging & Voice</h3>
                  <p className="text-slate-600">
                ...
                <div className="bg-white p-4 sm:p-5 md:p-6 rounded-sm border border-slate-100 shadow-sm hover:shadow-md transition-shadow">
                  ...
                  <h3 className="text-lg font-bold text-slate-900 mb-3">Brand Experience</h3>
                  <p className="text-slate-600">
            ...
            {/* Impact Section */}
            <section>
              <h2 className="text-2xl font-bold text-slate-900 mb-6 eb-garamond">Why Brand Matters</h2>
              <div className="bg-slate-50 p-4 sm:p-6 md:p-8 rounded-sm">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:p-6 md:p-8 text-center">
                  <div>
                    ...
                    <div className="text-sm text-slate-600 uppercase tracking-wide">Higher Shareholder Returns</div>
                  </div>
                  <div>
                    <div className="text-4xl font-bold text-blue-900 mb-2">50%</div>
                    <div className="text-sm text-slate-600 uppercase tracking-wide">More Customer Loyalty</div>
                  </div>
                  <div>
                    <div className="text-4xl font-bold text-blue-900 mb-2">20%</div>
                    <div className="text-sm text-slate-600 uppercase tracking-wide">Price Premium Potential</div>
                  </div>
                </div>
              </div>
            </section>
          ...
          <div className="lg:col-span-4 space-y-8">
            <div className="bg-slate-50 p-4 sm:p-6 md:p-8 border-t-4 border-blue-900">
              ...
              <ul className="space-y-3">
                <li>
                  <Link href="/capabilities/growth-marketing-sales/digital-marketing/performance-marketing" className="text-slate-600 hover:text-blue-900 hover:underline flex items-center">
                ...
                <li>
                  <Link href="/capabilities/strategy-finance" className="text-slate-600 hover:text-blue-900 hover:underline flex items-center">
                    <ArrowRight className="w-3 h-3 mr-2 text-blue-500" />
