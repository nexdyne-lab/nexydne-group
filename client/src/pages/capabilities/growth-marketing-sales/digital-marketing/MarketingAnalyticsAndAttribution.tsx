// TODO: confirm Marketing Analytics & Attribution content with Digital Marketing practice lead before publish.
...
export default function MarketingAnalyticsAndAttribution() {
  return (
    <ServiceDetailTemplate
      hubName="Digital Marketing"
      hubSlug="digital-marketing"
      hubHref="/capabilities/growth-marketing-sales/digital-marketing"
      serviceName="Marketing Analytics & Attribution"
      serviceSlug="marketing-analytics-and-attribution"
      heroSubtitle="Integrate customer data across channels to build a complete view of the customer journey. Develop attribution models that accurately measure marketing impact."
      heroImage="/images/capabilities/cap-hologram.jpg"
      heroFocal="45% 50%"
      experienceStats={[
        // TODO: confirm with practice lead before publish
        { number: "40+", label: "Marketing Analytics & Attribution engagements delivered" },
        // TODO: confirm with practice lead before publish
      ...
      challenge="Most mid-market teams underestimate how hard it is to translate marketing analytics & attribution from a one-off project into a repeatable, production-grade capability the rest of the business actually trusts. Pilots stall in isolation, ownership scatters, and the value case quietly drifts back to the slide deck it started from."
      // TODO: confirm opportunity framing with practice lead before publish
      opportunity="Done well, marketing analytics & attribution compounds — every iteration sharpens the operating model, lowers cost, and unlocks the next set of decisions leadership has been deferring. Our Digital Marketing team brings the strategy, design, data, and change-management muscle needed to move from one-off project to durable capability your team can keep evolving."
      approachPillars={[
        // TODO: confirm pillar copy with practice lead before publish
        {
          step: "01",
          title: "Diagnose the real problem",
          body: "We start with the operating reality, not the technology. Where is value leaking, where is risk concentrated, where do your people lose hours? That is where marketing analytics & attribution earns its keep.",
        },
        // TODO: confirm pillar copy with practice lead before publish
        {
          step: "02",
      ...
      outcomes={[
        ...
        "A clear, prioritized roadmap that ties marketing analytics & attribution to specific business outcomes leadership has signed off on.",
        // TODO: confirm outcomes with practice lead before publish
