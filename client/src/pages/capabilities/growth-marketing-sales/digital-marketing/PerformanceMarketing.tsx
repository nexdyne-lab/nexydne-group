      ...
      <header className="pt-16 sm:pt-20 pb-16 border-b border-slate-100 bg-slate-50">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl">
            ...
            <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold tracking-tight text-slate-900 mb-3 leading-[1.1] eb-garamond">
      ...
      <main className="container mx-auto px-4 py-16">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 sm:gap-12 lg:gap-16">
          ...
          <div className="lg:col-span-8 space-y-12">
            ...
            {/* Key Focus Areas */}
            <section>
              <h2 className="text-2xl font-bold text-slate-900 mb-5 sm:mb-6 md:mb-8 eb-garamond">How We Drive Performance</h2>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:p-6 md:p-8">
                <div className="bg-white p-4 sm:p-5 md:p-6 rounded-sm border border-slate-100 shadow-sm hover:shadow-md transition-shadow">
                  ...
                  <h3 className="text-lg font-bold text-slate-900 mb-3">Precision Targeting</h3>
                ...
                <div className="bg-white p-4 sm:p-5 md:p-6 rounded-sm border border-slate-100 shadow-sm hover:shadow-md transition-shadow">
                  ...
                  <h3 className="text-lg font-bold text-slate-900 mb-3">Channel Optimization</h3>
                  <p className="text-slate-600">
                ...
                <div className="bg-white p-4 sm:p-5 md:p-6 rounded-sm border border-slate-100 shadow-sm hover:shadow-md transition-shadow">
                  ...
                  <h3 className="text-lg font-bold text-slate-900 mb-3">Creative Testing</h3>
                  <p className="text-slate-600">
                ...
                <div className="bg-white p-4 sm:p-5 md:p-6 rounded-sm border border-slate-100 shadow-sm hover:shadow-md transition-shadow">
                  ...
                  <h3 className="text-lg font-bold text-slate-900 mb-3">Conversion Rate Optimization (CRO)</h3>
                  <p className="text-slate-600">
            ...
            {/* Impact Section */}
            <section>
              <h2 className="text-2xl font-bold text-slate-900 mb-6 eb-garamond">Client Impact</h2>
              <div className="bg-slate-50 p-4 sm:p-6 md:p-8 rounded-sm">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:p-6 md:p-8 text-center">
                  <div>
                    ...
                    <div className="text-sm text-slate-600 uppercase tracking-wide">Reduction in CAC</div>
                  </div>
                  <div>
                    <div className="text-4xl font-bold text-blue-900 mb-2">2.5x</div>
                    <div className="text-sm text-slate-600 uppercase tracking-wide">Increase in ROAS</div>
                  </div>
                  <div>
                    <div className="text-4xl font-bold text-blue-900 mb-2">45%</div>
                    <div className="text-sm text-slate-600 uppercase tracking-wide">Growth in Online Revenue</div>
                  </div>
                </div>
              </div>
            </section>
          ...
          <div className="lg:col-span-4 space-y-8">
            <div className="bg-slate-50 p-4 sm:p-6 md:p-8 border-t-4 border-blue-900">
              <h3 className="text-lg font-bold text-slate-900 mb-4">Related Capabilities</h3>
              <ul className="space-y-3">
                <li>
                  <Link href="/capabilities/growth-marketing-sales/digital-marketing/analytics-attribution" className="text-slate-600 hover:text-blue-900 hover:underline flex items-center">
                    <ArrowRight className="w-3 h-3 mr-2 text-blue-500" />
                    Analytics & Attribution
                  </Link>
                </li>
                <li>
                  <Link href="/capabilities/growth-marketing-sales/digital-marketing/brand-strategy" className="text-slate-600 hover:text-blue-900 hover:underline flex items-center">
                    <ArrowRight className="w-3 h-3 mr-2 text-blue-500" />
                    Brand Strategy
                  </Link>
                </li>
                <li>
                  <Link href="/capabilities/growth-marketing-sales/pricing" className="text-slate-600 hover:text-blue-900 hover:underline flex items-center">
                    <ArrowRight className="w-3 h-3 mr-2 text-blue-500" />
                    Pricing
                  </Link>
                </li>
