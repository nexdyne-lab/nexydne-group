    ...
    <div className="min-h-screen bg-white font-sans text-charcoal">
      ...
      <section className="relative pt-32 pb-24 overflow-hidden bg-background">
        <div className="absolute inset-0 opacity-10">
          <div className="absolute top-0 left-0 w-full h-full bg-[url('/images/capabilities/cap-retail-data.jpg')] bg-cover bg-center" />
        </div>
              ...
              <div className="space-y-6">
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground text-sm">Optimizing Core Web Vitals to reduce bounce rates. Every 100ms delay costs 1% in revenue.</p>
                  </div>
                </div>
                <div className="flex gap-4">
                  <div className="p-3 bg-primary/10 rounded-lg h-fit">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground text-sm">Simplifying navigation, improving search relevance, and clarifying value propositions.</p>
                  </div>
                </div>
                <div className="flex gap-4">
                  <div className="p-3 bg-primary/10 rounded-lg h-fit">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground text-sm">Strategically placing reviews, trust badges, and urgency signals to build confidence.</p>
                  </div>
                </div>
              </div>
            </div>
