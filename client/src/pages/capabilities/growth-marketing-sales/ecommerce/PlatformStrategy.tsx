        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="max-w-4xl">
            ...
            <h1 className="text-5xl md:text-6xl font-bold text-white mb-2 sm:mb-3 md:mb-4 leading-tight eb-garamond">
              ...
              <span className="text-[#00d4ff]">Migration Engineering</span>
            </h1>
        ...
        <div className="container mx-auto px-6">
          <div className="grid md:grid-cols-2 gap-8 sm:gap-12 lg:gap-16 items-center mb-24">
            ...
            <div className="bg-slate-50 p-4 sm:p-6 md:p-8 rounded-xl sm:rounded-2xl border border-slate-100">
              <h3 className="text-xl font-bold text-slate-900 mb-6">Our Architecture Principles</h3>
              <div className="space-y-6">
                <div className="flex gap-4">
                  ...
                  <div>
                    <h4 className="font-bold text-slate-900 mb-2">API-First Design</h4>
                    <p className="text-slate-600 text-sm">Ensuring all functionality is exposed via robust APIs for seamless integration with any frontend or third-party service.</p>
                  </div>
                </div>
                <div className="flex gap-4">
                  <div className="p-3 bg-blue-100 rounded-lg h-fit">
                  ...
                  <div>
                    <h4 className="font-bold text-slate-900 mb-2">Cloud-Native Scalability</h4>
                    <p className="text-slate-600 text-sm">Leveraging serverless functions and auto-scaling infrastructure to handle peak traffic without over-provisioning.</p>
                  </div>
                </div>
                <div className="flex gap-4">
                  <div className="p-3 bg-blue-100 rounded-lg h-fit">
                  ...
                  <div>
                    <h4 className="font-bold text-slate-900 mb-2">Data Consistency</h4>
                    <p className="text-slate-600 text-sm">Implementing eventual consistency models and distributed transaction patterns to ensure data integrity across microservices.</p>
                  </div>
                </div>
              </div>
            </div>
