            ...
            <section>
              ...
              <div className="space-y-10">
                <div className="bg-slate-50 p-4 sm:p-6 md:p-8 rounded-sm border border-slate-100">
                  <h3 className="text-xl font-bold text-slate-900 mb-4">Sustainable Packaging</h3>
                ...
                <div className="bg-slate-50 p-4 sm:p-6 md:p-8 rounded-sm border border-slate-100">
                  <h3 className="text-xl font-bold text-slate-900 mb-4">Supply Chain Transparency</h3>
                  <p className="text-slate-600 mb-6">
                ...
                <div className="bg-slate-50 p-4 sm:p-6 md:p-8 rounded-sm border border-slate-100">
                  <h3 className="text-xl font-bold text-slate-900 mb-4">Green Product Design</h3>
                  <p className="text-slate-600 mb-6">
                ...
                <div className="relative z-10">
                  ...
                  <div className="grid grid-cols-2 gap-4 sm:p-6 md:p-8 mb-5 sm:mb-6 md:mb-8 border-t border-white/10 pt-8">
                    <div>
                      ...
                      <div className="text-sm text-slate-400">Less Plastic</div>
                    </div>
                    <div>
