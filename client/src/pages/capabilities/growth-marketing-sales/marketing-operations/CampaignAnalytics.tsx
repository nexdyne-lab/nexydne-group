          ...
          >
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-8 md:gap-12">
              <div className="border-l-2 border-[#0077B5] pl-6">
                <div className="text-4xl sm:text-5xl font-bold text-[#051C2C] mb-2">85+</div>
                <div className="text-sm sm:text-base text-[#051C2C]/60">analytics frameworks deployed</div>
              </div>
              <div className="border-l-2 border-[#0077B5] pl-6">
                <div className="text-4xl sm:text-5xl font-bold text-[#051C2C] mb-2">3x</div>
                <div className="text-sm sm:text-base text-[#051C2C]/60">average improvement in attribution accuracy</div>
              </div>
              <div className="border-l-2 border-[#0077B5] pl-6">
                <div className="text-4xl sm:text-5xl font-bold text-[#051C2C] mb-2">20-40%</div>
                <div className="text-sm sm:text-base text-[#051C2C]/60">typical improvement in marketing ROI</div>
              </div>
            </div>
          </motion.div>
        </div>
