        ...
        <div className="container mx-auto max-w-4xl px-4">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:p-5 md:p-6 mt-12">
            <div className="bg-purple-50 p-4 sm:p-5 md:p-6 rounded-lg sm:rounded-xl border border-purple-100">
              ...
              <h3 className="font-bold text-[#0a0e3d] mb-2">Customer Acquisition Cost (CAC)</h3>
              <p className="text-sm text-slate-600">Granular tracking of acquisition costs by channel, campaign, and segment to ensure efficient growth.</p>
            </div>
            <div className="bg-purple-50 p-4 sm:p-5 md:p-6 rounded-lg sm:rounded-xl border border-purple-100">
              <div className="w-10 h-10 bg-purple-100 rounded-full flex items-center justify-center mb-4">
                <TrendingUp className="w-4 h-4 sm:w-5 sm:h-5 text-purple-700" />
              </div>
              <h3 className="font-bold text-[#0a0e3d] mb-2">Customer Lifetime Value (CLV)</h3>
              <p className="text-sm text-slate-600">Modeling long-term customer value to inform strategic decisions on acquisition spend and retention.</p>
            </div>
            <div className="bg-purple-50 p-4 sm:p-5 md:p-6 rounded-lg sm:rounded-xl border border-purple-100">
              <div className="w-10 h-10 bg-purple-100 rounded-full flex items-center justify-center mb-4">
                <Target className="w-4 h-4 sm:w-5 sm:h-5 text-purple-700" />
              </div>
              <h3 className="font-bold text-[#0a0e3d] mb-2">Return on Ad Spend (ROAS)</h3>
              <p className="text-sm text-slate-600">Real-time measurement of direct revenue impact from paid media to maximize campaign efficiency.</p>
            </div>
          </div>
        </div>
      </section>
                ...
                <div className="bg-white p-4 sm:p-6 md:p-8 rounded-xl sm:rounded-2xl shadow-xl relative z-10 border border-slate-100">
                  <div className="space-y-6">
                    <div className="flex items-center gap-4 p-4 bg-slate-50 rounded-lg border border-slate-100">
                      ...
                      <div>
                        <h4 className="font-bold text-slate-800">Multi-Touch Attribution</h4>
                        <p className="text-xs text-slate-500">Linear, Time Decay, U-Shaped Models</p>
                      </div>
                    </div>
                    <div className="flex items-center gap-4 p-4 bg-slate-50 rounded-lg border border-slate-100">
                      ...
                      <div>
                        <h4 className="font-bold text-slate-800">Media Mix Modeling (MMM)</h4>
                        <p className="text-xs text-slate-500">Statistical analysis for offline & online impact</p>
                      </div>
                    </div>
                    <div className="flex items-center gap-4 p-4 bg-slate-50 rounded-lg border border-slate-100">
                      ...
                      <div>
                        <h4 className="font-bold text-slate-800">Forecasting & Budgeting</h4>
                        <p className="text-xs text-slate-500">Predictive analytics for future spend allocation</p>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div className="order-1 md:order-2">
              ...
              <ul className="space-y-4">
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    <h4 className="font-bold text-[#0a0e3d]">Advanced Attribution Modeling</h4>
                    <p className="text-slate-600 text-sm">Moving beyond "last-click" to understand the full influence of your marketing mix across the entire journey.</p>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircleIcon className="w-6 h-6 text-purple-600 flex-shrink-0 mt-1" />
                  <div>
                    <h4 className="font-bold text-[#0a0e3d]">Dynamic Budget Optimization</h4>
                    <p className="text-slate-600 text-sm">Agile allocation of spend to the highest-performing channels and campaigns to maximize returns.</p>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircleIcon className="w-6 h-6 text-purple-600 flex-shrink-0 mt-1" />
                  <div>
                    <h4 className="font-bold text-[#0a0e3d]">Predictive Performance Forecasting</h4>
                    <p className="text-slate-600 text-sm">Leveraging historical data to model future outcomes and set ambitious, achievable targets.</p>
                  </div>
                </li>
              </ul>
            </div>
