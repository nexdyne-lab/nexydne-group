// TODO: confirm MarTech Strategy content with Marketing Operations practice lead before publish.
...
export default function MartechStrategy() {
  return (
    <ServiceDetailTemplate
      ...
      heroSubtitle="Define your marketing technology strategy and roadmap. Select, implement, and integrate tools that enable your marketing vision."
      ...
      opportunity="Done well, martech strategy compounds — every iteration sharpens the operating model, lowers cost, and unlocks the next set of decisions leadership has been deferring. Our Marketing Operations team brings the strategy, design, data, and change-management muscle needed to move from one-off project to durable capability your team can keep evolving."
      approachPillars={[
