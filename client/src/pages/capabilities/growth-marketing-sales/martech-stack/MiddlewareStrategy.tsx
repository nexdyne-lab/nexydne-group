            ...
            <div>
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-lg font-bold text-slate-900">API-First Architecture</h3>
                    <p className="text-slate-600">Designing systems where every function is accessible via robust, documented APIs.</p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  <div className="p-2 rounded-lg bg-blue-50 text-blue-600 mt-1">
                  ...
                  <div>
                    <h3 className="text-lg font-bold text-slate-900">Event-Driven Workflows</h3>
                    <p className="text-slate-600">Triggering actions based on real-time events rather than batch processing.</p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  <div className="p-2 rounded-lg bg-blue-50 text-blue-600 mt-1">
                  ...
                  <div>
                    <h3 className="text-lg font-bold text-slate-900">Idempotency & Deduplication</h3>
                    <p className="text-slate-600">Ensuring that retrying a failed operation doesn't result in duplicate records.</p>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="relative bg-white p-4 sm:p-6 md:p-8 rounded-3xl shadow-xl border border-slate-100">
                <div className="space-y-8">
                  <div className="flex items-center justify-between pb-6 border-b border-slate-100">
                    <h3 className="font-bold text-slate-900">Integration Health</h3>
                    <span className="px-3 py-1 rounded-full bg-green-100 text-green-700 text-xs font-bold">HEALTHY</span>
                  </div>
                  
                  <div className="space-y-4">
                    <div className="p-4 bg-slate-50 rounded-lg sm:rounded-xl border border-slate-100 flex justify-between items-center">
                      <div>
                        <div className="text-sm font-bold text-slate-900">API Uptime</div>
                    ...
                    <div className="p-4 bg-slate-50 rounded-lg sm:rounded-xl border border-slate-100 flex justify-between items-center">
                      <div>
                        <div className="text-sm font-bold text-slate-900">Sync Latency</div>
                    ...
                    <div className="p-4 bg-slate-50 rounded-lg sm:rounded-xl border border-slate-100 flex justify-between items-center">
                      <div>
                        <div className="text-sm font-bold text-slate-900">Error Rate</div>
                        <div className="text-xs text-slate-500">Failed requests</div>
                      </div>
                      <div className="text-xl font-bold text-green-600">0.01%</div>
                    </div>
                  </div>

                  <div className="pt-4">
                    <div className="text-xs font-medium text-slate-500 mb-2">RECENT EVENTS</div>
