      ...
      <main className="container mx-auto px-4 pt-16 pb-24">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 sm:gap-12 lg:gap-16">
          ...
          <div className="lg:col-span-8 space-y-16">
            ...
            {/* Key Strategies */}
            <section>
              <h2 className="text-3xl font-bold text-slate-900 mb-5 sm:mb-6 md:mb-8 eb-garamond">Strategic Levers</h2>
              <div className="grid md:grid-cols-2 gap-4 sm:p-6 md:p-8">
                <div className="bg-slate-50 p-4 sm:p-6 md:p-8 rounded-sm border border-slate-100">
                  <h3 className="text-xl font-bold text-slate-900 mb-4">Tiered Architecture</h3>
            ...
            <section>
              ...
              <div className="space-y-8">
                <div className="flex gap-4 sm:p-5 md:p-6">
                  ...
                  <div>
                    <h3 className="text-xl font-bold text-slate-900 mb-2">Feature Valuation</h3>
                    <p className="text-slate-600 leading-relaxed">
                ...
                <div className="flex gap-4 sm:p-5 md:p-6">
                  ...
                  <div>
                    <h3 className="text-xl font-bold text-slate-900 mb-2">Segmentation Analysis</h3>
                    <p className="text-slate-600 leading-relaxed">
                ...
                <div className="flex gap-4 sm:p-5 md:p-6">
                  ...
                  <div>
                    <h3 className="text-xl font-bold text-slate-900 mb-2">Package Design</h3>
                    <p className="text-slate-600 leading-relaxed">
                ...
                <div className="flex gap-4 sm:p-5 md:p-6">
                  ...
                  <div>
                    <h3 className="text-xl font-bold text-slate-900 mb-2">Go-to-Market Alignment</h3>
                    <p className="text-slate-600 leading-relaxed">
                ...
                <div className="flex-1">
                  ...
                  <div className="grid grid-cols-2 gap-4 sm:p-5 md:p-6 border-t border-slate-800 pt-6">
                    <div>
                      ...
                      <div className="text-sm text-slate-400">Increase in ARPU</div>
                    </div>
                    <div>
                      <div className="text-3xl font-bold text-white mb-1">15%</div>
                      <div className="text-sm text-slate-400">Upgrade Rate</div>
                    </div>
                  </div>
                </div>
