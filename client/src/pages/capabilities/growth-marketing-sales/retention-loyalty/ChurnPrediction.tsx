        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="max-w-4xl">
            ...
            <h1 className="text-5xl md:text-6xl font-bold text-white mb-3 leading-tight eb-garamond">
              Churn Prediction & <span className="text-[#00d4ff]">Prevention</span>
            </h1>
          ...
          <div className="grid md:grid-cols-2 gap-8 sm:gap-12 lg:gap-16">
            <div>
              ...
              <div className="prose prose-lg text-slate-600">
                ...
                <h3 className="text-xl font-bold text-slate-900 mt-8 mb-4">Our Methodology</h3>
                <ul className="space-y-4">
                  <li className="flex items-start gap-3">
                    ...
                    <div>
                      <strong className="text-slate-900">Behavioral Pattern Recognition</strong>
                  ...
                  <li className="flex items-start gap-3">
                    ...
                    <div>
                      <strong className="text-slate-900">Automated Intervention</strong>
                  ...
                  <li className="flex items-start gap-3">
                    ...
                    <div>
                      <strong className="text-slate-900">Cohort Analysis</strong>
            ...
            <div className="bg-slate-50 p-4 sm:p-6 md:p-8 rounded-xl sm:rounded-2xl border border-slate-100">
              ...
              <div className="space-y-6">
                <div className="relative pl-8 border-l-2 border-slate-200 pb-6 last:pb-0">
                  ...
                  <h4 className="font-bold text-slate-900 mb-2">1. Signal Detection</h4>
                ...
                <div className="relative pl-8 border-l-2 border-slate-200 pb-6 last:pb-0">
                  <div className="absolute -left-[9px] top-0 w-3 h-3 sm:w-4 sm:h-4 rounded-full bg-blue-600 border-4 border-white shadow-sm"></div>
                  <h4 className="font-bold text-slate-900 mb-2">2. Risk Scoring</h4>
                  <p className="text-sm text-slate-600">
                ...
                <div className="relative pl-8 border-l-2 border-slate-200 pb-6 last:pb-0">
                  <div className="absolute -left-[9px] top-0 w-3 h-3 sm:w-4 sm:h-4 rounded-full bg-blue-600 border-4 border-white shadow-sm"></div>
                  <h4 className="font-bold text-slate-900 mb-2">3. Automated Action</h4>
                  <p className="text-sm text-slate-600">
                    System triggers "Re-engagement Sequence B" (educational content + offer) and alerts the dedicated CSM via Slack.
                  </p>
                </div>
                <div className="relative pl-8 border-l-2 border-slate-200 pb-6 last:pb-0">
                  <div className="absolute -left-[9px] top-0 w-3 h-3 sm:w-4 sm:h-4 rounded-full bg-green-500 border-4 border-white shadow-sm"></div>
                  <h4 className="font-bold text-slate-900 mb-2">4. Resolution</h4>
                  <p className="text-sm text-slate-600">
