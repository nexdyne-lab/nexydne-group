    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="relative bg-background pt-32 pb-24 overflow-hidden">
        <div className="absolute inset-0 opacity-10">
          <div className="absolute inset-0 bg-[url('/images/capabilities/cap-peacock.jpg')] bg-cover bg-center mix-blend-overlay"></div>
          ...
          <div className="grid md:grid-cols-2 gap-8 sm:gap-12 lg:gap-16">
            <div>
              ...
              <div className="prose prose-lg text-muted-foreground">
                ...
                <h3 className="text-xl font-bold text-charcoal mt-8 mb-4">The Health Score Algorithm</h3>
                <ul className="space-y-4">
                  <li className="flex items-start gap-3">
                    ...
                    <div>
                      <strong className="text-charcoal">Usage Intensity</strong>
                  ...
                  <li className="flex items-start gap-3">
                    ...
                    <div>
                      <strong className="text-charcoal">Support Sentiment</strong>
                  ...
                  <li className="flex items-start gap-3">
                    ...
                    <div>
                      <strong className="text-charcoal">Commercial Health</strong>
