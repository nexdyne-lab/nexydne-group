// TODO: confirm Loyalty Program Design content with Retention & Loyalty practice lead before publish.
...
export default function LoyaltyProgramDesign() {
  return (
    <ServiceDetailTemplate
      hubName="Retention & Loyalty"
      hubSlug="retention-loyalty"
      hubHref="/capabilities/growth-marketing-sales/retention-loyalty"
      serviceName="Loyalty Program Design"
      serviceSlug="loyalty-program-design"
      heroSubtitle="Design loyalty programs that drive engagement and value. Create reward structures, tiers, and experiences that resonate with your customers."
      heroImage="https://images.unsplash.com/photo-1556742049-0cfed4f6a45d?w=1600&q=80"
      experienceStats={[
        // TODO: confirm with practice lead before publish
        { number: "40+", label: "Loyalty Program Design engagements delivered" },
        // TODO: confirm with practice lead before publish
      ...
      challenge="Most mid-market teams underestimate how hard it is to translate loyalty program design from a one-off project into a repeatable, production-grade capability the rest of the business actually trusts. Pilots stall in isolation, ownership scatters, and the value case quietly drifts back to the slide deck it started from."
      // TODO: confirm opportunity framing with practice lead before publish
      opportunity="Done well, loyalty program design compounds — every iteration sharpens the operating model, lowers cost, and unlocks the next set of decisions leadership has been deferring. Our Retention & Loyalty team brings the strategy, design, data, and change-management muscle needed to move from one-off project to durable capability your team can keep evolving."
      approachPillars={[
        // TODO: confirm pillar copy with practice lead before publish
        {
          step: "01",
          title: "Diagnose the real problem",
          body: "We start with the operating reality, not the technology. Where is value leaking, where is risk concentrated, where do your people lose hours? That is where loyalty program design earns its keep.",
        },
        // TODO: confirm pillar copy with practice lead before publish
        {
          step: "02",
      ...
      outcomes={[
        ...
        "A clear, prioritized roadmap that ties loyalty program design to specific business outcomes leadership has signed off on.",
        // TODO: confirm outcomes with practice lead before publish
