          ...
          <div className="lg:col-span-8 space-y-12">
            ...
            <div className="grid md:grid-cols-2 gap-4 sm:p-6 md:p-8">
              <div className="bg-slate-50 p-4 sm:p-6 md:p-8 rounded-sm border border-slate-100">
                <h3 className="text-xl font-bold text-slate-900 mb-4">High-Resolution Market Mapping</h3>
              ...
              <div className="bg-slate-50 p-4 sm:p-6 md:p-8 rounded-sm border border-slate-100">
                <h3 className="text-xl font-bold text-slate-900 mb-4">Product-Led Growth (PLG)</h3>
                <p className="text-slate-600 mb-6">
            ...
            <section>
              <h2 className="text-3xl font-bold text-slate-900 mb-6 eb-garamond">The "Full-Stack" GTM Team</h2>
