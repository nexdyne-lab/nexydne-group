// TODO: confirm Sales Capability content with Sales Excellence practice lead before publish.
...
export default function SalesCapability() {
  return (
    <ServiceDetailTemplate
      hubName="Sales Excellence"
      hubSlug="sales-excellence"
      hubHref="/capabilities/growth-marketing-sales/sales-excellence"
      serviceName="Sales Capability"
      serviceSlug="sales-capability"
      heroSubtitle="Build sales capabilities through training and coaching. Develop skills in prospecting, discovery, negotiation, and closing."
      heroImage="/images/capabilities/cap-colleagues.jpg"
      heroFocal="55% 50%"
      experienceStats={[
        // TODO: confirm with practice lead before publish
        { number: "40+", label: "Sales Capability engagements delivered" },
        // TODO: confirm with practice lead before publish
      ...
      challenge="Most mid-market teams underestimate how hard it is to translate sales capability from a one-off project into a repeatable, production-grade capability the rest of the business actually trusts. Pilots stall in isolation, ownership scatters, and the value case quietly drifts back to the slide deck it started from."
      // TODO: confirm opportunity framing with practice lead before publish
      opportunity="Done well, sales capability compounds — every iteration sharpens the operating model, lowers cost, and unlocks the next set of decisions leadership has been deferring. Our Sales Excellence team brings the strategy, design, data, and change-management muscle needed to move from one-off project to durable capability your team can keep evolving."
      approachPillars={[
        // TODO: confirm pillar copy with practice lead before publish
        {
          step: "01",
          title: "Diagnose the real problem",
          body: "We start with the operating reality, not the technology. Where is value leaking, where is risk concentrated, where do your people lose hours? That is where sales capability earns its keep.",
        },
        // TODO: confirm pillar copy with practice lead before publish
        {
          step: "02",
      ...
      outcomes={[
        ...
        "A clear, prioritized roadmap that ties sales capability to specific business outcomes leadership has signed off on.",
        // TODO: confirm outcomes with practice lead before publish
