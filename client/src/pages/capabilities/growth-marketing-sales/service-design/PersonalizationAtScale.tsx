// TODO: confirm Personalization at Scale content with Service Design practice lead before publish.
...
export default function PersonalizationAtScale() {
  return (
    <ServiceDetailTemplate
      ...
      serviceName="Personalization at Scale"
      serviceSlug="personalization-at-scale"
      heroSubtitle="Leveraging data and AI to deliver relevant content and offers to millions of users individually, in real-time, without compromising privacy or performance."
      heroImage="/images/capabilities/cap-hands-data.jpg"
      heroFocal="60% 50%"
      experienceStats={[
        // TODO: confirm with practice lead before publish
        { number: "40+", label: "Personalization at Scale engagements delivered" },
        // TODO: confirm with practice lead before publish
      ...
      challenge="Most teams underestimate how hard it is to translate personalization at scale from a one-off project into a repeatable, production-grade capability the rest of the business actually trusts. Pilots stall in isolation, ownership scatters, and the value case quietly drifts back to the slide deck it started from."
      // TODO: confirm opportunity framing with practice lead before publish
      opportunity="Done well, personalization at scale compounds — every iteration sharpens the operating model, lowers cost, and unlocks the next set of decisions leadership has been deferring. Our Service Design team brings the strategy, design, data, and change-management muscle needed to move from one-off project to durable capability your team can keep evolving."
      approachPillars={[
        // TODO: confirm pillar copy with practice lead before publish
        {
          step: "01",
          title: "Diagnose the real problem",
          body: "We start with the operating reality, not the technology. Where is value leaking, where is risk concentrated, where do your people lose hours? That is where personalization at scale earns its keep.",
        },
        // TODO: confirm pillar copy with practice lead before publish
        {
          step: "02",
      ...
      outcomes={[
        ...
        "A clear, prioritized roadmap that ties personalization at scale to specific business outcomes leadership has signed off on.",
        // TODO: confirm outcomes with practice lead before publish
