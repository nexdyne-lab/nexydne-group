        ...
        <table className="w-full">
          <thead>
            <tr className="border-b border-border">
              <th className="text-left py-3 font-semibold text-charcoal">Risk Level</th>
              <th className="text-left py-3 font-semibold text-charcoal">Characteristics</th>
              <th className="text-left py-3 font-semibold text-charcoal">Governance Requirements</th>
            </tr>
          </thead>
