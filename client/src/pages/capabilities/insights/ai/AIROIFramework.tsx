        ...
        <table className="w-full">
          <thead>
            <tr className="border-b border-gray-200">
              <th className="text-left py-3 font-semibold text-gray-900">Use Case Category</th>
              <th className="text-left py-3 font-semibold text-gray-900">Typical Investment</th>
              <th className="text-left py-3 font-semibold text-gray-900">First-Year ROI</th>
              <th className="text-left py-3 font-semibold text-gray-900">Three-Year ROI</th>
            </tr>
          </thead>
