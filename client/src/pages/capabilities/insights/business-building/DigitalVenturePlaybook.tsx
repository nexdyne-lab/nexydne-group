    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="bg-charcoal text-white pt-32 pb-20">
        <div className="container max-w-4xl">
          <Link href="/capabilities/business-building/insights" className="inline-flex items-center text-sm text-muted-foreground/70 hover:text-white mb-8 transition-colors">
            ...
            <div className="flex items-center gap-8">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <div className="text-sm text-muted-foreground">Partner, Business Building</div>
                </div>
              </div>
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <div className="text-sm text-muted-foreground">Senior Manager, Ventures</div>
                </div>
              </div>
            </div>
      ...
      <article className="py-16">
        <div className="container max-w-3xl">
          <div className="prose prose-lg max-w-none">
            ...
            <h3 className="text-2xl font-bold text-charcoal mt-10 mb-4">Phase 2: Concept Development (6-8 Weeks)</h3>
            ...
            <h3 className="text-2xl font-bold text-charcoal mt-10 mb-4">Phase 3: MVP Launch (8-12 Weeks)</h3>
            ...
            <h3 className="text-2xl font-bold text-charcoal mt-10 mb-4">Phase 4: Scale or Pivot (Ongoing)</h3>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Link href="/insights/from-mvp-to-scale" className="group">
              <div className="bg-white p-6 h-full hover:shadow-lg transition-shadow">
                <span className="text-xs font-semibold text-secondary uppercase tracking-wider">SCALING</span>
            ...
            <Link href="/insights/corporate-venture-advantage" className="group">
              <div className="bg-white p-6 h-full hover:shadow-lg transition-shadow">
                <span className="text-xs font-semibold text-secondary uppercase tracking-wider">STRATEGY</span>
                <h3 className="text-lg font-bold text-charcoal mt-3 mb-2 group-hover:text-primary transition-colors">
            ...
            <Link href="/insights/hiring-for-builders" className="group">
              <div className="bg-white p-6 h-full hover:shadow-lg transition-shadow">
                <span className="text-xs font-semibold text-secondary uppercase tracking-wider">TALENT</span>
                <h3 className="text-lg font-bold text-charcoal mt-3 mb-2 group-hover:text-primary transition-colors">
