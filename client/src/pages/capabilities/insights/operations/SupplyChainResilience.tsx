    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="bg-charcoal text-white pt-32 pb-20">
        <div className="container max-w-4xl">
          <Link href="/capabilities/operations/insights" className="inline-flex items-center text-sm text-muted-foreground/70 hover:text-white mb-8 transition-colors">
          ...
          <div className="flex flex-wrap items-center justify-between gap-6">
            <div className="flex items-center gap-8">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="font-semibold text-charcoal">Marcus Williams</div>
                  <div className="text-sm text-muted-foreground">Partner, Operations</div>
                </div>
              </div>
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="font-semibold text-charcoal">Elena Petrova</div>
                  <div className="text-sm text-muted-foreground">Senior Manager, Supply Chain</div>
                </div>
              </div>
            </div>
      ...
      <article className="py-16">
        <div className="container max-w-3xl">
          <div className="prose prose-lg max-w-none">
            ...
            <h3 className="text-2xl font-bold text-charcoal mt-10 mb-4">2. Strategic Supplier Relationships</h3>
            ...
            <h3 className="text-2xl font-bold text-charcoal mt-10 mb-4">3. Flexible Sourcing Strategies</h3>
            ...
            <h3 className="text-2xl font-bold text-charcoal mt-10 mb-4">4. Demand-Side Flexibility</h3>
            ...
            <h3 className="text-2xl font-bold text-charcoal mt-10 mb-4">5. Response Playbooks</h3>
        ...
        <div className="container max-w-6xl">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <Link href="/insights/digital-twin-manufacturing" className="group">
              <div className="bg-white p-6 h-full hover:shadow-lg transition-shadow">
                <span className="text-xs font-semibold text-secondary uppercase tracking-wider">TECHNOLOGY</span>
                <h3 className="text-lg font-bold text-charcoal mt-3 mb-2 group-hover:text-primary transition-colors">
