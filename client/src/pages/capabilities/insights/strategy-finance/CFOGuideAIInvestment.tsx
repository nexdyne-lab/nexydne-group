    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="bg-black text-white pt-32 pb-20">
        <div className="container max-w-4xl">
          <Link href="/capabilities/strategy-corporate-finance/insights" className="inline-flex items-center text-sm text-gray-400 hover:text-white mb-8 transition-colors">
            ...
            <div className="flex items-center gap-8">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <div className="text-sm text-gray-500">Partner, Corporate Finance</div>
                </div>
              </div>
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <div className="text-sm text-gray-500">Senior Manager, FP&A</div>
                </div>
              </div>
            </div>
      ...
      <article className="py-16">
        <div className="container max-w-3xl">
          <div className="prose prose-lg max-w-none">
            ...
            <h2 className="text-3xl font-bold text-gray-900 mt-12 mb-6 eb-garamond">The AI Investment Paradox</h2>
            ...
            <h2 className="text-3xl font-bold text-gray-900 mt-12 mb-6 eb-garamond">A Framework for AI Investment Evaluation</h2>
            
            <h3 className="text-2xl font-bold text-gray-900 mt-10 mb-4">Step 1: Categorize the Investment</h3>
            ...
            <h3 className="text-2xl font-bold text-gray-900 mt-10 mb-4">Step 2: Assess Value Drivers</h3>
            ...
            <h3 className="text-2xl font-bold text-gray-900 mt-10 mb-4">Step 3: Model Total Cost of Ownership</h3>
            ...
            <h2 className="text-3xl font-bold text-gray-900 mt-12 mb-6 eb-garamond">Portfolio Approach to AI Investment</h2>
            ...
            <h2 className="text-3xl font-bold text-gray-900 mt-12 mb-6 eb-garamond">Measuring AI Investment Performance</h2>
            ...
            <h2 className="text-3xl font-bold text-gray-900 mt-12 mb-6 eb-garamond">Governance Recommendations</h2>
        ...
        <div className="container max-w-6xl">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <Link href="/insights/rolling-forecasts" className="group">
              <div className="bg-white p-6 h-full hover:shadow-lg transition-shadow">
                <span className="text-xs font-semibold text-[#00d4ff] uppercase tracking-wider">FP&A</span>
                <h3 className="text-lg font-bold text-gray-900 mt-3 mb-2 group-hover:text-[#0077B5] transition-colors">
            ...
            <Link href="/insights/financial-discipline-growth" className="group">
              <div className="bg-white p-6 h-full hover:shadow-lg transition-shadow">
                <span className="text-xs font-semibold text-[#00d4ff] uppercase tracking-wider">GROWTH</span>
                <h3 className="text-lg font-bold text-gray-900 mt-3 mb-2 group-hover:text-[#0077B5] transition-colors">
      ...
      <section className="py-16 bg-white">
        <div className="container max-w-4xl text-center">
          <h2 className="text-3xl font-bold text-gray-900 mb-4 eb-garamond">Ready to Optimize Your AI Investments?</h2>
