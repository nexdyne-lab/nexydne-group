  ...
  return (
    ...
    >
      ...
      <div className="bg-gray-50 p-6 rounded-lg my-8">
        <h4 className="font-semibold text-gray-900 mb-4">Phase 1: Foundation (Months 1-3)</h4>
      ...
      <div className="bg-gray-50 p-6 rounded-lg my-8">
        <h4 className="font-semibold text-gray-900 mb-4">Phase 2: Enhancement (Months 4-9)</h4>
        <ul className="list-disc pl-6 text-gray-700 space-y-2">
      ...
      <div className="bg-gray-50 p-6 rounded-lg my-8">
        <h4 className="font-semibold text-gray-900 mb-4">Phase 3: Optimization (Months 10-18)</h4>
        <ul className="list-disc pl-6 text-gray-700 space-y-2">
        ...
        <table className="min-w-full border border-gray-200">
          <thead className="bg-gray-50">
            <tr>
              ...
              <th className="px-6 py-3 text-left text-sm font-semibold text-gray-900 border-b">Traditional Finance</th>
              <th className="px-6 py-3 text-left text-sm font-semibold text-gray-900 border-b">Strategic Finance</th>
            </tr>
          </thead>
          <tbody>
            <tr>
              <td className="px-6 py-4 text-gray-700 border-b">Time spent on reporting vs. analysis</td>
              <td className="px-6 py-4 text-gray-700 border-b">70% / 30%</td>
              <td className="px-6 py-4 text-gray-700 border-b">30% / 70%</td>
            </tr>
            <tr>
              <td className="px-6 py-4 text-gray-700 border-b">Forecast accuracy</td>
              <td className="px-6 py-4 text-gray-700 border-b">±15%</td>
              <td className="px-6 py-4 text-gray-700 border-b">±5%</td>
            </tr>
            <tr>
              <td className="px-6 py-4 text-gray-700 border-b">Days to close</td>
              <td className="px-6 py-4 text-gray-700 border-b">15-20 days</td>
              <td className="px-6 py-4 text-gray-700 border-b">5-7 days</td>
            </tr>
            <tr>
              <td className="px-6 py-4 text-gray-700 border-b">CEO satisfaction with finance partnership</td>
              <td className="px-6 py-4 text-gray-700 border-b">Adequate</td>
              <td className="px-6 py-4 text-gray-700 border-b">Essential</td>
            </tr>
          </tbody>
        </table>
      </div>
