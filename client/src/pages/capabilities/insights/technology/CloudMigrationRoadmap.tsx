    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="bg-charcoal text-white pt-32 pb-20">
        <div className="container max-w-4xl">
          <Link href="/capabilities/technology/insights" className="inline-flex items-center text-sm text-muted-foreground/70 hover:text-white mb-8 transition-colors">
          ...
          <div className="flex flex-wrap items-center justify-between gap-6">
            <div className="flex items-center gap-8">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="font-semibold text-charcoal">Robert Kim</div>
                  <div className="text-sm text-muted-foreground">Partner, Technology Practice</div>
                </div>
              </div>
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="font-semibold text-charcoal">Amanda Torres</div>
                  <div className="text-sm text-muted-foreground">Senior Architect, Cloud</div>
                </div>
              </div>
            </div>
      ...
      <article className="py-16">
        <div className="container max-w-3xl">
          <div className="prose prose-lg max-w-none">
            ...
            <h3 className="text-2xl font-bold text-charcoal mt-10 mb-4">Phase 2: Foundation Building (6-8 Weeks)</h3>
            ...
            <h3 className="text-2xl font-bold text-charcoal mt-10 mb-4">Phase 3: Pilot Migration (4-6 Weeks)</h3>
            ...
            <h3 className="text-2xl font-bold text-charcoal mt-10 mb-4">Phase 4: Wave Migration (3-12 Months)</h3>
            ...
            <h3 className="text-2xl font-bold text-charcoal mt-10 mb-4">Phase 5: Optimization (Ongoing)</h3>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Link href="/insights/cloud-native-architecture" className="group">
              <div className="bg-white p-6 h-full hover:shadow-lg transition-shadow">
                <span className="text-xs font-semibold text-secondary uppercase tracking-wider">ARCHITECTURE</span>
            ...
            <Link href="/insights/ceo-guide-data-modernization" className="group">
              <div className="bg-white p-6 h-full hover:shadow-lg transition-shadow">
                <span className="text-xs font-semibold text-secondary uppercase tracking-wider">DATA</span>
                <h3 className="text-lg font-bold text-charcoal mt-3 mb-2 group-hover:text-primary transition-colors">
            ...
            <Link href="/insights/building-data-culture" className="group">
              <div className="bg-white p-6 h-full hover:shadow-lg transition-shadow">
                <span className="text-xs font-semibold text-secondary uppercase tracking-wider">CULTURE</span>
                <h3 className="text-lg font-bold text-charcoal mt-3 mb-2 group-hover:text-primary transition-colors">
