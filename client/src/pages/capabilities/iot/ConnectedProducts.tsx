            ...
            <div className="grid grid-cols-2 gap-4 sm:p-5 md:p-6">
              {[
                ...
                <div key={i} className="p-4 sm:p-5 md:p-6 rounded-lg sm:rounded-xl bg-white/5 border border-white/10 hover:bg-white hover:border-white transition-all duration-300 group">
                  <div className="text-3xl font-bold text-white mb-2 group-hover:text-[#0a0e3d] transition-colors">{stat.value}</div>
                  <div className="font-bold text-slate-300 mb-1 group-hover:text-[#0a0e3d] transition-colors">{stat.label}</div>
                  <div className="text-sm text-slate-500 group-hover:text-slate-600 transition-colors">{stat.desc}</div>
                </div>
              ))}
            </div>
          </div>
      ...
      <section className="py-24 bg-[#050829] border-y border-white/5">
        <div className="container mx-auto px-6">
          <div className="text-center max-w-3xl mx-auto mb-8 sm:mb-12 md:mb-16">
            <h2 className="text-sm font-bold tracking-widest text-[#00d4ff] uppercase mb-3 eb-garamond">Our Capabilities</h2>
