...
export default function DemandForecasting() {
  return (
    <ServiceDetailTemplate
      ...
      challenge="Most teams underestimate how hard it is to translate demand forecasting from a slide deck into a production-grade capability that other people in the business actually trust and use. The result is pilots that work in isolation, models that quietly drift, and roadmaps that never quite turn into operating reality."
      opportunity="Done well, demand forecasting compounds — every iteration improves accuracy, lowers cost, and unlocks new use cases that were previously out of reach. Our Predictive Analytics team brings the engineering rigor, design sensibility, and change management muscle needed to move from one-off project to durable, scaling capability."
      approachPillars={[
        {
          step: "01",
          title: "Diagnose the real problem",
          body: "We start with the operating reality, not the technology. Where is value leaking, where is risk concentrated, where do your people lose hours? That is where demand forecasting earns its keep.",
        },
        {
          step: "02",
      ...
      outcomes={[
        "A clear, prioritized roadmap that ties demand forecasting to specific business outcomes leadership has signed off on.",
      ...
      featuredCases={[
        ...
        { slug: "healthcare-readmission", title: "Cutting avoidable readmissions with better prediction", industry: "Healthcare", metric: "42%", image: "/images/cases/healthcare-readmission-hero.jpg" },
      ]}
      relatedServices={[
