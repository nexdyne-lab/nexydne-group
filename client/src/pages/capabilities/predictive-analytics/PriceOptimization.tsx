...
export default function PriceOptimization() {
  return (
    <ServiceDetailTemplate
      ...
      outcomes={[
        "A clear, prioritized roadmap that ties price optimization to specific business outcomes leadership has signed off on.",
