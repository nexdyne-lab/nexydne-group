    ...
    <div className="min-h-screen bg-white text-white selection:bg-primary selection:text-white">
      ...
      <section className="relative pt-32 pb-20 md:pt-40 md:pb-28 overflow-hidden">
        ...
        <div className="container relative z-10 px-4 md:px-12">
          ...
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }} className="max-w-4xl">
            <span className="text-xs uppercase tracking-[0.2em] text-primary mb-6 block">Case Study · Industrial</span>
      ...
      <section id="challenge" className="py-24 md:py-32 bg-primary">
        <div className="container px-4 md:px-12">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }}>
            ...
            <h2 className="text-4xl md:text-5xl text-white max-w-4xl leading-tight">Creating a standalone company from an integrated division</h2>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-16 bg-white text-charcoal">
        <div className="container px-4 md:px-12 max-w-4xl">
          <div className="space-y-8">
            <div>
              <h3 className="text-xl text-charcoal mb-4">Deep integration with parent systems</h3>
            ...
            <div>
              <h3 className="text-xl text-charcoal mb-4">Shared services dependencies</h3>
            ...
            <div>
              <h3 className="text-xl text-charcoal mb-4">Tight timeline to close</h3>
      ...
      <section id="solution" className="py-24 md:py-32 bg-primary">
        <div className="container px-4 md:px-12">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }}>
            ...
            <h2 className="text-4xl md:text-5xl text-white max-w-4xl leading-tight">Comprehensive separation and standup program</h2>
          </motion.div>
        </div>
      </section>
        ...
        <div className="container px-4 md:px-12 max-w-4xl">
          ...
          <div className="space-y-12">
            <div className="flex gap-8">
              ...
              <div>
                <h3 className="text-xl text-charcoal mb-4 flex items-center gap-3">Dependency mapping and separation planning</h3>
                ...
                <ul className="space-y-2 text-charcoal/70">
                  <li className="flex items-start gap-2"><span>Identified 150+ dependencies across all functions</span></li>
                  <li className="flex items-start gap-2"><span>Categorized by criticality and separation approach</span></li>
                  <li className="flex items-start gap-2"><span>Developed detailed workplans for each workstream</span></li>
                </ul>
              </div>
            </div>
            <div className="flex gap-8">
              ...
              <div>
                <h3 className="text-xl text-charcoal mb-4 flex items-center gap-3">Standalone capability development</h3>
                ...
                <ul className="space-y-2 text-charcoal/70">
                  <li className="flex items-start gap-2"><span>Implemented new ERP and core business systems</span></li>
                  <li className="flex items-start gap-2"><span>Established finance, HR, and IT functions</span></li>
                  <li className="flex items-start gap-2"><span>Negotiated and managed TSA with parent company</span></li>
                </ul>
              </div>
            </div>
            <div className="flex gap-8">
              ...
              <div>
                <h3 className="text-xl text-charcoal mb-4 flex items-center gap-3">Day 1 readiness and TSA exit</h3>
                ...
                <ul className="space-y-2 text-charcoal/70">
                  <li className="flex items-start gap-2"><span>Day 1 readiness testing and cutover planning</span></li>
                  <li className="flex items-start gap-2"><span>TSA management and exit planning</span></li>
                  <li className="flex items-start gap-2"><span>Post-close stabilization and optimization</span></li>
                </ul>
              </div>
            </div>
          </div>
      ...
      <section className="py-16 bg-white text-charcoal">
        <div className="container px-4 md:px-12 max-w-4xl">
          <div className="space-y-8">
            <div>
              <h3 className="text-xl text-charcoal mb-4 flex items-center gap-3">Successful transaction close</h3>
              ...
              <div className="grid md:grid-cols-2 gap-4">
                <div className="p-6 bg-white/5"><div className="text-3xl text-charcoal mb-2">$220M</div><div className="text-sm text-charcoal/60">Transaction value</div></div>
                <div className="p-6 bg-white/5"><div className="text-3xl text-charcoal mb-2">Day 1</div><div className="text-sm text-charcoal/60">Standalone operations ready</div></div>
              </div>
            </div>
            <div>
              <h3 className="text-xl text-charcoal mb-4 flex items-center gap-3">Clean TSA exit</h3>
              ...
              <div className="p-6 bg-white/5"><div className="text-3xl text-charcoal mb-2">100%</div><div className="text-sm text-charcoal/60">TSA exit within 12 months</div></div>
            </div>
            <div>
              <h3 className="text-xl text-charcoal mb-4 flex items-center gap-3">Improved standalone performance</h3>
              ...
              <div className="p-6 bg-white/5"><div className="text-3xl text-charcoal mb-2">35%</div><div className="text-sm text-charcoal/60">EBITDA improvement in Year 2</div></div>
            </div>
          </div>
        </div>
      </section>
