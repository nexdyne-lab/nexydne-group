...
export default function CarveOutTransaction() {
  return (
    <div className="min-h-screen bg-[#051C2C] text-white selection:bg-[#0077B5] selection:text-white">
      ...
      <section className="relative pt-32 pb-20 md:pt-40 md:pb-28 overflow-hidden">
        ...
        <div className="container relative z-10 px-4 md:px-12">
          ...
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }} className="max-w-4xl">
            <span className="text-xs font-bold uppercase tracking-[0.2em] text-[#0077B5] mb-6 block">Case Study · Industrial</span>
            <h1 className="text-5xl md:text-7xl font-serif font-bold tracking-tight leading-[1.05] mb-4">
              <span className="text-[#0077B5]">$220M</span> carve-out creates standalone success
            </h1>
        ...
        <div className="container px-4 md:px-12 max-w-4xl">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }}>
            ...
            <div className="grid md:grid-cols-3 gap-6 mt-12 p-8 bg-[#051C2C]/5 rounded-xl">
              <div><div className="text-sm font-semibold text-[#0077B5] mb-2">Industry</div><div className="text-[#051C2C] font-medium">Industrial Components</div></div>
              <div><div className="text-sm font-semibold text-[#0077B5] mb-2">Employees</div><div className="text-[#051C2C] font-medium">850</div></div>
      ...
      <section className="py-16 bg-white text-[#051C2C]">
        <div className="container px-4 md:px-12 max-w-4xl">
          <div className="space-y-8">
            <div>
              <h3 className="text-xl font-serif font-bold text-[#051C2C] mb-4">Deep integration with parent systems</h3>
              <p className="text-[#051C2C]/70 leading-relaxed">The division relied on the parent company's ERP system, HR platform, financial reporting, and IT infrastructure. Separating these systems while maintaining business continuity was a significant technical challenge.</p>
            </div>
            <div>
              <h3 className="text-xl font-serif font-bold text-[#051C2C] mb-4">Shared services dependencies</h3>
              <p className="text-[#051C2C]/70 leading-relaxed">Many corporate functions—finance, HR, legal, IT—were provided by the parent company. The division needed to either build these capabilities internally or find alternative providers, all while maintaining operations.</p>
            </div>
            <div>
              <h3 className="text-xl font-serif font-bold text-[#051C2C] mb-4">Tight timeline to close</h3>
              <p className="text-[#051C2C]/70 leading-relaxed">The transaction had a fixed close date, and the division needed to be ready to operate independently on Day 1. There was no room for delays or operational disruptions that could impact customers.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-white text-[#051C2C]">
        <div className="container px-4 md:px-12 max-w-4xl">
          <p className="text-xl text-[#051C2C]/80 leading-relaxed mb-12">We led a comprehensive separation program that identified all dependencies, developed standalone capabilities, and ensured Day 1 readiness.</p>
          <div className="space-y-12">
            <div className="flex gap-8">
              ...
              <div>
                <h3 className="text-xl font-serif font-bold text-[#051C2C] mb-4 flex items-center gap-3"><Scissors className="w-6 h-6 text-[#0077B5]" />Dependency mapping and separation planning</h3>
                <p className="text-[#051C2C]/70 leading-relaxed mb-4">We conducted a comprehensive assessment of all dependencies on the parent company and developed a detailed separation plan.</p>
                <ul className="space-y-2 text-[#051C2C]/70">
                  <li className="flex items-start gap-2"><CheckCircle2 className="w-5 h-5 text-[#0077B5] flex-shrink-0 mt-0.5" /><span>Identified 150+ dependencies across all functions</span></li>
                  <li className="flex items-start gap-2"><CheckCircle2 className="w-5 h-5 text-[#0077B5] flex-shrink-0 mt-0.5" /><span>Categorized by criticality and separation approach</span></li>
                  <li className="flex items-start gap-2"><CheckCircle2 className="w-5 h-5 text-[#0077B5] flex-shrink-0 mt-0.5" /><span>Developed detailed workplans for each workstream</span></li>
                </ul>
              </div>
            </div>
            <div className="flex gap-8">
              ...
              <div>
                <h3 className="text-xl font-serif font-bold text-[#051C2C] mb-4 flex items-center gap-3"><Building className="w-6 h-6 text-[#0077B5]" />Standalone capability development</h3>
                <p className="text-[#051C2C]/70 leading-relaxed mb-4">We helped build or source all capabilities needed to operate as a standalone company, from IT systems to corporate functions.</p>
                <ul className="space-y-2 text-[#051C2C]/70">
                  <li className="flex items-start gap-2"><CheckCircle2 className="w-5 h-5 text-[#0077B5] flex-shrink-0 mt-0.5" /><span>Implemented new ERP and core business systems</span></li>
                  <li className="flex items-start gap-2"><CheckCircle2 className="w-5 h-5 text-[#0077B5] flex-shrink-0 mt-0.5" /><span>Established finance, HR, and IT functions</span></li>
                  <li className="flex items-start gap-2"><CheckCircle2 className="w-5 h-5 text-[#0077B5] flex-shrink-0 mt-0.5" /><span>Negotiated and managed TSA with parent company</span></li>
                </ul>
              </div>
            </div>
            <div className="flex gap-8">
              ...
              <div>
                <h3 className="text-xl font-serif font-bold text-[#051C2C] mb-4 flex items-center gap-3"><Users className="w-6 h-6 text-[#0077B5]" />Day 1 readiness and TSA exit</h3>
                <p className="text-[#051C2C]/70 leading-relaxed mb-4">We ensured the company was ready to operate independently on Day 1 and managed the transition off transitional service agreements.</p>
                <ul className="space-y-2 text-[#051C2C]/70">
                  <li className="flex items-start gap-2"><CheckCircle2 className="w-5 h-5 text-[#0077B5] flex-shrink-0 mt-0.5" /><span>Day 1 readiness testing and cutover planning</span></li>
                  <li className="flex items-start gap-2"><CheckCircle2 className="w-5 h-5 text-[#0077B5] flex-shrink-0 mt-0.5" /><span>TSA management and exit planning</span></li>
                  <li className="flex items-start gap-2"><CheckCircle2 className="w-5 h-5 text-[#0077B5] flex-shrink-0 mt-0.5" /><span>Post-close stabilization and optimization</span></li>
                </ul>
              </div>
            </div>
          </div>
      ...
      <section className="py-16 bg-white text-[#051C2C]">
        <div className="container px-4 md:px-12 max-w-4xl">
          <div className="space-y-8">
            <div>
              <h3 className="text-xl font-serif font-bold text-[#051C2C] mb-4 flex items-center gap-3"><Target className="w-6 h-6 text-[#0077B5]" />Successful transaction close</h3>
              <p className="text-[#051C2C]/70 leading-relaxed mb-4">The $220M transaction closed on schedule with the company fully ready to operate independently on Day 1, with no disruption to customers or operations.</p>
              <div className="grid md:grid-cols-2 gap-4">
                <div className="p-6 bg-[#051C2C]/5 rounded-xl"><div className="text-3xl font-serif font-bold text-[#051C2C] mb-2">$220M</div><div className="text-sm text-[#051C2C]/60">Transaction value</div></div>
                <div className="p-6 bg-[#051C2C]/5 rounded-xl"><div className="text-3xl font-serif font-bold text-[#051C2C] mb-2">Day 1</div><div className="text-sm text-[#051C2C]/60">Standalone operations ready</div></div>
              </div>
            </div>
            <div>
              <h3 className="text-xl font-serif font-bold text-[#051C2C] mb-4 flex items-center gap-3"><Scissors className="w-6 h-6 text-[#0077B5]" />Clean TSA exit</h3>
              <p className="text-[#051C2C]/70 leading-relaxed mb-4">All transitional service agreements were exited within 12 months, ahead of schedule and under budget, eliminating ongoing dependencies on the former parent.</p>
              <div className="p-6 bg-[#051C2C]/5 rounded-xl"><div className="text-3xl font-serif font-bold text-[#051C2C] mb-2">100%</div><div className="text-sm text-[#051C2C]/60">TSA exit within 12 months</div></div>
            </div>
            <div>
              <h3 className="text-xl font-serif font-bold text-[#051C2C] mb-4 flex items-center gap-3"><TrendingUp className="w-6 h-6 text-[#0077B5]" />Improved standalone performance</h3>
              <p className="text-[#051C2C]/70 leading-relaxed mb-4">Free from conglomerate constraints, the company optimized operations and improved EBITDA margins by 35% in Year 2, exceeding the PE firm's investment thesis.</p>
              <div className="p-6 bg-[#051C2C]/5 rounded-xl"><div className="text-3xl font-serif font-bold text-[#051C2C] mb-2">35%</div><div className="text-sm text-[#051C2C]/60">EBITDA improvement in Year 2</div></div>
            </div>
          </div>
        </div>
      </section>
