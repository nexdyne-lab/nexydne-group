            ...
            <div className="grid md:grid-cols-3 gap-6 mt-12 p-8 bg-white/5">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <div className="text-charcoal font-medium">Precision Manufacturing</div>
                </div>
              </div>
              <div className="flex items-start gap-4">
                <div className="w-12 h-12 bg-primary/10 rounded-lg flex items-center justify-center flex-shrink-0">
      ...
      <section className="py-16 bg-white text-charcoal">
        <div className="container px-4 md:px-12 max-w-4xl">
          <div className="space-y-8">
            ...
            <div>
              <h3 className="text-xl text-charcoal mb-4">Operational Inefficiencies</h3>
              <p className="text-charcoal/70 leading-relaxed">
            ...
            <div>
              <h3 className="text-xl text-charcoal mb-4">Limited Visibility and Control</h3>
              <p className="text-charcoal/70 leading-relaxed">
            ...
            <div>
              <h3 className="text-xl text-charcoal mb-4">Change Management Complexity</h3>
              <p className="text-charcoal/70 leading-relaxed">
        ...
        <div className="container px-4 md:px-12 max-w-4xl">
          ...
          <div className="space-y-12">
            ...
            <div className="flex gap-8">
              ...
              <div>
                <h3 className="text-xl text-charcoal mb-2">Technology Platform Modernization</h3>
            ...
            <div className="flex gap-8">
              ...
              <div>
                <h3 className="text-xl text-charcoal mb-2">Process Optimization and Capability Building</h3>
            ...
            <div className="flex gap-8">
              ...
              <div>
                <h3 className="text-xl text-charcoal mb-2">Stabilization and Knowledge Transfer</h3>
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-12">
            <div>
              ...
              <div className="space-y-4">
                ...
                <div className="p-4 bg-white/5">
                  <div className="text-2xl text-charcoal mb-1">98%</div>
                  <div className="text-sm text-charcoal/60">On-time delivery (up from 82%)</div>
                </div>
                <div className="p-4 bg-white/5">
                  <div className="text-2xl text-charcoal mb-1">99.2%</div>
            ...
            <div>
              ...
              <div className="space-y-4">
                <div className="p-4 bg-white/5">
                  <div className="text-2xl text-charcoal mb-1">$2.8M</div>
                ...
                <div className="p-4 bg-white/5">
                  <div className="text-2xl text-charcoal mb-1">14 mo</div>
            ...
            <div>
              ...
              <div className="space-y-4">
                <div className="p-4 bg-white/5">
                  <div className="text-2xl text-charcoal mb-1">42%</div>
                  <div className="text-sm text-charcoal/60">Reduction in quality incidents</div>
                </div>
                <div className="p-4 bg-white/5">
                  <div className="text-2xl text-charcoal mb-1">100%</div>
        ...
        <div className="container px-4 md:px-12 max-w-4xl">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="border-l-4 border-primary pl-6">
              <h3 className="text-xl text-charcoal mb-3">Executive Commitment</h3>
              <p className="text-charcoal/70">
            ...
            <div className="border-l-4 border-primary pl-6">
              <h3 className="text-xl text-charcoal mb-3">Phased Implementation</h3>
              <p className="text-charcoal/70">
            ...
            <div className="border-l-4 border-primary pl-6">
              <h3 className="text-xl text-charcoal mb-3">Change Management Focus</h3>
              <p className="text-charcoal/70">
            ...
            <div className="border-l-4 border-primary pl-6">
              <h3 className="text-xl text-charcoal mb-3">Process Before Technology</h3>
              <p className="text-charcoal/70">
