    ...
    <div className="min-h-screen bg-white text-white selection:bg-primary selection:text-white">
      ...
      <section id="challenge" className="py-24 md:py-32 bg-primary">
        <div className="container px-4 md:px-12">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }}>
            ...
            <h2 className="text-4xl md:text-5xl text-white max-w-4xl leading-tight">Fragmented operations eroding profitability</h2>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-16 bg-white text-charcoal">
        <div className="container px-4 md:px-12 max-w-4xl">
          <div className="space-y-8">
            <div>
              <h3 className="text-xl text-charcoal mb-4">Redundant facilities and infrastructure</h3>
            ...
            <div>
              <h3 className="text-xl text-charcoal mb-4">Inconsistent processes and systems</h3>
            ...
            <div>
              <h3 className="text-xl text-charcoal mb-4">Rising logistics costs</h3>
      ...
      <section id="solution" className="py-24 md:py-32 bg-primary">
        <div className="container px-4 md:px-12">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }}>
            ...
            <h2 className="text-4xl md:text-5xl text-white max-w-4xl leading-tight">Network optimization and operational integration</h2>
          </motion.div>
        </div>
      </section>
        ...
        <div className="container px-4 md:px-12 max-w-4xl">
          ...
          <div className="space-y-12">
            <div className="flex gap-8">
              ...
              <div>
                <h3 className="text-xl text-charcoal mb-4 flex items-center gap-3">Network optimization</h3>
                ...
                <ul className="space-y-2 text-charcoal/70">
                  <li className="flex items-start gap-2"><span>Network modeling and optimization analysis</span></li>
                  <li className="flex items-start gap-2"><span>Facility consolidation from 7 to 4 locations</span></li>
                  <li className="flex items-start gap-2"><span>Strategic facility upgrades and automation</span></li>
                </ul>
              </div>
            </div>
            <div className="flex gap-8">
              ...
              <div>
                <h3 className="text-xl text-charcoal mb-4 flex items-center gap-3">Logistics optimization</h3>
                ...
                <ul className="space-y-2 text-charcoal/70">
                  <li className="flex items-start gap-2"><span>Route optimization and fleet right-sizing</span></li>
                  <li className="flex items-start gap-2"><span>Carrier management and rate negotiation</span></li>
                  <li className="flex items-start gap-2"><span>Transportation management system implementation</span></li>
                </ul>
              </div>
            </div>
            <div className="flex gap-8">
              ...
              <div>
                <h3 className="text-xl text-charcoal mb-4 flex items-center gap-3">Process standardization</h3>
                ...
                <ul className="space-y-2 text-charcoal/70">
                  <li className="flex items-start gap-2"><span>Standard operating procedures development</span></li>
                  <li className="flex items-start gap-2"><span>WMS consolidation and upgrade</span></li>
                  <li className="flex items-start gap-2"><span>Performance management and KPI dashboards</span></li>
                </ul>
              </div>
            </div>
          </div>
      ...
      <section className="py-16 bg-white text-charcoal">
        <div className="container px-4 md:px-12 max-w-4xl">
          <div className="space-y-8">
            <div>
              <h3 className="text-xl text-charcoal mb-4 flex items-center gap-3">Significant margin improvement</h3>
              ...
              <div className="grid md:grid-cols-2 gap-4">
                <div className="p-6 bg-white/5"><div className="text-3xl text-charcoal mb-2">40%</div><div className="text-sm text-charcoal/60">Operating margin improvement</div></div>
                <div className="p-6 bg-white/5"><div className="text-3xl text-charcoal mb-2">$8M</div><div className="text-sm text-charcoal/60">Annual cost savings</div></div>
              </div>
            </div>
            <div>
              <h3 className="text-xl text-charcoal mb-4 flex items-center gap-3">Reduced logistics costs</h3>
              ...
              <div className="p-6 bg-white/5"><div className="text-3xl text-charcoal mb-2">25%</div><div className="text-sm text-charcoal/60">Reduction in logistics costs</div></div>
            </div>
            <div>
              <h3 className="text-xl text-charcoal mb-4 flex items-center gap-3">Improved service levels</h3>
              ...
              <div className="p-6 bg-white/5"><div className="text-3xl text-charcoal mb-2">99.2%</div><div className="text-sm text-charcoal/60">Order accuracy achieved</div></div>
            </div>
          </div>
        </div>
      </section>
