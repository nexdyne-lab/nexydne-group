...
export default function DistributionRestructuring() {
  return (
    <div className="min-h-screen bg-[#051C2C] text-white selection:bg-[#0077B5] selection:text-white">
        ...
        <div className="container relative z-10 px-4 md:px-12">
          ...
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }} className="max-w-4xl">
            ...
            <h1 className="text-5xl md:text-7xl font-serif font-bold tracking-tight leading-[1.05] mb-4">
              <span className="text-[#0077B5]">40%</span> margin improvement through restructuring
            </h1>
        ...
        <div className="container px-4 md:px-12 max-w-4xl">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }}>
            ...
            <div className="grid md:grid-cols-3 gap-6 mt-12 p-8 bg-[#051C2C]/5 rounded-xl">
              <div><div className="text-sm font-semibold text-[#0077B5] mb-2">Industry</div><div className="text-[#051C2C] font-medium">Industrial Distribution</div></div>
              <div><div className="text-sm font-semibold text-[#0077B5] mb-2">Employees</div><div className="text-[#051C2C] font-medium">320</div></div>
              <div><div className="text-sm font-semibold text-[#0077B5] mb-2">Annual Revenue</div><div className="text-[#051C2C] font-medium">$95M</div></div>
            </div>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-16 bg-white text-[#051C2C]">
        <div className="container px-4 md:px-12 max-w-4xl">
          <div className="space-y-8">
            <div>
              <h3 className="text-xl font-serif font-bold text-[#051C2C] mb-4">Redundant facilities and infrastructure</h3>
              <p className="text-[#051C2C]/70 leading-relaxed">Multiple acquisitions had left the company with seven distribution facilities, many with overlapping service areas. Fixed costs were high and capacity utilization was low across the network.</p>
            </div>
            <div>
              <h3 className="text-xl font-serif font-bold text-[#051C2C] mb-4">Inconsistent processes and systems</h3>
              <p className="text-[#051C2C]/70 leading-relaxed">Each acquired company had brought its own systems and processes. The resulting complexity made it difficult to manage operations efficiently and provide consistent customer service.</p>
            </div>
            <div>
              <h3 className="text-xl font-serif font-bold text-[#051C2C] mb-4">Rising logistics costs</h3>
              <p className="text-[#051C2C]/70 leading-relaxed">The fragmented network resulted in inefficient routing and high transportation costs. Logistics expenses had grown faster than revenue for three consecutive years.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-white text-[#051C2C]">
        <div className="container px-4 md:px-12 max-w-4xl">
          <p className="text-xl text-[#051C2C]/80 leading-relaxed mb-12">We led a comprehensive restructuring program that optimized the distribution network, standardized operations, and built a scalable platform for growth.</p>
          <div className="space-y-12">
            <div className="flex gap-8">
              ...
              <div>
                <h3 className="text-xl font-serif font-bold text-[#051C2C] mb-4 flex items-center gap-3"><Building className="w-6 h-6 text-[#0077B5]" />Network optimization</h3>
                <p className="text-[#051C2C]/70 leading-relaxed mb-4">We analyzed the distribution network and developed an optimized footprint that reduced facilities while improving service levels.</p>
                <ul className="space-y-2 text-[#051C2C]/70">
                  <li className="flex items-start gap-2"><CheckCircle2 className="w-5 h-5 text-[#0077B5] flex-shrink-0 mt-0.5" /><span>Network modeling and optimization analysis</span></li>
                  <li className="flex items-start gap-2"><CheckCircle2 className="w-5 h-5 text-[#0077B5] flex-shrink-0 mt-0.5" /><span>Facility consolidation from 7 to 4 locations</span></li>
                  <li className="flex items-start gap-2"><CheckCircle2 className="w-5 h-5 text-[#0077B5] flex-shrink-0 mt-0.5" /><span>Strategic facility upgrades and automation</span></li>
                </ul>
              </div>
            </div>
            <div className="flex gap-8">
              ...
              <div>
                <h3 className="text-xl font-serif font-bold text-[#051C2C] mb-4 flex items-center gap-3"><Truck className="w-6 h-6 text-[#0077B5]" />Logistics optimization</h3>
                <p className="text-[#051C2C]/70 leading-relaxed mb-4">We redesigned routing and transportation to reduce costs while improving delivery performance.</p>
                <ul className="space-y-2 text-[#051C2C]/70">
                  <li className="flex items-start gap-2"><CheckCircle2 className="w-5 h-5 text-[#0077B5] flex-shrink-0 mt-0.5" /><span>Route optimization and fleet right-sizing</span></li>
                  <li className="flex items-start gap-2"><CheckCircle2 className="w-5 h-5 text-[#0077B5] flex-shrink-0 mt-0.5" /><span>Carrier management and rate negotiation</span></li>
                  <li className="flex items-start gap-2"><CheckCircle2 className="w-5 h-5 text-[#0077B5] flex-shrink-0 mt-0.5" /><span>Transportation management system implementation</span></li>
                </ul>
              </div>
            </div>
            <div className="flex gap-8">
              ...
              <div>
                <h3 className="text-xl font-serif font-bold text-[#051C2C] mb-4 flex items-center gap-3"><BarChart3 className="w-6 h-6 text-[#0077B5]" />Process standardization</h3>
                <p className="text-[#051C2C]/70 leading-relaxed mb-4">We standardized operations across all facilities with common processes, systems, and performance metrics.</p>
                <ul className="space-y-2 text-[#051C2C]/70">
                  <li className="flex items-start gap-2"><CheckCircle2 className="w-5 h-5 text-[#0077B5] flex-shrink-0 mt-0.5" /><span>Standard operating procedures development</span></li>
                  <li className="flex items-start gap-2"><CheckCircle2 className="w-5 h-5 text-[#0077B5] flex-shrink-0 mt-0.5" /><span>WMS consolidation and upgrade</span></li>
                  <li className="flex items-start gap-2"><CheckCircle2 className="w-5 h-5 text-[#0077B5] flex-shrink-0 mt-0.5" /><span>Performance management and KPI dashboards</span></li>
                </ul>
              </div>
            </div>
          </div>
      ...
      <section className="py-16 bg-white text-[#051C2C]">
        <div className="container px-4 md:px-12 max-w-4xl">
          <div className="space-y-8">
            <div>
              <h3 className="text-xl font-serif font-bold text-[#051C2C] mb-4 flex items-center gap-3"><TrendingUp className="w-6 h-6 text-[#0077B5]" />Significant margin improvement</h3>
              <p className="text-[#051C2C]/70 leading-relaxed mb-4">Operating margins improved by 40% through reduced fixed costs, lower logistics expenses, and improved operational efficiency.</p>
              <div className="grid md:grid-cols-2 gap-4">
                <div className="p-6 bg-[#051C2C]/5 rounded-xl"><div className="text-3xl font-serif font-bold text-[#051C2C] mb-2">40%</div><div className="text-sm text-[#051C2C]/60">Operating margin improvement</div></div>
                <div className="p-6 bg-[#051C2C]/5 rounded-xl"><div className="text-3xl font-serif font-bold text-[#051C2C] mb-2">$8M</div><div className="text-sm text-[#051C2C]/60">Annual cost savings</div></div>
              </div>
            </div>
            <div>
              <h3 className="text-xl font-serif font-bold text-[#051C2C] mb-4 flex items-center gap-3"><Truck className="w-6 h-6 text-[#0077B5]" />Reduced logistics costs</h3>
              <p className="text-[#051C2C]/70 leading-relaxed mb-4">Transportation and logistics costs decreased by 25% through network optimization, route efficiency, and improved carrier management.</p>
              <div className="p-6 bg-[#051C2C]/5 rounded-xl"><div className="text-3xl font-serif font-bold text-[#051C2C] mb-2">25%</div><div className="text-sm text-[#051C2C]/60">Reduction in logistics costs</div></div>
            </div>
            <div>
              <h3 className="text-xl font-serif font-bold text-[#051C2C] mb-4 flex items-center gap-3"><Target className="w-6 h-6 text-[#0077B5]" />Improved service levels</h3>
              <p className="text-[#051C2C]/70 leading-relaxed mb-4">Despite facility consolidation, service levels improved with order accuracy reaching 99.2% and on-time delivery improving to 97%.</p>
              <div className="p-6 bg-[#051C2C]/5 rounded-xl"><div className="text-3xl font-serif font-bold text-[#051C2C] mb-2">99.2%</div><div className="text-sm text-[#051C2C]/60">Order accuracy achieved</div></div>
            </div>
          </div>
        </div>
      </section>
