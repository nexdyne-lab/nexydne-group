  ...
  return (
    <div className="min-h-screen bg-background text-charcoal selection:bg-primary selection:text-white">
      ...
      <section className="relative pt-32 pb-20 md:pt-40 md:pb-28 overflow-hidden">
        <div className="absolute inset-0 bg-[url('/images/industries/retail-warehouse.jpg')] bg-cover bg-center opacity-30"></div>
      ...
      <section id="challenge" className="py-24 md:py-32 bg-background">
        <div className="container px-4 md:px-12">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }}>
            ...
            <h2 className="nx-h2 text-charcoal max-w-4xl">Cash trapped in working capital</h2>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-16 bg-white text-charcoal">
        <div className="container px-4 md:px-12 max-w-4xl">
          <div className="space-y-8">
            <div>
              <h3 className="text-xl font-bold text-charcoal mb-4">Excess inventory across the network</h3>
            ...
            <div>
              <h3 className="text-xl font-bold text-charcoal mb-4">Slow receivables collection</h3>
            ...
            <div>
              <h3 className="text-xl font-bold text-charcoal mb-4">Fear of service level impact</h3>
      ...
      <section id="solution" className="py-24 md:py-32 bg-background">
        <div className="container px-4 md:px-12">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }}>
            ...
            <h2 className="nx-h2 text-charcoal max-w-4xl">Data-driven working capital optimization</h2>
          </motion.div>
        </div>
      </section>
