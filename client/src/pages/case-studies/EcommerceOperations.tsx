  ...
  return (
    <div className="min-h-screen bg-background text-charcoal selection:bg-primary selection:text-white">
      ...
      <section className="relative pt-32 pb-20 md:pt-40 md:pb-28 overflow-hidden">
        <div className="absolute inset-0 bg-[url('/images/capabilities/cap-retail-apparel.jpg')] bg-cover bg-center opacity-30"></div>
      ...
      <section id="challenge" className="py-24 md:py-32 bg-background">
        <div className="container px-4 md:px-12">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }}>
            ...
            <h2 className="text-4xl md:text-5xl font-bold text-charcoal max-w-4xl leading-tight">Operations at breaking point</h2>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-24 md:py-32 bg-background">
        <div className="container px-4 md:px-12 max-w-5xl">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }}>
            ...
            <div className="text-base text-charcoal"><div className="font-semibold">— Amanda Chen</div><div className="text-muted-foreground">COO, Client Company</div></div>
          </motion.div>
        </div>
      </section>
      ...
      <section id="solution" className="py-24 md:py-32 bg-background">
        <div className="container px-4 md:px-12">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }}>
            ...
            <h2 className="text-4xl md:text-5xl font-bold text-charcoal max-w-4xl leading-tight">Scalable fulfillment transformation</h2>
          </motion.div>
        </div>
      </section>
          ...
          <div className="space-y-8">
            <div>
              ...
              <div className="grid md:grid-cols-2 gap-4">
                <div className="p-6 bg-charcoal/5 rounded-xl"><div className="text-3xl font-bold text-charcoal mb-2">3x</div><div className="text-sm text-charcoal/60">Order volume scaled</div></div>
                <div className="p-6 bg-charcoal/5 rounded-xl"><div className="text-3xl font-bold text-charcoal mb-2">15,000+</div><div className="text-sm text-charcoal/60">Daily orders at peak</div></div>
              </div>
            </div>
            <div>
              ...
              <div className="p-6 bg-charcoal/5 rounded-xl"><div className="text-3xl font-bold text-charcoal mb-2">28%</div><div className="text-sm text-charcoal/60">Reduction in cost per order</div></div>
            </div>
            <div>
              ...
              <div className="p-6 bg-charcoal/5 rounded-xl"><div className="text-3xl font-bold text-charcoal mb-2">99.8%</div><div className="text-sm text-charcoal/60">Order accuracy achieved</div></div>
            </div>
          </div>
        </div>
      </section>
