...
export default function EcommerceOperations() {
  return (
    <div className="min-h-screen bg-[#051C2C] text-white selection:bg-[#0077B5] selection:text-white">
      ...
      <section className="relative pt-32 pb-20 md:pt-40 md:pb-28 overflow-hidden">
        ...
        <div className="container relative z-10 px-4 md:px-12">
          ...
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }} className="max-w-4xl">
            <span className="text-xs font-bold uppercase tracking-[0.2em] text-[#0077B5] mb-6 block">Case Study · E-commerce</span>
            <h1 className="text-5xl md:text-7xl font-serif font-bold tracking-tight leading-[1.05] mb-4">
              <span className="text-[#0077B5]">3x</span> scale with 28% lower cost per order
            </h1>
        ...
        <div className="container px-4 md:px-12 max-w-4xl">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }}>
            ...
            <div className="grid md:grid-cols-3 gap-6 mt-12 p-8 bg-[#051C2C]/5 rounded-xl">
              <div><div className="text-sm font-semibold text-[#0077B5] mb-2">Industry</div><div className="text-[#051C2C] font-medium">E-commerce / DTC</div></div>
              <div><div className="text-sm font-semibold text-[#0077B5] mb-2">Daily Orders</div><div className="text-[#051C2C] font-medium">5,000+</div></div>
              <div><div className="text-sm font-semibold text-[#0077B5] mb-2">Annual Revenue</div><div className="text-[#051C2C] font-medium">$65M</div></div>
            </div>
          </motion.div>
        </div>
      </section>
      ...
      <section id="challenge" className="py-24 md:py-32 bg-[#0077B5]">
        <div className="container px-4 md:px-12">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }}>
            ...
            <h2 className="text-4xl md:text-5xl font-serif font-bold text-white max-w-4xl leading-tight">Operations at breaking point</h2>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-16 bg-white text-[#051C2C]">
        <div className="container px-4 md:px-12 max-w-4xl">
          <div className="space-y-8">
            <div>
              <h3 className="text-xl font-serif font-bold text-[#051C2C] mb-4">Capacity constraints</h3>
              <p className="text-[#051C2C]/70 leading-relaxed">The fulfillment operation was at capacity during peak periods, resulting in delayed shipments and overtime costs. The facility layout and processes couldn't handle projected growth without major changes.</p>
            </div>
            <div>
              <h3 className="text-xl font-serif font-bold text-[#051C2C] mb-4">Rising costs per order</h3>
              <p className="text-[#051C2C]/70 leading-relaxed">Cost per order had increased 15% over the past year as the operation struggled with growth. Labor productivity was declining, and error rates were increasing, driving up costs.</p>
            </div>
            <div>
              <h3 className="text-xl font-serif font-bold text-[#051C2C] mb-4">Customer experience issues</h3>
              <p className="text-[#051C2C]/70 leading-relaxed">Ship times had increased and order accuracy had declined, resulting in customer complaints and returns. The company was at risk of losing marketplace seller ratings and customer loyalty.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="solution" className="py-24 md:py-32 bg-[#0077B5]">
        <div className="container px-4 md:px-12">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }}>
            ...
            <h2 className="text-4xl md:text-5xl font-serif font-bold text-white max-w-4xl leading-tight">Scalable fulfillment transformation</h2>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-16 bg-white text-[#051C2C]">
        <div className="container px-4 md:px-12 max-w-4xl">
          <p className="text-xl text-[#051C2C]/80 leading-relaxed mb-12">We designed and implemented a scalable fulfillment operation that could handle 3x growth while reducing cost per order and improving customer experience.</p>
          <div className="space-y-12">
            <div className="flex gap-8">
              ...
              <div>
                <h3 className="text-xl font-serif font-bold text-[#051C2C] mb-4 flex items-center gap-3"><ShoppingCart className="w-6 h-6 text-[#0077B5]" />Fulfillment redesign</h3>
                <p className="text-[#051C2C]/70 leading-relaxed mb-4">We redesigned the fulfillment operation with optimized layout, processes, and automation to dramatically increase throughput and reduce costs.</p>
                <ul className="space-y-2 text-[#051C2C]/70">
                  <li className="flex items-start gap-2"><CheckCircle2 className="w-5 h-5 text-[#0077B5] flex-shrink-0 mt-0.5" /><span>Facility layout optimization</span></li>
                  <li className="flex items-start gap-2"><CheckCircle2 className="w-5 h-5 text-[#0077B5] flex-shrink-0 mt-0.5" /><span>Pick/pack process redesign</span></li>
                  <li className="flex items-start gap-2"><CheckCircle2 className="w-5 h-5 text-[#0077B5] flex-shrink-0 mt-0.5" /><span>Automation implementation</span></li>
                </ul>
              </div>
            </div>
            <div className="flex gap-8">
              ...
              <div>
                <h3 className="text-xl font-serif font-bold text-[#051C2C] mb-4 flex items-center gap-3"><Truck className="w-6 h-6 text-[#0077B5]" />Shipping optimization</h3>
                <p className="text-[#051C2C]/70 leading-relaxed mb-4">We optimized carrier selection, packaging, and shipping processes to reduce costs and improve delivery speed.</p>
                <ul className="space-y-2 text-[#051C2C]/70">
                  <li className="flex items-start gap-2"><CheckCircle2 className="w-5 h-5 text-[#0077B5] flex-shrink-0 mt-0.5" /><span>Multi-carrier strategy and rate optimization</span></li>
                  <li className="flex items-start gap-2"><CheckCircle2 className="w-5 h-5 text-[#0077B5] flex-shrink-0 mt-0.5" /><span>Packaging right-sizing and standardization</span></li>
                  <li className="flex items-start gap-2"><CheckCircle2 className="w-5 h-5 text-[#0077B5] flex-shrink-0 mt-0.5" /><span>Zone-skipping and consolidation programs</span></li>
                </ul>
              </div>
            </div>
            <div className="flex gap-8">
              ...
              <div>
                <h3 className="text-xl font-serif font-bold text-[#051C2C] mb-4 flex items-center gap-3"><BarChart3 className="w-6 h-6 text-[#0077B5]" />Quality and performance management</h3>
                <p className="text-[#051C2C]/70 leading-relaxed mb-4">We implemented quality controls and performance management systems to ensure accuracy and enable continuous improvement.</p>
                <ul className="space-y-2 text-[#051C2C]/70">
                  <li className="flex items-start gap-2"><CheckCircle2 className="w-5 h-5 text-[#0077B5] flex-shrink-0 mt-0.5" /><span>Quality control checkpoints</span></li>
                  <li className="flex items-start gap-2"><CheckCircle2 className="w-5 h-5 text-[#0077B5] flex-shrink-0 mt-0.5" /><span>Real-time performance dashboards</span></li>
                  <li className="flex items-start gap-2"><CheckCircle2 className="w-5 h-5 text-[#0077B5] flex-shrink-0 mt-0.5" /><span>Continuous improvement program</span></li>
                </ul>
              </div>
            </div>
          </div>
      ...
      <section className="py-16 bg-white text-[#051C2C]">
        <div className="container px-4 md:px-12 max-w-4xl">
          <div className="space-y-8">
            <div>
              <h3 className="text-xl font-serif font-bold text-[#051C2C] mb-4 flex items-center gap-3"><TrendingUp className="w-6 h-6 text-[#0077B5]" />Scalable capacity</h3>
              <p className="text-[#051C2C]/70 leading-relaxed mb-4">The redesigned operation successfully scaled to handle 3x order volume, supporting the company's rapid growth without capacity constraints.</p>
              <div className="grid md:grid-cols-2 gap-4">
                <div className="p-6 bg-[#051C2C]/5 rounded-xl"><div className="text-3xl font-serif font-bold text-[#051C2C] mb-2">3x</div><div className="text-sm text-[#051C2C]/60">Order volume scaled</div></div>
                <div className="p-6 bg-[#051C2C]/5 rounded-xl"><div className="text-3xl font-serif font-bold text-[#051C2C] mb-2">15,000+</div><div className="text-sm text-[#051C2C]/60">Daily orders at peak</div></div>
              </div>
            </div>
            <div>
              <h3 className="text-xl font-serif font-bold text-[#051C2C] mb-4 flex items-center gap-3"><Target className="w-6 h-6 text-[#0077B5]" />Improved unit economics</h3>
              <p className="text-[#051C2C]/70 leading-relaxed mb-4">Cost per order decreased by 28% through process optimization, automation, and shipping improvements—improving profitability as the company scaled.</p>
              <div className="p-6 bg-[#051C2C]/5 rounded-xl"><div className="text-3xl font-serif font-bold text-[#051C2C] mb-2">28%</div><div className="text-sm text-[#051C2C]/60">Reduction in cost per order</div></div>
            </div>
            <div>
              <h3 className="text-xl font-serif font-bold text-[#051C2C] mb-4 flex items-center gap-3"><ShoppingCart className="w-6 h-6 text-[#0077B5]" />Enhanced customer experience</h3>
              <p className="text-[#051C2C]/70 leading-relaxed mb-4">Order accuracy improved to 99.8% and average ship time decreased to 1.2 days, dramatically improving customer satisfaction and marketplace ratings.</p>
              <div className="p-6 bg-[#051C2C]/5 rounded-xl"><div className="text-3xl font-serif font-bold text-[#051C2C] mb-2">99.8%</div><div className="text-sm text-[#051C2C]/60">Order accuracy achieved</div></div>
            </div>
          </div>
        </div>
      </section>
