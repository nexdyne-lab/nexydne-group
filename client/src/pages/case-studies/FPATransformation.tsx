...
import { ArrowRight, ArrowLeft, TrendingUp, Target, Database, BarChart3, Clock, CheckCircle2, Download } from 'lucide-react';
        ...
        <div className="container relative z-10 px-4 md:px-12">
          ...
          >
            ...
            <h1 className="text-5xl md:text-7xl font-serif font-bold tracking-tight leading-[1.05] mb-4">
              FP&A transformation delivers <span className="text-[#0077B5]">60%</span> faster close
            </h1>
          ...
          >
            ...
            <div className="grid md:grid-cols-3 gap-6 mt-12 p-8 bg-[#051C2C]/5 rounded-xl">
              <div>
                ...
                <div className="text-[#051C2C] font-medium">Industrial Manufacturing</div>
              </div>
              <div>
                <div className="text-sm font-semibold text-[#0077B5] mb-2">Company Size</div>
                <div className="text-[#051C2C] font-medium">320 employees</div>
              </div>
              <div>
                <div className="text-sm font-semibold text-[#0077B5] mb-2">Annual Revenue</div>
                <div className="text-[#051C2C] font-medium">$85M</div>
              </div>
            </div>
          </motion.div>
        </div>
      ...
      <section className="py-16 bg-white text-[#051C2C]">
        <div className="container px-4 md:px-12 max-w-4xl">
          <div className="space-y-8">
            <div>
              <h3 className="text-xl font-serif font-bold text-[#051C2C] mb-4">Multiple ERP systems with no integration</h3>
              <p className="text-[#051C2C]/70 leading-relaxed">
            ...
            <div>
              <h3 className="text-xl font-serif font-bold text-[#051C2C] mb-4">Extended close process limiting strategic value</h3>
              <p className="text-[#051C2C]/70 leading-relaxed">
            ...
            <div>
              <h3 className="text-xl font-serif font-bold text-[#051C2C] mb-4">Forecasting based on gut feel rather than data</h3>
              <p className="text-[#051C2C]/70 leading-relaxed">
        ...
        <div className="container px-4 md:px-12 max-w-4xl">
          ...
          <div className="space-y-12">
            ...
            <div className="flex gap-8">
              ...
              <div>
                <h3 className="text-xl font-serif font-bold text-[#051C2C] mb-4 flex items-center gap-3">
                  <Database className="w-6 h-6 text-[#0077B5]" />
            ...
            <div className="flex gap-8">
              ...
              <div>
                <h3 className="text-xl font-serif font-bold text-[#051C2C] mb-4 flex items-center gap-3">
                  <Clock className="w-6 h-6 text-[#0077B5]" />
            ...
            <div className="flex gap-8">
              ...
              <div>
                <h3 className="text-xl font-serif font-bold text-[#051C2C] mb-4 flex items-center gap-3">
                  <BarChart3 className="w-6 h-6 text-[#0077B5]" />
          ...
          <div className="space-y-8">
            <div>
              ...
              <div className="grid md:grid-cols-2 gap-4">
                <div className="p-6 bg-[#051C2C]/5 rounded-xl">
                  <div className="text-3xl font-serif font-bold text-[#051C2C] mb-2">6 days</div>
                  <div className="text-sm text-[#051C2C]/60">New close time (down from 15 days)</div>
                </div>
                <div className="p-6 bg-[#051C2C]/5 rounded-xl">
                  <div className="text-3xl font-serif font-bold text-[#051C2C] mb-2">60%</div>
                  <div className="text-sm text-[#051C2C]/60">Reduction in close cycle time</div>
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="p-6 bg-[#051C2C]/5 rounded-xl">
                ...
                <div className="text-sm text-[#051C2C]/60">Quarterly forecast variance (down from ±15%)</div>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="p-6 bg-[#051C2C]/5 rounded-xl">
                <div className="text-3xl font-serif font-bold text-[#051C2C] mb-2">25 hrs</div>
                <div className="text-sm text-[#051C2C]/60">Monthly time savings redirected to strategic work</div>
              </div>
            </div>
          </div>
        </div>
