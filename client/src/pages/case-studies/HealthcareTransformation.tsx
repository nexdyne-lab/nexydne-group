      ...
      <section id="challenge" className="py-24 md:py-32 bg-background">
        <div className="container px-4 md:px-12">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }}>
            ...
            <h2 className="nx-h2 text-charcoal max-w-4xl">Transforming care delivery in a changing landscape</h2>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-16 bg-white text-charcoal">
        <div className="container px-4 md:px-12 max-w-4xl">
          <div className="space-y-8">
            <div>
              <h3 className="text-xl font-bold text-charcoal mb-4">Shift to value-based care</h3>
            ...
            <div>
              <h3 className="text-xl font-bold text-charcoal mb-4">Fragmented care delivery</h3>
            ...
            <div>
              <h3 className="text-xl font-bold text-charcoal mb-4">Staff burnout and turnover</h3>
      ...
      <section id="solution" className="py-24 md:py-32 bg-background">
        <div className="container px-4 md:px-12">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }}>
            ...
            <h2 className="nx-h2 text-charcoal max-w-4xl">Comprehensive care delivery transformation</h2>
          </motion.div>
        </div>
      </section>
