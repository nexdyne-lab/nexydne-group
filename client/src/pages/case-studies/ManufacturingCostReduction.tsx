...
export default function ManufacturingCostReduction() {
  return (
    <div className="min-h-screen bg-[#051C2C] text-white selection:bg-[#0077B5] selection:text-white">
      ...
      <section className="relative pt-32 pb-20 md:pt-40 md:pb-28 overflow-hidden">
        ...
        <div className="container relative z-10 px-4 md:px-12">
          ...
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }} className="max-w-4xl">
            <span className="text-xs font-bold uppercase tracking-[0.2em] text-[#0077B5] mb-6 block">Case Study · Manufacturing</span>
            <h1 className="text-5xl md:text-7xl font-serif font-bold tracking-tight leading-[1.05] mb-4">
              <span className="text-[#0077B5]">$18M</span> annual savings through operational excellence
            </h1>
        ...
        <div className="container px-4 md:px-12 max-w-4xl">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }}>
            ...
            <div className="grid md:grid-cols-3 gap-6 mt-12 p-8 bg-[#051C2C]/5 rounded-xl">
              <div><div className="text-sm font-semibold text-[#0077B5] mb-2">Industry</div><div className="text-[#051C2C] font-medium">Industrial Manufacturing</div></div>
              <div><div className="text-sm font-semibold text-[#0077B5] mb-2">Employees</div><div className="text-[#051C2C] font-medium">450</div></div>
              <div><div className="text-sm font-semibold text-[#0077B5] mb-2">Annual Revenue</div><div className="text-[#051C2C] font-medium">$120M</div></div>
            </div>
          </motion.div>
        </div>
      </section>
      ...
      <section id="challenge" className="py-24 md:py-32 bg-[#0077B5]">
        <div className="container px-4 md:px-12">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }}>
            ...
            <h2 className="text-4xl md:text-5xl font-serif font-bold text-white max-w-4xl leading-tight">Margin erosion threatening competitiveness</h2>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-16 bg-white text-[#051C2C]">
        <div className="container px-4 md:px-12 max-w-4xl">
          <div className="space-y-8">
            <div>
              <h3 className="text-xl font-serif font-bold text-[#051C2C] mb-4">Declining gross margins</h3>
              <p className="text-[#051C2C]/70 leading-relaxed">Gross margins had declined from 28% to 22% over three years due to customer price pressure and rising material and labor costs. Without significant cost reduction, the company would become uncompetitive.</p>
            </div>
            <div>
              <h3 className="text-xl font-serif font-bold text-[#051C2C] mb-4">Low equipment effectiveness</h3>
              <p className="text-[#051C2C]/70 leading-relaxed">Overall Equipment Effectiveness (OEE) averaged only 55% across the three facilities, well below industry benchmarks. Unplanned downtime, changeover time, and quality issues were consuming capacity.</p>
            </div>
            <div>
              <h3 className="text-xl font-serif font-bold text-[#051C2C] mb-4">Quality and scrap issues</h3>
              <p className="text-[#051C2C]/70 leading-relaxed">Defect rates were high, resulting in significant scrap costs and customer quality complaints. The company was at risk of losing key customer certifications if quality didn't improve.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="solution" className="py-24 md:py-32 bg-[#0077B5]">
        <div className="container px-4 md:px-12">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }}>
            ...
            <h2 className="text-4xl md:text-5xl font-serif font-bold text-white max-w-4xl leading-tight">Comprehensive operational excellence program</h2>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-16 bg-white text-[#051C2C]">
        <div className="container px-4 md:px-12 max-w-4xl">
          <p className="text-xl text-[#051C2C]/80 leading-relaxed mb-12">We implemented a comprehensive operational excellence program covering lean manufacturing, quality improvement, and strategic sourcing.</p>
          <div className="space-y-12">
            <div className="flex gap-8">
              ...
              <div>
                <h3 className="text-xl font-serif font-bold text-[#051C2C] mb-4 flex items-center gap-3"><Factory className="w-6 h-6 text-[#0077B5]" />Lean manufacturing transformation</h3>
                <p className="text-[#051C2C]/70 leading-relaxed mb-4">We implemented lean principles across all facilities, focusing on waste elimination, flow optimization, and continuous improvement.</p>
                <ul className="space-y-2 text-[#051C2C]/70">
                  <li className="flex items-start gap-2"><CheckCircle2 className="w-5 h-5 text-[#0077B5] flex-shrink-0 mt-0.5" /><span>Value stream mapping and waste identification</span></li>
                  <li className="flex items-start gap-2"><CheckCircle2 className="w-5 h-5 text-[#0077B5] flex-shrink-0 mt-0.5" /><span>Cellular manufacturing and flow optimization</span></li>
                  <li className="flex items-start gap-2"><CheckCircle2 className="w-5 h-5 text-[#0077B5] flex-shrink-0 mt-0.5" /><span>SMED for changeover reduction</span></li>
                </ul>
              </div>
            </div>
            <div className="flex gap-8">
              ...
              <div>
                <h3 className="text-xl font-serif font-bold text-[#051C2C] mb-4 flex items-center gap-3"><Cog className="w-6 h-6 text-[#0077B5]" />Equipment effectiveness improvement</h3>
                <p className="text-[#051C2C]/70 leading-relaxed mb-4">We implemented TPM and addressed root causes of downtime, quality losses, and speed losses to dramatically improve OEE.</p>
                <ul className="space-y-2 text-[#051C2C]/70">
                  <li className="flex items-start gap-2"><CheckCircle2 className="w-5 h-5 text-[#0077B5] flex-shrink-0 mt-0.5" /><span>Total Productive Maintenance implementation</span></li>
                  <li className="flex items-start gap-2"><CheckCircle2 className="w-5 h-5 text-[#0077B5] flex-shrink-0 mt-0.5" /><span>Root cause analysis and corrective action</span></li>
                  <li className="flex items-start gap-2"><CheckCircle2 className="w-5 h-5 text-[#0077B5] flex-shrink-0 mt-0.5" /><span>Real-time OEE monitoring and management</span></li>
                </ul>
              </div>
            </div>
            <div className="flex gap-8">
              ...
              <div>
                <h3 className="text-xl font-serif font-bold text-[#051C2C] mb-4 flex items-center gap-3"><BarChart3 className="w-6 h-6 text-[#0077B5]" />Strategic sourcing</h3>
                <p className="text-[#051C2C]/70 leading-relaxed mb-4">We optimized the supply base and negotiated improved terms with key suppliers to reduce material costs.</p>
                <ul className="space-y-2 text-[#051C2C]/70">
                  <li className="flex items-start gap-2"><CheckCircle2 className="w-5 h-5 text-[#0077B5] flex-shrink-0 mt-0.5" /><span>Spend analysis and category strategy</span></li>
                  <li className="flex items-start gap-2"><CheckCircle2 className="w-5 h-5 text-[#0077B5] flex-shrink-0 mt-0.5" /><span>Supplier consolidation and negotiation</span></li>
                  <li className="flex items-start gap-2"><CheckCircle2 className="w-5 h-5 text-[#0077B5] flex-shrink-0 mt-0.5" /><span>Make vs. buy optimization</span></li>
                </ul>
              </div>
            </div>
          </div>
        ...
        <div className="container px-4 md:px-12 max-w-4xl">
          <div className="space-y-8">
            <div>
              ...
              <p className="text-[#051C2C]/70 leading-relaxed mb-4">The program delivered $18M in annual cost savings, reducing COGS by 15% and restoring gross margins to 30%.</p>
              <div className="grid md:grid-cols-2 gap-4">
                <div className="p-6 bg-[#051C2C]/5 rounded-xl"><div className="text-3xl font-serif font-bold text-[#051C2C] mb-2">$18M</div><div className="text-sm text-[#051C2C]/60">Annual cost savings</div></div>
                <div className="p-6 bg-[#051C2C]/5 rounded-xl"><div className="text-3xl font-serif font-bold text-[#051C2C] mb-2">15%</div><div className="text-sm text-[#051C2C]/60">Reduction in COGS</div></div>
              </div>
            </div>
            <div>
              <h3 className="text-xl font-serif font-bold text-[#051C2C] mb-4 flex items-center gap-3"><Cog className="w-6 h-6 text-[#0077B5]" />Improved equipment effectiveness</h3>
              <p className="text-[#051C2C]/70 leading-relaxed mb-4">OEE improved from 55% to 77%, unlocking significant capacity without capital investment and enabling the company to take on new business.</p>
              <div className="p-6 bg-[#051C2C]/5 rounded-xl"><div className="text-3xl font-serif font-bold text-[#051C2C] mb-2">40%</div><div className="text-sm text-[#051C2C]/60">Improvement in OEE</div></div>
            </div>
            <div>
              <h3 className="text-xl font-serif font-bold text-[#051C2C] mb-4 flex items-center gap-3"><Target className="w-6 h-6 text-[#0077B5]" />Quality improvement</h3>
              <p className="text-[#051C2C]/70 leading-relaxed mb-4">Defect rates decreased by 65%, reducing scrap costs and improving customer satisfaction. The company successfully renewed all customer certifications.</p>
              <div className="p-6 bg-[#051C2C]/5 rounded-xl"><div className="text-3xl font-serif font-bold text-[#051C2C] mb-2">65%</div><div className="text-sm text-[#051C2C]/60">Reduction in defect rate</div></div>
            </div>
          </div>
        </div>
      </section>
