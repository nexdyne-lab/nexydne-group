      ...
      <section className="py-16 bg-white text-charcoal">
        <div className="container px-4 md:px-12 max-w-4xl">
          <div className="space-y-8">
            <div>
              <h3 className="text-xl font-serif font-bold text-charcoal mb-4">Declining gross margins</h3>
            ...
            <div>
              <h3 className="text-xl font-serif font-bold text-charcoal mb-4">Low equipment effectiveness</h3>
            ...
            <div>
              <h3 className="text-xl font-serif font-bold text-charcoal mb-4">Quality and scrap issues</h3>
        ...
        <div className="container px-4 md:px-12 max-w-4xl">
          ...
          <div className="space-y-12">
            <div className="flex gap-8">
              ...
              <div>
                <h3 className="text-xl font-serif font-bold text-charcoal mb-4 flex items-center gap-3"><Factory className="w-6 h-6 text-primary" />Lean manufacturing transformation</h3>
            ...
            <div className="flex gap-8">
              ...
              <div>
                <h3 className="text-xl font-serif font-bold text-charcoal mb-4 flex items-center gap-3"><Cog className="w-6 h-6 text-primary" />Equipment effectiveness improvement</h3>
            ...
            <div className="flex gap-8">
              ...
              <div>
                <h3 className="text-xl font-serif font-bold text-charcoal mb-4 flex items-center gap-3"><BarChart3 className="w-6 h-6 text-primary" />Strategic sourcing</h3>
          ...
          <div className="space-y-8">
            <div>
              ...
              <div className="grid md:grid-cols-2 gap-4">
                <div className="p-6 bg-base/5 rounded-xl"><div className="text-3xl font-serif font-bold text-charcoal mb-2">$18M</div><div className="text-sm text-charcoal/60">Annual cost savings</div></div>
                <div className="p-6 bg-base/5 rounded-xl"><div className="text-3xl font-serif font-bold text-charcoal mb-2">15%</div><div className="text-sm text-charcoal/60">Reduction in COGS</div></div>
              </div>
            </div>
            <div>
              <h3 className="text-xl font-serif font-bold text-charcoal mb-4 flex items-center gap-3"><Cog className="w-6 h-6 text-primary" />Improved equipment effectiveness</h3>
              ...
              <div className="p-6 bg-base/5 rounded-xl"><div className="text-3xl font-serif font-bold text-charcoal mb-2">40%</div><div className="text-sm text-charcoal/60">Improvement in OEE</div></div>
            </div>
            <div>
              <h3 className="text-xl font-serif font-bold text-charcoal mb-4 flex items-center gap-3"><Target className="w-6 h-6 text-primary" />Quality improvement</h3>
              ...
              <div className="p-6 bg-base/5 rounded-xl"><div className="text-3xl font-serif font-bold text-charcoal mb-2">65%</div><div className="text-sm text-charcoal/60">Reduction in defect rate</div></div>
            </div>
          </div>
        </div>
      </section>
