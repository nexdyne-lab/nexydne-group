      ...
      <section className="relative pt-32 pb-20 md:pt-40 md:pb-28 overflow-hidden">
        ...
        <div className="container relative z-10 px-4 md:px-12">
          ...
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }} className="max-w-4xl">
            <span className="text-xs uppercase tracking-[0.2em] text-primary mb-6 block">Case Study · Manufacturing</span>
      ...
      <section id="challenge" className="py-24 md:py-32 bg-primary">
        <div className="container px-4 md:px-12">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }}>
            ...
            <h2 className="text-4xl md:text-5xl text-white max-w-4xl leading-tight">Margin erosion threatening competitiveness</h2>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-16 bg-white text-charcoal">
        <div className="container px-4 md:px-12 max-w-4xl">
          <div className="space-y-8">
            <div>
              <h3 className="text-xl text-charcoal mb-4">Declining gross margins</h3>
            ...
            <div>
              <h3 className="text-xl text-charcoal mb-4">Low equipment effectiveness</h3>
            ...
            <div>
              <h3 className="text-xl text-charcoal mb-4">Quality and scrap issues</h3>
      ...
      <section id="solution" className="py-24 md:py-32 bg-primary">
        <div className="container px-4 md:px-12">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }}>
            ...
            <h2 className="text-4xl md:text-5xl text-white max-w-4xl leading-tight">Comprehensive operational excellence program</h2>
          </motion.div>
        </div>
      </section>
        ...
        <div className="container px-4 md:px-12 max-w-4xl">
          ...
          <div className="space-y-12">
            <div className="flex gap-8">
              ...
              <div>
                <h3 className="text-xl text-charcoal mb-4 flex items-center gap-3">Lean manufacturing transformation</h3>
                ...
                <ul className="space-y-2 text-charcoal/70">
                  <li className="flex items-start gap-2"><span>Value stream mapping and waste identification</span></li>
                  <li className="flex items-start gap-2"><span>Cellular manufacturing and flow optimization</span></li>
                  <li className="flex items-start gap-2"><span>SMED for changeover reduction</span></li>
                </ul>
              </div>
            </div>
            <div className="flex gap-8">
              ...
              <div>
                <h3 className="text-xl text-charcoal mb-4 flex items-center gap-3">Equipment effectiveness improvement</h3>
                ...
                <ul className="space-y-2 text-charcoal/70">
                  <li className="flex items-start gap-2"><span>Total Productive Maintenance implementation</span></li>
                  <li className="flex items-start gap-2"><span>Root cause analysis and corrective action</span></li>
                  <li className="flex items-start gap-2"><span>Real-time OEE monitoring and management</span></li>
                </ul>
              </div>
            </div>
            <div className="flex gap-8">
              ...
              <div>
                <h3 className="text-xl text-charcoal mb-4 flex items-center gap-3">Strategic sourcing</h3>
                ...
                <ul className="space-y-2 text-charcoal/70">
                  <li className="flex items-start gap-2"><span>Spend analysis and category strategy</span></li>
                  <li className="flex items-start gap-2"><span>Supplier consolidation and negotiation</span></li>
                  <li className="flex items-start gap-2"><span>Make vs. buy optimization</span></li>
                </ul>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-8">
            <div>
              ...
              <div className="grid md:grid-cols-2 gap-4">
                <div className="p-6 bg-white/5"><div className="text-3xl text-charcoal mb-2">$18M</div><div className="text-sm text-charcoal/60">Annual cost savings</div></div>
                <div className="p-6 bg-white/5"><div className="text-3xl text-charcoal mb-2">15%</div><div className="text-sm text-charcoal/60">Reduction in COGS</div></div>
              </div>
            </div>
            <div>
              <h3 className="text-xl text-charcoal mb-4 flex items-center gap-3">Improved equipment effectiveness</h3>
              ...
              <div className="p-6 bg-white/5"><div className="text-3xl text-charcoal mb-2">40%</div><div className="text-sm text-charcoal/60">Improvement in OEE</div></div>
            </div>
            <div>
              <h3 className="text-xl text-charcoal mb-4 flex items-center gap-3">Quality improvement</h3>
              ...
              <div className="p-6 bg-white/5"><div className="text-3xl text-charcoal mb-2">65%</div><div className="text-sm text-charcoal/60">Reduction in defect rate</div></div>
            </div>
          </div>
        </div>
      </section>
