    ...
    <div className="min-h-screen bg-white text-white selection:bg-primary selection:text-white">
      ...
      <section className="relative pt-32 pb-20 md:pt-40 md:pb-28 overflow-hidden">
        ...
        <div className="container relative z-10 px-4 md:px-12">
          ...
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }} className="max-w-4xl">
            <span className="text-xs uppercase tracking-[0.2em] text-primary mb-6 block">Case Study · Precision Manufacturing</span>
      ...
      <section id="challenge" className="py-24 md:py-32 bg-primary">
        <div className="container px-4 md:px-12">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }}>
            ...
            <h2 className="text-4xl md:text-5xl text-white max-w-4xl leading-tight">Capacity constraints limiting growth potential</h2>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-16 bg-white text-charcoal">
        <div className="container px-4 md:px-12 max-w-4xl">
          <div className="space-y-8">
            <div>
              <h3 className="text-xl text-charcoal mb-4">Turning away business due to capacity limits</h3>
            ...
            <div>
              <h3 className="text-xl text-charcoal mb-4">Geographic concentration creating risk</h3>
            ...
            <div>
              <h3 className="text-xl text-charcoal mb-4">Capital requirements beyond internal resources</h3>
      ...
      <section id="solution" className="py-24 md:py-32 bg-primary">
        <div className="container px-4 md:px-12">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }}>
            ...
            <h2 className="text-4xl md:text-5xl text-white max-w-4xl leading-tight">Growth equity with operational support</h2>
          </motion.div>
        </div>
      </section>
        ...
        <div className="container px-4 md:px-12 max-w-4xl">
          ...
          <div className="space-y-12">
            <div className="flex gap-8">
              ...
              <div>
                <h3 className="text-xl text-charcoal mb-4 flex items-center gap-3">Investment thesis development</h3>
                ...
                <ul className="space-y-2 text-charcoal/70">
                  <li className="flex items-start gap-2"><span>Market analysis and competitive positioning</span></li>
                  <li className="flex items-start gap-2"><span>Customer reference program and demand validation</span></li>
                  <li className="flex items-start gap-2"><span>Detailed expansion plan with ROI analysis</span></li>
                </ul>
              </div>
            </div>
            <div className="flex gap-8">
              ...
              <div>
                <h3 className="text-xl text-charcoal mb-4 flex items-center gap-3">Investor targeting and process</h3>
                ...
                <ul className="space-y-2 text-charcoal/70">
                  <li className="flex items-start gap-2"><span>Targeted 20 manufacturing-focused growth equity firms</span></li>
                  <li className="flex items-start gap-2"><span>Managed competitive process with 6 term sheets</span></li>
                  <li className="flex items-start gap-2"><span>Negotiated optimal terms with preferred partner</span></li>
                </ul>
              </div>
            </div>
            <div className="flex gap-8">
              ...
              <div>
                <h3 className="text-xl text-charcoal mb-4 flex items-center gap-3">Expansion execution support</h3>
                ...
                <ul className="space-y-2 text-charcoal/70">
                  <li className="flex items-start gap-2"><span>Site selection analysis for three new facilities</span></li>
                  <li className="flex items-start gap-2"><span>Equipment procurement and installation planning</span></li>
                  <li className="flex items-start gap-2"><span>Workforce development and training programs</span></li>
                </ul>
              </div>
            </div>
          </div>
      ...
      <section className="py-16 bg-white text-charcoal">
        <div className="container px-4 md:px-12 max-w-4xl">
          <div className="space-y-8">
            <div>
              <h3 className="text-xl text-charcoal mb-4 flex items-center gap-3">Growth equity secured at attractive terms</h3>
              ...
              <div className="grid md:grid-cols-2 gap-4">
                <div className="p-6 bg-white/5"><div className="text-3xl text-charcoal mb-2">$35M</div><div className="text-sm text-charcoal/60">Growth equity secured</div></div>
                <div className="p-6 bg-white/5"><div className="text-3xl text-charcoal mb-2">6</div><div className="text-sm text-charcoal/60">Term sheets received</div></div>
              </div>
            </div>
            <div>
              <h3 className="text-xl text-charcoal mb-4 flex items-center gap-3">Successful capacity expansion</h3>
              ...
              <div className="p-6 bg-white/5"><div className="text-3xl text-charcoal mb-2">2x</div><div className="text-sm text-charcoal/60">Production capacity increase</div></div>
            </div>
            <div>
              <h3 className="text-xl text-charcoal mb-4 flex items-center gap-3">Accelerated revenue growth</h3>
              ...
              <div className="p-6 bg-white/5"><div className="text-3xl text-charcoal mb-2">45%</div><div className="text-sm text-charcoal/60">Revenue growth in Year 1</div></div>
            </div>
          </div>
        </div>
      </section>
