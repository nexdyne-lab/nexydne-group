...
export default function ManufacturingGrowthEquity() {
  return (
    <div className="min-h-screen bg-[#051C2C] text-white selection:bg-[#0077B5] selection:text-white">
      ...
      <section className="relative pt-32 pb-20 md:pt-40 md:pb-28 overflow-hidden">
        ...
        <div className="container relative z-10 px-4 md:px-12">
          ...
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }} className="max-w-4xl">
            <span className="text-xs font-bold uppercase tracking-[0.2em] text-[#0077B5] mb-6 block">Case Study · Precision Manufacturing</span>
            <h1 className="text-5xl md:text-7xl font-serif font-bold tracking-tight leading-[1.05] mb-4">
              <span className="text-[#0077B5]">$35M</span> growth equity for capacity expansion
            </h1>
        ...
        <div className="container px-4 md:px-12 max-w-4xl">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }}>
            ...
            <div className="grid md:grid-cols-3 gap-6 mt-12 p-8 bg-[#051C2C]/5 rounded-xl">
              <div><div className="text-sm font-semibold text-[#0077B5] mb-2">Industry</div><div className="text-[#051C2C] font-medium">Precision Manufacturing</div></div>
              <div><div className="text-sm font-semibold text-[#0077B5] mb-2">Employees</div><div className="text-[#051C2C] font-medium">185</div></div>
              <div><div className="text-sm font-semibold text-[#0077B5] mb-2">Annual Revenue</div><div className="text-[#051C2C] font-medium">$42M</div></div>
            </div>
          </motion.div>
        </div>
      </section>
      ...
      <section id="challenge" className="py-24 md:py-32 bg-[#0077B5]">
        <div className="container px-4 md:px-12">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }}>
            ...
            <h2 className="text-4xl md:text-5xl font-serif font-bold text-white max-w-4xl leading-tight">Capacity constraints limiting growth potential</h2>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-16 bg-white text-[#051C2C]">
        <div className="container px-4 md:px-12 max-w-4xl">
          <div className="space-y-8">
            <div>
              <h3 className="text-xl font-serif font-bold text-[#051C2C] mb-4">Turning away business due to capacity limits</h3>
              <p className="text-[#051C2C]/70 leading-relaxed">The company was operating at 95% capacity utilization and had been forced to decline several significant opportunities from existing customers. Without expansion, they risked losing market share to competitors who could meet growing demand.</p>
            </div>
            <div>
              <h3 className="text-xl font-serif font-bold text-[#051C2C] mb-4">Geographic concentration creating risk</h3>
              <p className="text-[#051C2C]/70 leading-relaxed">All production was concentrated in a single facility, creating supply chain risk for customers who increasingly required geographic diversification. Several major customers had indicated this was becoming a barrier to expanding the relationship.</p>
            </div>
            <div>
              <h3 className="text-xl font-serif font-bold text-[#051C2C] mb-4">Capital requirements beyond internal resources</h3>
              <p className="text-[#051C2C]/70 leading-relaxed">The expansion plan required $35M in capital for new facilities, equipment, and working capital—far beyond what the company could fund through operations or traditional bank financing. They needed an equity partner.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="solution" className="py-24 md:py-32 bg-[#0077B5]">
        <div className="container px-4 md:px-12">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }}>
            ...
            <h2 className="text-4xl md:text-5xl font-serif font-bold text-white max-w-4xl leading-tight">Growth equity with operational support</h2>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-16 bg-white text-[#051C2C]">
        <div className="container px-4 md:px-12 max-w-4xl">
          <p className="text-xl text-[#051C2C]/80 leading-relaxed mb-12">We identified and secured a growth equity partner with deep manufacturing expertise and supported the expansion execution.</p>
          <div className="space-y-12">
            <div className="flex gap-8">
              ...
              <div>
                <h3 className="text-xl font-serif font-bold text-[#051C2C] mb-4 flex items-center gap-3"><Target className="w-6 h-6 text-[#0077B5]" />Investment thesis development</h3>
                <p className="text-[#051C2C]/70 leading-relaxed mb-4">We developed a compelling investment thesis highlighting the company's quality reputation, customer relationships, and growth potential with expanded capacity.</p>
                <ul className="space-y-2 text-[#051C2C]/70">
                  <li className="flex items-start gap-2"><CheckCircle2 className="w-5 h-5 text-[#0077B5] flex-shrink-0 mt-0.5" /><span>Market analysis and competitive positioning</span></li>
                  <li className="flex items-start gap-2"><CheckCircle2 className="w-5 h-5 text-[#0077B5] flex-shrink-0 mt-0.5" /><span>Customer reference program and demand validation</span></li>
                  <li className="flex items-start gap-2"><CheckCircle2 className="w-5 h-5 text-[#0077B5] flex-shrink-0 mt-0.5" /><span>Detailed expansion plan with ROI analysis</span></li>
                </ul>
              </div>
            </div>
            <div className="flex gap-8">
              ...
              <div>
                <h3 className="text-xl font-serif font-bold text-[#051C2C] mb-4 flex items-center gap-3"><Users className="w-6 h-6 text-[#0077B5]" />Investor targeting and process</h3>
                <p className="text-[#051C2C]/70 leading-relaxed mb-4">We targeted growth equity firms with manufacturing portfolio experience and ran a competitive process that generated multiple term sheets.</p>
                <ul className="space-y-2 text-[#051C2C]/70">
                  <li className="flex items-start gap-2"><CheckCircle2 className="w-5 h-5 text-[#0077B5] flex-shrink-0 mt-0.5" /><span>Targeted 20 manufacturing-focused growth equity firms</span></li>
                  <li className="flex items-start gap-2"><CheckCircle2 className="w-5 h-5 text-[#0077B5] flex-shrink-0 mt-0.5" /><span>Managed competitive process with 6 term sheets</span></li>
                  <li className="flex items-start gap-2"><CheckCircle2 className="w-5 h-5 text-[#0077B5] flex-shrink-0 mt-0.5" /><span>Negotiated optimal terms with preferred partner</span></li>
                </ul>
              </div>
            </div>
            <div className="flex gap-8">
              ...
              <div>
                <h3 className="text-xl font-serif font-bold text-[#051C2C] mb-4 flex items-center gap-3"><Factory className="w-6 h-6 text-[#0077B5]" />Expansion execution support</h3>
                <p className="text-[#051C2C]/70 leading-relaxed mb-4">Post-close, we supported the expansion execution including site selection, equipment procurement, and operational ramp-up.</p>
                <ul className="space-y-2 text-[#051C2C]/70">
                  <li className="flex items-start gap-2"><CheckCircle2 className="w-5 h-5 text-[#0077B5] flex-shrink-0 mt-0.5" /><span>Site selection analysis for three new facilities</span></li>
                  <li className="flex items-start gap-2"><CheckCircle2 className="w-5 h-5 text-[#0077B5] flex-shrink-0 mt-0.5" /><span>Equipment procurement and installation planning</span></li>
                  <li className="flex items-start gap-2"><CheckCircle2 className="w-5 h-5 text-[#0077B5] flex-shrink-0 mt-0.5" /><span>Workforce development and training programs</span></li>
                </ul>
              </div>
            </div>
          </div>
      ...
      <section className="py-16 bg-white text-[#051C2C]">
        <div className="container px-4 md:px-12 max-w-4xl">
          <div className="space-y-8">
            <div>
              <h3 className="text-xl font-serif font-bold text-[#051C2C] mb-4 flex items-center gap-3"><DollarSign className="w-6 h-6 text-[#0077B5]" />Growth equity secured at attractive terms</h3>
              <p className="text-[#051C2C]/70 leading-relaxed mb-4">The company secured $35M in growth equity from a manufacturing-focused fund with deep operational expertise and a track record of supporting similar expansions.</p>
              <div className="grid md:grid-cols-2 gap-4">
                <div className="p-6 bg-[#051C2C]/5 rounded-xl"><div className="text-3xl font-serif font-bold text-[#051C2C] mb-2">$35M</div><div className="text-sm text-[#051C2C]/60">Growth equity secured</div></div>
                <div className="p-6 bg-[#051C2C]/5 rounded-xl"><div className="text-3xl font-serif font-bold text-[#051C2C] mb-2">6</div><div className="text-sm text-[#051C2C]/60">Term sheets received</div></div>
              </div>
            </div>
            <div>
              <h3 className="text-xl font-serif font-bold text-[#051C2C] mb-4 flex items-center gap-3"><Factory className="w-6 h-6 text-[#0077B5]" />Successful capacity expansion</h3>
              <p className="text-[#051C2C]/70 leading-relaxed mb-4">Within 18 months, the company had opened three new facilities, doubling production capacity and establishing geographic diversification that satisfied customer requirements.</p>
              <div className="p-6 bg-[#051C2C]/5 rounded-xl"><div className="text-3xl font-serif font-bold text-[#051C2C] mb-2">2x</div><div className="text-sm text-[#051C2C]/60">Production capacity increase</div></div>
            </div>
            <div>
              <h3 className="text-xl font-serif font-bold text-[#051C2C] mb-4 flex items-center gap-3"><TrendingUp className="w-6 h-6 text-[#0077B5]" />Accelerated revenue growth</h3>
              <p className="text-[#051C2C]/70 leading-relaxed mb-4">With expanded capacity, the company was able to capture previously declined opportunities and win new business, driving 45% revenue growth in the first year post-investment.</p>
              <div className="p-6 bg-[#051C2C]/5 rounded-xl"><div className="text-3xl font-serif font-bold text-[#051C2C] mb-2">45%</div><div className="text-sm text-[#051C2C]/60">Revenue growth in Year 1</div></div>
            </div>
          </div>
        </div>
      </section>
