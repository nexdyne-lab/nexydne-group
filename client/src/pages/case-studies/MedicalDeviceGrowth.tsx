        ...
        <div className="container relative z-10 px-4 md:px-12">
          ...
          >
            ...
            <h1 className="text-5xl md:text-7xl font-serif font-bold tracking-tight leading-[1.05] mb-4">
              Identifying and Capturing <span className="text-[#0077B5]">Growth Opportunities</span>
            </h1>
          ...
          >
            ...
            <div className="grid md:grid-cols-3 gap-6 mt-12 p-8 bg-[#051C2C]/5 rounded-xl">
              <div>
                ...
                <div className="text-[#051C2C] font-medium">Healthcare Manufacturing</div>
              </div>
              <div>
                <div className="text-sm font-semibold text-[#0077B5] mb-2">Company Size</div>
                <div className="text-[#051C2C] font-medium">Mid-Market</div>
              </div>
              <div>
      ...
      <section className="py-16 bg-white text-[#051C2C]">
        <div className="container px-4 md:px-12 max-w-4xl">
          <div className="space-y-8">
            <div>
              <h3 className="text-xl font-serif font-bold text-[#051C2C] mb-4">Lack of Strategic Framework</h3>
              <p className="text-[#051C2C]/70 leading-relaxed">
            ...
            <div>
              <h3 className="text-xl font-serif font-bold text-[#051C2C] mb-4">Limited Market Intelligence</h3>
              <p className="text-[#051C2C]/70 leading-relaxed">
            ...
            <div>
              <h3 className="text-xl font-serif font-bold text-[#051C2C] mb-4">Reactive Rather Than Proactive</h3>
              <p className="text-[#051C2C]/70 leading-relaxed">
            ...
            <div>
              <h3 className="text-xl font-serif font-bold text-[#051C2C] mb-4">Unclear Partnership Strategy</h3>
              <p className="text-[#051C2C]/70 leading-relaxed">
        ...
        <div className="container px-4 md:px-12 max-w-4xl">
          <div className="space-y-8">
            <div>
              ...
              <div className="grid md:grid-cols-2 gap-4">
                <div className="p-6 bg-[#051C2C]/5 rounded-xl">
                  ...
                  <div className="text-sm text-[#051C2C]/60">Growth themes systematically evaluated</div>
                </div>
                <div className="p-6 bg-[#051C2C]/5 rounded-xl">
                  <div className="text-3xl font-serif font-bold text-[#051C2C] mb-2">5</div>
                  <div className="text-sm text-[#051C2C]/60">Priority investment channels identified</div>
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="p-6 bg-[#051C2C]/5 rounded-xl">
                <div className="text-3xl font-serif font-bold text-[#051C2C] mb-2">25+</div>
                <div className="text-sm text-[#051C2C]/60">Strategic partners evaluated and prioritized</div>
              </div>
            </div>

            <div>
              <h3 className="text-xl font-serif font-bold text-[#051C2C] mb-4 flex items-center gap-3">
                <Lightbulb className="w-6 h-6 text-[#0077B5]" />
