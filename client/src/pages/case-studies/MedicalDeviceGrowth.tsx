      ...
      <section className="py-16 bg-white text-charcoal">
        <div className="container px-4 md:px-12 max-w-4xl">
          <div className="space-y-8">
            <div>
              <h3 className="text-xl text-charcoal mb-4">Lack of Strategic Framework</h3>
              <p className="text-charcoal/70 leading-relaxed">
            ...
            <div>
              <h3 className="text-xl text-charcoal mb-4">Limited Market Intelligence</h3>
              <p className="text-charcoal/70 leading-relaxed">
            ...
            <div>
              <h3 className="text-xl text-charcoal mb-4">Reactive Rather Than Proactive</h3>
              <p className="text-charcoal/70 leading-relaxed">
            ...
            <div>
              <h3 className="text-xl text-charcoal mb-4">Unclear Partnership Strategy</h3>
              <p className="text-charcoal/70 leading-relaxed">
        ...
        <div className="container px-4 md:px-12 max-w-4xl">
          <div className="space-y-8">
            ...
            <div>
              ...
              <div className="p-6 bg-white/5">
                <div className="text-3xl text-charcoal mb-2">25+</div>
