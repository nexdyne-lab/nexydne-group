    ...
    <div className="min-h-screen bg-[#051C2C] text-white selection:bg-[#0077B5] selection:text-white">
        ...
        <div className="container relative z-10 px-4 md:px-12">
          ...
          >
            ...
            <h1 className="text-5xl md:text-7xl font-serif font-bold tracking-tight leading-[1.05] mb-4">
              Operational Excellence in <span className="text-[#0077B5]">Multi-Site Healthcare</span>
            </h1>
      ...
      <section className="py-16 bg-white text-[#051C2C]">
        <div className="container px-4 md:px-12 max-w-4xl">
          ...
          >
            <h2 className="text-3xl font-serif font-bold text-[#051C2C] mb-6">Organization Background</h2>
            ...
            <div className="grid md:grid-cols-3 gap-6 mt-12 p-8 bg-[#051C2C]/5 rounded-xl">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <div className="text-[#051C2C] font-medium">Healthcare Services</div>
                </div>
              </div>
              <div className="flex items-start gap-4">
                <div className="w-12 h-12 bg-[#0077B5]/10 rounded-lg flex items-center justify-center flex-shrink-0">
                ...
                <div>
                  <div className="text-sm font-semibold text-[#0077B5] mb-1">Organization Size</div>
                  <div className="text-[#051C2C] font-medium">850 employees, 12 facilities</div>
                </div>
              </div>
              <div className="flex items-start gap-4">
                <div className="w-12 h-12 bg-[#0077B5]/10 rounded-lg flex items-center justify-center flex-shrink-0">
                ...
                <div>
                  ...
                  <div className="text-[#051C2C] font-medium">$120M</div>
                </div>
              </div>
            </div>
          </motion.div>
      ...
      <section className="py-16 bg-white text-[#051C2C]">
        <div className="container px-4 md:px-12 max-w-4xl">
          <div className="space-y-8">
            <div>
              <h3 className="text-xl font-serif font-bold text-[#051C2C] mb-4">Process Inconsistency</h3>
              <p className="text-[#051C2C]/70 leading-relaxed">
            ...
            <div>
              <h3 className="text-xl font-serif font-bold text-[#051C2C] mb-4">Resource Utilization Gaps</h3>
              <p className="text-[#051C2C]/70 leading-relaxed">
            ...
            <div>
              <h3 className="text-xl font-serif font-bold text-[#051C2C] mb-4">Revenue Cycle Inefficiencies</h3>
              <p className="text-[#051C2C]/70 leading-relaxed">
            ...
            <div>
              <h3 className="text-xl font-serif font-bold text-[#051C2C] mb-4">Limited Performance Visibility</h3>
              <p className="text-[#051C2C]/70 leading-relaxed">
        ...
        <div className="container px-4 md:px-12 max-w-4xl">
          ...
          <div className="space-y-12">
            ...
            <div className="flex gap-8">
              ...
              <div>
                <h3 className="text-xl font-serif font-bold text-[#051C2C] mb-2">Comprehensive Diagnostic and Opportunity Identification</h3>
                <p className="text-sm text-[#0077B5] mb-4">Months 1-2</p>
            ...
            <div className="flex gap-8">
              ...
              <div>
                <h3 className="text-xl font-serif font-bold text-[#051C2C] mb-2">Process Standardization and Optimization</h3>
                <p className="text-sm text-[#0077B5] mb-4">Months 3-7</p>
                <p className="text-[#051C2C]/70 leading-relaxed mb-4">
            ...
            <div className="flex gap-8">
              ...
              <div>
                <h3 className="text-xl font-serif font-bold text-[#051C2C] mb-2">Performance Management Infrastructure</h3>
                <p className="text-sm text-[#0077B5] mb-4">Months 6-9</p>
                <p className="text-[#051C2C]/70 leading-relaxed mb-4">
            ...
            <div className="flex gap-8">
              ...
              <div>
                <h3 className="text-xl font-serif font-bold text-[#051C2C] mb-2">Continuous Improvement Capability Building</h3>
                <p className="text-sm text-[#0077B5] mb-4">Months 9-12</p>
                <p className="text-[#051C2C]/70 leading-relaxed mb-4">
        ...
        <div className="container px-4 md:px-12 max-w-4xl">
          <div className="grid md:grid-cols-2 gap-8 mb-12">
            <div>
              ...
              <div className="space-y-4">
                <div className="p-4 bg-[#051C2C]/5 rounded-xl">
                  <div className="text-2xl font-serif font-bold text-[#051C2C] mb-1">$8.4M</div>
                  <div className="text-sm text-[#051C2C]/60">Annual cost savings</div>
                </div>
                <div className="p-4 bg-[#051C2C]/5 rounded-xl">
                  <div className="text-2xl font-serif font-bold text-[#051C2C] mb-1">22%</div>
                  <div className="text-sm text-[#051C2C]/60">Operating cost reduction per visit</div>
                </div>
                <div className="p-4 bg-[#051C2C]/5 rounded-xl">
                  <div className="text-2xl font-serif font-bold text-[#051C2C] mb-1">2.8% → 10%</div>
                  <div className="text-sm text-[#051C2C]/60">Operating margin improvement</div>
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="space-y-4">
                <div className="p-4 bg-[#051C2C]/5 rounded-xl">
                  <div className="text-2xl font-serif font-bold text-[#051C2C] mb-1">18%</div>
                  <div className="text-sm text-[#051C2C]/60">Provider productivity improvement</div>
                </div>
                <div className="p-4 bg-[#051C2C]/5 rounded-xl">
                  <div className="text-2xl font-serif font-bold text-[#051C2C] mb-1">50%</div>
                  <div className="text-sm text-[#051C2C]/60">Reduction in patient no-shows</div>
                </div>
                <div className="p-4 bg-[#051C2C]/5 rounded-xl">
                  <div className="text-2xl font-serif font-bold text-[#051C2C] mb-1">85%</div>
                  <div className="text-sm text-[#051C2C]/60">Core processes standardized</div>
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="space-y-4">
                <div className="p-4 bg-[#051C2C]/5 rounded-xl">
                  <div className="text-2xl font-serif font-bold text-[#051C2C] mb-1">52 → 38 days</div>
                  <div className="text-sm text-[#051C2C]/60">Days in accounts receivable</div>
                </div>
                <div className="p-4 bg-[#051C2C]/5 rounded-xl">
                  <div className="text-2xl font-serif font-bold text-[#051C2C] mb-1">35%</div>
                  <div className="text-sm text-[#051C2C]/60">Reduction in claim denials</div>
                </div>
                <div className="p-4 bg-[#051C2C]/5 rounded-xl">
                  <div className="text-2xl font-serif font-bold text-[#051C2C] mb-1">$1.8M</div>
                  <div className="text-sm text-[#051C2C]/60">Additional revenue recovered</div>
                </div>
              </div>
            </div>
            ...
            <div>
              <h3 className="text-xl font-serif font-bold text-[#051C2C] mb-4 flex items-center gap-3">
                <Heart className="w-6 h-6 text-[#0077B5]" />
                Quality and Patient Experience
              </h3>
              <div className="space-y-4">
                <div className="p-4 bg-[#051C2C]/5 rounded-xl">
                  <div className="text-2xl font-serif font-bold text-[#051C2C] mb-1">15%</div>
                  <div className="text-sm text-[#051C2C]/60">Patient satisfaction increase</div>
                </div>
                <div className="p-4 bg-[#051C2C]/5 rounded-xl">
                  <div className="text-2xl font-serif font-bold text-[#051C2C] mb-1">28%</div>
                  <div className="text-sm text-[#051C2C]/60">Clinical quality improvement</div>
                </div>
                <div className="p-4 bg-[#051C2C]/5 rounded-xl">
                  <div className="text-2xl font-serif font-bold text-[#051C2C] mb-1">72% → 89%</div>
                  <div className="text-sm text-[#051C2C]/60">Employee engagement scores</div>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="container px-4 md:px-12 max-w-4xl">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="border-l-4 border-[#0077B5] pl-6">
              <h3 className="text-xl font-serif font-bold text-[#051C2C] mb-3">Balanced Approach</h3>
              <p className="text-[#051C2C]/70">
            ...
            <div className="border-l-4 border-[#0077B5] pl-6">
              <h3 className="text-xl font-serif font-bold text-[#051C2C] mb-3">Frontline Engagement</h3>
              <p className="text-[#051C2C]/70">
            ...
            <div className="border-l-4 border-[#0077B5] pl-6">
              <h3 className="text-xl font-serif font-bold text-[#051C2C] mb-3">Data-Driven Decisions</h3>
              <p className="text-[#051C2C]/70">
            ...
            <div className="border-l-4 border-[#0077B5] pl-6">
              <h3 className="text-xl font-serif font-bold text-[#051C2C] mb-3">Capability Building</h3>
              <p className="text-[#051C2C]/70">
