    ...
    <div className="min-h-screen bg-base text-white selection:bg-primary selection:text-white">
      ...
      <section className="py-16 bg-white text-charcoal">
        <div className="container px-4 md:px-12 max-w-4xl">
          <div className="space-y-8">
            <div>
              <h3 className="text-xl font-serif font-bold text-charcoal mb-4">Different cultures and ways of working</h3>
            ...
            <div>
              <h3 className="text-xl font-serif font-bold text-charcoal mb-4">Complex system and process integration</h3>
            ...
            <div>
              <h3 className="text-xl font-serif font-bold text-charcoal mb-4">High-stakes talent retention</h3>
        ...
        <div className="container px-4 md:px-12 max-w-4xl">
          ...
          <div className="space-y-12">
            <div className="flex gap-8">
              ...
              <div>
                <h3 className="text-xl font-serif font-bold text-charcoal mb-4 flex items-center gap-3"><Puzzle className="w-6 h-6 text-primary" />Integration management office</h3>
            ...
            <div className="flex gap-8">
              ...
              <div>
                <h3 className="text-xl font-serif font-bold text-charcoal mb-4 flex items-center gap-3"><Users className="w-6 h-6 text-primary" />Cultural integration program</h3>
            ...
            <div className="flex gap-8">
              ...
              <div>
                <h3 className="text-xl font-serif font-bold text-charcoal mb-4 flex items-center gap-3"><Target className="w-6 h-6 text-primary" />Synergy tracking and accountability</h3>
      ...
      <section className="py-16 bg-white text-charcoal">
        <div className="container px-4 md:px-12 max-w-4xl">
          <div className="space-y-8">
            <div>
              <h3 className="text-xl font-serif font-bold text-charcoal mb-4 flex items-center gap-3"><TrendingUp className="w-6 h-6 text-primary" />Synergies exceeded expectations</h3>
              ...
              <div className="grid md:grid-cols-2 gap-4">
                <div className="p-6 bg-base/5 rounded-xl"><div className="text-3xl font-serif font-bold text-charcoal mb-2">120%</div><div className="text-sm text-charcoal/60">Synergy target achieved</div></div>
                <div className="p-6 bg-base/5 rounded-xl"><div className="text-3xl font-serif font-bold text-charcoal mb-2">$12M</div><div className="text-sm text-charcoal/60">Annual run-rate synergies</div></div>
              </div>
            </div>
            <div>
              <h3 className="text-xl font-serif font-bold text-charcoal mb-4 flex items-center gap-3"><Users className="w-6 h-6 text-primary" />Exceptional talent retention</h3>
              ...
              <div className="p-6 bg-base/5 rounded-xl"><div className="text-3xl font-serif font-bold text-charcoal mb-2">95%</div><div className="text-sm text-charcoal/60">Key talent retention rate</div></div>
            </div>
            <div>
              <h3 className="text-xl font-serif font-bold text-charcoal mb-4 flex items-center gap-3"><Clock className="w-6 h-6 text-primary" />Client relationships preserved</h3>
              ...
              <div className="p-6 bg-base/5 rounded-xl"><div className="text-3xl font-serif font-bold text-charcoal mb-2">98%</div><div className="text-sm text-charcoal/60">Client retention rate</div></div>
            </div>
          </div>
        </div>
      </section>
