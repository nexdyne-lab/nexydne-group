    ...
    <div className="min-h-screen bg-white text-white selection:bg-primary selection:text-white">
      ...
      <section id="challenge" className="py-24 md:py-32 bg-primary">
        <div className="container px-4 md:px-12">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }}>
            ...
            <h2 className="text-4xl md:text-5xl text-white max-w-4xl leading-tight">Stagnant growth in an evolving market</h2>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-16 bg-white text-charcoal">
        <div className="container px-4 md:px-12 max-w-4xl">
          <div className="space-y-8">
            <div>
              <h3 className="text-xl text-charcoal mb-4">Undifferentiated market position</h3>
            ...
            <div>
              <h3 className="text-xl text-charcoal mb-4">Reactive sales approach</h3>
            ...
            <div>
              <h3 className="text-xl text-charcoal mb-4">Service portfolio misaligned with market needs</h3>
      ...
      <section id="solution" className="py-24 md:py-32 bg-primary">
        <div className="container px-4 md:px-12">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }}>
            ...
            <h2 className="text-4xl md:text-5xl text-white max-w-4xl leading-tight">Comprehensive growth transformation</h2>
          </motion.div>
        </div>
      </section>
        ...
        <div className="container px-4 md:px-12 max-w-4xl">
          ...
          <div className="space-y-12">
            <div className="flex gap-8">
              ...
              <div>
                <h3 className="text-xl text-charcoal mb-4 flex items-center gap-3">Strategic repositioning</h3>
                ...
                <ul className="space-y-2 text-charcoal/70">
                  <li className="flex items-start gap-2"><span>Market and competitive analysis</span></li>
                  <li className="flex items-start gap-2"><span>Differentiated positioning development</span></li>
                  <li className="flex items-start gap-2"><span>Brand and messaging refresh</span></li>
                </ul>
              </div>
            </div>
            <div className="flex gap-8">
              ...
              <div>
                <h3 className="text-xl text-charcoal mb-4 flex items-center gap-3">Service portfolio optimization</h3>
                ...
                <ul className="space-y-2 text-charcoal/70">
                  <li className="flex items-start gap-2"><span>Service portfolio assessment and rationalization</span></li>
                  <li className="flex items-start gap-2"><span>New service development for growth areas</span></li>
                  <li className="flex items-start gap-2"><span>Pricing strategy optimization</span></li>
                </ul>
              </div>
            </div>
            <div className="flex gap-8">
              ...
              <div>
                <h3 className="text-xl text-charcoal mb-4 flex items-center gap-3">Go-to-market transformation</h3>
                ...
                <ul className="space-y-2 text-charcoal/70">
                  <li className="flex items-start gap-2"><span>Business development process and playbooks</span></li>
                  <li className="flex items-start gap-2"><span>Key account management program</span></li>
                  <li className="flex items-start gap-2"><span>Marketing and thought leadership strategy</span></li>
                </ul>
              </div>
            </div>
          </div>
      ...
      <section className="py-16 bg-white text-charcoal">
        <div className="container px-4 md:px-12 max-w-4xl">
          <div className="space-y-8">
            <div>
              <h3 className="text-xl text-charcoal mb-4 flex items-center gap-3">Breakthrough revenue growth</h3>
              ...
              <div className="grid md:grid-cols-2 gap-4">
                <div className="p-6 bg-white/5"><div className="text-3xl text-charcoal mb-2">85%</div><div className="text-sm text-charcoal/60">Revenue growth over 3 years</div></div>
                <div className="p-6 bg-white/5"><div className="text-3xl text-charcoal mb-2">$83M</div><div className="text-sm text-charcoal/60">Revenue in Year 3</div></div>
              </div>
            </div>
            <div>
              <h3 className="text-xl text-charcoal mb-4 flex items-center gap-3">Improved sales effectiveness</h3>
              ...
              <div className="p-6 bg-white/5"><div className="text-3xl text-charcoal mb-2">2.5x</div><div className="text-sm text-charcoal/60">Average deal size increase</div></div>
            </div>
            <div>
              <h3 className="text-xl text-charcoal mb-4 flex items-center gap-3">Enhanced client relationships</h3>
              ...
              <div className="p-6 bg-white/5"><div className="text-3xl text-charcoal mb-2">+15pts</div><div className="text-sm text-charcoal/60">NPS improvement</div></div>
            </div>
          </div>
        </div>
      </section>
