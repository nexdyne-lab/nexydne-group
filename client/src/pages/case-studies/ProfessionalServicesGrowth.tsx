      ...
      <section id="challenge" className="py-24 md:py-32 bg-background">
        <div className="container px-4 md:px-12">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }}>
            ...
            <h2 className="text-4xl md:text-5xl font-bold text-charcoal max-w-4xl leading-tight">Stagnant growth in an evolving market</h2>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-24 md:py-32 bg-background">
        <div className="container px-4 md:px-12 max-w-5xl">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }}>
            ...
            <div className="text-base text-charcoal"><div className="font-semibold">— Sarah Johnson</div><div className="text-muted-foreground">Managing Partner, Client Company</div></div>
          </motion.div>
        </div>
      </section>
      ...
      <section id="solution" className="py-24 md:py-32 bg-background">
        <div className="container px-4 md:px-12">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }}>
            ...
            <h2 className="text-4xl md:text-5xl font-bold text-charcoal max-w-4xl leading-tight">Comprehensive growth transformation</h2>
          </motion.div>
        </div>
      </section>
        ...
        <div className="container px-4 md:px-12 max-w-4xl">
          <div className="space-y-8">
            ...
            <div>
              ...
              <div className="p-6 bg-charcoal/5 rounded-xl"><div className="text-3xl font-bold text-charcoal mb-2">2.5x</div><div className="text-sm text-charcoal/60">Average deal size increase</div></div>
            </div>
            <div>
              ...
              <div className="p-6 bg-charcoal/5 rounded-xl"><div className="text-3xl font-bold text-charcoal mb-2">+15pts</div><div className="text-sm text-charcoal/60">NPS improvement</div></div>
            </div>
          </div>
        </div>
      </section>
