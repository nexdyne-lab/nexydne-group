        ...
        <div className="container relative z-10 px-4 md:px-12">
          ...
          >
            ...
            <h1 className="text-5xl md:text-7xl font-serif font-bold tracking-tight leading-[1.05] mb-4">
              Shifting Mindsets to <span className="text-[#0077B5]">Drive Performance</span>
            </h1>
      ...
      <section className="py-16 bg-white text-[#051C2C]">
        <div className="container px-4 md:px-12 max-w-4xl">
          <div className="space-y-8">
            <div>
              <h3 className="text-xl font-serif font-bold text-[#051C2C] mb-4">Reactive Product Strategy</h3>
              <p className="text-[#051C2C]/70 leading-relaxed">
            ...
            <div>
              <h3 className="text-xl font-serif font-bold text-[#051C2C] mb-4">Conservative Financial Culture</h3>
              <p className="text-[#051C2C]/70 leading-relaxed">
            ...
            <div>
              <h3 className="text-xl font-serif font-bold text-[#051C2C] mb-4">Limited Revenue Diversification</h3>
              <p className="text-[#051C2C]/70 leading-relaxed">
            ...
            <div>
              <h3 className="text-xl font-serif font-bold text-[#051C2C] mb-4">Misaligned Incentives</h3>
              <p className="text-[#051C2C]/70 leading-relaxed">
        ...
        <div className="container px-4 md:px-12 max-w-4xl">
          <div className="space-y-8">
            <div>
              ...
              <div className="grid md:grid-cols-2 gap-4">
                <div className="p-6 bg-[#051C2C]/5 rounded-xl">
                  ...
                  <div className="text-sm text-[#051C2C]/60">New revenue streams funded</div>
                </div>
                <div className="p-6 bg-[#051C2C]/5 rounded-xl">
                  <div className="text-3xl font-serif font-bold text-[#051C2C] mb-2">$50M+</div>
                  <div className="text-sm text-[#051C2C]/60">Potential ARR from new products</div>
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="p-6 bg-[#051C2C]/5 rounded-xl">
                <div className="text-3xl font-serif font-bold text-[#051C2C] mb-2">18% → 42%</div>
                <div className="text-sm text-[#051C2C]/60">Year-over-year revenue growth acceleration</div>
              </div>
            </div>
