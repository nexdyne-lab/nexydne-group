...
import { ArrowRight, ArrowLeft, TrendingUp, Target, DollarSign, Users, FileText, CheckCircle2, Download } from 'lucide-react';
        ...
        <div className="container relative z-10 px-4 md:px-12">
          ...
          >
            ...
            <h1 className="text-5xl md:text-7xl font-serif font-bold tracking-tight leading-[1.05] mb-4">
              <span className="text-[#0077B5]">$45M</span> Series B at 3x valuation premium
            </h1>
          ...
          >
            ...
            <div className="grid md:grid-cols-3 gap-6 mt-12 p-8 bg-[#051C2C]/5 rounded-xl">
              <div>
                ...
                <div className="text-[#051C2C] font-medium">HealthTech / Digital Health</div>
              </div>
              <div>
                <div className="text-sm font-semibold text-[#0077B5] mb-2">Stage</div>
                <div className="text-[#051C2C] font-medium">Series B</div>
              </div>
              <div>
                <div className="text-sm font-semibold text-[#0077B5] mb-2">Annual Revenue</div>
                <div className="text-[#051C2C] font-medium">$8M ARR</div>
              </div>
            </div>
          </motion.div>
        </div>
      ...
      <section className="py-16 bg-white text-[#051C2C]">
        <div className="container px-4 md:px-12 max-w-4xl">
          <div className="space-y-8">
            <div>
              <h3 className="text-xl font-serif font-bold text-[#051C2C] mb-4">Crowded market with multiple well-funded competitors</h3>
              <p className="text-[#051C2C]/70 leading-relaxed">
            ...
            <div>
              <h3 className="text-xl font-serif font-bold text-[#051C2C] mb-4">Complex business model requiring clear articulation</h3>
              <p className="text-[#051C2C]/70 leading-relaxed">
            ...
            <div>
              <h3 className="text-xl font-serif font-bold text-[#051C2C] mb-4">Limited bandwidth for fundraising while running the business</h3>
              <p className="text-[#051C2C]/70 leading-relaxed">
        ...
        <div className="container px-4 md:px-12 max-w-4xl">
          ...
          <div className="space-y-12">
            ...
            <div className="flex gap-8">
              ...
              <div>
                <h3 className="text-xl font-serif font-bold text-[#051C2C] mb-4 flex items-center gap-3">
                  <FileText className="w-6 h-6 text-[#0077B5]" />
        ...
        <div className="container px-4 md:px-12 max-w-4xl">
          <div className="space-y-8">
            <div>
              ...
              <div className="grid md:grid-cols-2 gap-4">
                <div className="p-6 bg-[#051C2C]/5 rounded-xl">
                  <div className="text-3xl font-serif font-bold text-[#051C2C] mb-2">$45M</div>
                  <div className="text-sm text-[#051C2C]/60">Series B raised (vs. $25M target)</div>
                </div>
                <div className="p-6 bg-[#051C2C]/5 rounded-xl">
                  <div className="text-3xl font-serif font-bold text-[#051C2C] mb-2">12</div>
                  <div className="text-sm text-[#051C2C]/60">Term sheets received</div>
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="p-6 bg-[#051C2C]/5 rounded-xl">
                <div className="text-3xl font-serif font-bold text-[#051C2C] mb-2">8 weeks</div>
                <div className="text-sm text-[#051C2C]/60">From process launch to close</div>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="p-6 bg-[#051C2C]/5 rounded-xl">
                <div className="text-3xl font-serif font-bold text-[#051C2C] mb-2">3</div>
                <div className="text-sm text-[#051C2C]/60">Major partnerships facilitated by investor network</div>
              </div>
            </div>
          </div>
        </div>
