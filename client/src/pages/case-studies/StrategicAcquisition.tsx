    ...
    <div className="min-h-screen bg-base text-white selection:bg-primary selection:text-white">
      ...
      <section className="relative pt-32 pb-20 md:pt-40 md:pb-28 overflow-hidden">
        ...
        <div className="container relative z-10 px-4 md:px-12">
          ...
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }} className="max-w-4xl">
            <span className="text-xs font-bold uppercase tracking-[0.2em] text-primary mb-6 block">Case Study · Technology</span>
      ...
      <section className="py-16 bg-white text-charcoal">
        <div className="container px-4 md:px-12 max-w-4xl">
          <div className="space-y-8">
            <div>
              <h3 className="text-xl font-serif font-bold text-charcoal mb-4">Organic entry would take years</h3>
            ...
            <div>
              <h3 className="text-xl font-serif font-bold text-charcoal mb-4">Limited visibility into target landscape</h3>
            ...
            <div>
              <h3 className="text-xl font-serif font-bold text-charcoal mb-4">No M&A experience or infrastructure</h3>
        ...
        <div className="container px-4 md:px-12 max-w-4xl">
          ...
          <div className="space-y-12">
            <div className="flex gap-8">
              ...
              <div>
                <h3 className="text-xl font-serif font-bold text-charcoal mb-4 flex items-center gap-3"><Search className="w-6 h-6 text-primary" />Market mapping and target identification</h3>
                ...
                <ul className="space-y-2 text-charcoal/70">
                  <li className="flex items-start gap-2"><CheckCircle2 className="w-5 h-5 text-primary flex-shrink-0 mt-0.5" /><span>Screened 200+ companies in the insurance tech ecosystem</span></li>
                  <li className="flex items-start gap-2"><CheckCircle2 className="w-5 h-5 text-primary flex-shrink-0 mt-0.5" /><span>Developed detailed profiles on 25 priority targets</span></li>
                  <li className="flex items-start gap-2"><CheckCircle2 className="w-5 h-5 text-primary flex-shrink-0 mt-0.5" /><span>Assessed strategic fit, financial profile, and acquirability</span></li>
                </ul>
              </div>
            </div>
            <div className="flex gap-8">
              ...
              <div>
                <h3 className="text-xl font-serif font-bold text-charcoal mb-4 flex items-center gap-3"><Handshake className="w-6 h-6 text-primary" />Target outreach and relationship building</h3>
                ...
                <ul className="space-y-2 text-charcoal/70">
                  <li className="flex items-start gap-2"><CheckCircle2 className="w-5 h-5 text-primary flex-shrink-0 mt-0.5" /><span>Confidential outreach to 15 priority targets</span></li>
                  <li className="flex items-start gap-2"><CheckCircle2 className="w-5 h-5 text-primary flex-shrink-0 mt-0.5" /><span>Management meetings with 8 interested parties</span></li>
                  <li className="flex items-start gap-2"><CheckCircle2 className="w-5 h-5 text-primary flex-shrink-0 mt-0.5" /><span>Deep-dive sessions with 3 finalists</span></li>
                </ul>
              </div>
            </div>
            <div className="flex gap-8">
              ...
              <div>
                <h3 className="text-xl font-serif font-bold text-charcoal mb-4 flex items-center gap-3"><FileText className="w-6 h-6 text-primary" />Due diligence and transaction execution</h3>
                ...
                <ul className="space-y-2 text-charcoal/70">
                  <li className="flex items-start gap-2"><CheckCircle2 className="w-5 h-5 text-primary flex-shrink-0 mt-0.5" /><span>Commercial, financial, and technical due diligence</span></li>
                  <li className="flex items-start gap-2"><CheckCircle2 className="w-5 h-5 text-primary flex-shrink-0 mt-0.5" /><span>Valuation analysis and negotiation support</span></li>
                  <li className="flex items-start gap-2"><CheckCircle2 className="w-5 h-5 text-primary flex-shrink-0 mt-0.5" /><span>Integration planning and Day 1 readiness</span></li>
                </ul>
              </div>
            </div>
          </div>
      ...
      <section className="py-16 bg-white text-charcoal">
        <div className="container px-4 md:px-12 max-w-4xl">
          <div className="space-y-8">
            <div>
              <h3 className="text-xl font-serif font-bold text-charcoal mb-4 flex items-center gap-3"><Target className="w-6 h-6 text-primary" />Successful acquisition completed</h3>
              ...
              <div className="grid md:grid-cols-2 gap-4">
                <div className="p-6 bg-base/5 rounded-xl"><div className="text-3xl font-serif font-bold text-charcoal mb-2">$85M</div><div className="text-sm text-charcoal/60">Transaction value</div></div>
                <div className="p-6 bg-base/5 rounded-xl"><div className="text-3xl font-serif font-bold text-charcoal mb-2">$35M</div><div className="text-sm text-charcoal/60">Target ARR</div></div>
              </div>
            </div>
            <div>
              <h3 className="text-xl font-serif font-bold text-charcoal mb-4 flex items-center gap-3"><TrendingUp className="w-6 h-6 text-primary" />Accelerated market entry</h3>
              ...
              <div className="p-6 bg-base/5 rounded-xl"><div className="text-3xl font-serif font-bold text-charcoal mb-2">3 years</div><div className="text-sm text-charcoal/60">Market entry acceleration vs. organic build</div></div>
            </div>
            <div>
              <h3 className="text-xl font-serif font-bold text-charcoal mb-4 flex items-center gap-3"><TrendingUp className="w-6 h-6 text-primary" />Strong post-acquisition performance</h3>
              ...
              <div className="p-6 bg-base/5 rounded-xl"><div className="text-3xl font-serif font-bold text-charcoal mb-2">65%</div><div className="text-sm text-charcoal/60">Revenue growth in Year 1</div></div>
            </div>
          </div>
        </div>
      </section>
