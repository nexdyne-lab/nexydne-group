      ...
      <section className="py-20 bg-slate-50">
        <div className="container max-w-4xl">
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <h3 className="text-2xl font-bold text-slate-900 mb-4">Key Components</h3>
            <ul className="space-y-4 mb-8">
              <li className="flex gap-3">
                <Check className="w-6 h-6 text-blue-500 flex-shrink-0 mt-1" />
                <div>
                  <strong className="text-slate-900">Unified Data Platform.</strong> We integrated data from flight logs, sensor telemetry, and maintenance records into a single source of truth for every aircraft in the fleet.
                </div>
              </li>
              <li className="flex gap-3">
                <Check className="w-6 h-6 text-blue-500 flex-shrink-0 mt-1" />
                <div>
                  <strong className="text-slate-900">Fleet Digital Twin.</strong> A simulation model allowed planners to test "what-if" scenarios. For example, "What happens to fleet availability if we extend the interval for Check C by 50 flight hours?" or "How does stocking more spare engines at Hub A vs. Hub B affect downtime?"
                </div>
              </li>
              <li className="flex gap-3">
                <Check className="w-6 h-6 text-blue-500 flex-shrink-0 mt-1" />
                <div>
                  <strong className="text-slate-900">Predictive Parts Allocation.</strong> ML algorithms predicted the demand for specific spare parts at different hubs based on flight routes and aircraft age, ensuring parts were available when needed.
                </div>
              </li>
            </ul>
          </div>
        ...
        <div className="container max-w-4xl">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            <div className="text-center">
              ...
              <div className="text-slate-600">Reduction in maintenance costs</div>
            </div>
            <div className="text-center">
              <div className="text-5xl font-bold text-blue-600 mb-2">20%</div>
              <div className="text-slate-600">Increase in aircraft availability</div>
            </div>
            <div className="text-center">
              <div className="text-5xl font-bold text-blue-600 mb-2">30%</div>
              <div className="text-slate-600">Reduction in AOG (Aircraft on Ground) time</div>
            </div>
          </div>
