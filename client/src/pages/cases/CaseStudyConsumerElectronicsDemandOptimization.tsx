            ...
            >
              ...
              <div className="grid md:grid-cols-3 gap-8 mb-12">
                <div className="bg-[#051C2C]/5 p-6 rounded-lg">
                  <Store className="w-8 h-8 text-[#0077B5] mb-4" />
                  <h3 className="font-semibold mb-2">Industry</h3>
                  <p className="text-[#051C2C]/70 text-sm">Consumer Electronics & Furniture Retail</p>
                </div>
                <div className="bg-[#051C2C]/5 p-6 rounded-lg">
                  <MapPin className="w-8 h-8 text-[#0077B5] mb-4" />
                  <h3 className="font-semibold mb-2">Store Network</h3>
                  <p className="text-[#051C2C]/70 text-sm">120+ locations across 6 regions</p>
                </div>
                <div className="bg-[#051C2C]/5 p-6 rounded-lg">
                  <ShoppingCart className="w-8 h-8 text-[#0077B5] mb-4" />
                  <h3 className="font-semibold mb-2">SKU Count</h3>
                  <p className="text-[#051C2C]/70 text-sm">15,000+ active SKUs</p>
                </div>
              </div>
        ...
        <div className="container px-4 md:px-12">
          <div className="max-w-4xl mx-auto">
            ...
            >
              ...
              <div className="bg-[#051C2C]/5 p-8 rounded-xl mb-8">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  {[
                    ...
                    <div key={index} className="flex gap-4">
                      <div className="flex-shrink-0 w-2 h-2 bg-[#0077B5] rounded-full mt-2" />
                      <div>
                        <h4 className="font-semibold text-[#051C2C] mb-1">{insight.title}</h4>
                        <p className="text-[#051C2C]/70 text-sm">{insight.description}</p>
                      </div>
                    </div>
                  ))}
                </div>
              ...
              {[
                ...
                >
                  <Link href={caseStudy.link} className="group block">
                    <div className="bg-[#051C2C]/5 p-6 rounded-xl border border-transparent hover:border-[#0077B5]/30 transition-all h-full">
