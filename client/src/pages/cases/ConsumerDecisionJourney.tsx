        ...
        <div className="container mx-auto px-6 max-w-4xl">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-16">
            <div className="text-center p-6 bg-white/5 rounded-2xl border border-white/10">
              <div className="text-4xl font-bold text-[#00d4ff] mb-2">Sold Out</div>
              <div className="text-sm text-slate-400">Inventory in 2 Weeks</div>
            </div>
            <div className="text-center p-6 bg-white/5 rounded-2xl border border-white/10">
              <div className="text-4xl font-bold text-[#00d4ff] mb-2">3x</div>
              <div className="text-sm text-slate-400">ROAS vs. Previous Launch</div>
            </div>
            <div className="text-center p-6 bg-white/5 rounded-2xl border border-white/10">
              <div className="text-4xl font-bold text-[#00d4ff] mb-2">#1</div>
              <div className="text-sm text-slate-400">Category Market Share</div>
            </div>
          </div>
