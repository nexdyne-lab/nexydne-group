        ...
        <div className="container mx-auto px-6 max-w-4xl">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-16">
            <div className="text-center p-6 bg-white/5 rounded-2xl border border-white/10">
              ...
              <div className="text-sm text-slate-400">Increase in Profitability</div>
            </div>
            <div className="text-center p-6 bg-white/5 rounded-2xl border border-white/10">
              <div className="text-4xl font-bold text-[#00d4ff] mb-2">&lt;2%</div>
              <div className="text-sm text-slate-400">Customer Attrition Rate</div>
            </div>
            <div className="text-center p-6 bg-white/5 rounded-2xl border border-white/10">
              <div className="text-4xl font-bold text-[#00d4ff] mb-2">15%</div>
              <div className="text-sm text-slate-400">Increase in Primary Bank Status</div>
            </div>
          </div>
