          ...
          <div className="prose prose-lg max-w-none">
            ...
            <ul className="space-y-4 mb-8">
              <li className="flex gap-3">
                ...
                <div>
                  <strong className="text-slate-900">AI-Powered Visual Inspection.</strong> Computer vision models analyzed drone and satellite imagery to detect vegetation growth within right-of-way zones and identify damaged hardware with 98% accuracy.
                </div>
              </li>
              <li className="flex gap-3">
                <Check className="w-6 h-6 text-blue-500 flex-shrink-0 mt-1" />
                <div>
                  <strong className="text-slate-900">Real-time Anomaly Detection.</strong> Machine learning algorithms monitored electrical waveforms to detect "high impedance" faults—often precursors to fires—that traditional protection systems missed.
                </div>
              </li>
              <li className="flex gap-3">
                <Check className="w-6 h-6 text-blue-500 flex-shrink-0 mt-1" />
                <div>
                  <strong className="text-slate-900">Dynamic Risk Modeling.</strong> A digital twin of the grid simulated stress under various weather conditions, allowing operators to preemptively de-energize high-risk lines during storms while maintaining service elsewhere.
                </div>
              </li>
            </ul>
          </div>
        ...
        <div className="container max-w-4xl">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            <div className="text-center">
              ...
              <div className="text-slate-600">Ignition sources identified</div>
            </div>
            <div className="text-center">
              <div className="text-5xl font-bold text-blue-600 mb-2">40%</div>
              <div className="text-slate-600">Reduction in outage duration</div>
            </div>
            <div className="text-center">
              <div className="text-5xl font-bold text-blue-600 mb-2">$12M</div>
              <div className="text-slate-600">Annual maintenance savings</div>
            </div>
          </div>
