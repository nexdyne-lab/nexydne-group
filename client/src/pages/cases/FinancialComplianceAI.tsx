          ...
          <div className="prose prose-lg max-w-none">
            ...
            <ul className="space-y-4 mb-8">
              <li className="flex gap-3">
                ...
                <div>
                  <strong className="text-slate-900">Communication Surveillance.</strong> The model analyzed emails, chats, and voice transcripts to detect subtle indicators of collusion, market manipulation, or bribery, understanding context and slang that keyword filters missed.
                </div>
              </li>
              <li className="flex gap-3">
                <Check className="w-6 h-6 text-blue-500 flex-shrink-0 mt-1" />
                <div>
                  <strong className="text-slate-900">Regulatory Change Management.</strong> The system automatically ingested new regulatory documents from global bodies, summarized the changes, and flagged internal policies that needed updating.
                </div>
              </li>
              <li className="flex gap-3">
                <Check className="w-6 h-6 text-blue-500 flex-shrink-0 mt-1" />
                <div>
                  <strong className="text-slate-900">KYC/AML Automation.</strong> The AI reviewed customer onboarding documents and transaction histories, automatically clearing low-risk cases and preparing detailed investigation dossiers for high-risk ones.
                </div>
              </li>
            </ul>
          </div>
        ...
        <div className="container max-w-4xl">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            <div className="text-center">
              ...
              <div className="text-slate-600">Reduction in false positive alerts</div>
            </div>
            <div className="text-center">
              <div className="text-5xl font-bold text-blue-600 mb-2">40%</div>
              <div className="text-slate-600">Decrease in compliance costs</div>
            </div>
            <div className="text-center">
              <div className="text-5xl font-bold text-blue-600 mb-2">100%</div>
              <div className="text-slate-600">Coverage of employee communications</div>
            </div>
          </div>
