...
export default function FinancialFraudDetection() {
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="py-20 bg-slate-50">
        <div className="container max-w-4xl">
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <h3 className="text-2xl font-bold text-slate-900 mb-4">Architecture</h3>
            <ul className="space-y-3 mb-6">
              <li className="flex items-start gap-3">
                <Check className="w-6 h-6 text-indigo-600 flex-shrink-0 mt-1" />
                <span className="text-slate-700"><strong>Streaming ingestion:</strong> Apache Kafka consumed transaction events from payment gateway (Authorize.Net) at 50K messages/second. Separate topics for authorization requests, settlement confirmations, and chargeback notifications.</span>
              </li>
              <li className="flex items-start gap-3">
                <Check className="w-6 h-6 text-indigo-600 flex-shrink-0 mt-1" />
                <span className="text-slate-700"><strong>Feature engineering:</strong> Apache Flink streaming jobs calculated real-time features—transaction velocity (count in last hour), geographic anomalies (distance from previous transaction), merchant risk score, device fingerprint matches. Features stored in Redis for sub-10ms lookup.</span>
              </li>
              <li className="flex items-start gap-3">
                <Check className="w-6 h-6 text-indigo-600 flex-shrink-0 mt-1" />
                <span className="text-slate-700"><strong>ML scoring:</strong> Gradient boosting models (LightGBM) deployed as REST APIs on AWS Lambda. Models trained daily on labeled fraud data (confirmed fraud + legitimate transactions). Ensemble of 3 models voted on final fraud probability score.</span>
              </li>
              <li className="flex items-start gap-3">
                <Check className="w-6 h-6 text-indigo-600 flex-shrink-0 mt-1" />
                <span className="text-slate-700"><strong>Decision engine:</strong> Rules engine combined ML scores with business policies (transaction limits, merchant risk tiers, customer whitelist). Transactions scored above threshold declined automatically. Borderline cases routed to fraud analysts for manual review.</span>
              </li>
              <li className="flex items-start gap-3">
                <Check className="w-6 h-6 text-indigo-600 flex-shrink-0 mt-1" />
                <span className="text-slate-700"><strong>Data warehouse:</strong> Snowflake stored historical transactions, fraud labels, and model performance metrics. Analysts queried data to investigate fraud patterns and retrain models.</span>
              </li>
            </ul>

            <h3 className="text-2xl font-bold text-slate-900 mb-4">Implementation Approach</h3>
            <p className="text-lg text-slate-700 mb-4">
        ...
        <div className="container max-w-4xl">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            <div className="text-center">
              ...
              <div className="text-slate-700">Reduction in fraud losses</div>
            </div>
            <div className="text-center">
              <div className="text-5xl font-bold text-indigo-600 mb-2">65%</div>
              <div className="text-slate-700">Decrease in false positives</div>
            </div>
            <div className="text-center">
              <div className="text-5xl font-bold text-indigo-600 mb-2">&lt;100ms</div>
              <div className="text-slate-700">Fraud scoring latency</div>
            </div>
          </div>
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <ul className="space-y-3">
              <li className="flex items-start gap-3">
                <Check className="w-6 h-6 text-indigo-600 flex-shrink-0 mt-1" />
                <span className="text-slate-700"><strong>Financial savings:</strong> Blocked $12M in fraudulent transactions annually. Chargeback rates decreased from 0.8% to 0.2%, saving $3.2M in chargeback fees and operational costs.</span>
              </li>
              <li className="flex items-start gap-3">
                <Check className="w-6 h-6 text-indigo-600 flex-shrink-0 mt-1" />
                <span className="text-slate-700"><strong>Customer experience:</strong> False positive reduction improved authorization rates 4.2%. Legitimate customers no longer had cards declined incorrectly, reducing customer service complaints 45%.</span>
              </li>
              <li className="flex items-start gap-3">
                <Check className="w-6 h-6 text-indigo-600 flex-shrink-0 mt-1" />
                <span className="text-slate-700"><strong>Operational efficiency:</strong> Automated fraud detection reduced manual review workload 70%. Fraud analysts focused on sophisticated fraud rings instead of investigating false alerts.</span>
              </li>
              <li className="flex items-start gap-3">
                <Check className="w-6 h-6 text-indigo-600 flex-shrink-0 mt-1" />
                <span className="text-slate-700"><strong>Merchant retention:</strong> Lower fraud rates and fewer false declines improved merchant satisfaction scores 38%. Merchant churn decreased 22%.</span>
              </li>
            </ul>
          </div>
        </div>
      ...
      <section className="py-20 bg-slate-50">
        <div className="container max-w-4xl">
          <h2 className="text-4xl font-bold text-slate-900 mb-8">Technology Stack</h2>
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-white p-6 rounded-lg border border-slate-200">
              <h3 className="text-xl font-bold text-slate-900 mb-3">Streaming Platform</h3>
            ...
            <div className="bg-white p-6 rounded-lg border border-slate-200">
              <h3 className="text-xl font-bold text-slate-900 mb-3">ML & Scoring</h3>
              <ul className="space-y-2 text-slate-700">
            ...
            <div className="bg-white p-6 rounded-lg border border-slate-200">
              <h3 className="text-xl font-bold text-slate-900 mb-3">Monitoring & Ops</h3>
              <ul className="space-y-2 text-slate-700">
      ...
      <section className="py-20 bg-gradient-to-br from-slate-900 to-indigo-900 text-white">
        <div className="container max-w-4xl text-center">
          ...
          <div className="flex flex-wrap gap-4 justify-center">
            ...
            <button className="px-8 py-3 border-2 border-white text-white rounded-full hover:bg-white hover:text-slate-900 transition-colors font-semibold">
              View all cases
            </button>
          </div>
        </div>
