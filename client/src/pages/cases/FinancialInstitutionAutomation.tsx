...
export function FinancialInstitutionAutomation() {
  return (
    <IndustryCaseStudyTemplate
      ...
      seoDescription="A regional bank took 5–7 days to process loans with 15% error rates. Intelligent document processing automated 90% of workflows, cut decisions to under 4 hours, and freed 200+ FTEs for higher-value work."
      ...
      subtitle="Intelligent document processing and workflow automation transformed lending operations — cutting standard decisions from 5–7 days to under 4 hours at 99.2% extraction accuracy, and redeploying 200+ document-processing FTEs to higher-value work."
      ...
      metrics={[
        ...
        { value: "200+", label: "FTEs Redeployed" }
      ]}
      clientContextTitle="Days to Decide a Loan"
      clientContextIntro="A regional bank was struggling with manual loan processing that averaged 5–7 business days. Across 50,000+ annual applications spanning consumer, commercial, and mortgage products, manual review consumed enormous resources and left the bank behind digital-first lenders offering same-day decisions."
      ...
      clientProfile={{
        ...
        companySize: "Consumer, Commercial & Mortgage",
      ...
      results={[
        ...
        },
        {
          icon: DollarSign,
          value: "200+",
          label: "FTEs redeployed",
          detail: "From document processing to higher-value work"
        }
      ]}
