      ...
      <section className="py-24 md:py-32 bg-subtle text-charcoal">
        <div className="container px-4 md:px-12">
          ...
          <div className="grid md:grid-cols-2 gap-12 max-w-5xl mx-auto">
            ...
            >
              <h3 className="text-xl font-bold mb-6">Scale & Performance</h3>
              <ul className="space-y-4">
                {[
            ...
            <motion.div
              ...
              className="bg-white p-8 rounded-xl shadow-sm"
            >
              <h3 className="text-xl font-bold mb-6">Development Velocity</h3>
              <ul className="space-y-4">
                {[
      ...
      <section className="py-24 md:py-32 bg-base">
        <div className="container px-4 md:px-12">
          ...
          >
            ...
            <div>
              <p className="text-white font-bold text-lg">Marcus Johnson</p>
