    ...
    <div className="min-h-screen bg-[#051C2C] font-sans text-white selection:bg-[#0077B5] selection:text-white">
      ...
      <section className="relative min-h-[70vh] flex items-center pt-20 overflow-hidden">
        <div className="absolute inset-0 z-0">
          <div className="absolute inset-0 bg-gradient-to-br from-[#00A3E0] to-[#0077B5] opacity-20" />
        ...
        <div className="container px-4 md:px-12">
          <div className="grid md:grid-cols-4 gap-8 max-w-5xl mx-auto">
            {[
              ...
              >
                <div className="w-12 h-12 bg-[#0077B5]/10 rounded-full flex items-center justify-center mx-auto mb-4 text-[#0077B5]">
                  {metric.icon}
                </div>
                <div className="text-4xl font-serif font-bold text-[#0077B5] mb-2">{metric.value}</div>
                <div className="text-sm text-[#051C2C]/60">{metric.label}</div>
              </motion.div>
            ))}
          </div>
        </div>
                ...
                <ul className="space-y-4">
                  {[
                    ...
                    <li key={i} className="flex items-start">
                      <div className="w-2 h-2 bg-[#0077B5] rounded-full mt-2 mr-3 flex-shrink-0" />
                      <span className="text-[#051C2C]/70">{challenge}</span>
                    </li>
                  ))}
                </ul>
              </div>
        ...
        <div className="container px-4 md:px-12">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {[
              ...
              >
                <div className="w-12 h-12 bg-[#0077B5]/20 rounded-lg flex items-center justify-center mb-6 text-[#0077B5]">
                  {item.icon}
                </div>
            ...
            {[
              ...
              >
                <div className="flex-shrink-0 w-24">
                  <span className="text-sm font-bold text-[#0077B5]">{item.phase}</span>
                </div>
                <div className="flex-grow pb-12 border-l-2 border-[#0077B5]/20 pl-8 relative">
                  <div className="absolute -left-[9px] top-0 w-4 h-4 bg-[#0077B5] rounded-full" />
            ...
            >
              ...
              <ul className="space-y-4">
                {[
                  ...
                  <li key={i} className="flex items-start">
                    <CheckCircle2 className="w-5 h-5 text-[#0077B5] mr-3 flex-shrink-0 mt-0.5" />
                    <span className="text-[#051C2C]/70">{result}</span>
                  </li>
                ))}
              </ul>
            </motion.div>
            ...
            {[
              ...
              >
                <Link href={caseStudy.link}>
                  <div className="bg-[#F8F9FA] rounded-xl overflow-hidden hover:shadow-lg transition-all duration-300 cursor-pointer group">
                    ...
                    <div className="p-6">
                      ...
                      <h3 className="text-xl font-serif font-bold group-hover:text-[#0077B5] transition-colors">
                        {caseStudy.title}
                      </h3>
                    </div>
                  </div>
