      ...
      <div className="bg-white border-b border-slate-200">
        <div className="container py-4">
          <div className="flex items-center gap-2 text-sm text-slate-600">
            ...
            <span>/</span>
            <span className="text-slate-900 font-medium">Credit Union Launches Mobile Banking App</span>
          </div>
        </div>
      </div>
        ...
        <div className="container max-w-4xl">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            <div className="text-center">
              ...
              <div className="text-slate-700 font-medium">Member adoption rate</div>
            </div>
            <div className="text-center">
            ...
            <div className="text-center">
              ...
              <div className="text-slate-700 font-medium">Reduction in branch visits</div>
            </div>
          </div>
