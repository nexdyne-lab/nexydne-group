          ...
          <div className="max-w-3xl mx-auto">
            ...
            >
              ...
              <blockquote className="border-l-4 border-[#C41230] pl-8 my-12">
                ...
                <cite className="text-sm text-[#1A1A1A]/60 not-italic">— Chief Digital Officer</cite>
              </blockquote>
            ...
            >
              ...
              <div className="mb-16">
                <div className="flex items-center gap-4 mb-4">
                  ...
                  <span className="text-sm text-[#1A1A1A]/40">Weeks 1-4</span>
                </div>
                <h3 className="text-2xl font-bold text-[#1A1A1A] mb-6 font-serif">Data Foundation & Customer Intelligence</h3>
                <p className="text-lg text-[#1A1A1A]/80 leading-relaxed">
              ...
              <div className="mb-16">
                <div className="flex items-center gap-4 mb-4">
                  ...
                  <span className="text-sm text-[#1A1A1A]/40">Weeks 5-10</span>
                </div>
                <h3 className="text-2xl font-bold text-[#1A1A1A] mb-6 font-serif">AI Personalization Engine</h3>
                <p className="text-lg text-[#1A1A1A]/80 leading-relaxed">
              ...
              <div className="mb-8">
                <div className="flex items-center gap-4 mb-4">
                  ...
                  <span className="text-sm text-[#1A1A1A]/40">Weeks 11-16</span>
                </div>
                <h3 className="text-2xl font-bold text-[#1A1A1A] mb-6 font-serif">Omnichannel Activation</h3>
                <p className="text-lg text-[#1A1A1A]/80 leading-relaxed">
            ...
            >
              ...
              <div className="grid md:grid-cols-2 gap-x-12 gap-y-10 mb-12">
                <div className="border-l-2 border-[#00BCD4] pl-6">
                  <div className="text-4xl font-bold text-[#00BCD4] mb-3">65%</div>
                ...
                <div className="border-l-2 border-[#00BCD4] pl-6">
                  <div className="text-4xl font-bold text-[#00BCD4] mb-3">52%</div>
                  <p className="text-white/70 leading-relaxed">
                ...
                <div className="border-l-2 border-[#00BCD4] pl-6">
                  <div className="text-4xl font-bold text-[#00BCD4] mb-3">$180M</div>
                  <p className="text-white/70 leading-relaxed">
                ...
                <div className="border-l-2 border-[#00BCD4] pl-6">
                  <div className="text-4xl font-bold text-[#00BCD4] mb-3">4.2x</div>
                  <p className="text-white/70 leading-relaxed">
        ...
        <div className="container px-4 md:px-8 lg:px-12">
          <div className="max-w-3xl mx-auto text-center">
            ...
            >
              ...
              <div>
                <div className="font-semibold text-[#1A1A1A] text-lg">Sarah Chen</div>
                <div className="text-[#1A1A1A]/60">Chief Digital Officer</div>
              </div>
            </motion.div>
          </div>
        </div>
