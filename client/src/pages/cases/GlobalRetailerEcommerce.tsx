          ...
          <div className="max-w-3xl mx-auto">
            ...
            >
              ...
              <div className="mb-16">
                ...
                <h3 className="text-2xl font-bold text-charcoal mb-6 ">Data Foundation & Customer Intelligence</h3>
                <p className="text-lg text-charcoal/80 leading-relaxed">
              ...
              <div className="mb-16">
                ...
                <h3 className="text-2xl font-bold text-charcoal mb-6 ">AI Personalization Engine</h3>
                <p className="text-lg text-charcoal/80 leading-relaxed">
              ...
              <div className="mb-8">
                ...
                <h3 className="text-2xl font-bold text-charcoal mb-6 ">Omnichannel Activation</h3>
                <p className="text-lg text-charcoal/80 leading-relaxed">
