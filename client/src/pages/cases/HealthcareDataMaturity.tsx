...
export default function HealthcareDataMaturity() {
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="py-20 bg-slate-50">
        <div className="container max-w-4xl">
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <h3 className="text-2xl font-bold text-charcoal mb-4">Maturity Assessment Framework</h3>
            <ul className="space-y-3 mb-6">
              <li className="flex items-start gap-3">
                <Check className="w-6 h-6 text-teal-600 flex-shrink-0 mt-1" />
                <span className="text-charcoal/80"><strong>Data platform maturity.</strong> Current: No centralized platform, data scattered across operational systems. Target: Unified data warehouse with governed data models, self-service query access.</span>
              </li>
              <li className="flex items-start gap-3">
                <Check className="w-6 h-6 text-teal-600 flex-shrink-0 mt-1" />
                <span className="text-charcoal/80"><strong>Analytics capabilities.</strong> Current: Manual Excel-based reporting, no predictive analytics. Target: Self-service BI dashboards, ML models for readmission prediction and resource forecasting.</span>
              </li>
              <li className="flex items-start gap-3">
                <Check className="w-6 h-6 text-teal-600 flex-shrink-0 mt-1" />
                <span className="text-charcoal/80"><strong>Data governance.</strong> Current: No governance, inconsistent definitions, no data quality monitoring. Target: Data stewardship program, certified data sets, automated quality checks.</span>
              </li>
              <li className="flex items-start gap-3">
                <Check className="w-6 h-6 text-teal-600 flex-shrink-0 mt-1" />
                <span className="text-charcoal/80"><strong>Organizational culture.</strong> Current: IT-dependent reporting, analysts spend 80% time on data extraction. Target: Self-service culture, business users answer own questions, analysts focus on advanced analytics.</span>
              </li>
            </ul>

            <h3 className="text-2xl font-bold text-charcoal mb-4">18-Month Roadmap</h3>
            <p className="text-lg text-charcoal/80 mb-4">
        ...
        <div className="container max-w-4xl">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            <div className="text-center">
              ...
              <div className="text-charcoal/80">Data maturity achieved (from Level 1)</div>
            </div>
            <div className="text-center">
              <div className="text-5xl font-bold text-teal-600 mb-2">75%</div>
              <div className="text-charcoal/80">Reduction in IT reporting requests</div>
            </div>
            <div className="text-center">
              <div className="text-5xl font-bold text-teal-600 mb-2">18 months</div>
              <div className="text-charcoal/80">From ad-hoc to self-service analytics</div>
            </div>
          </div>
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <ul className="space-y-3">
              <li className="flex items-start gap-3">
                <Check className="w-6 h-6 text-teal-600 flex-shrink-0 mt-1" />
                <span className="text-charcoal/80"><strong>Clinical outcomes:</strong> Readmission prediction model identified 1,200 high-risk patients annually. Care coordination interventions reduced 30-day readmissions 18%, saving $2.8M in penalties and improving patient outcomes.</span>
              </li>
              <li className="flex items-start gap-3">
                <Check className="w-6 h-6 text-teal-600 flex-shrink-0 mt-1" />
                <span className="text-charcoal/80"><strong>Operational efficiency:</strong> Self-service analytics reduced IT reporting workload 75%. 6 FTEs reallocated from manual reporting to advanced analytics projects. Quality reporting time decreased from 3 weeks to 2 hours.</span>
              </li>
              <li className="flex items-start gap-3">
                <Check className="w-6 h-6 text-teal-600 flex-shrink-0 mt-1" />
                <span className="text-charcoal/80"><strong>Data governance:</strong> Standardized metric definitions eliminated inconsistencies. "Readmission rate" calculated identically across all departments. Data stewardship program ensured data quality—error rates decreased 65%.</span>
              </li>
              <li className="flex items-start gap-3">
                <Check className="w-6 h-6 text-teal-600 flex-shrink-0 mt-1" />
                <span className="text-charcoal/80"><strong>Cultural transformation:</strong> Shifted from IT-dependent reporting to self-service analytics culture. 50 certified business users answer their own questions. Analysts focus on predictive models instead of Excel reports.</span>
              </li>
            </ul>
          </div>
        </div>
      ...
      <section className="py-20 bg-slate-50">
        <div className="container max-w-4xl">
          <h2 className="text-4xl font-bold text-charcoal mb-8">Data Maturity Framework</h2>
          <div className="space-y-4">
            <div className="bg-red-50 border-l-4 border-red-500 p-6 rounded-lg">
              <h3 className="text-xl font-bold text-charcoal mb-2">Level 1: Ad-hoc (Starting Point)</h3>
              <p className="text-charcoal/80">Manual reporting, no centralized platform, inconsistent definitions, IT-dependent analytics.</p>
            </div>

            <div className="bg-blue-50 border-l-4 border-blue-500 p-6 rounded-lg">
              <h3 className="text-xl font-bold text-charcoal mb-2">Level 2: Repeatable</h3>
              <p className="text-charcoal/80">Standardized reports, basic data warehouse, some governance, still IT-dependent for custom analysis.</p>
            </div>

            <div className="bg-secondary/10 border-l-4 border-green-500 p-6 rounded-lg">
              <h3 className="text-xl font-bold text-charcoal mb-2">Level 3: Defined (Target Achieved)</h3>
              <p className="text-charcoal/80">Self-service analytics, certified data sets, predictive models, business users answer own questions.</p>
            </div>

            <div className="bg-blue-50 border-l-4 border-blue-500 p-6 rounded-lg">
              <h3 className="text-xl font-bold text-charcoal mb-2">Level 4: Managed</h3>
              <p className="text-charcoal/80">Real-time analytics, embedded ML in workflows, proactive insights, continuous improvement culture.</p>
            </div>

            <div className="bg-purple-50 border-l-4 border-purple-500 p-6 rounded-lg">
              <h3 className="text-xl font-bold text-charcoal mb-2">Level 5: Optimized</h3>
              <p className="text-charcoal/80">AI-driven decision automation, data monetization, industry-leading capabilities, competitive advantage.</p>
            </div>
          </div>
        </div>
      </section>
