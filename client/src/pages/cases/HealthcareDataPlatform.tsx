        ...
        <div className="container mx-auto px-6 relative z-20">
          ...
          <div className="max-w-4xl">
            <div className="inline-flex items-center space-x-2 bg-[#00d4ff]/10 backdrop-blur-md border border-[#00d4ff]/20 rounded-full px-4 py-1.5 mb-6">
              <span className="text-sm font-medium text-[#00d4ff] tracking-widest uppercase">Healthcare Case Study</span>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-4">
                <li className="flex items-start">
                  ...
                  <span className="text-slate-300">Incomplete patient history at the point of care.</span>
                </li>
                <li className="flex items-start">
                  <div className="w-6 h-6 rounded-full bg-red-500/10 flex items-center justify-center mt-1 mr-4">
                    <span className="w-2 h-2 rounded-full bg-red-500" />
                  </div>
                  <span className="text-slate-300">High administrative burden for data reconciliation.</span>
                </li>
                <li className="flex items-start">
                  <div className="w-6 h-6 rounded-full bg-red-500/10 flex items-center justify-center mt-1 mr-4">
                    <span className="w-2 h-2 rounded-full bg-red-500" />
                  </div>
                  <span className="text-slate-300">Inability to perform population health analytics.</span>
                </li>
              </ul>
            </div>
              ...
              <div className="space-y-6">
                <div className="bg-white/5 border border-white/10 p-6 rounded-xl">
                  <div className="flex items-center mb-4">
                    <Database className="w-6 h-6 text-[#00d4ff] mr-3" />
                ...
                <div className="bg-white/5 border border-white/10 p-6 rounded-xl">
                  <div className="flex items-center mb-4">
                    <Shield className="w-6 h-6 text-[#00d4ff] mr-3" />
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center p-8">
              <div className="text-5xl font-bold text-[#00d4ff] mb-4">15+</div>
              <div className="text-white font-medium text-lg mb-2">Systems Integrated</div>
              <p className="text-slate-400 text-sm">Legacy EMRs, labs, and billing systems.</p>
            </div>
            <div className="text-center p-8 border-x border-white/5">
              <div className="text-5xl font-bold text-[#00d4ff] mb-4">360°</div>
              <div className="text-white font-medium text-lg mb-2">Patient View</div>
              <p className="text-slate-400 text-sm">Complete history available in &lt; 1 second.</p>
            </div>
            <div className="text-center p-8">
              <div className="text-5xl font-bold text-[#00d4ff] mb-4">20%</div>
              <div className="text-white font-medium text-lg mb-2">Readmission Drop</div>
              <p className="text-slate-400 text-sm">Due to better predictive risk modeling.</p>
            </div>
          </div>
        </div>
      </section>
