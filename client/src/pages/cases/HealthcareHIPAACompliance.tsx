      ...
      <nav className="bg-slate-50 py-4">
        <div className="container">
          <div className="flex items-center gap-2 text-sm text-slate-600">
            ...
            <span>/</span>
            <span className="text-slate-900">Hospital Achieves HIPAA Compliance with Automated Audit Trails</span>
          </div>
        </div>
      </nav>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-white p-6 rounded-lg border border-slate-200">
              ...
              <ul className="space-y-2">
                <li className="flex items-start gap-2">
                  ...
                  <span className="text-slate-700">Immuta for policy enforcement and audit logging</span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="w-5 h-5 text-green-600 flex-shrink-0 mt-0.5" />
                  <span className="text-slate-700">Active Directory integration for identity sync</span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="w-5 h-5 text-green-600 flex-shrink-0 mt-0.5" />
                  <span className="text-slate-700">Role-based + attribute-based access controls</span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="w-5 h-5 text-green-600 flex-shrink-0 mt-0.5" />
                  <span className="text-slate-700">Real-time anomaly detection and alerting</span>
                </li>
              </ul>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg border border-slate-200">
              ...
              <ul className="space-y-2">
                <li className="flex items-start gap-2">
                  <CheckCircle className="w-5 h-5 text-green-600 flex-shrink-0 mt-0.5" />
                  <span className="text-slate-700">Epic EHR system via FHIR API</span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="w-5 h-5 text-green-600 flex-shrink-0 mt-0.5" />
                  <span className="text-slate-700">Splunk SIEM for security event correlation</span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="w-5 h-5 text-green-600 flex-shrink-0 mt-0.5" />
                  <span className="text-slate-700">Workday HR for employee lifecycle sync</span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="w-5 h-5 text-green-600 flex-shrink-0 mt-0.5" />
                  <span className="text-slate-700">Tableau dashboard for compliance reporting</span>
                </li>
              </ul>
            </div>
          </div>
        ...
        <div className="container max-w-4xl">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="bg-blue-50 p-6 rounded-lg border-l-4 border-blue-600">
              ...
              <div className="text-slate-700">Breach Investigation Time (down from 3 weeks)</div>
            </div>
            <div className="bg-green-50 p-6 rounded-lg border-l-4 border-green-600">
              <div className="text-3xl font-bold text-green-900 mb-2">Zero</div>
              <div className="text-slate-700">OCR Audit Findings</div>
            </div>
            <div className="bg-purple-50 p-6 rounded-lg border-l-4 border-purple-600">
              <div className="text-3xl font-bold text-purple-900 mb-2">14</div>
              <div className="text-slate-700">Policy Violations Caught & Resolved</div>
            </div>
          </div>
        </div>
      </section>
