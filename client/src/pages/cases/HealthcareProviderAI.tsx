            ...
            >
              ...
              <div className="mb-16">
                <div className="flex items-center gap-4 mb-4">
                  ...
                  <span className="text-sm text-[#1A1A1A]/40">Weeks 1-8</span>
                </div>
                <h3 className="text-2xl font-bold text-[#1A1A1A] mb-6 font-serif">Predictive Demand Modeling</h3>
                <p className="text-lg text-[#1A1A1A]/80 leading-relaxed">
              ...
              <div className="mb-16">
                <div className="flex items-center gap-4 mb-4">
                  ...
                  <span className="text-sm text-[#1A1A1A]/40">Weeks 9-16</span>
                </div>
                <h3 className="text-2xl font-bold text-[#1A1A1A] mb-6 font-serif">Intelligent Scheduling System</h3>
                <p className="text-lg text-[#1A1A1A]/80 leading-relaxed">
              ...
              <div className="mb-8">
                <div className="flex items-center gap-4 mb-4">
                  ...
                  <span className="text-sm text-[#1A1A1A]/40">Weeks 17-24</span>
                </div>
                <h3 className="text-2xl font-bold text-[#1A1A1A] mb-6 font-serif">Real-Time Flow Optimization</h3>
                <p className="text-lg text-[#1A1A1A]/80 leading-relaxed">
            ...
            >
              ...
              <div className="grid md:grid-cols-2 gap-x-12 gap-y-10 mb-12">
                <div className="border-l-2 border-[#00BCD4] pl-6">
                  <div className="text-4xl font-bold text-[#00BCD4] mb-3">35%</div>
                ...
                <div className="border-l-2 border-[#00BCD4] pl-6">
                  <div className="text-4xl font-bold text-[#00BCD4] mb-3">28%</div>
                  <p className="text-white/70 leading-relaxed">
                ...
                <div className="border-l-2 border-[#00BCD4] pl-6">
                  <div className="text-4xl font-bold text-[#00BCD4] mb-3">92%</div>
                  <p className="text-white/70 leading-relaxed">
                ...
                <div className="border-l-2 border-[#00BCD4] pl-6">
                  <div className="text-4xl font-bold text-[#00BCD4] mb-3">$24M</div>
                  <p className="text-white/70 leading-relaxed">
        ...
        <div className="container px-4 md:px-8 lg:px-12">
          <div className="max-w-3xl mx-auto text-center">
            ...
            >
              ...
              <div>
                <div className="font-semibold text-[#1A1A1A] text-lg">Dr. Jennifer Walsh</div>
                <div className="text-[#1A1A1A]/60">Chief Medical Officer</div>
              </div>
            </motion.div>
          </div>
        </div>
