...
export default function InsuranceAnalyticsBacklog() {
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="py-20 bg-slate-50">
        <div className="container max-w-4xl">
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <h3 className="text-2xl font-bold text-charcoal mb-4">Prioritization Framework</h3>
            <ul className="space-y-3 mb-6">
              <li className="flex items-start gap-3">
                <Check className="w-6 h-6 text-indigo-600 flex-shrink-0 mt-1" />
                <span className="text-charcoal/80"><strong>Business value scoring.</strong> Evaluated each project on financial impact (revenue increase, cost reduction, loss prevention), strategic alignment (regulatory compliance, competitive differentiation), and stakeholder demand (number of users, executive sponsorship). Scored 1-10 on each dimension.</span>
              </li>
              <li className="flex items-start gap-3">
                <Check className="w-6 h-6 text-indigo-600 flex-shrink-0 mt-1" />
                <span className="text-charcoal/80"><strong>Implementation complexity assessment.</strong> Scored each project on data readiness (quality, completeness, accessibility), technical difficulty (ML model complexity, integration requirements), and organizational change (process changes, training needs). Scored 1-10 on each dimension.</span>
              </li>
              <li className="flex items-start gap-3">
                <Check className="w-6 h-6 text-indigo-600 flex-shrink-0 mt-1" />
                <span className="text-charcoal/80"><strong>Value/complexity matrix.</strong> Plotted all 47 projects on 2x2 matrix. High-value, low-complexity projects (quick wins) executed first. High-value, high-complexity projects (strategic bets) sequenced based on dependencies. Low-value projects killed regardless of complexity.</span>
              </li>
              <li className="flex items-start gap-3">
                <Check className="w-6 h-6 text-indigo-600 flex-shrink-0 mt-1" />
                <span className="text-charcoal/80"><strong>Capacity planning.</strong> Calculated team capacity (8 FTEs = 14,400 hours/year after meetings, training, support). Estimated effort for each project. Sequenced projects to match capacity, avoiding overcommitment that caused previous delays.</span>
              </li>
            </ul>

            <h3 className="text-2xl font-bold text-charcoal mb-4">Key Findings</h3>
            <p className="text-lg text-charcoal/80 mb-4">
        ...
        <div className="container max-w-4xl">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            <div className="text-center">
              ...
              <div className="text-charcoal/80">Projected value from 8 prioritized projects</div>
            </div>
            <div className="text-center">
              <div className="text-5xl font-bold text-indigo-600 mb-2">49%</div>
              <div className="text-charcoal/80">Backlog reduction (23 projects killed)</div>
            </div>
            <div className="text-center">
              <div className="text-5xl font-bold text-indigo-600 mb-2">6 weeks</div>
              <div className="text-charcoal/80">From backlog chaos to executable roadmap</div>
            </div>
          </div>
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <ul className="space-y-3">
              <li className="flex items-start gap-3">
                <Check className="w-6 h-6 text-indigo-600 flex-shrink-0 mt-1" />
                <span className="text-charcoal/80"><strong>Financial clarity:</strong> Quantified value of each project—$13.3M projected impact from 8 prioritized initiatives vs. unknown ROI from previous ad-hoc approach. Executive team approved $2.5M analytics investment based on clear business case.</span>
              </li>
              <li className="flex items-start gap-3">
                <Check className="w-6 h-6 text-indigo-600 flex-shrink-0 mt-1" />
                <span className="text-charcoal/80"><strong>Resource optimization:</strong> Eliminated 23 low-value projects that would have consumed 8,000 hours. Reallocated effort to high-impact initiatives. Team focused on 8 projects instead of context-switching across 47.</span>
              </li>
              <li className="flex items-start gap-3">
                <Check className="w-6 h-6 text-indigo-600 flex-shrink-0 mt-1" />
                <span className="text-charcoal/80"><strong>Stakeholder alignment:</strong> Transparent prioritization framework ended political battles over project sequencing. Business units accepted decisions because criteria were objective. Reduced escalations to executive team 80%.</span>
              </li>
              <li className="flex items-start gap-3">
                <Check className="w-6 h-6 text-indigo-600 flex-shrink-0 mt-1" />
                <span className="text-charcoal/80"><strong>Delivery predictability:</strong> Capacity-based roadmap set realistic expectations. Average project delivery time decreased from 9 months to 5 months because scope was defined upfront and team wasn't overcommitted.</span>
              </li>
            </ul>
          </div>
        </div>
      ...
      <section className="py-20 bg-slate-50">
        <div className="container max-w-4xl">
          <h2 className="text-4xl font-bold text-charcoal mb-8">Prioritization Matrix</h2>
          <div className="bg-white p-8 rounded-lg border border-slate-200">
            <div className="grid grid-cols-2 gap-6">
              <div className="border-2 border-green-500 p-6 rounded-lg bg-secondary/10">
                <h3 className="text-xl font-bold text-charcoal mb-3">Quick Wins (Execute First)</h3>
                <p className="text-sm text-muted-foreground mb-4">High value, low complexity</p>
              ...
              <div className="border-2 border-yellow-500 p-6 rounded-lg bg-yellow-50">
                <h3 className="text-xl font-bold text-charcoal mb-3">Strategic Bets (Sequence Carefully)</h3>
                <p className="text-sm text-muted-foreground mb-4">High value, high complexity</p>
                <ul className="space-y-2 text-charcoal/80 text-sm">
              ...
              <div className="border-2 border-slate-300 p-6 rounded-lg bg-slate-50">
                <h3 className="text-xl font-bold text-charcoal mb-3">Fill-Ins (Execute When Capacity Allows)</h3>
                <p className="text-sm text-muted-foreground mb-4">Low value, low complexity</p>
                <ul className="space-y-2 text-charcoal/80 text-sm">
              ...
              <div className="border-2 border-red-500 p-6 rounded-lg bg-red-50">
                <h3 className="text-xl font-bold text-charcoal mb-3">Kill (Eliminate Immediately)</h3>
                <p className="text-sm text-muted-foreground mb-4">Low value, any complexity</p>
                <ul className="space-y-2 text-charcoal/80 text-sm">
