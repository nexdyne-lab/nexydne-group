          ...
          <div className="prose prose-lg max-w-none">
            ...
            <ul className="space-y-4 mb-8">
              <li className="flex gap-3">
                ...
                <div>
                  <strong className="text-slate-900">Hyper-Local Risk Scoring.</strong> We combined satellite elevation data, soil permeability maps, and climate projections to assess flood and fire risk at the individual property level, not just by zip code.
                </div>
              </li>
              <li className="flex gap-3">
                <Check className="w-6 h-6 text-blue-500 flex-shrink-0 mt-1" />
                <div>
                  <strong className="text-slate-900">Portfolio Stress Testing.</strong> The platform simulated thousands of climate scenarios (e.g., "1-in-100 year storm becomes 1-in-20 year storm") to identify concentration risks and capital requirements.
                </div>
              </li>
              <li className="flex gap-3">
                <Check className="w-6 h-6 text-blue-500 flex-shrink-0 mt-1" />
                <div>
                  <strong className="text-slate-900">Dynamic Pricing Models.</strong> Underwriters received real-time risk adjustments for new policies, allowing them to price coverage accurately based on current and future climate exposure.
                </div>
              </li>
            </ul>
          </div>
        ...
        <div className="container max-w-4xl">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            <div className="text-center">
              ...
              <div className="text-slate-600">Improvement in loss ratio</div>
            </div>
            <div className="text-center">
              <div className="text-5xl font-bold text-blue-600 mb-2">20%</div>
              <div className="text-slate-600">Reduction in capital requirements</div>
            </div>
            <div className="text-center">
              <div className="text-5xl font-bold text-blue-600 mb-2">100%</div>
              <div className="text-slate-600">Portfolio visibility</div>
            </div>
          </div>
