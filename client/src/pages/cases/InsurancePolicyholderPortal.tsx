      ...
      <div className="bg-subtle border-b">
        <div className="container py-4">
          <div className="flex items-center gap-2 text-sm text-muted-foreground">
            ...
            <span>/</span>
            <span className="text-charcoal">Insurance Carrier Launches Digital Policyholder Portal for 1.2M Members</span>
          </div>
        </div>
      </div>
        ...
        <div className="container max-w-4xl">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            <div className="text-center p-6 bg-blue-50 rounded-lg">
              ...
              <div className="text-charcoal/80">Reduction in agent service requests</div>
            </div>
            <div className="text-center p-6 bg-blue-50 rounded-lg">
              <div className="text-4xl font-bold text-primary mb-2">18%</div>
              <div className="text-charcoal/80">Improvement in retention (ages 25-40)</div>
            </div>
            <div className="text-center p-6 bg-blue-50 rounded-lg">
