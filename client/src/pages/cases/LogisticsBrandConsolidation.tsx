        ...
        <div className="container mx-auto px-6 max-w-4xl">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-16">
            <div className="text-center p-6 bg-white/5 rounded-2xl border border-white/10">
              <div className="text-4xl font-bold text-[#00d4ff] mb-2">Top 50</div>
              <div className="text-sm text-slate-400">Global Brand Ranking</div>
            </div>
            <div className="text-center p-6 bg-white/5 rounded-2xl border border-white/10">
              <div className="text-4xl font-bold text-[#00d4ff] mb-2">18%</div>
              <div className="text-sm text-slate-400">Increase in Cross-Selling</div>
            </div>
            <div className="text-center p-6 bg-white/5 rounded-2xl border border-white/10">
              <div className="text-4xl font-bold text-[#00d4ff] mb-2">$55M</div>
              <div className="text-sm text-slate-400">Operational Efficiency Savings</div>
            </div>
          </div>
