          ...
          <div className="prose prose-lg max-w-none">
            ...
            <ul className="space-y-4 mb-8">
              <li className="flex gap-3">
                ...
                <div>
                  <strong className="text-slate-900">Real-Time Telemetry.</strong> Smart sensors tracked temperature, humidity, light exposure, and shock in real-time, transmitting data via 5G/LTE-M networks.
                </div>
              </li>
              <li className="flex gap-3">
                <Check className="w-6 h-6 text-blue-500 flex-shrink-0 mt-1" />
                <div>
                  <strong className="text-slate-900">Predictive Alerts.</strong> ML algorithms analyzed trends to predict temperature breaches before they happened (e.g., "Container A will exceed 8°C in 30 minutes based on current ambient temperature").
                </div>
              </li>
              <li className="flex gap-3">
                <Check className="w-6 h-6 text-blue-500 flex-shrink-0 mt-1" />
                <div>
                  <strong className="text-slate-900">Automated Compliance.</strong> The system automatically generated audit-ready reports for FDA and EMA compliance, eliminating manual paperwork and data entry errors.
                </div>
              </li>
            </ul>
          </div>
        ...
        <div className="container max-w-4xl">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            <div className="text-center">
              ...
              <div className="text-slate-600">Reduction in product spoilage</div>
            </div>
            <div className="text-center">
              <div className="text-5xl font-bold text-blue-600 mb-2">100%</div>
              <div className="text-slate-600">Regulatory compliance visibility</div>
            </div>
            <div className="text-center">
              <div className="text-5xl font-bold text-blue-600 mb-2">$5M</div>
              <div className="text-slate-600">Annual insurance savings</div>
            </div>
          </div>
