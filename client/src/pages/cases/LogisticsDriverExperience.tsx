...
export function LogisticsDriverExperience() {
  return (
    <CaseStudyTemplate
      ...
      challenge={`In the high-pressure world of last-mile delivery, driver retention is a constant struggle. Our client was facing a turnover rate of 60% annually, a heavy recurring cost in recruitment and training.
      ...
      Delivery errors dropped by 28% as the new app guided drivers more effectively. Driver retention improved by 40% year-over-year, sharply cutting recruitment and training costs. The "Driver Voice" feature alone corrected over 50,000 address data points in the first six months.`}
      metrics={[
        { value: "28%", label: "Reduction in delivery errors" },
        { value: "40%", label: "Improvement in driver retention" },
        { value: "50,000+", label: "Address errors fixed by Driver Voice" }
      ]}
      quote={{
