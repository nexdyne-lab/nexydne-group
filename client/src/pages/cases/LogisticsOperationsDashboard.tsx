...
export default function LogisticsOperationsDashboard() {
  return (
    <div className="min-h-screen bg-white">
      <Navigation />
      {/* Hero Section */}
      <section className="relative bg-gradient-to-br from-red-900 via-[#2D5BFF] to-[#1a2b5c] text-white py-20">
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <ul className="space-y-4 mb-8">
              <li className="flex gap-3">
                ...
                <div>
                  <strong className="text-slate-900">Network health map.</strong> Geographic visualization showing all active deliveries, color-coded by status (on-time: green, at-risk: yellow, delayed: red). Dispatchers clicked on at-risk shipments to see root cause—traffic delays, equipment failures, or capacity constraints.
                </div>
              </li>
              <li className="flex gap-3">
                <Check className="w-6 h-6 text-blue-500 flex-shrink-0 mt-1" />
                <div>
                  <strong className="text-slate-900">Capacity utilization heatmap.</strong> Distribution center capacity displayed hour-by-hour for the next 48 hours. Red zones indicated overloaded facilities where incoming shipments exceeded processing capacity. Dispatchers rerouted shipments to underutilized centers before delays occurred.
                </div>
              </li>
              <li className="flex gap-3">
                <Check className="w-6 h-6 text-blue-500 flex-shrink-0 mt-1" />
                <div>
                  <strong className="text-slate-900">Route efficiency metrics.</strong> Average delivery time per route compared to historical baseline. Routes performing 20%+ slower than baseline triggered alerts. Operations team investigated root causes—construction detours, driver performance issues, or suboptimal routing algorithms.
                </div>
              </li>
              <li className="flex gap-3">
                <Check className="w-6 h-6 text-blue-500 flex-shrink-0 mt-1" />
                <div>
                  <strong className="text-slate-900">Customer impact forecast.</strong> Predictive model estimated how many customers would experience delayed deliveries based on current network status. Dispatchers prioritized interventions on shipments affecting high-value customers or time-sensitive orders.
                </div>
              </li>
            </ul>
        ...
        <div className="container max-w-4xl">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            <div className="text-center">
              ...
              <div className="text-slate-600">Reduction in delivery delays</div>
            </div>
            <div className="text-center">
              <div className="text-5xl font-bold text-blue-600 mb-2">92%</div>
              <div className="text-slate-600">On-time delivery rate achieved</div>
            </div>
            <div className="text-center">
              <div className="text-5xl font-bold text-blue-600 mb-2">$1.8M</div>
              <div className="text-slate-600">Annual savings from reduced delays</div>
            </div>
          </div>
      ...
      {/* CTA Section */}
      <section className="py-20 bg-gradient-to-br from-red-600 to-[#5B7FFF] text-white">
        <div className="container max-w-4xl text-center">
          ...
          <div className="flex flex-wrap gap-4 justify-center">
            <button className="px-8 py-3 bg-white text-red-600 rounded-full hover:bg-red-50 transition-colors font-semibold">
              Contact us
            </button>
            <Link href="/solutions/data-visualization">
              <button className="px-8 py-3 border-2 border-white text-white rounded-full hover:bg-white hover:text-red-600 transition-colors font-semibold">
                View all cases
              </button>
            </Link>
          </div>
