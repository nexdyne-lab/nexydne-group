      ...
      <section className="py-20 bg-slate-50">
        <div className="container max-w-4xl">
          ...
          <div className="space-y-4">
            <Card className="p-6">
              <h3 className="text-xl font-bold text-charcoal mb-3">Poor Search Relevance</h3>
            ...
            <Card className="p-6">
              <h3 className="text-xl font-bold text-charcoal mb-3">Lack of Personalization</h3>
              <p className="text-muted-foreground">
            ...
            <Card className="p-6">
              <h3 className="text-xl font-bold text-charcoal mb-3">Missed Cross-Sell Opportunities</h3>
              <p className="text-muted-foreground">
            ...
            <Card className="p-6">
              <h3 className="text-xl font-bold text-charcoal mb-3">High Dependency on Sales Support</h3>
              <p className="text-muted-foreground">
      ...
      <section className="py-20">
        <div className="container max-w-4xl">
          ...
          <div className="space-y-8">
            <div>
              <h3 className="text-2xl font-bold text-charcoal mb-4">Phase 1: Intelligent Search Implementation</h3>
            ...
            <div>
              <h3 className="text-2xl font-bold text-charcoal mb-4">Phase 2: Behavioral Personalization</h3>
              <p className="text-muted-foreground mb-4">
            ...
            <div>
              <h3 className="text-2xl font-bold text-charcoal mb-4">Phase 3: Intelligent Product Recommendations</h3>
              <p className="text-muted-foreground mb-4">
            ...
            <div>
              <h3 className="text-2xl font-bold text-charcoal mb-4">Phase 4: Merchandising Automation</h3>
              <p className="text-muted-foreground">
