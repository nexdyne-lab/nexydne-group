...
export default function ManufacturerDataMonetization() {
  return (
    <div className="min-h-screen bg-white">
      <Navigation />
      {/* Hero Section */}
      <section className="relative bg-gradient-to-br from-purple-900 via-purple-800 to-primary text-white py-20">
        ...
        <div className="container max-w-4xl">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            <div className="text-center">
              ...
              <div className="text-charcoal/80">Projected annual recurring revenue</div>
            </div>
            <div className="text-center">
              <div className="text-5xl font-bold text-purple-600 mb-2">12</div>
              <div className="text-charcoal/80">Use cases identified and prioritized</div>
            </div>
            <div className="text-center">
              <div className="text-5xl font-bold text-purple-600 mb-2">6 weeks</div>
              <div className="text-charcoal/80">From kickoff to executive approval</div>
            </div>
          </div>
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <ul className="space-y-3">
              <li className="flex items-start gap-3">
                <Check className="w-6 h-6 text-purple-600 flex-shrink-0 mt-1" />
                <span className="text-charcoal/80"><strong>Revenue diversification:</strong> Predictive maintenance subscription service created new recurring revenue stream, reducing dependence on equipment sales. Projected $4M ARR at 50% gross margin.</span>
              </li>
              <li className="flex items-start gap-3">
                <Check className="w-6 h-6 text-purple-600 flex-shrink-0 mt-1" />
                <span className="text-charcoal/80"><strong>Customer retention:</strong> Predictive maintenance increased customer stickiness. Customers using the service renewed equipment service contracts at 95% rate vs. 78% industry average.</span>
              </li>
              <li className="flex items-start gap-3">
                <Check className="w-6 h-6 text-purple-600 flex-shrink-0 mt-1" />
                <span className="text-charcoal/80"><strong>Competitive differentiation:</strong> Launched predictive maintenance offering 9 months ahead of competitors. Sales team closed 3 major deals citing predictive capabilities as key differentiator.</span>
              </li>
              <li className="flex items-start gap-3">
                <Check className="w-6 h-6 text-purple-600 flex-shrink-0 mt-1" />
                <span className="text-charcoal/80"><strong>Strategic alignment:</strong> Roadmap aligned engineering resources with highest-ROI opportunities. Eliminated 4 low-value projects that would have consumed $800K in development costs.</span>
              </li>
            </ul>
          </div>
        </div>
      ...
      <section className="py-20 bg-slate-50">
        <div className="container max-w-4xl">
          <h2 className="text-4xl font-bold text-charcoal mb-8">18-Month Roadmap</h2>
          <div className="space-y-6">
            <div className="bg-white p-6 rounded-lg border-l-4 border-purple-600">
              <h3 className="text-xl font-bold text-charcoal mb-2">Phase 1: MVP Development (Months 1-6)</h3>
            ...
            <div className="bg-white p-6 rounded-lg border-l-4 border-purple-600">
              <h3 className="text-xl font-bold text-charcoal mb-2">Phase 2: Commercial Launch (Months 7-12)</h3>
              <ul className="space-y-2 text-charcoal/80">
            ...
            <div className="bg-white p-6 rounded-lg border-l-4 border-purple-600">
              <h3 className="text-xl font-bold text-charcoal mb-2">Phase 3: Feature Expansion (Months 13-18)</h3>
              <ul className="space-y-2 text-charcoal/80">
