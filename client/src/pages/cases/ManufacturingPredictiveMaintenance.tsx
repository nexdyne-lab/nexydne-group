          ...
          <div className="prose prose-lg max-w-none">
            ...
            <ul className="space-y-4 mb-8">
              <li className="flex gap-3">
                ...
                <div>
                  <strong className="text-slate-900">Equipment health heatmap.</strong> Visual overview of all 150 assets color-coded by health score (green: healthy, yellow: degrading, red: critical). Maintenance team prioritized inspections on red/yellow assets instead of following fixed schedules.
                </div>
              </li>
              <li className="flex gap-3">
                <Check className="w-6 h-6 text-blue-500 flex-shrink-0 mt-1" />
                <div>
                  <strong className="text-slate-900">Failure prediction timeline.</strong> ML model predicted equipment failures 2-4 weeks in advance based on sensor patterns (vibration anomalies, temperature spikes, pressure fluctuations). Dashboard showed predicted failure date with confidence interval, enabling proactive maintenance scheduling.
                </div>
              </li>
              <li className="flex gap-3">
                <Check className="w-6 h-6 text-blue-500 flex-shrink-0 mt-1" />
                <div>
                  <strong className="text-slate-900">Sensor trend analysis.</strong> Time-series charts displayed vibration, temperature, and pressure trends for each asset. Maintenance engineers investigated anomalies—a motor showing gradual temperature increase over 3 weeks indicated bearing degradation requiring replacement.
                </div>
              </li>
              <li className="flex gap-3">
                <Check className="w-6 h-6 text-blue-500 flex-shrink-0 mt-1" />
                <div>
                  <strong className="text-slate-900">Maintenance work order integration.</strong> Dashboard automatically generated work orders for predicted failures, assigning them to maintenance technicians with recommended actions (replace bearing, lubricate motor, inspect belt tension). Technicians received mobile notifications with asset location and repair instructions.
                </div>
              </li>
            </ul>

            <h3 className="text-2xl font-bold text-slate-900 mb-4">Predictive Model Development</h3>
        ...
        <div className="container max-w-4xl">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            <div className="text-center">
              ...
              <div className="text-slate-600">Reduction in unplanned downtime</div>
            </div>
            <div className="text-center">
              <div className="text-5xl font-bold text-blue-600 mb-2">85%</div>
              <div className="text-slate-600">Failure prediction accuracy</div>
            </div>
            <div className="text-center">
              <div className="text-5xl font-bold text-blue-600 mb-2">$2.4M</div>
              <div className="text-slate-600">Annual savings from reduced downtime</div>
            </div>
          </div>
        ...
        <div className="container max-w-4xl">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-white p-6 rounded-lg border border-slate-200">
              <h3 className="text-xl font-bold text-slate-900 mb-3">IoT & Data Pipeline</h3>
            ...
            <div className="bg-white p-6 rounded-lg border border-slate-200">
              <h3 className="text-xl font-bold text-slate-900 mb-3">ML & Visualization</h3>
              <ul className="space-y-2 text-slate-700">
