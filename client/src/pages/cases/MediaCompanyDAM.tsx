      ...
      <nav className="bg-slate-50 py-4">
        <div className="container">
          <div className="flex items-center gap-2 text-sm text-slate-600">
            ...
            <span>/</span>
            <span className="text-slate-900">Media Company Centralizes 2M Assets with DAM Platform</span>
          </div>
        </div>
      </nav>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-white p-6 rounded-lg border border-slate-200">
              ...
              <ul className="space-y-2">
                <li className="flex items-start gap-2">
                  ...
                  <span className="text-slate-700">Bynder DAM for centralized asset repository</span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="w-5 h-5 text-green-600 flex-shrink-0 mt-0.5" />
                  <span className="text-slate-700">AI-powered auto-tagging for video content</span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="w-5 h-5 text-green-600 flex-shrink-0 mt-0.5" />
                  <span className="text-slate-700">Automated transcoding and distribution workflows</span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="w-5 h-5 text-green-600 flex-shrink-0 mt-0.5" />
                  <span className="text-slate-700">Rights management with expiration tracking</span>
                </li>
              </ul>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg border border-slate-200">
              ...
              <ul className="space-y-2">
                <li className="flex items-start gap-2">
                  <CheckCircle className="w-5 h-5 text-green-600 flex-shrink-0 mt-0.5" />
                  <span className="text-slate-700">Adobe Premiere and Avid Media Composer plugins</span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="w-5 h-5 text-green-600 flex-shrink-0 mt-0.5" />
                  <span className="text-slate-700">YouTube, Facebook, Twitter APIs for social distribution</span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="w-5 h-5 text-green-600 flex-shrink-0 mt-0.5" />
                  <span className="text-slate-700">AWS MediaConvert for automated transcoding</span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="w-5 h-5 text-green-600 flex-shrink-0 mt-0.5" />
                  <span className="text-slate-700">Slack for workflow notifications and approvals</span>
                </li>
              </ul>
            </div>
          </div>
        ...
        <div className="container max-w-4xl">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="bg-indigo-50 p-6 rounded-lg border-l-4 border-indigo-600">
              ...
              <div className="text-slate-700">Breaking News Distribution Time</div>
            </div>
            <div className="bg-green-50 p-6 rounded-lg border-l-4 border-green-600">
              <div className="text-3xl font-bold text-green-900 mb-2">Zero</div>
              <div className="text-slate-700">Copyright Violations in Year 1</div>
            </div>
            <div className="bg-purple-50 p-6 rounded-lg border-l-4 border-purple-600">
              <div className="text-3xl font-bold text-purple-900 mb-2">12TB</div>
              <div className="text-slate-700">Storage Freed by Deduplication</div>
            </div>
          </div>
        </div>
      </section>
