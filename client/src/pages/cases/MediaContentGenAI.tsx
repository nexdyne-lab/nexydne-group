          ...
          <div className="prose prose-lg max-w-none">
            ...
            <ul className="space-y-4 mb-8">
              <li className="flex gap-3">
                ...
                <div>
                  <strong className="text-slate-900">Intelligent Clipping.</strong> Computer vision and NLP models analyzed full-length episodes to identify viral moments, automatically cropping them to vertical formats for TikTok and Instagram Reels.
                </div>
              </li>
              <li className="flex gap-3">
                <Check className="w-6 h-6 text-blue-500 flex-shrink-0 mt-1" />
                <div>
                  <strong className="text-slate-900">Automated Localization.</strong> The system transcribed audio and generated frame-accurate subtitles in 20+ languages, using style transfer to match the tone of the original content.
                </div>
              </li>
              <li className="flex gap-3">
                <Check className="w-6 h-6 text-blue-500 flex-shrink-0 mt-1" />
                <div>
                  <strong className="text-slate-900">Metadata Enrichment.</strong> GenAI generated SEO-optimized titles, descriptions, and tags for every asset, improving discoverability across streaming platforms.
                </div>
              </li>
            </ul>
          </div>
        ...
        <div className="container max-w-4xl">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            <div className="text-center">
              ...
              <div className="text-slate-600">Reduction in post-production time</div>
            </div>
            <div className="text-center">
              <div className="text-5xl font-bold text-blue-600 mb-2">3x</div>
              <div className="text-slate-600">Increase in social media engagement</div>
            </div>
            <div className="text-center">
              <div className="text-5xl font-bold text-blue-600 mb-2">20+</div>
              <div className="text-slate-600">Languages supported instantly</div>
            </div>
          </div>
