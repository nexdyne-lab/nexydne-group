          ...
          <div className="prose prose-lg max-w-none">
            ...
            <ul className="space-y-4 mb-8">
              <li className="flex gap-3">
                ...
                <div>
                  <strong className="text-slate-900">Multi-Modal Simulation.</strong> The model aggregated data from GPS providers, traffic cameras, public transit sensors, and mobile network data to simulate the movement of millions of commuters across all modes of transport.
                </div>
              </li>
              <li className="flex gap-3">
                <Check className="w-6 h-6 text-blue-500 flex-shrink-0 mt-1" />
                <div>
                  <strong className="text-slate-900">Scenario Planning.</strong> Planners could test the impact of closing a street for a pedestrian zone, adding a new bus line, or changing traffic light logic before implementing changes in the real world.
                </div>
              </li>
              <li className="flex gap-3">
                <Check className="w-6 h-6 text-blue-500 flex-shrink-0 mt-1" />
                <div>
                  <strong className="text-slate-900">Citizen Engagement.</strong> An interactive version of the model was made public, allowing citizens to visualize the benefits of proposed changes (e.g., "See how this new bike lane reduces your commute time by reducing car traffic").
                </div>
              </li>
            </ul>
          </div>
        ...
        <div className="container max-w-4xl">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            <div className="text-center">
              ...
              <div className="text-slate-600">Reduction in peak congestion</div>
            </div>
            <div className="text-center">
              <div className="text-5xl font-bold text-blue-600 mb-2">10%</div>
              <div className="text-slate-600">Decrease in CO2 emissions</div>
            </div>
            <div className="text-center">
              <div className="text-5xl font-bold text-blue-600 mb-2">20%</div>
              <div className="text-slate-600">Increase in public transit usage</div>
            </div>
          </div>
