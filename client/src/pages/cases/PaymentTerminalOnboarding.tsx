        ...
        <div className="container">
          <div className="grid md:grid-cols-4 gap-8">
            <Card className="p-6 text-center">
              ...
              <div className="text-4xl font-bold text-slate-900 mb-2">52%</div>
            ...
            <Card className="p-6 text-center">
              ...
              <div className="text-slate-600">Support Ticket Reduction</div>
            </Card>
            
            <Card className="p-6 text-center">
              <Award className="w-12 h-12 text-blue-600 mx-auto mb-4" />
              <div className="text-4xl font-bold text-slate-900 mb-2">4.7/5</div>
              <div className="text-slate-600">Merchant Satisfaction</div>
            </Card>
            
            <Card className="p-6 text-center">
              <Users className="w-12 h-12 text-blue-600 mx-auto mb-4" />
              <div className="text-4xl font-bold text-slate-900 mb-2">89%</div>
              <div className="text-slate-600">First-Time Completion Rate</div>
            </Card>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-slate-50">
        <div className="container max-w-4xl">
          ...
          <div className="space-y-4">
            <Card className="p-6">
              <h3 className="text-xl font-bold text-slate-900 mb-3">Lengthy Time-to-Activation</h3>
            ...
            <Card className="p-6">
              <h3 className="text-xl font-bold text-slate-900 mb-3">High Support Costs</h3>
              <p className="text-slate-600">
            ...
            <Card className="p-6">
              <h3 className="text-xl font-bold text-slate-900 mb-3">Poor Merchant Experience</h3>
              <p className="text-slate-600">
            ...
            <Card className="p-6">
              <h3 className="text-xl font-bold text-slate-900 mb-3">Abandoned Onboarding</h3>
              <p className="text-slate-600">
      ...
      <section className="py-20">
        <div className="container max-w-4xl">
          ...
          <div className="space-y-8">
            <div>
              <h3 className="text-2xl font-bold text-slate-900 mb-4">Phase 1: Merchant Journey Mapping</h3>
            ...
            <div>
              <h3 className="text-2xl font-bold text-slate-900 mb-4">Phase 2: Personalization Rules Engine</h3>
              <p className="text-slate-600 mb-4">
            ...
            <div>
              <h3 className="text-2xl font-bold text-slate-900 mb-4">Phase 3: Interactive Onboarding Workflows</h3>
              <p className="text-slate-600 mb-4">
            ...
            <div>
              <h3 className="text-2xl font-bold text-slate-900 mb-4">Phase 4: Proactive Support Integration</h3>
              <p className="text-slate-600">
