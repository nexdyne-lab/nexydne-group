      ...
      <nav className="bg-slate-50 py-4">
        <div className="container">
          <div className="flex items-center gap-2 text-sm text-slate-600">
            ...
            <span>/</span>
            <span className="text-slate-900">Retailer Implements GDPR-Compliant Data Catalog for 15M Customers</span>
          </div>
        </div>
      </nav>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-white p-6 rounded-lg border border-slate-200">
              ...
              <ul className="space-y-2">
                <li className="flex items-start gap-2">
                  ...
                  <span className="text-slate-700">Collibra for data catalog and lineage tracking</span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="w-5 h-5 text-green-600 flex-shrink-0 mt-0.5" />
                  <span className="text-slate-700">Automated PII discovery and classification</span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="w-5 h-5 text-green-600 flex-shrink-0 mt-0.5" />
                  <span className="text-slate-700">Workflow automation for GDPR requests</span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="w-5 h-5 text-green-600 flex-shrink-0 mt-0.5" />
                  <span className="text-slate-700">Data residency enforcement via policy engine</span>
                </li>
              </ul>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg border border-slate-200">
              ...
              <ul className="space-y-2">
                <li className="flex items-start gap-2">
                  <CheckCircle className="w-5 h-5 text-green-600 flex-shrink-0 mt-0.5" />
                  <span className="text-slate-700">Shopify e-commerce platform</span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="w-5 h-5 text-green-600 flex-shrink-0 mt-0.5" />
                  <span className="text-slate-700">Salesforce CRM and Marketing Cloud</span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="w-5 h-5 text-green-600 flex-shrink-0 mt-0.5" />
                  <span className="text-slate-700">Zendesk customer service platform</span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="w-5 h-5 text-green-600 flex-shrink-0 mt-0.5" />
                  <span className="text-slate-700">AWS for data residency controls</span>
                </li>
              </ul>
            </div>
          </div>
        ...
        <div className="container max-w-4xl">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="bg-purple-50 p-6 rounded-lg border-l-4 border-purple-600">
              ...
              <div className="text-slate-700">GDPR Requests Processed in Year 1</div>
            </div>
            <div className="bg-blue-50 p-6 rounded-lg border-l-4 border-blue-600">
              <div className="text-3xl font-bold text-blue-900 mb-2">24 hours</div>
              <div className="text-slate-700">Right-to-be-Forgotten Completion Time</div>
            </div>
            <div className="bg-green-50 p-6 rounded-lg border-l-4 border-green-600">
              <div className="text-3xl font-bold text-green-900 mb-2">Zero</div>
              <div className="text-slate-700">Regulatory Complaints</div>
            </div>
          </div>
        </div>
      </section>
