      ...
      <div className="bg-white border-b border-slate-200">
        <div className="container py-4">
          <div className="flex items-center gap-2 text-sm text-muted-foreground">
            ...
            <span>/</span>
            <span className="text-charcoal font-medium">Retailer Builds Custom Inventory App</span>
          </div>
        </div>
      </div>
        ...
        <div className="container max-w-4xl">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            <div className="text-center">
              ...
              <div className="text-charcoal/80 font-medium">Reduction in stockouts</div>
            </div>
            <div className="text-center">
              <div className="text-5xl font-bold text-blue-500 mb-2">98.5%</div>
              <div className="text-charcoal/80 font-medium">Inventory accuracy achieved</div>
            </div>
            <div className="text-center">
              <div className="text-5xl font-bold text-blue-500 mb-2">$1.2M</div>
              <div className="text-charcoal/80 font-medium">Annual labor savings</div>
            </div>
          </div>
