      ...
      <section className="py-20 bg-slate-50">
        <div className="container max-w-4xl">
          ...
          <div className="space-y-4">
            <Card className="p-6">
              <h3 className="text-xl font-bold text-charcoal mb-3">Fragmented Customer Data</h3>
            ...
            <Card className="p-6">
              <h3 className="text-xl font-bold text-charcoal mb-3">Batch Processing Limitations</h3>
              <p className="text-muted-foreground">
            ...
            <Card className="p-6">
              <h3 className="text-xl font-bold text-charcoal mb-3">Generic Marketing Campaigns</h3>
              <p className="text-muted-foreground">
            ...
            <Card className="p-6">
              <h3 className="text-xl font-bold text-charcoal mb-3">Technical Debt and Scalability</h3>
              <p className="text-muted-foreground">
      ...
      <section className="py-20">
        <div className="container max-w-4xl">
          ...
          <div className="space-y-8">
            <div>
              <h3 className="text-2xl font-bold text-charcoal mb-4">Phase 1: Customer Data Platform Foundation</h3>
            ...
            <div>
              <h3 className="text-2xl font-bold text-charcoal mb-4">Phase 2: AI-Powered Product Recommendations</h3>
              <p className="text-muted-foreground mb-4">
            ...
            <div>
              <h3 className="text-2xl font-bold text-charcoal mb-4">Phase 3: Personalized Email Orchestration</h3>
              <p className="text-muted-foreground mb-4">
            ...
            <div>
              <h3 className="text-2xl font-bold text-charcoal mb-4">Phase 4: Self-Service Marketing Tools</h3>
              <p className="text-muted-foreground">
