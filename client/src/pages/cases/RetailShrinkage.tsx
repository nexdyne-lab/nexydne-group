          ...
          <div className="prose prose-lg max-w-none">
            ...
            <ul className="space-y-4 mb-8">
              <li className="flex gap-3">
                ...
                <div>
                  <strong className="text-slate-900">Self-Checkout Monitoring.</strong> Overhead cameras analyzed items placed in the bagging area. If a customer scanned a cheap item but bagged an expensive one (ticket switching) or failed to scan an item (miss-scan), the system alerted the attendant instantly.
                </div>
              </li>
              <li className="flex gap-3">
                <Check className="w-6 h-6 text-blue-500 flex-shrink-0 mt-1" />
                <div>
                  <strong className="text-slate-900">POS Anomaly Detection.</strong> ML models analyzed transaction logs to flag suspicious patterns, such as excessive voids, refunds to the same credit card, or transactions occurring outside business hours, helping identify internal theft.
                </div>
              </li>
              <li className="flex gap-3">
                <Check className="w-6 h-6 text-blue-500 flex-shrink-0 mt-1" />
                <div>
                  <strong className="text-slate-900">Shelf Sweep Detection.</strong> Computer vision identified rapid, large-volume removal of high-value items (like razors or baby formula) from shelves, triggering real-time alerts to security personnel.
                </div>
              </li>
            </ul>
          </div>
        ...
        <div className="container max-w-4xl">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            <div className="text-center">
              ...
              <div className="text-slate-600">Reduction in overall shrinkage</div>
            </div>
            <div className="text-center">
              <div className="text-5xl font-bold text-blue-600 mb-2">3x</div>
              <div className="text-slate-600">ROI within first year</div>
            </div>
            <div className="text-center">
              <div className="text-5xl font-bold text-blue-600 mb-2">60%</div>
              <div className="text-slate-600">Decrease in false positive alerts</div>
            </div>
          </div>
