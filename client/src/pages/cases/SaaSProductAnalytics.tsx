      ...
      <section className="py-20 bg-slate-50">
        <div className="container max-w-4xl">
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <h3 className="text-2xl font-bold text-slate-900 mb-4">Dashboard Components</h3>
            <ul className="space-y-4 mb-8">
              <li className="flex gap-3">
                <Check className="w-6 h-6 text-purple-500 flex-shrink-0 mt-1" />
                <div>
                  <strong className="text-slate-900">Conversion funnel analysis.</strong> Visualized trial journey from signup → activation → feature adoption → conversion. Identified drop-off points where users abandoned the product. 42% of users never completed onboarding—they signed up but never created their first project.
                </div>
              </li>
              <li className="flex gap-3">
                <Check className="w-6 h-6 text-purple-500 flex-shrink-0 mt-1" />
                <div>
                  <strong className="text-slate-900">Feature adoption heatmap.</strong> Showed which features converted users adopted vs. churned users. Converted users were 3x more likely to use collaboration features (comments, @mentions, file sharing) and 2x more likely to integrate with external tools (Slack, Google Drive).
                </div>
              </li>
              <li className="flex gap-3">
                <Check className="w-6 h-6 text-purple-500 flex-shrink-0 mt-1" />
                <div>
                  <strong className="text-slate-900">Cohort retention analysis.</strong> Tracked how different user cohorts (by signup source, company size, industry) engaged over time. Enterprise users (50+ employees) had 35% conversion rate vs. 12% for SMBs, suggesting product-market fit issues for smaller teams.
                </div>
              </li>
              <li className="flex gap-3">
                <Check className="w-6 h-6 text-purple-500 flex-shrink-0 mt-1" />
                <div>
                  <strong className="text-slate-900">Time-to-value metrics.</strong> Measured how long it took users to reach activation milestones (first project created, first collaborator invited, first task completed). Converted users reached activation 60% faster than churned users, indicating importance of fast time-to-value.
                </div>
              </li>
            </ul>

            <h3 className="text-2xl font-bold text-slate-900 mb-4">Product Improvements Driven by Analytics</h3>
        ...
        <div className="container max-w-4xl">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            <div className="text-center">
              ...
              <div className="text-slate-600">Increase in trial-to-paid conversion</div>
            </div>
            <div className="text-center">
              <div className="text-5xl font-bold text-purple-600 mb-2">23%</div>
              <div className="text-slate-600">Trial-to-paid conversion rate achieved</div>
            </div>
            <div className="text-center">
              <div className="text-5xl font-bold text-purple-600 mb-2">$3.2M</div>
              <div className="text-slate-600">Additional ARR from improved conversion</div>
            </div>
          </div>
        ...
        <div className="container max-w-4xl">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-white p-6 rounded-lg border border-slate-200">
              <h3 className="text-xl font-bold text-slate-900 mb-3">Analytics & Visualization</h3>
            ...
            <div className="bg-white p-6 rounded-lg border border-slate-200">
              <h3 className="text-xl font-bold text-slate-900 mb-3">Integration & Infrastructure</h3>
              <ul className="space-y-2 text-slate-700">
