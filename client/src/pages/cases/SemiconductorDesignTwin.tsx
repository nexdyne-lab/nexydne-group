      ...
      <section className="py-20 bg-slate-50">
        <div className="container max-w-4xl">
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <h3 className="text-2xl font-bold text-slate-900 mb-4">Key Innovations</h3>
            <ul className="space-y-4 mb-8">
              <li className="flex gap-3">
                <Check className="w-6 h-6 text-blue-500 flex-shrink-0 mt-1" />
                <div>
                  <strong className="text-slate-900">Virtual Metrology.</strong> We used ML models to predict wafer quality metrics based on equipment sensor data, effectively creating "virtual measurements" for every step of the process without slowing down production for physical inspection.
                </div>
              </li>
              <li className="flex gap-3">
                <Check className="w-6 h-6 text-blue-500 flex-shrink-0 mt-1" />
                <div>
                  <strong className="text-slate-900">Process Simulation.</strong> Engineers could simulate the impact of parameter changes (e.g., temperature, pressure, exposure time) on the final chip structure, optimizing recipes in the digital realm.
                </div>
              </li>
              <li className="flex gap-3">
                <Check className="w-6 h-6 text-blue-500 flex-shrink-0 mt-1" />
                <div>
                  <strong className="text-slate-900">Yield Prediction.</strong> The system identified design patterns likely to cause manufacturing defects, allowing designers to modify layouts for higher manufacturability (DFM) early in the cycle.
                </div>
              </li>
            </ul>
          </div>
        ...
        <div className="container max-w-4xl">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            <div className="text-center">
              ...
              <div className="text-slate-600">Increase in first-time-right designs</div>
            </div>
            <div className="text-center">
              <div className="text-5xl font-bold text-blue-600 mb-2">30%</div>
              <div className="text-slate-600">Reduction in root cause analysis time</div>
            </div>
            <div className="text-center">
              <div className="text-5xl font-bold text-blue-600 mb-2">20%</div>
              <div className="text-slate-600">Increase in engineering capacity</div>
            </div>
          </div>
