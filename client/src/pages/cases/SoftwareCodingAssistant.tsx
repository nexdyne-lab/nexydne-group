          ...
          <div className="prose prose-lg max-w-none">
            ...
            <ul className="space-y-4 mb-8">
              <li className="flex gap-3">
                ...
                <div>
                  <strong className="text-charcoal">Context-Aware Autocomplete.</strong> The assistant suggested code snippets that adhered to internal style guides and utilized proprietary libraries, reducing context switching.
                </div>
              </li>
              <li className="flex gap-3">
                <Check className="w-6 h-6 text-blue-500 flex-shrink-0 mt-1" />
                <div>
                  <strong className="text-charcoal">Automated Unit Testing.</strong> Developers could highlight a function and ask the assistant to generate comprehensive unit tests, covering edge cases that were often overlooked.
                </div>
              </li>
              <li className="flex gap-3">
                <Check className="w-6 h-6 text-blue-500 flex-shrink-0 mt-1" />
                <div>
                  <strong className="text-charcoal">Legacy Code Refactoring.</strong> The tool could explain complex legacy code and suggest modern refactoring strategies, accelerating the modernization of technical debt.
                </div>
              </li>
            </ul>
          </div>
