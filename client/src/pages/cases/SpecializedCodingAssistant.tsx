          ...
          <div className="prose prose-lg max-w-none">
            ...
            <ul className="space-y-4 mb-8">
              <li className="flex gap-3">
                ...
                <div>
                  <strong className="text-charcoal">Safety-Critical Code Generation.</strong> The model was trained to prioritize MISRA C compliance and avoid unsafe memory practices, generating code that was ready for safety certification.
                </div>
              </li>
              <li className="flex gap-3">
                <Check className="w-6 h-6 text-blue-500 flex-shrink-0 mt-1" />
                <div>
                  <strong className="text-charcoal">Hardware-Aware Optimization.</strong> The assistant suggested optimizations specific to the target microcontroller architecture, ensuring efficient use of limited RAM and CPU cycles.
                </div>
              </li>
              <li className="flex gap-3">
                <Check className="w-6 h-6 text-blue-500 flex-shrink-0 mt-1" />
                <div>
                  <strong className="text-charcoal">Automated Documentation.</strong> The tool automatically generated detailed technical documentation and traceability matrices required for regulatory audits.
                </div>
              </li>
            </ul>
          </div>
