      ...
      <nav className="bg-slate-50 py-4">
        <div className="container">
          <div className="flex items-center gap-2 text-sm text-muted-foreground">
            ...
            <span>/</span>
            <span className="text-charcoal">Telecom Provider Cuts Churn 22% with Predictive Model</span>
          </div>
        </div>
      </nav>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-white p-6 rounded-lg border border-slate-200">
              ...
              <ul className="space-y-2">
                <li className="flex items-start gap-2">
                  ...
                  <span className="text-charcoal/80">LightGBM classifier for churn probability</span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="w-5 h-5 text-secondary flex-shrink-0 mt-0.5" />
                  <span className="text-charcoal/80">Feature engineering: usage trends, support patterns</span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="w-5 h-5 text-secondary flex-shrink-0 mt-0.5" />
                  <span className="text-charcoal/80">Nightly batch scoring on Databricks</span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="w-5 h-5 text-secondary flex-shrink-0 mt-0.5" />
                  <span className="text-charcoal/80">SHAP values for personalized retention drivers</span>
                </li>
              </ul>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg border border-slate-200">
              ...
              <ul className="space-y-2">
                <li className="flex items-start gap-2">
                  <CheckCircle className="w-5 h-5 text-secondary flex-shrink-0 mt-0.5" />
                  <span className="text-charcoal/80">Salesforce CRM workflow automation</span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="w-5 h-5 text-secondary flex-shrink-0 mt-0.5" />
                  <span className="text-charcoal/80">Email campaign platform (Braze)</span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="w-5 h-5 text-secondary flex-shrink-0 mt-0.5" />
                  <span className="text-charcoal/80">Outbound dialer prioritization</span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="w-5 h-5 text-secondary flex-shrink-0 mt-0.5" />
                  <span className="text-charcoal/80">Looker dashboard for retention team</span>
                </li>
              </ul>
            </div>
          </div>
        ...
        <div className="container max-w-4xl">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="bg-purple-50 p-6 rounded-lg border-l-4 border-purple-600">
              ...
              <div className="text-charcoal/80">Precision (customers flagged who actually churn)</div>
            </div>
            <div className="bg-blue-50 p-6 rounded-lg border-l-4 border-blue-600">
              <div className="text-3xl font-bold text-blue-900 mb-2">41%</div>
              <div className="text-charcoal/80">Win-back Rate (up from 23%)</div>
            </div>
            <div className="bg-secondary/10 p-6 rounded-lg border-l-4 border-green-600">
              ...
              <div className="text-charcoal/80">Customer Lifetime Value Increase</div>
            </div>
          </div>
        </div>
      </section>
