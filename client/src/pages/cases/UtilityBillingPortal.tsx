      ...
      <div className="bg-gray-50 border-b">
        <div className="container py-4">
          <div className="flex items-center gap-2 text-sm text-gray-600">
            ...
            <span>/</span>
            <span className="text-gray-900">Utility Company Modernizes Billing Portal for 500K Households</span>
          </div>
        </div>
      </div>
        ...
        <div className="container max-w-4xl">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            <div className="text-center p-6 bg-blue-50 rounded-lg">
              ...
              <div className="text-gray-700">Reduction in call center volume</div>
            </div>
            <div className="text-center p-6 bg-blue-50 rounded-lg">
              <div className="text-4xl font-bold text-blue-600 mb-2">28%</div>
              <div className="text-gray-700">Improvement in payment timeliness</div>
            </div>
            <div className="text-center p-6 bg-blue-50 rounded-lg">
