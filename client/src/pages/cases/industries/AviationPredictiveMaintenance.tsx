...
export default function AviationPredictiveMaintenance() {
  return (
    <IndustryCaseStudyTemplate
      ...
      seoDescription="Every unplanned grounding left a regional carrier with a plane full of disrupted passengers and a day of scrambled schedules. Reading the signals its aircraft already sent cut surprise groundings in half."
      ...
      subtitle="Every unexpected grounding left a regional carrier with a plane full of disrupted passengers and a costly scramble to recover the schedule. Reading the signals its aircraft were already sending let the airline fix problems on its own schedule, not the fault's."
      heroImage="/images/industries/ops-monitors-dark.jpg"
      metrics={[
        { value: "50%", label: "Fewer Groundings" },
        { value: "99.2%", label: "On-Time Dispatch" },
        { value: "50%", label: "Lower Disruption Cost" },
        { value: "~30 Days", label: "Advance Warning" }
      ]}
      clientContextTitle="The High Price of an Unplanned Grounding"
      clientContextIntro="A regional airline flew a fleet of 80 aircraft on around 500 departures a day. Its biggest operational enemy was the unplanned grounding — an aircraft pulled from service without warning. Each one triggered a cascade of delays, rebookings and compensation, and the airline was absorbing around 50 of them a year — a heavy recurring cost, and a steady erosion of passenger trust."
      ...
      challenges={[
        {
          ...
          description: "Around 50 unplanned groundings a year drove heavy disruption costs and left passengers stranded."
        },
        {
          icon: Clock,
      ...
      results={[
        ...
        },
        {
          icon: DollarSign,
          value: "50%",
          label: "Lower disruption cost",
          detail: "From avoided groundings and better-planned maintenance"
        },
        {
          icon: Clock,
          value: "~30 Days",
