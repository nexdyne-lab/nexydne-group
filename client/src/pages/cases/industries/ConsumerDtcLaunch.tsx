...
export default function ConsumerDtcLaunch() {
  return (
    <IndustryCaseStudyTemplate
      seoTitle="DTC Launch Clears $18M in Year One Without Cannibalizing Wholesale | Consumer Case Study"
      seoDescription="A heritage consumer brand needed to launch DTC across two new categories without hurting the wholesale channel that drove 80% of revenue. A channel-respecting model and headless stack cleared $18M year-one DTC — and wholesale grew."
      ...
      approachIntro="We sized the opportunity, designed a channel-respecting commercial model, selected the headless commerce stack, and stood up the launch operating model — so DTC cleared $18M in year one while wholesale finished the year up."
      steps={[
      ...
      results={[
        { icon: DollarSign, value: "$18M", label: "Year-one DTC revenue", detail: "Across two new categories" },
