...
export default function UrbanCapitalProjects() {
  return (
    <IndustryCaseStudyTemplate
      ...
      clientContextIntro="A developer had roughly a dozen construction projects underway at any given time — apartments, offices and public spaces spread across a program worth around $250 million. Each project was run by its own team, its own contractors and its own set of spreadsheets, and progress was reported up to leadership in monthly meetings. On paper it was organised. In practice, by the time a problem reached those meetings it had usually been growing for weeks, and the moment to do something cheap about it had already passed."
