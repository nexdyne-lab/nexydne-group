          ...
          <div className="max-w-xl lg:max-w-2xl">
            ...
            >
              ...
              <p className="text-base md:text-lg text-charcoal/75 leading-relaxed max-w-lg">
                Compete in the modern insurance marketplace.
              </p>
            </motion.div>
          </div>
        </div>
        ...
        <div className="container px-4 md:px-12">
          ...
          <div className="grid lg:grid-cols-5 gap-12 items-center">
            ...
            >
              ...
              <Link href="/cases/insurance-claims-automation" className="inline-flex items-center text-primary font-semibold hover:underline">
