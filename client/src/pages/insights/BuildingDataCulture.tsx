      ...
      <section className="py-16 md:py-24 bg-white">
        <div className="container px-4 md:px-8 lg:px-12">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16">
            ...
            >
              {/* Video Placeholder */}
              <div className="relative aspect-video bg-[#051C2C] rounded-lg overflow-hidden shadow-xl mb-12 group cursor-pointer">
                <div className="absolute inset-0 flex items-center justify-center z-20">
                  <div className="w-20 h-20 rounded-full bg-[#0077B5] flex items-center justify-center pl-1 shadow-lg group-hover:scale-110 transition-transform duration-300">
                ...
                <div className="absolute bottom-4 left-4 z-20">
                  <span className="px-3 py-1 rounded bg-black/60 text-white text-sm font-medium">
                    12:45
                  </span>
                </div>
              </div>

              <div className="prose prose-lg max-w-none prose-headings:font-serif prose-headings:text-[#1A1A1A] prose-headings:font-bold prose-h2:text-2xl prose-h2:md:text-3xl prose-h2:mt-12 prose-h2:mb-6 prose-p:text-[#1A1A1A]/70 prose-p:leading-relaxed prose-p:mb-6 prose-li:text-[#1A1A1A]/70 prose-li:leading-relaxed prose-strong:text-[#1A1A1A] prose-strong:font-semibold">
                <h2>Key Takeaways</h2>
                <ul className="space-y-4 list-none pl-0">
                  <li className="flex items-start gap-3">
                    <div className="mt-2 w-2 h-2 rounded-full bg-[#0077B5] flex-shrink-0" />
                ...
                <div className="bg-[#F5F5F5] p-8 rounded-lg border-l-4 border-[#0077B5] my-8">
              ...
              <div className="border-t border-[#1A1A1A]/10 mt-16 pt-12">
                <div className="flex items-center gap-6">
                  ...
                  <div>
                    <h3 className="text-lg font-serif font-bold text-[#1A1A1A]">Sarah Jenkins</h3>
                    <p className="text-[#1A1A1A]/50 text-sm">Chief Data Officer, NexDyne</p>
                  </div>
                </div>
              </div>
            </motion.div>
            ...
            >
              <div className="sticky top-32 space-y-8">
                ...
                <div className="bg-[#F5F5F5] rounded-lg p-6">
                  <h3 className="text-sm font-bold uppercase tracking-wider text-[#1A1A1A]/50 mb-4">Share this video</h3>
                ...
                <div className="border border-[#1A1A1A]/10 rounded-lg p-6">
                  <h3 className="text-sm font-bold uppercase tracking-wider text-[#1A1A1A]/50 mb-4">Related Resources</h3>
                  <ul className="space-y-4">
                    <li>
                      <a href="#" className="group block">
                        <h4 className="text-[#1A1A1A] font-medium group-hover:text-[#0077B5] transition-colors mb-1">Data Maturity Assessment</h4>
                        <p className="text-xs text-[#1A1A1A]/50">Interactive Tool</p>
                      </a>
                    </li>
                    <li className="border-t border-[#1A1A1A]/10 pt-4">
                      <a href="#" className="group block">
                        <h4 className="text-[#1A1A1A] font-medium group-hover:text-[#0077B5] transition-colors mb-1">The Cultural Framework PDF</h4>
                        <p className="text-xs text-[#1A1A1A]/50">Downloadable Guide</p>
                      </a>
                    </li>
                  </ul>
                </div>
                ...
                {/* Newsletter CTA */}
                <div className="bg-[#051C2C] rounded-lg p-6 text-white">
      ...
      <section className="py-16 md:py-24 bg-[#F5F5F5]">
        <div className="container px-4 md:px-8 lg:px-12">
          <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-6">
            ...
            >
              <h2 className="text-3xl md:text-4xl font-serif italic font-bold mb-4 text-[#1A1A1A]">
                Related Thinking
              </h2>
