  ...
  return (
    ...
    >
      ...
      <div className="space-y-6 mb-12">
        <p className="text-xl text-[#051C2C]/80 leading-relaxed font-serif">
      ...
      {/* Section 1 */}
      <div className="mb-12">
        <h2 id="understanding-imperative" className="text-3xl font-serif font-bold text-[#051C2C] mb-6">Understanding the Transformation Imperative</h2>
        ...
        <div className="bg-[#051C2C]/5 border-l-4 border-[#0077B5] p-6 my-8 rounded-r-lg">
          <h3 className="text-xl font-serif font-semibold text-[#051C2C] mb-3">Key Transformation Drivers</h3>
          <ul className="space-y-3 text-[#051C2C]/70">
            <li><strong className="text-[#051C2C]">Digital Disruption:</strong> Emerging technologies fundamentally alter competitive dynamics and customer expectations</li>
            <li><strong className="text-[#051C2C]">Market Volatility:</strong> Rapid shifts in demand patterns require unprecedented organizational agility</li>
            <li><strong className="text-[#051C2C]">Operational Complexity:</strong> Legacy systems and processes create inefficiencies that compound over time</li>
            <li><strong className="text-[#051C2C]">Talent Evolution:</strong> Changing workforce demographics and expectations demand new organizational models</li>
          </ul>
        </div>
      ...
      {/* Section 2 */}
      <div className="mb-12">
        <h2 id="strategic-framework" className="text-3xl font-serif font-bold text-[#051C2C] mb-6">The Strategic Transformation Framework</h2>
        ...
        <div className="space-y-8 my-8">
          <div className="border-l-4 border-[#0077B5] pl-6">
            <h3 className="text-xl font-serif font-semibold text-[#051C2C] mb-3">1. Strategic Clarity and Alignment</h3>
            <p className="text-[#051C2C]/70 leading-relaxed">
          ...
          <div className="border-l-4 border-[#0077B5] pl-6">
            <h3 className="text-xl font-serif font-semibold text-[#051C2C] mb-3">2. Operating Model Redesign</h3>
            <p className="text-[#051C2C]/70 leading-relaxed">
          ...
          <div className="border-l-4 border-[#0077B5] pl-6">
            <h3 className="text-xl font-serif font-semibold text-[#051C2C] mb-3">3. Technology and Data Architecture</h3>
            <p className="text-[#051C2C]/70 leading-relaxed">
          ...
          <div className="border-l-4 border-[#0077B5] pl-6">
            <h3 className="text-xl font-serif font-semibold text-[#051C2C] mb-3">4. Capability Building and Change Management</h3>
            <p className="text-[#051C2C]/70 leading-relaxed">
          ...
          <div className="border-l-4 border-[#0077B5] pl-6">
            <h3 className="text-xl font-serif font-semibold text-[#051C2C] mb-3">5. Performance Management and Continuous Improvement</h3>
            <p className="text-[#051C2C]/70 leading-relaxed">
      ...
      {/* Section 3 */}
      <div className="mb-12">
        <h2 id="implementation-principles" className="text-3xl font-serif font-bold text-[#051C2C] mb-6">Implementation Principles for Success</h2>
        ...
        <div className="bg-gradient-to-br from-[#0077B5]/5 to-[#051C2C]/5 rounded-xl p-8 my-8">
          <div className="space-y-6">
            <div>
              <h4 className="text-lg font-serif font-semibold text-[#051C2C] mb-2">Start with Quick Wins</h4>
            ...
            <div>
              <h4 className="text-lg font-serif font-semibold text-[#051C2C] mb-2">Maintain Strategic Coherence</h4>
              <p className="text-[#051C2C]/70">
            ...
            <div>
              <h4 className="text-lg font-serif font-semibold text-[#051C2C] mb-2">Embrace Iterative Delivery</h4>
              <p className="text-[#051C2C]/70">
            ...
            <div>
              <h4 className="text-lg font-serif font-semibold text-[#051C2C] mb-2">Invest in Leadership Alignment</h4>
              <p className="text-[#051C2C]/70">
            ...
            <div>
              <h4 className="text-lg font-serif font-semibold text-[#051C2C] mb-2">Measure What Matters</h4>
              <p className="text-[#051C2C]/70">
      ...
      {/* Conclusion */}
      <div className="mb-12">
        <h2 id="building-capability" className="text-3xl font-serif font-bold text-[#051C2C] mb-6">Building Transformation as a Core Capability</h2>
        ...
        <div className="bg-[#051C2C] text-white p-8 rounded-xl my-8">
          ...
          <a 
            href="/contact" 
            className="inline-flex items-center gap-2 bg-[#0077B5] hover:bg-[#005a8c] text-white px-6 py-3 rounded-lg font-semibold transition-colors"
          >
