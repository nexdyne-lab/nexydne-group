...
export default function BusinessTransformationStrategy() {
  return (
    ...
    >
      ...
      {/* Section 1 */}
      <div className="mb-12">
        <h2 id="understanding-imperative" className="text-3xl font-bold text-charcoal mb-6">Understanding the Transformation Imperative</h2>
      ...
      {/* Section 2 */}
      <div className="mb-12">
        <h2 id="strategic-framework" className="text-3xl font-bold text-charcoal mb-6">The Strategic Transformation Framework</h2>
        ...
        <div className="space-y-8 my-8">
          <div className="border-l-4 border-primary pl-6">
            <h3 className="text-xl font-semibold text-charcoal mb-3">1. Strategic Clarity and Alignment</h3>
            <p className="text-charcoal/70 leading-relaxed">
          ...
          <div className="border-l-4 border-primary pl-6">
            <h3 className="text-xl font-semibold text-charcoal mb-3">2. Operating Model Redesign</h3>
            <p className="text-charcoal/70 leading-relaxed">
          ...
          <div className="border-l-4 border-primary pl-6">
            <h3 className="text-xl font-semibold text-charcoal mb-3">3. Technology and Data Architecture</h3>
            <p className="text-charcoal/70 leading-relaxed">
          ...
          <div className="border-l-4 border-primary pl-6">
            <h3 className="text-xl font-semibold text-charcoal mb-3">4. Capability Building and Change Management</h3>
            <p className="text-charcoal/70 leading-relaxed">
          ...
          <div className="border-l-4 border-primary pl-6">
            <h3 className="text-xl font-semibold text-charcoal mb-3">5. Performance Management and Continuous Improvement</h3>
            <p className="text-charcoal/70 leading-relaxed">
      ...
      {/* Section 3 */}
      <div className="mb-12">
        <h2 id="implementation-principles" className="text-3xl font-bold text-charcoal mb-6">Implementation Principles for Success</h2>
        ...
        <div className="bg-gradient-to-br from-[#0077B5]/5 to-base/5 rounded-xl p-8 my-8">
          <div className="space-y-6">
            ...
            <div>
              <h4 className="text-lg font-semibold text-charcoal mb-2">Maintain Strategic Coherence</h4>
              <p className="text-charcoal/70">
            ...
            <div>
              <h4 className="text-lg font-semibold text-charcoal mb-2">Embrace Iterative Delivery</h4>
              <p className="text-charcoal/70">
            ...
            <div>
              <h4 className="text-lg font-semibold text-charcoal mb-2">Invest in Leadership Alignment</h4>
              <p className="text-charcoal/70">
            ...
            <div>
              <h4 className="text-lg font-semibold text-charcoal mb-2">Measure What Matters</h4>
              <p className="text-charcoal/70">
      ...
      {/* Conclusion */}
      <div className="mb-12">
        <h2 id="building-capability" className="text-3xl font-bold text-charcoal mb-6">Building Transformation as a Core Capability</h2>
