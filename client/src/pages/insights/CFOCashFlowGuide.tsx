      ...
      <article className="py-16 bg-white text-charcoal">
        <div className="container px-4 md:px-12 max-w-4xl">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }} className="prose prose-lg max-w-none">
            ...
            <h2 className="text-3xl font-serif font-bold text-charcoal mb-6">Cash Is King—And Queen</h2>
            ...
            <h2 className="text-3xl font-serif font-bold text-charcoal mb-6">Building a Cash Flow Forecast</h2>
            
            <div className="p-8 bg-base/5 rounded-xl mb-12">
              <h3 className="text-xl font-serif font-bold text-charcoal mb-4 flex items-center gap-3"><BarChart3 className="w-6 h-6 text-primary" />The 13-Week Cash Flow Model</h3>
            ...
            <h2 className="text-3xl font-serif font-bold text-charcoal mb-6">Cash Flow Optimization Levers</h2>
            ...
            <div className="space-y-8 mb-12">
              <div className="flex gap-6">
                ...
                <div>
                  <h3 className="text-xl font-serif font-bold text-charcoal mb-2">Accelerate Receivables</h3>
              ...
              <div className="flex gap-6">
                ...
                <div>
                  <h3 className="text-xl font-serif font-bold text-charcoal mb-2">Optimize Inventory</h3>
              ...
              <div className="flex gap-6">
                ...
                <div>
                  <h3 className="text-xl font-serif font-bold text-charcoal mb-2">Manage Payables Strategically</h3>
            ...
            <h2 className="text-3xl font-serif font-bold text-charcoal mb-6">Cash Flow Warning Signs</h2>
            ...
            <h2 className="text-3xl font-serif font-bold text-charcoal mb-6">Navigating a Cash Crunch</h2>
            <div className="space-y-6 mb-12">
              <div className="p-6 bg-base/5 rounded-xl">
                <h4 className="text-lg font-serif font-bold text-charcoal mb-2">Immediate Actions (Days 1-7)</h4>
              ...
              <div className="p-6 bg-base/5 rounded-xl">
                <h4 className="text-lg font-serif font-bold text-charcoal mb-2">Short-Term Actions (Weeks 2-4)</h4>
              ...
              <div className="p-6 bg-base/5 rounded-xl">
                <h4 className="text-lg font-serif font-bold text-charcoal mb-2">Medium-Term Actions (Month 2+)</h4>
