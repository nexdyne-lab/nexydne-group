          ...
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }} className="prose prose-lg max-w-none">
            ...
            <div className="p-8 bg-charcoal/5 rounded-xl mb-12">
              ...
              <ul className="space-y-3 text-charcoal/70">
                ...
                <li className="flex items-start gap-3"><CheckCircle2 className="w-5 h-5 text-primary flex-shrink-0 mt-0.5" /><span><strong className="text-charcoal">External data:</strong> Market data, benchmarks, economic indicators</span></li>
                <li className="flex items-start gap-3"><CheckCircle2 className="w-5 h-5 text-primary flex-shrink-0 mt-0.5" /><span><strong className="text-charcoal">Spreadsheets:</strong> The shadow IT that fills gaps between systems</span></li>
              </ul>
            </div>
            ...
            <ul className="space-y-4 text-charcoal/70 mb-8">
              <li className="flex items-start gap-3"><CheckCircle2 className="w-5 h-5 text-primary flex-shrink-0 mt-0.5" /><span><strong className="text-charcoal">Efficiency gains:</strong> Reduced time spent on data gathering, reconciliation, and manual reporting</span></li>
              <li className="flex items-start gap-3"><CheckCircle2 className="w-5 h-5 text-primary flex-shrink-0 mt-0.5" /><span><strong className="text-charcoal">Faster close:</strong> Accelerated month-end and quarter-end close processes</span></li>
              <li className="flex items-start gap-3"><CheckCircle2 className="w-5 h-5 text-primary flex-shrink-0 mt-0.5" /><span><strong className="text-charcoal">Better decisions:</strong> Improved visibility enabling better resource allocation and risk management</span></li>
