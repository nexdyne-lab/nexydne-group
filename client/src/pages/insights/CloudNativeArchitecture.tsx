    ...
    <div className="min-h-screen bg-white text-[#1A1A1A] font-sans">
      ...
      <article className="pt-24 pb-16">
        ...
        <div className="container px-4 md:px-8 lg:px-12 mb-8">
          <Link href="/">
            <span className="inline-flex items-center text-[#0077B5] hover:text-[#005885] transition-colors text-sm font-medium">
        ...
        <header className="container px-4 md:px-8 lg:px-12 mb-12">
          <div className="max-w-4xl">
            {/* Category */}
            <span className="inline-block px-3 py-1.5 bg-[#E3F2FD] text-[#1565C0] text-xs font-semibold rounded-full tracking-wide mb-6">
              TECHNOLOGY
            </span>
            ...
            <motion.h1
              ...
              className="text-3xl md:text-4xl lg:text-5xl font-bold font-serif leading-tight mb-6 text-[#1A1A1A]"
            >
              Cloud-Native Architecture for Scale: Building Infrastructure That Grows With Your Ambition
            </motion.h1>

            {/* Meta Info */}
            <div className="flex flex-wrap items-center gap-4 text-[#1A1A1A]/60 text-sm mb-8">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
              <div className="flex items-center gap-4">
                <span className="text-sm text-[#1A1A1A]/60">Share:</span>
                <button className="p-2 rounded-full border border-[#1A1A1A]/20 hover:bg-[#0077B5] hover:border-[#0077B5] hover:text-white transition-colors">
                  <Linkedin className="w-4 h-4" />
                </button>
                <button className="p-2 rounded-full border border-[#1A1A1A]/20 hover:bg-[#1A1A1A] hover:border-[#1A1A1A] hover:text-white transition-colors">
                  <Twitter className="w-4 h-4" />
                </button>
              </div>
              <button className="inline-flex items-center gap-2 px-4 py-2 bg-[#1565C0] text-white rounded font-semibold text-sm hover:bg-[#0D47A1] transition-colors">
        ...
        <div className="w-full mb-16">
          <div className="container px-4 md:px-8 lg:px-12">
            ...
            <p className="text-sm text-[#1A1A1A]/50 mt-3 italic">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_300px] gap-12 lg:gap-16">
            ...
            <div className="max-w-3xl">
              ...
              <div className="bg-[#F8FAFC] border border-[#E2E8F0] rounded-lg p-8 mb-12">
                <h2 className="text-xl font-bold font-serif mb-4 text-[#1A1A1A]">Executive Summary</h2>
              ...
              <section className="mb-12">
                <h2 className="text-2xl md:text-3xl font-bold font-serif mb-6 text-[#1A1A1A]">
              ...
              {/* Pull Quote */}
              <blockquote className="border-l-4 border-[#1565C0] pl-6 py-4 my-12 bg-[#F0F7FF]">
                <p className="text-xl md:text-2xl font-serif text-[#1565C0] leading-relaxed mb-4">
                ...
                <cite className="text-sm text-[#1A1A1A]/60 not-italic">
              ...
              <div className="space-y-6 my-12">
                <div className="bg-[#F8FAFC] border border-[#E2E8F0] rounded-lg p-6">
                  <div className="flex items-start gap-4">
                    <div className="flex-shrink-0 w-12 h-12 rounded-lg bg-[#1565C0] text-white flex items-center justify-center font-bold text-lg">01</div>
                    <div>
                      <h3 className="text-lg font-bold text-[#1A1A1A] mb-2">Containerization</h3>
                      <p className="text-[#1A1A1A]/70 leading-relaxed">
                ...
                <div className="bg-[#F8FAFC] border border-[#E2E8F0] rounded-lg p-6">
                  <div className="flex items-start gap-4">
                    <div className="flex-shrink-0 w-12 h-12 rounded-lg bg-[#1565C0] text-white flex items-center justify-center font-bold text-lg">02</div>
                    <div>
                      <h3 className="text-lg font-bold text-[#1A1A1A] mb-2">Microservices Architecture</h3>
                      <p className="text-[#1A1A1A]/70 leading-relaxed">
                ...
                <div className="bg-[#F8FAFC] border border-[#E2E8F0] rounded-lg p-6">
                  <div className="flex items-start gap-4">
                    <div className="flex-shrink-0 w-12 h-12 rounded-lg bg-[#1565C0] text-white flex items-center justify-center font-bold text-lg">03</div>
                    <div>
                      <h3 className="text-lg font-bold text-[#1A1A1A] mb-2">Continuous Integration and Delivery</h3>
                      <p className="text-[#1A1A1A]/70 leading-relaxed">
                ...
                <div className="bg-[#F8FAFC] border border-[#E2E8F0] rounded-lg p-6">
                  <div className="flex items-start gap-4">
                    <div className="flex-shrink-0 w-12 h-12 rounded-lg bg-[#1565C0] text-white flex items-center justify-center font-bold text-lg">04</div>
                    <div>
                      <h3 className="text-lg font-bold text-[#1A1A1A] mb-2">Infrastructure as Code</h3>
                      <p className="text-[#1A1A1A]/70 leading-relaxed">
                ...
                <div className="bg-[#F8FAFC] border border-[#E2E8F0] rounded-lg p-6">
                  <div className="flex items-start gap-4">
                    <div className="flex-shrink-0 w-12 h-12 rounded-lg bg-[#1565C0] text-white flex items-center justify-center font-bold text-lg">05</div>
                    <div>
                      <h3 className="text-lg font-bold text-[#1A1A1A] mb-2">Observability</h3>
                      <p className="text-[#1A1A1A]/70 leading-relaxed">
              ...
              {/* Statistics Box */}
              <div className="grid grid-cols-2 md:grid-cols-4 gap-6 my-12 py-8 border-y border-[#E2E8F0]">
                <div className="text-center">
                  <div className="text-3xl md:text-4xl font-bold text-[#1565C0] mb-2">40%</div>
                  <div className="text-sm text-[#1A1A1A]/60">Faster time-to-market</div>
                </div>
                <div className="text-center">
                  <div className="text-3xl md:text-4xl font-bold text-[#1565C0] mb-2">60%</div>
                  <div className="text-sm text-[#1A1A1A]/60">Infrastructure cost reduction</div>
                </div>
                <div className="text-center">
                  <div className="text-3xl md:text-4xl font-bold text-[#1565C0] mb-2">90%</div>
                  <div className="text-sm text-[#1A1A1A]/60">Availability improvement</div>
                </div>
                <div className="text-center">
                  <div className="text-3xl md:text-4xl font-bold text-[#1565C0] mb-2">5x</div>
                  <div className="text-sm text-[#1A1A1A]/60">Deployment frequency</div>
                </div>
              </div>
              ...
              <div className="bg-[#051C2C] text-white rounded-lg p-8 mt-12">
                ...
                <div className="flex flex-wrap gap-4">
                  <Link href="/contact">
                    <button className="inline-flex items-center gap-2 px-6 py-3 bg-white text-[#051C2C] rounded font-semibold text-sm hover:bg-[#E3F2FD] transition-colors">
                      Contact Our Team
            ...
            <aside className="lg:sticky lg:top-24 lg:self-start space-y-8">
              {/* Download CTA */}
              <div className="bg-[#1565C0] text-white rounded-lg p-6">
                ...
                <button className="w-full inline-flex items-center justify-center gap-2 px-4 py-2 bg-white text-[#1565C0] rounded font-semibold text-sm hover:bg-[#E3F2FD] transition-colors">
                  <Download className="w-4 h-4" />
                  Download PDF
                </button>
              </div>
              ...
              {/* Related Insights */}
              <div>
                <h3 className="text-sm font-bold text-[#1A1A1A]/60 uppercase tracking-wider mb-4">
                  Related Insights
                </h3>
                <div className="space-y-4">
                  <Link href="/insights/building-data-culture">
                    <div className="group cursor-pointer">
                      <span className="text-xs text-[#0077B5] font-medium">INSIGHT</span>
                      <h4 className="font-bold text-[#1A1A1A] group-hover:text-[#0077B5] transition-colors leading-snug mt-1">
                  ...
                  <Link href="/insights/digital-growth-playbook">
                    <div className="group cursor-pointer">
                      <span className="text-xs text-[#0077B5] font-medium">ARTICLE</span>
                      <h4 className="font-bold text-[#1A1A1A] group-hover:text-[#0077B5] transition-colors leading-snug mt-1">
              ...
              {/* Newsletter Signup */}
              <div className="bg-[#F8FAFC] border border-[#E2E8F0] rounded-lg p-6">
                <h3 className="font-bold text-[#1A1A1A] mb-2">Stay informed</h3>
                ...
                <input
                  ...
                  className="w-full px-4 py-2 border border-[#E2E8F0] rounded mb-3 text-sm focus:outline-none focus:border-[#1565C0]"
                />
                <button className="w-full px-4 py-2 bg-[#051C2C] text-white rounded font-semibold text-sm hover:bg-[#1565C0] transition-colors">
                  Subscribe
                </button>
              </div>
            </aside>
