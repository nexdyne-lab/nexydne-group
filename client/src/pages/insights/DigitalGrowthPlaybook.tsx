          ...
          <div className="grid md:grid-cols-12 gap-12">
            ...
            <div className="md:col-span-3 hidden md:block">
              <div className="sticky top-32">
                ...
                <ul className="space-y-3 text-sm text-[#051C2C]/60 border-l border-[#051C2C]/10 pl-4">
                  <li className="hover:text-[#0077B5] cursor-pointer">The Mid-Market Advantage</li>
                  <li className="hover:text-[#0077B5] cursor-pointer">Digital Channel Strategy</li>
                  <li className="hover:text-[#0077B5] cursor-pointer">The Growth Framework</li>
                  <li className="hover:text-[#0077B5] cursor-pointer">Technology Choices</li>
                  <li className="hover:text-[#0077B5] cursor-pointer">Measuring Success</li>
                  <li className="hover:text-[#0077B5] cursor-pointer">Case Examples</li>
                </ul>
            ...
            <div className="md:col-span-7">
              <div className="prose prose-lg prose-slate max-w-none">
                ...
                <h2 className="text-2xl font-bold text-[#051C2C] mt-12 mb-6">The Mid-Market Advantage</h2>
                ...
                <div className="bg-[#F8F9FA] p-8 rounded-xl border border-[#051C2C]/10 my-10">
                  ...
                  <div className="grid md:grid-cols-3 gap-6 text-center">
                    <div>
                      <div className="text-3xl font-serif font-bold text-[#0077B5]">67%</div>
                      <div className="text-sm text-[#051C2C]/60">of mid-market companies plan to increase digital investment</div>
                    </div>
                    <div>
                      <div className="text-3xl font-serif font-bold text-[#0077B5]">3.2x</div>
                      <div className="text-sm text-[#051C2C]/60">faster growth for digitally mature mid-market firms</div>
                    </div>
                    <div>
                      <div className="text-3xl font-serif font-bold text-[#0077B5]">42%</div>
                      <div className="text-sm text-[#051C2C]/60">report digital channels as primary growth driver</div>
                    </div>
                  </div>
                </div>

                <h2 className="text-2xl font-bold text-[#051C2C] mt-12 mb-6">Digital Channel Strategy</h2>
                <p className="text-[#051C2C]/70 leading-relaxed mb-6">
                ...
                <div className="space-y-4 mb-8">
                  {[
                    ...
                    <div key={index} className="flex gap-4 p-4 bg-[#F8F9FA] rounded-lg">
                      <CheckCircle2 className="w-6 h-6 text-[#0077B5] flex-shrink-0 mt-1" />
                      <div>
                        <h4 className="font-bold text-[#051C2C] mb-1">{channel.title}</h4>
                        <p className="text-[#051C2C]/60 text-sm">{channel.description}</p>
                      </div>
                    </div>
                  ))}
                </div>

                <h2 className="text-2xl font-bold text-[#051C2C] mt-12 mb-6">The Growth Framework</h2>
                <p className="text-[#051C2C]/70 leading-relaxed mb-6">
                  ...
                  <div className="space-y-6">
                    {[
                      ...
                      <div key={index} className="flex gap-4 items-start">
                        <div className="w-10 h-10 bg-[#0077B5] rounded-lg flex items-center justify-center font-bold text-lg flex-shrink-0">
                          {step.letter}
                        </div>
                        <div>
                ...
                <h2 className="text-2xl font-bold text-[#051C2C] mt-12 mb-6">Technology Choices That Matter</h2>
                <p className="text-[#051C2C]/70 leading-relaxed mb-6">
                ...
                <div className="grid md:grid-cols-2 gap-6 my-10">
                  <div className="p-6 bg-[#F8F9FA] rounded-xl">
                    <Rocket className="w-8 h-8 text-[#0077B5] mb-4" />
                    <h4 className="font-bold text-[#051C2C] mb-2">Quick Wins (0-6 months)</h4>
                    <ul className="text-sm text-[#051C2C]/60 space-y-2">
                  ...
                  <div className="p-6 bg-[#F8F9FA] rounded-xl">
                    <Globe className="w-8 h-8 text-[#0077B5] mb-4" />
                    <h4 className="font-bold text-[#051C2C] mb-2">Strategic Investments (6-18 months)</h4>
                    <ul className="text-sm text-[#051C2C]/60 space-y-2">
                ...
                <h2 className="text-2xl font-bold text-[#051C2C] mt-12 mb-6">Measuring Success</h2>
                <p className="text-[#051C2C]/70 leading-relaxed mb-6">
                  ...
                  <table className="w-full text-sm">
                    <thead>
                      <tr className="border-b border-[#051C2C]/10">
                        <th className="text-left py-3 font-bold text-[#051C2C]">Metric Category</th>
                        <th className="text-left py-3 font-bold text-[#051C2C]">Leading Indicators</th>
                        <th className="text-left py-3 font-bold text-[#051C2C]">Lagging Indicators</th>
                      </tr>
                    </thead>
                ...
                <h2 className="text-2xl font-bold text-[#051C2C] mt-12 mb-6">Real-World Examples</h2>
                <p className="text-[#051C2C]/70 leading-relaxed mb-6">
                ...
                <div className="space-y-6 my-8">
                  <div className="p-6 border border-[#051C2C]/10 rounded-xl">
                    <div className="flex items-center gap-2 text-[#0077B5] text-sm font-semibold mb-2">
                      <Target className="w-4 h-4" />
                      SPECIALTY RETAIL
                    </div>
                    <h4 className="font-bold text-[#051C2C] mb-2">Outdoor Gear Retailer: 180% Online Revenue Growth</h4>
                  ...
                  <div className="p-6 border border-[#051C2C]/10 rounded-xl">
                    ...
                    <h4 className="font-bold text-[#051C2C] mb-2">Industrial Supplier: $4.5M New Revenue</h4>
                    <p className="text-[#051C2C]/60 text-sm">
                  ...
                  <div className="p-6 border border-[#051C2C]/10 rounded-xl">
                    ...
                    <h4 className="font-bold text-[#051C2C] mb-2">Training Company: $1.8M ARR Subscription Platform</h4>
                    <p className="text-[#051C2C]/60 text-sm">
                ...
                <h2 className="text-2xl font-bold text-[#051C2C] mt-12 mb-6">Getting Started</h2>
                <p className="text-[#051C2C]/70 leading-relaxed mb-6">
                ...
                <ol className="list-decimal pl-6 space-y-3 text-[#051C2C]/70 mb-8">
                ...
                <div className="bg-[#0077B5]/10 p-8 rounded-xl my-10">
                  <h4 className="font-bold text-[#051C2C] mb-4">Ready to accelerate your digital growth?</h4>
