  ...
  return (
    <div className="min-h-screen bg-background text-charcoal selection:bg-primary selection:text-white">
      ...
      <section className="relative pt-32 pb-20 md:pt-40 md:pb-28 overflow-hidden">
        <div className="absolute inset-0 bg-[url('/images/industries/deal-handshake.jpg')] bg-cover bg-center opacity-20"></div>
      ...
      <div className="w-full h-96 bg-background overflow-hidden">
        <img 
          src="/images/industries/fin-handshake-city.jpg" 
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <div className="bg-primary/10 border-l-4 border-primary p-6 my-8 rounded-r-xl">
              ...
              <ul className="space-y-3 text-charcoal/80">
                ...
                <li className="flex items-start gap-2"><CheckCircle2 className="w-5 h-5 text-primary flex-shrink-0 mt-0.5" /><span><strong>Revenue details:</strong> Customer-level revenue, cohort analysis, churn metrics</span></li>
                <li className="flex items-start gap-2"><CheckCircle2 className="w-5 h-5 text-primary flex-shrink-0 mt-0.5" /><span><strong>Expense breakdown:</strong> Detailed categorization with headcount allocation</span></li>
                <li className="flex items-start gap-2"><CheckCircle2 className="w-5 h-5 text-primary flex-shrink-0 mt-0.5" /><span><strong>Financial projections:</strong> 3-5 year model with detailed assumptions</span></li>
                <li className="flex items-start gap-2"><CheckCircle2 className="w-5 h-5 text-primary flex-shrink-0 mt-0.5" /><span><strong>Cap table:</strong> Complete ownership structure with all option grants</span></li>
                <li className="flex items-start gap-2"><CheckCircle2 className="w-5 h-5 text-primary flex-shrink-0 mt-0.5" /><span><strong>Banking relationships:</strong> Credit facilities, loan agreements, bank statements</span></li>
              </ul>
            </div>
