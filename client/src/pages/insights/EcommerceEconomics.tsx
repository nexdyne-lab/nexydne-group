      ...
      <section className="relative min-h-[60vh] flex items-center pt-20 overflow-hidden bg-[#051C2C]">
        ...
        <div className="container px-4 md:px-12 relative z-10">
          ...
          >
            ...
            <div className="flex items-center gap-4 text-sm text-[#0077B5] font-semibold mb-6">
          ...
          <div className="grid md:grid-cols-12 gap-12">
            ...
            <div className="md:col-span-3 hidden md:block">
              <div className="sticky top-32">
                ...
                <ul className="space-y-3 text-sm text-[#051C2C]/60 border-l border-[#051C2C]/10 pl-4">
                  <li className="hover:text-[#0077B5] cursor-pointer">The D2C Opportunity</li>
                  <li className="hover:text-[#0077B5] cursor-pointer">Unit Economics Fundamentals</li>
                  <li className="hover:text-[#0077B5] cursor-pointer">Customer Acquisition</li>
                  <li className="hover:text-[#0077B5] cursor-pointer">Fulfillment & Operations</li>
                  <li className="hover:text-[#0077B5] cursor-pointer">Technology Stack</li>
                  <li className="hover:text-[#0077B5] cursor-pointer">Path to Profitability</li>
                </ul>
            ...
            <div className="md:col-span-7">
              <div className="prose prose-lg prose-slate max-w-none">
                ...
                <h2 className="text-2xl font-bold text-[#051C2C] mt-12 mb-6">The D2C Opportunity</h2>
                ...
                <div className="bg-[#F8F9FA] p-8 rounded-xl border border-[#051C2C]/10 my-10">
                  <h4 className="font-bold text-[#051C2C] mb-4 flex items-center gap-2">
                    <DollarSign className="w-5 h-5 text-[#0077B5]" />
                    D2C vs. Traditional Retail Margin Comparison
                  </h4>
                  <div className="space-y-4">
                    <div className="flex items-center gap-4">
                      <span className="w-32 text-sm text-[#051C2C]/60">Traditional Retail</span>
                      <div className="flex-1 bg-[#051C2C]/10 rounded-full h-6 overflow-hidden">
                        <div className="bg-[#051C2C]/40 h-full rounded-full" style={{ width: '35%' }}></div>
                      </div>
                      <span className="w-16 text-sm font-semibold text-[#051C2C]">35%</span>
                    </div>
                    <div className="flex items-center gap-4">
                      <span className="w-32 text-sm text-[#051C2C]/60">Marketplace</span>
                      <div className="flex-1 bg-[#051C2C]/10 rounded-full h-6 overflow-hidden">
                        <div className="bg-[#0077B5]/60 h-full rounded-full" style={{ width: '50%' }}></div>
                      </div>
                      <span className="w-16 text-sm font-semibold text-[#051C2C]">50%</span>
                    </div>
                    <div className="flex items-center gap-4">
                      <span className="w-32 text-sm text-[#051C2C]/60">D2C E-commerce</span>
                      <div className="flex-1 bg-[#051C2C]/10 rounded-full h-6 overflow-hidden">
                        <div className="bg-[#0077B5] h-full rounded-full" style={{ width: '70%' }}></div>
                      </div>
                      <span className="w-16 text-sm font-semibold text-[#0077B5]">70%</span>
                    </div>
                  </div>
                  <p className="text-xs text-[#051C2C]/50 mt-4">*Gross margin before customer acquisition and fulfillment costs</p>
                </div>

                <h2 className="text-2xl font-bold text-[#051C2C] mt-12 mb-6">Unit Economics Fundamentals</h2>
                <p className="text-[#051C2C]/70 leading-relaxed mb-6">
                ...
                <div className="grid md:grid-cols-2 gap-6 my-8">
                  {[
                    ...
                    <div key={index} className="p-6 bg-[#F8F9FA] rounded-xl">
                      ...
                      <h4 className="font-bold text-[#051C2C] mb-2">{metric.title}</h4>
                      <p className="text-[#051C2C]/60 text-sm">{metric.description}</p>
                    </div>
                  ))}
                </div>
                ...
                <div className="bg-[#051C2C] p-8 rounded-xl my-10 text-white">
                  <h4 className="font-bold mb-4 flex items-center gap-2">
                    <BarChart3 className="w-5 h-5 text-[#0077B5]" />
                  ...
                  <div className="space-y-3 text-sm">
                    ...
                    <div className="flex justify-between py-2 text-[#0077B5]">
                ...
                <h2 className="text-2xl font-bold text-[#051C2C] mt-12 mb-6">Customer Acquisition Strategy</h2>
                <p className="text-[#051C2C]/70 leading-relaxed mb-6">
                  ...
                  {[
                    ...
                    <div key={index} className="p-4 border border-[#051C2C]/10 rounded-lg">
                      <div className="flex justify-between items-start mb-2">
                        <h4 className="font-bold text-[#051C2C]">{channel.title}</h4>
                        <span className="text-sm font-semibold text-[#0077B5]">CAC: {channel.cac}</span>
                      </div>
                      <div className="grid md:grid-cols-2 gap-4 text-sm">
                        <div>
                          <span className="text-green-600 font-semibold">+</span>
                          <span className="text-[#051C2C]/60 ml-2">{channel.pros}</span>
                        </div>
                        <div>
                          <span className="text-red-500 font-semibold">-</span>
                          <span className="text-[#051C2C]/60 ml-2">{channel.cons}</span>
                        </div>
                      </div>
                    </div>
                  ))}
                ...
                <h2 className="text-2xl font-bold text-[#051C2C] mt-12 mb-6">Fulfillment & Operations</h2>
                <p className="text-[#051C2C]/70 leading-relaxed mb-6">
                  ...
                  <table className="w-full text-sm">
                    <thead>
                      <tr className="border-b border-[#051C2C]/10">
                        ...
                        <th className="text-left py-3 font-bold text-[#051C2C]">Best For</th>
                        <th className="text-left py-3 font-bold text-[#051C2C]">Cost/Order</th>
                        <th className="text-left py-3 font-bold text-[#051C2C]">Control</th>
                      </tr>
                    </thead>
                ...
                <h2 className="text-2xl font-bold text-[#051C2C] mt-12 mb-6">Technology Stack Decisions</h2>
                <p className="text-[#051C2C]/70 leading-relaxed mb-6">
                ...
                <div className="grid md:grid-cols-2 gap-6 my-8">
                  <div className="p-6 border border-[#051C2C]/10 rounded-xl">
                    <h4 className="font-bold text-[#051C2C] mb-4">All-in-One Platforms</h4>
                    <p className="text-sm text-[#051C2C]/60 mb-4">Shopify, BigCommerce, Squarespace</p>
                    <ul className="space-y-2 text-sm text-[#051C2C]/70">
                      <li className="flex gap-2"><CheckCircle2 className="w-4 h-4 text-green-600 flex-shrink-0" /> Fast time to market</li>
                      <li className="flex gap-2"><CheckCircle2 className="w-4 h-4 text-green-600 flex-shrink-0" /> Lower upfront cost</li>
                      <li className="flex gap-2"><CheckCircle2 className="w-4 h-4 text-green-600 flex-shrink-0" /> Built-in best practices</li>
                      <li className="flex gap-2"><CheckCircle2 className="w-4 h-4 text-red-500 flex-shrink-0" /> Limited customization</li>
                      <li className="flex gap-2"><CheckCircle2 className="w-4 h-4 text-red-500 flex-shrink-0" /> Transaction fees add up</li>
                    </ul>
                  </div>
                  <div className="p-6 border border-[#051C2C]/10 rounded-xl">
                    <h4 className="font-bold text-[#051C2C] mb-4">Composable Commerce</h4>
                    <p className="text-sm text-[#051C2C]/60 mb-4">Headless + best-of-breed components</p>
                    <ul className="space-y-2 text-sm text-[#051C2C]/70">
                      <li className="flex gap-2"><CheckCircle2 className="w-4 h-4 text-green-600 flex-shrink-0" /> Maximum flexibility</li>
                      <li className="flex gap-2"><CheckCircle2 className="w-4 h-4 text-green-600 flex-shrink-0" /> Better performance</li>
                      <li className="flex gap-2"><CheckCircle2 className="w-4 h-4 text-green-600 flex-shrink-0" /> No vendor lock-in</li>
                      <li className="flex gap-2"><CheckCircle2 className="w-4 h-4 text-red-500 flex-shrink-0" /> Higher complexity</li>
                      <li className="flex gap-2"><CheckCircle2 className="w-4 h-4 text-red-500 flex-shrink-0" /> Requires technical team</li>
                    </ul>
                  </div>
                </div>

                <h2 className="text-2xl font-bold text-[#051C2C] mt-12 mb-6">Path to Profitability</h2>
                <p className="text-[#051C2C]/70 leading-relaxed mb-6">
                ...
                <div className="space-y-4 mb-8">
                  {[
                    ...
                    <div key={index} className="flex gap-4 p-4 bg-[#F8F9FA] rounded-lg">
                      <div className="w-8 h-8 bg-[#0077B5] rounded-full flex items-center justify-center text-white font-bold text-sm flex-shrink-0">
                        {index + 1}
                      </div>
                      <div>
                        <h4 className="font-bold text-[#051C2C] mb-1">{lever.title}</h4>
                        <p className="text-[#051C2C]/60 text-sm">{lever.description}</p>
                      </div>
                    </div>
                  ))}
                </div>

                <div className="bg-[#0077B5]/10 p-8 rounded-xl my-10">
                  <h4 className="font-bold text-[#051C2C] mb-4">Ready to build a profitable D2C channel?</h4>
                  ...
                  <Link href="/contact">
                    <Button className="bg-[#0077B5] hover:bg-[#005a8c] text-white">
