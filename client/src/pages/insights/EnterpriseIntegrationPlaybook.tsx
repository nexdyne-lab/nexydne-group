          ...
          >
            ...
            <div className="flex items-center justify-between border-t border-b border-base/10 py-6">
              <div className="flex items-center gap-6">
                <div>
                  <p className="font-bold">NEXDYNE Architecture Team</p>
        ...
        <div className="container px-4 md:px-12">
          <div className="max-w-3xl mx-auto">
            ...
            >
              ...
              <h2 className="text-3xl font-bold mt-12 mb-6">Integration architecture patterns</h2>
            ...
            <motion.div
              ...
              className="prose prose-lg max-w-none"
            >
              <h2 className="text-3xl font-bold mt-12 mb-6">API-first integration strategy</h2>
              ...
              <h3 className="text-2xl font-bold mt-8 mb-4">API Design Principles</h3>
              <p className="text-charcoal/70 leading-relaxed mb-6">
              ...
              <h3 className="text-2xl font-bold mt-8 mb-4">API Gateway & Management</h3>
              <p className="text-charcoal/70 leading-relaxed mb-6">
              ...
              <h3 className="text-2xl font-bold mt-8 mb-4">Developer Experience</h3>
              <p className="text-charcoal/70 leading-relaxed mb-6">
              ...
              <h2 className="text-3xl font-bold mt-12 mb-6">Legacy system integration strategies</h2>
              ...
              <h3 className="text-2xl font-bold mt-8 mb-4">Strangler Fig Pattern</h3>
              <p className="text-charcoal/70 leading-relaxed mb-6">
              ...
              <h3 className="text-2xl font-bold mt-8 mb-4">Anti-Corruption Layer</h3>
              <p className="text-charcoal/70 leading-relaxed mb-6">
              ...
              <h3 className="text-2xl font-bold mt-8 mb-4">Change Data Capture</h3>
              <p className="text-charcoal/70 leading-relaxed mb-6">
              ...
              <h2 className="text-3xl font-bold mt-12 mb-6">Security and compliance</h2>
            ...
            >
              <h3 className="text-xl font-bold mb-6">Integration Security Checklist</h3>
