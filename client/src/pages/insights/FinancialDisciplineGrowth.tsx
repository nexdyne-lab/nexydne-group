        ...
        <div className="container relative z-10 px-4 md:px-12">
          ...
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }} className="max-w-4xl">
            ...
            <h1 className="text-4xl md:text-6xl eb-garamond font-bold tracking-tight leading-[1.1] mb-4">
              Financial Discipline as a <span className="text-[#0077B5]">Growth Enabler</span>
            </h1>
      ...
      <article className="py-16 bg-white text-[#051C2C]">
        <div className="container px-4 md:px-12 max-w-4xl">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }} className="prose prose-lg max-w-none">
            ...
            <h2 className="text-3xl font-serif font-bold text-[#051C2C] mb-6">The Discipline-Growth Paradox</h2>
            ...
            <h2 className="text-3xl font-serif font-bold text-[#051C2C] mb-6">The Foundations of Financial Discipline</h2>
            ...
            <div className="space-y-8 mb-12">
              <div className="flex gap-6">
                ...
                <div>
                  <h3 className="text-xl font-serif font-bold text-[#051C2C] mb-2">Clear Financial Visibility</h3>
                  <p className="text-[#051C2C]/70 leading-relaxed">You can't manage what you can't see. Financial discipline starts with accurate, timely financial reporting that gives leaders the information they need to make good decisions.</p>
                </div>
              </div>
              <div className="flex gap-6">
                ...
                <div>
                  <h3 className="text-xl font-serif font-bold text-[#051C2C] mb-2">Unit Economics Understanding</h3>
                  <p className="text-[#051C2C]/70 leading-relaxed">Know your unit economics cold. What does it cost to acquire a customer? What's the lifetime value? What's the payback period? These metrics should guide every growth investment.</p>
                </div>
              </div>
              <div className="flex gap-6">
                ...
                <div>
                  <h3 className="text-xl font-serif font-bold text-[#051C2C] mb-2">Cash Flow Management</h3>
                  <p className="text-[#051C2C]/70 leading-relaxed">Cash is oxygen. Companies don't die from lack of profit—they die from lack of cash. Disciplined cash flow management ensures you can fund growth without running out of runway.</p>
                </div>
              </div>
            </div>

            <div className="p-8 bg-[#051C2C]/5 rounded-xl mb-12">
              <h3 className="text-xl font-serif font-bold text-[#051C2C] mb-4 flex items-center gap-3"><TrendingUp className="w-6 h-6 text-[#0077B5]" />The Rule of 40</h3>
              <p className="text-[#051C2C]/70 mb-4">A useful benchmark for balancing growth and profitability:</p>
              <div className="p-4 bg-white rounded-lg text-center font-mono text-[#051C2C]">
                Revenue Growth Rate + Profit Margin ≥ 40%
              </div>
              <p className="text-[#051C2C]/70 mt-4">This framework acknowledges that high-growth companies may sacrifice profitability, but there should be limits. A company growing 50% can afford to lose 10%, but a company growing 10% should be profitable.</p>
            </div>

            <h2 className="text-3xl font-serif font-bold text-[#051C2C] mb-6">How Discipline Enables Growth</h2>
            
            <div className="space-y-6 mb-12">
              <div className="p-6 bg-[#051C2C]/5 rounded-xl">
                <h4 className="text-lg font-serif font-bold text-[#051C2C] mb-2">Better Resource Allocation</h4>
                <p className="text-[#051C2C]/70">Financial discipline forces hard choices about where to invest. This focus means resources go to the highest-impact opportunities rather than being spread thin across too many initiatives.</p>
              </div>
              <div className="p-6 bg-[#051C2C]/5 rounded-xl">
                <h4 className="text-lg font-serif font-bold text-[#051C2C] mb-2">Investor Confidence</h4>
                <p className="text-[#051C2C]/70">Investors fund companies they trust. Financial discipline—demonstrated through accurate forecasting, clean books, and thoughtful capital allocation—builds the credibility that attracts capital.</p>
              </div>
              <div className="p-6 bg-[#051C2C]/5 rounded-xl">
                <h4 className="text-lg font-serif font-bold text-[#051C2C] mb-2">Sustainable Scaling</h4>
                <p className="text-[#051C2C]/70">Growth without discipline often leads to chaos—processes break, quality suffers, and culture erodes. Financial discipline provides the guardrails that enable sustainable scaling.</p>
              </div>
            </div>

            <h2 className="text-3xl font-serif font-bold text-[#051C2C] mb-6">Building Financial Discipline</h2>
            <ul className="space-y-4 text-[#051C2C]/70 mb-8">
              <li className="flex items-start gap-3"><CheckCircle2 className="w-5 h-5 text-[#0077B5] flex-shrink-0 mt-0.5" /><span><strong className="text-[#051C2C]">Implement monthly closes:</strong> Close your books within 10 days of month-end. This creates the rhythm and visibility needed for disciplined management.</span></li>
              <li className="flex items-start gap-3"><CheckCircle2 className="w-5 h-5 text-[#0077B5] flex-shrink-0 mt-0.5" /><span><strong className="text-[#051C2C]">Build a rolling forecast:</strong> Replace annual budgets with rolling forecasts that adapt to changing conditions while maintaining accountability.</span></li>
              <li className="flex items-start gap-3"><CheckCircle2 className="w-5 h-5 text-[#0077B5] flex-shrink-0 mt-0.5" /><span><strong className="text-[#051C2C]">Track leading indicators:</strong> Don't just measure results—track the leading indicators that predict future performance.</span></li>
              <li className="flex items-start gap-3"><CheckCircle2 className="w-5 h-5 text-[#0077B5] flex-shrink-0 mt-0.5" /><span><strong className="text-[#051C2C]">Create spending guardrails:</strong> Establish clear approval thresholds and spending policies that empower teams while maintaining control.</span></li>
            </ul>
