      ...
      <article className="py-16">
        <div className="container max-w-3xl">
          <div className="prose prose-lg max-w-none">
            ...
            <h3 className="text-2xl font-bold text-slate-900 mt-8 mb-4">1. Virtual Photoshoots</h3>
            <p className="text-lg text-slate-700 leading-relaxed mb-6">
            ...
            <h3 className="text-2xl font-bold text-slate-900 mt-8 mb-4">2. Dynamic Copy Generation</h3>
            <p className="text-lg text-slate-700 leading-relaxed mb-6">
            ...
            <h3 className="text-2xl font-bold text-slate-900 mt-8 mb-4">3. Automated Assembly</h3>
            <p className="text-lg text-slate-700 leading-relaxed mb-6">
