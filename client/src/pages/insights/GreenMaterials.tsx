        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16">
          ...
          <div className="lg:col-span-8 space-y-12">
            ...
            <section className="prose prose-lg prose-slate max-w-none">
              ...
              <h3 className="text-2xl font-serif font-bold text-slate-900 mt-12 mb-6">The Premium for Green</h3>
              ...
              <h3 className="text-2xl font-serif font-bold text-slate-900 mt-12 mb-6">Technology Breakthroughs</h3>
              <p className="text-slate-600">
              ...
              <h3 className="text-2xl font-serif font-bold text-slate-900 mt-12 mb-6">The Supply Gap</h3>
              <p className="text-slate-600">
              ...
              <h3 className="text-2xl font-serif font-bold text-slate-900 mt-12 mb-6">What Leaders Should Do</h3>
              <p className="text-slate-600">
            ...
            <div className="bg-slate-50 p-8 rounded-sm border border-slate-100 sticky top-24">
              ...
              <ul className="space-y-4 mb-8">
                <li className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-xs text-slate-500">Partner, Seoul</div>
                  </div>
                </li>
                <li className="flex items-center gap-3">
                  <div className="w-10 h-10 bg-slate-200 rounded-full"></div>
                  <div>
                    <div className="font-medium text-slate-900">Dr. Anna Weber</div>
                    <div className="text-xs text-slate-500">Expert Associate Partner, Munich</div>
                  </div>
                </li>
              </ul>
              ...
              <div className="pt-8 border-t border-slate-200">
                ...
                <ul className="space-y-3">
                  ...
                  <li>
                    <Link href="/capabilities/growth-marketing-sales/green-growth/consumer-goods" className="text-slate-600 hover:text-blue-700 transition-colors text-sm block">
                      Consumer Goods
                    </Link>
                  </li>
                </ul>
