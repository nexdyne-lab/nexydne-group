        ...
        <div className="container px-4 md:px-8 lg:px-12">
          <div className="grid lg:grid-cols-[1fr_300px] gap-12 max-w-6xl mx-auto">
            ...
            >
              ...
              <h2 className="text-2xl font-bold text-charcoal mt-12 mb-6 font-serif">Understanding AI Agents</h2>
              ...
              <div className="grid grid-cols-2 gap-4 my-10 not-prose">
                {[
                  ...
                  <div key={i} className="bg-subtle p-5 rounded-lg">
                    <cap.icon className="w-6 h-6 text-primary mb-3" />
                    <h4 className="font-bold text-charcoal text-sm mb-1">{cap.title}</h4>
                    <p className="text-xs text-charcoal/70">{cap.desc}</p>
                  </div>
                ))}
              </div>

              <h2 className="text-2xl font-bold text-charcoal mt-12 mb-6 font-serif">The Evolution from RPA to AI Agents</h2>
              ...
              <h2 className="text-2xl font-bold text-charcoal mt-12 mb-6 font-serif">Enterprise Use Cases</h2>
              ...
              <h3 className="text-xl font-bold text-charcoal mt-8 mb-4">Intelligent Document Processing</h3>
              <p className="text-charcoal/80 leading-relaxed mb-6">
              ...
              <h3 className="text-xl font-bold text-charcoal mt-8 mb-4">Supply Chain Orchestration</h3>
              <p className="text-charcoal/80 leading-relaxed mb-6">
              ...
              <h3 className="text-xl font-bold text-charcoal mt-8 mb-4">IT Operations and Support</h3>
              <p className="text-charcoal/80 leading-relaxed mb-6">
                ...
                <table className="w-full border-collapse">
                  ...
                  <tbody className="text-sm">
                    {[
                      ...
                      <tr key={i} className={i % 2 === 0 ? "bg-subtle" : "bg-white"}>
                        <td className="p-4 font-medium text-charcoal">{row[0]}</td>
                        <td className="p-4 text-charcoal/70">{row[1]}</td>
                        <td className="p-4 text-primary font-medium">{row[2]}</td>
                      </tr>
                    ))}
                  </tbody>
                </table>
              ...
              <h2 className="text-2xl font-bold text-charcoal mt-12 mb-6 font-serif">Implementation Considerations</h2>
              ...
              <h2 className="text-2xl font-bold text-charcoal mt-12 mb-6 font-serif">The Road Ahead</h2>
              ...
              <div className="border-t border-border pt-8 mt-12 not-prose">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <div className="font-bold text-charcoal">NexDyne Technology Team</div>
