      ...
      <article className="py-16">
        <div className="container max-w-3xl">
          <div className="prose prose-lg max-w-none">
            ...
            <h3 className="text-2xl font-bold text-charcoal mt-8 mb-4">1. Real-Time Context</h3>
            <p className="text-lg text-charcoal/80 leading-relaxed mb-6">
            ...
            <h3 className="text-2xl font-bold text-charcoal mt-8 mb-4">2. Predictive Intent</h3>
            <p className="text-lg text-charcoal/80 leading-relaxed mb-6">
            ...
            <h3 className="text-2xl font-bold text-charcoal mt-8 mb-4">3. Omnichannel Consistency</h3>
            <p className="text-lg text-charcoal/80 leading-relaxed mb-6">
