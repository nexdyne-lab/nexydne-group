        ...
        <div className="container relative z-10 px-4 md:px-12 max-w-4xl">
          ...
          >
            ...
            <h1 className="text-4xl md:text-6xl font-serif font-bold tracking-tight leading-[1.1] mb-4">
              The <span className="text-[#0077B5]">100-Day</span> Integration Playbook for Successful M&A
            </h1>
        ...
        <div className="container max-w-3xl px-4 md:px-12">
          <div className="prose prose-lg max-w-none">
            ...
            <div className="bg-[#0077B5]/10 border-l-4 border-[#0077B5] p-6 my-8 rounded-r-xl">
              <h3 className="text-xl font-serif font-bold text-[#051C2C] mb-4">Pre-Close Integration Priorities</h3>
              <ul className="space-y-3 text-[#051C2C]/80">
                <li className="flex items-start gap-2"><CheckCircle2 className="w-5 h-5 text-[#0077B5] flex-shrink-0 mt-0.5" /><span><strong>IMO structure:</strong> Dedicated leader, workstream owners, governance model</span></li>
                <li className="flex items-start gap-2"><CheckCircle2 className="w-5 h-5 text-[#0077B5] flex-shrink-0 mt-0.5" /><span><strong>Day-one plan:</strong> Operational continuity, system access, communication cascade</span></li>
                <li className="flex items-start gap-2"><CheckCircle2 className="w-5 h-5 text-[#0077B5] flex-shrink-0 mt-0.5" /><span><strong>Talent assessment:</strong> Identify critical employees and retention risks</span></li>
                <li className="flex items-start gap-2"><CheckCircle2 className="w-5 h-5 text-[#0077B5] flex-shrink-0 mt-0.5" /><span><strong>Quick wins:</strong> Identify opportunities for immediate value creation</span></li>
                <li className="flex items-start gap-2"><CheckCircle2 className="w-5 h-5 text-[#0077B5] flex-shrink-0 mt-0.5" /><span><strong>Communication plan:</strong> Messages for employees, customers, partners, media</span></li>
                <li className="flex items-start gap-2"><CheckCircle2 className="w-5 h-5 text-[#0077B5] flex-shrink-0 mt-0.5" /><span><strong>Integration roadmap:</strong> 30-day, 60-day, 100-day milestones</span></li>
              </ul>
            </div>
            ...
            <div className="bg-[#051C2C]/5 border-l-4 border-[#051C2C]/30 p-6 my-8 rounded-r-xl">
              <h3 className="text-xl font-serif font-bold text-[#051C2C] mb-4">30-Day Milestone Checklist</h3>
              <ul className="space-y-3 text-[#051C2C]/80">
            ...
            <div className="bg-[#0077B5]/10 border-l-4 border-[#0077B5] p-6 my-8 rounded-r-xl">
              <h3 className="text-xl font-serif font-bold text-[#051C2C] mb-4">100-Day Success Metrics</h3>
              <ul className="space-y-3 text-[#051C2C]/80">
            ...
            <div className="bg-[#051C2C]/5 border-l-4 border-[#051C2C]/30 p-6 my-8 rounded-r-xl">
              <h3 className="text-xl font-serif font-bold text-[#051C2C] mb-4">Synergy Categories and Timing</h3>
              <ul className="space-y-3 text-[#051C2C]/80">
