        ...
        <div className="container relative z-10 px-4 md:px-12">
          ...
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }} className="max-w-4xl">
            ...
            <h1 className="text-4xl md:text-6xl font-serif font-bold tracking-tight leading-[1.1] mb-4">
              Building <span className="text-[#0077B5]">Investor-Ready</span> Board Decks
            </h1>
      ...
      <article className="py-16 bg-white text-[#051C2C]">
        <div className="container px-4 md:px-12 max-w-4xl">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }} className="prose prose-lg max-w-none">
            ...
            <h2 className="text-3xl font-serif font-bold text-[#051C2C] mb-6">The Board Deck as a Signal</h2>
            ...
            <h2 className="text-3xl font-serif font-bold text-[#051C2C] mb-6">The Essential Board Deck Structure</h2>
            
            <div className="p-8 bg-[#051C2C]/5 rounded-xl mb-12">
              <h3 className="text-xl font-serif font-bold text-[#051C2C] mb-4 flex items-center gap-3"><Presentation className="w-6 h-6 text-[#0077B5]" />Core Sections</h3>
              <div className="space-y-4 text-[#051C2C]/70">
                <p><strong className="text-[#051C2C]">1. Executive Summary (1-2 slides):</strong> Key highlights, critical issues, and decisions needed. Board members should understand the state of the business in 2 minutes.</p>
                <p><strong className="text-[#051C2C]">2. Financial Performance (3-5 slides):</strong> P&L, cash flow, key metrics vs. plan and prior year. Focus on trends and drivers, not just numbers.</p>
                <p><strong className="text-[#051C2C]">3. Operational Highlights (2-3 slides):</strong> Product, sales, marketing, and team updates. Focus on what moved the needle.</p>
                <p><strong className="text-[#051C2C]">4. Strategic Initiatives (2-3 slides):</strong> Progress on key initiatives, milestones achieved, and roadblocks encountered.</p>
                <p><strong className="text-[#051C2C]">5. Discussion Topics (1-2 slides):</strong> Specific questions or decisions requiring board input.</p>
              </div>
            </div>

            <h2 className="text-3xl font-serif font-bold text-[#051C2C] mb-6">Financial Reporting Best Practices</h2>
            ...
            <div className="space-y-8 mb-12">
              <div className="flex gap-6">
                ...
                <div>
                  <h3 className="text-xl font-serif font-bold text-[#051C2C] mb-2">Show Trends, Not Just Numbers</h3>
                  <p className="text-[#051C2C]/70 leading-relaxed">A single month's numbers mean little without context. Show 12-month trends, year-over-year comparisons, and performance vs. plan. Make it easy to see whether things are getting better or worse.</p>
                </div>
              </div>
              <div className="flex gap-6">
                ...
                <div>
                  <h3 className="text-xl font-serif font-bold text-[#051C2C] mb-2">Explain the Drivers</h3>
                  <p className="text-[#051C2C]/70 leading-relaxed">Don't just report that revenue was up 15%—explain why. Was it new customers, expansion, pricing, or mix? Understanding drivers enables better discussion and decision-making.</p>
                </div>
              </div>
              <div className="flex gap-6">
                ...
                <div>
                  <h3 className="text-xl font-serif font-bold text-[#051C2C] mb-2">Surface Issues Proactively</h3>
                  <p className="text-[#051C2C]/70 leading-relaxed">Nothing erodes board trust faster than surprises. If something is going wrong, surface it early with a clear explanation of what happened, what you're doing about it, and what help you need.</p>
                </div>
              </div>
            </div>

            <h2 className="text-3xl font-serif font-bold text-[#051C2C] mb-6">Key Metrics to Include</h2>
            <ul className="space-y-4 text-[#051C2C]/70 mb-8">
              <li className="flex items-start gap-3"><CheckCircle2 className="w-5 h-5 text-[#0077B5] flex-shrink-0 mt-0.5" /><span><strong className="text-[#051C2C]">Revenue metrics:</strong> ARR/MRR, growth rate, net revenue retention, new vs. expansion revenue</span></li>
              <li className="flex items-start gap-3"><CheckCircle2 className="w-5 h-5 text-[#0077B5] flex-shrink-0 mt-0.5" /><span><strong className="text-[#051C2C]">Unit economics:</strong> CAC, LTV, LTV/CAC ratio, payback period</span></li>
              <li className="flex items-start gap-3"><CheckCircle2 className="w-5 h-5 text-[#0077B5] flex-shrink-0 mt-0.5" /><span><strong className="text-[#051C2C]">Cash metrics:</strong> Cash balance, burn rate, runway, cash flow from operations</span></li>
              <li className="flex items-start gap-3"><CheckCircle2 className="w-5 h-5 text-[#0077B5] flex-shrink-0 mt-0.5" /><span><strong className="text-[#051C2C]">Operational metrics:</strong> Customer count, churn rate, NPS, employee headcount</span></li>
            </ul>
            ...
            <div className="space-y-6 mb-12">
              <div className="p-6 bg-[#051C2C]/5 rounded-xl">
                <h4 className="text-lg font-serif font-bold text-[#051C2C] mb-2">Too Much Detail</h4>
                <p className="text-[#051C2C]/70">Board decks should be strategic, not operational. Resist the urge to include every metric and update. Focus on what matters most and put details in an appendix.</p>
              </div>
              <div className="p-6 bg-[#051C2C]/5 rounded-xl">
                <h4 className="text-lg font-serif font-bold text-[#051C2C] mb-2">No Clear Narrative</h4>
                <p className="text-[#051C2C]/70">Data without narrative is confusing. Your deck should tell a coherent story about where the business is, where it's going, and what's needed to get there.</p>
              </div>
              <div className="p-6 bg-[#051C2C]/5 rounded-xl">
                <h4 className="text-lg font-serif font-bold text-[#051C2C] mb-2">Late Distribution</h4>
                <p className="text-[#051C2C]/70">Send materials at least 3-5 days before the meeting. Board members need time to review and come prepared with thoughtful questions.</p>
              </div>
            </div>
