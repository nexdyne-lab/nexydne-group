      ...
      <article className="py-16">
        <div className="container max-w-3xl">
          <div className="prose prose-lg max-w-none">
            ...
            <h3 className="text-2xl font-bold text-charcoal mt-8 mb-4">1. Location & Status</h3>
            <p className="text-lg text-charcoal/80 leading-relaxed mb-6">
            ...
            <h3 className="text-2xl font-bold text-charcoal mt-8 mb-4">2. Condition Monitoring</h3>
            <p className="text-lg text-charcoal/80 leading-relaxed mb-6">
            ...
            <h3 className="text-2xl font-bold text-charcoal mt-8 mb-4">3. Contextual Intelligence</h3>
            <p className="text-lg text-charcoal/80 leading-relaxed mb-6">
