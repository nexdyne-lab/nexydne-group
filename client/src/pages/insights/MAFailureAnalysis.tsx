        ...
        <div className="container relative z-10 px-4 md:px-12 max-w-4xl">
          ...
          >
            ...
            <h1 className="text-4xl md:text-6xl font-serif font-bold tracking-tight leading-[1.1] mb-4">
              Why Most Acquisitions <span className="text-[#0077B5]">Fail</span> and How to Beat the Odds
            </h1>
        ...
        <div className="container max-w-3xl px-4 md:px-12">
          <div className="prose prose-lg max-w-none">
            ...
            <div className="bg-red-50 border-l-4 border-red-500 p-6 my-8 rounded-r-xl">
              <h3 className="text-xl font-serif font-bold text-[#051C2C] mb-4 flex items-center gap-2">
            ...
            <h2 className="text-3xl font-serif font-bold text-[#051C2C] mt-12 mb-6 flex items-center gap-3">
              <Target className="w-8 h-8 text-[#0077B5]" />
            ...
            <div className="bg-[#0077B5]/10 border-l-4 border-[#0077B5] p-6 my-8 rounded-r-xl">
              <h3 className="text-xl font-serif font-bold text-[#051C2C] mb-4">Strategic Fit Assessment Questions</h3>
              <ul className="space-y-3 text-[#051C2C]/80">
            ...
            <h2 className="text-3xl font-serif font-bold text-[#051C2C] mt-12 mb-6 flex items-center gap-3">
              <Puzzle className="w-8 h-8 text-[#0077B5]" />
            ...
            <div className="bg-[#051C2C]/5 border-l-4 border-[#051C2C]/30 p-6 my-8 rounded-r-xl">
              <h3 className="text-xl font-serif font-bold text-[#051C2C] mb-4">Integration Success Factors</h3>
              <ul className="space-y-3 text-[#051C2C]/80">
            ...
            <div className="bg-[#0077B5]/10 border-l-4 border-[#0077B5] p-6 my-8 rounded-r-xl">
              <h3 className="text-xl font-serif font-bold text-[#051C2C] mb-4">M&A Excellence Framework</h3>
              <ul className="space-y-3 text-[#051C2C]/80">
                <li className="flex items-start gap-2"><CheckCircle2 className="w-5 h-5 text-[#0077B5] flex-shrink-0 mt-0.5" /><span><strong>Strategic clarity:</strong> Explicit criteria for target selection and evaluation</span></li>
                <li className="flex items-start gap-2"><CheckCircle2 className="w-5 h-5 text-[#0077B5] flex-shrink-0 mt-0.5" /><span><strong>Disciplined valuation:</strong> Walk-away prices set before negotiations begin</span></li>
                <li className="flex items-start gap-2"><CheckCircle2 className="w-5 h-5 text-[#0077B5] flex-shrink-0 mt-0.5" /><span><strong>Comprehensive diligence:</strong> Financial, strategic, cultural, and operational assessment</span></li>
                <li className="flex items-start gap-2"><CheckCircle2 className="w-5 h-5 text-[#0077B5] flex-shrink-0 mt-0.5" /><span><strong>Integration planning:</strong> Detailed plans developed during due diligence</span></li>
                <li className="flex items-start gap-2"><CheckCircle2 className="w-5 h-5 text-[#0077B5] flex-shrink-0 mt-0.5" /><span><strong>Talent focus:</strong> Proactive retention programs for critical employees</span></li>
                <li className="flex items-start gap-2"><CheckCircle2 className="w-5 h-5 text-[#0077B5] flex-shrink-0 mt-0.5" /><span><strong>Synergy accountability:</strong> Clear ownership and tracking of value creation</span></li>
                <li className="flex items-start gap-2"><CheckCircle2 className="w-5 h-5 text-[#0077B5] flex-shrink-0 mt-0.5" /><span><strong>Learning culture:</strong> Post-mortem reviews to improve future deals</span></li>
              </ul>
            </div>
