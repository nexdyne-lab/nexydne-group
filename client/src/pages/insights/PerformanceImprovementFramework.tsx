    ...
    <div className="min-h-screen bg-white">
        ...
        <div className="container max-w-4xl">
          ...
          <div className="space-y-6">
            <div className="inline-block px-4 py-1.5 bg-primary/10 border border-primary/20 rounded-full">
              <span className="text-amber text-sm font-medium">Performance Improvement</span>
            </div>
            ...
            <div className="flex flex-wrap items-center gap-6 text-muted-foreground/50">
              ...
              <Button variant="ghost" size="sm" className="text-muted-foreground/50 hover:text-white">
      ...
      <article className="container max-w-4xl py-16">
        <div className="prose prose-lg max-w-none">
          ...
          {/* Section 1 */}
          <div className="mb-12">
            <h2 className="text-3xl font-bold text-charcoal mb-6">The Performance Improvement Challenge</h2>
            ...
            <div className="bg-off-white border-l-4 border-primary p-6 my-8">
              <h3 className="text-xl font-semibold text-charcoal mb-3">Common Performance Improvement Pitfalls</h3>
          ...
          {/* Section 2 */}
          <div className="mb-12">
            <h2 className="text-3xl font-bold text-charcoal mb-6">The Four-Phase Performance Improvement Framework</h2>
            ...
            <div className="space-y-8 my-8">
              <div className="bg-gradient-to-br from-primary to-primary rounded-lg p-6">
                <h3 className="text-2xl font-semibold text-charcoal mb-4">Phase 1: Diagnostic Assessment</h3>
              ...
              <div className="bg-gradient-to-br from-primary to-primary rounded-lg p-6">
                <h3 className="text-2xl font-semibold text-charcoal mb-4">Phase 2: Solution Design</h3>
                <p className="text-charcoal/80 leading-relaxed mb-4">
              ...
              <div className="bg-gradient-to-br from-primary to-primary rounded-lg p-6">
                <h3 className="text-2xl font-semibold text-charcoal mb-4">Phase 3: Implementation Execution</h3>
                <p className="text-charcoal/80 leading-relaxed mb-4">
              ...
              <div className="bg-gradient-to-br from-primary to-primary rounded-lg p-6">
                <h3 className="text-2xl font-semibold text-charcoal mb-4">Phase 4: Sustainability and Continuous Improvement</h3>
                <p className="text-charcoal/80 leading-relaxed mb-4">
          ...
          {/* Section 3 */}
          <div className="mb-12">
            <h2 className="text-3xl font-bold text-charcoal mb-6">Critical Success Factors</h2>
            ...
            <div className="grid md:grid-cols-2 gap-6 my-8">
              <div className="border border-border rounded-lg p-6">
                <h4 className="text-lg font-semibold text-charcoal mb-3">Executive Sponsorship</h4>
              ...
              <div className="border border-border rounded-lg p-6">
                <h4 className="text-lg font-semibold text-charcoal mb-3">Data-Driven Decision Making</h4>
                <p className="text-charcoal/80">
              ...
              <div className="border border-border rounded-lg p-6">
                <h4 className="text-lg font-semibold text-charcoal mb-3">Cross-Functional Collaboration</h4>
                <p className="text-charcoal/80">
              ...
              <div className="border border-border rounded-lg p-6">
                <h4 className="text-lg font-semibold text-charcoal mb-3">Change Management Discipline</h4>
                <p className="text-charcoal/80">
              ...
              <div className="border border-border rounded-lg p-6">
                <h4 className="text-lg font-semibold text-charcoal mb-3">Balanced Metrics</h4>
                <p className="text-charcoal/80">
              ...
              <div className="border border-border rounded-lg p-6">
                <h4 className="text-lg font-semibold text-charcoal mb-3">Iterative Approach</h4>
                <p className="text-charcoal/80">
          ...
          {/* Section 4 */}
          <div className="mb-12">
            <h2 className="text-3xl font-bold text-charcoal mb-6">Measuring and Sustaining Impact</h2>
            ...
            <div className="bg-off-white rounded-lg p-6 my-8">
              <h4 className="text-lg font-semibold text-charcoal mb-3">Key Performance Indicators to Track</h4>
          ...
          {/* Conclusion */}
          <div className="mb-12">
            <h2 className="text-3xl font-bold text-charcoal mb-6">Building a Performance-Driven Organization</h2>
          ...
          {/* CTA Section */}
          <div className="bg-charcoal text-white rounded-lg p-8 my-12">
      ...
      <section className="bg-off-white py-16">
        <div className="container max-w-6xl">
          <h2 className="text-3xl font-bold text-charcoal mb-8">Related Insights</h2>
          <div className="grid md:grid-cols-3 gap-8">
            <Link href="/insights/business-transformation-strategy">
              <div className="bg-white rounded-lg overflow-hidden shadow-sm hover:shadow-md transition-shadow cursor-pointer">
                <div className="h-48 bg-gradient-to-br from-charcoal to-charcoal"></div>
                <div className="p-6">
                  <div className="text-sm text-primary font-medium mb-2">Business Transformation</div>
            ...
            <Link href="/services/strategy-corporate-finance">
              <div className="bg-white rounded-lg overflow-hidden shadow-sm hover:shadow-md transition-shadow cursor-pointer">
                <div className="h-48 bg-gradient-to-br from-primary to-primary"></div>
                <div className="p-6">
