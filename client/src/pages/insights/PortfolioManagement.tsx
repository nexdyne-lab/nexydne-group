      ...
      <article className="py-16 bg-white text-charcoal">
        <div className="container px-4 md:px-12 max-w-4xl">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }} className="prose prose-lg max-w-none">
            ...
            <h2 className="text-3xl font-bold text-charcoal mb-6">The Portfolio Challenge</h2>
            ...
            <h2 className="text-3xl font-bold text-charcoal mb-6">The Portfolio Management Framework</h2>
            ...
            <h2 className="text-3xl font-bold text-charcoal mb-6">Portfolio Governance</h2>
            <p className="text-charcoal/80 leading-relaxed mb-6">
            ...
            <h2 className="text-3xl font-bold text-charcoal mb-6">Common Portfolio Mistakes</h2>
