      ...
      <article className="py-16 bg-white text-charcoal">
        <div className="container px-4 md:px-12 max-w-4xl">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }} className="prose prose-lg max-w-none">
            ...
            <h2 className="text-3xl font-serif font-bold text-charcoal mb-6">The Portfolio Challenge</h2>
            ...
            <h2 className="text-3xl font-serif font-bold text-charcoal mb-6">The Portfolio Management Framework</h2>
            ...
            <div className="space-y-8 mb-12">
              <div className="flex gap-6">
                ...
                <div>
                  <h3 className="text-xl font-serif font-bold text-charcoal mb-2">Strategic Alignment</h3>
              ...
              <div className="flex gap-6">
                ...
                <div>
                  <h3 className="text-xl font-serif font-bold text-charcoal mb-2">Value Assessment</h3>
              ...
              <div className="flex gap-6">
                ...
                <div>
                  <h3 className="text-xl font-serif font-bold text-charcoal mb-2">Resource Capacity</h3>
              ...
              <div className="flex gap-6">
                ...
                <div>
                  <h3 className="text-xl font-serif font-bold text-charcoal mb-2">Portfolio Balance</h3>
            ...
            <div className="p-8 bg-base/5 rounded-xl mb-12">
              <h3 className="text-xl font-serif font-bold text-charcoal mb-4 flex items-center gap-3"><Briefcase className="w-6 h-6 text-primary" />The Three Horizons Model</h3>
              ...
              <ul className="space-y-3 text-charcoal/70">
                <li className="flex items-start gap-3"><CheckCircle2 className="w-5 h-5 text-primary flex-shrink-0 mt-0.5" /><span><strong className="text-charcoal">Horizon 1 (70%):</strong> Core business improvements with near-term payback</span></li>
                <li className="flex items-start gap-3"><CheckCircle2 className="w-5 h-5 text-primary flex-shrink-0 mt-0.5" /><span><strong className="text-charcoal">Horizon 2 (20%):</strong> Emerging opportunities with medium-term potential</span></li>
                <li className="flex items-start gap-3"><CheckCircle2 className="w-5 h-5 text-primary flex-shrink-0 mt-0.5" /><span><strong className="text-charcoal">Horizon 3 (10%):</strong> Transformational bets with long-term upside</span></li>
              </ul>
            </div>

            <h2 className="text-3xl font-serif font-bold text-charcoal mb-6">Portfolio Governance</h2>
            <p className="text-charcoal/80 leading-relaxed mb-6">
            ...
            <div className="space-y-6 mb-12">
              <div className="p-6 bg-base/5 rounded-xl">
                <h4 className="text-lg font-serif font-bold text-charcoal mb-2">Portfolio Review Board</h4>
              ...
              <div className="p-6 bg-base/5 rounded-xl">
                <h4 className="text-lg font-serif font-bold text-charcoal mb-2">Stage-Gate Process</h4>
              ...
              <div className="p-6 bg-base/5 rounded-xl">
                <h4 className="text-lg font-serif font-bold text-charcoal mb-2">Portfolio Dashboard</h4>
            ...
            <h2 className="text-3xl font-serif font-bold text-charcoal mb-6">Common Portfolio Mistakes</h2>
            <ul className="space-y-4 text-charcoal/70 mb-8">
              <li className="flex items-start gap-3"><CheckCircle2 className="w-5 h-5 text-primary flex-shrink-0 mt-0.5" /><span><strong className="text-charcoal">Too many initiatives:</strong> Spreading resources too thin means nothing gets done well. Focus on fewer, bigger bets.</span></li>
              <li className="flex items-start gap-3"><CheckCircle2 className="w-5 h-5 text-primary flex-shrink-0 mt-0.5" /><span><strong className="text-charcoal">Failure to kill:</strong> Continuing to fund underperforming initiatives because of sunk costs or politics. Be willing to cut losses.</span></li>
              <li className="flex items-start gap-3"><CheckCircle2 className="w-5 h-5 text-primary flex-shrink-0 mt-0.5" /><span><strong className="text-charcoal">Short-term bias:</strong> Over-investing in quick wins at the expense of longer-term transformation.</span></li>
