      ...
      <article className="py-16">
        <div className="container max-w-3xl mx-auto px-4">
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <h2 className="text-3xl font-bold text-slate-900 mt-12 mb-6">The Anchor and the Frame</h2>
            <p className="text-lg text-slate-700 leading-relaxed mb-6">
            ...
            <h2 className="text-3xl font-bold text-slate-900 mt-12 mb-6">The Decoy Effect</h2>
            <p className="text-lg text-slate-700 leading-relaxed mb-6">
            ...
            <h2 className="text-3xl font-bold text-slate-900 mt-12 mb-6">Willingness-to-Pay (WTP) is Not Fixed</h2>
            <p className="text-lg text-slate-700 leading-relaxed mb-6">
            ...
            <h2 className="text-3xl font-bold text-slate-900 mt-12 mb-6">Moving to Value-Based Pricing</h2>
            <p className="text-lg text-slate-700 leading-relaxed mb-6">
