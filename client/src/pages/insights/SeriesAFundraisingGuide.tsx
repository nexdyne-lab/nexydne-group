        ...
        <div className="container relative z-10 px-4 md:px-12 max-w-4xl">
          ...
          >
            ...
            <h1 className="text-4xl md:text-6xl font-serif font-bold tracking-tight leading-[1.1] mb-4">
              The Complete Guide to <span className="text-[#0077B5]">Series A Fundraising</span> Preparation
            </h1>
        ...
        <div className="container max-w-3xl px-4 md:px-12">
          <div className="prose prose-lg max-w-none">
            ...
            <div className="bg-[#0077B5]/10 border-l-4 border-[#0077B5] p-6 my-8 rounded-r-xl">
              <h3 className="text-xl font-serif font-bold text-[#051C2C] mb-4">The Series A Readiness Checklist</h3>
            ...
            <div className="bg-[#051C2C]/5 border-l-4 border-[#051C2C]/30 p-6 my-8 rounded-r-xl">
              <h3 className="text-xl font-serif font-bold text-[#051C2C] mb-4">Narrative Structure That Resonates</h3>
              <p className="text-[#051C2C]/70 mb-4">Structure your pitch around these five core elements:</p>
              <ul className="space-y-3 text-[#051C2C]/80">
            ...
            <div className="bg-[#0077B5]/10 border-l-4 border-[#0077B5] p-6 my-8 rounded-r-xl">
              <h3 className="text-xl font-serif font-bold text-[#051C2C] mb-4">Six-Month Pre-Fundraise Preparation Timeline</h3>
              <ul className="space-y-3 text-[#051C2C]/80">
