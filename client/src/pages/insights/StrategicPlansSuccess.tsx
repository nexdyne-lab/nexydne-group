      ...
      <article className="py-16 bg-white text-charcoal">
        <div className="container px-4 md:px-12 max-w-4xl">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }} className="prose prose-lg max-w-none">
            ...
            <h2 className="text-3xl font-serif font-bold text-charcoal mb-6">The Strategy-Execution Gap</h2>
            ...
            <h2 className="text-3xl font-serif font-bold text-charcoal mb-6">Why Strategies Fail</h2>
            
            <div className="p-8 bg-base/5 rounded-xl mb-12">
              <h3 className="text-xl font-serif font-bold text-charcoal mb-4 flex items-center gap-3"><Target className="w-6 h-6 text-primary" />Common Failure Modes</h3>
            ...
            <h2 className="text-3xl font-serif font-bold text-charcoal mb-6">A Framework for Executable Strategy</h2>
            ...
            <div className="space-y-8 mb-12">
              <div className="flex gap-6">
                ...
                <div>
                  <h3 className="text-xl font-serif font-bold text-charcoal mb-2">1. Make Hard Choices</h3>
              ...
              <div className="flex gap-6">
                ...
                <div>
                  <h3 className="text-xl font-serif font-bold text-charcoal mb-2">2. Define Clear Outcomes</h3>
              ...
              <div className="flex gap-6">
                ...
                <div>
                  <h3 className="text-xl font-serif font-bold text-charcoal mb-2">3. Assign Clear Ownership</h3>
              ...
              <div className="flex gap-6">
                ...
                <div>
                  <h3 className="text-xl font-serif font-bold text-charcoal mb-2">4. Build Execution Rhythms</h3>
            ...
            <h2 className="text-3xl font-serif font-bold text-charcoal mb-6">Cascading Strategy Through the Organization</h2>
            <p className="text-charcoal/80 leading-relaxed mb-6">
            ...
            <div className="space-y-6 mb-12">
              <div className="p-6 bg-base/5 rounded-xl">
                <h4 className="text-lg font-serif font-bold text-charcoal mb-2">Corporate Level</h4>
                <p className="text-charcoal/70">3-5 strategic priorities with clear outcomes and timelines</p>
              </div>
              <div className="p-6 bg-base/5 rounded-xl">
                <h4 className="text-lg font-serif font-bold text-charcoal mb-2">Business Unit Level</h4>
                <p className="text-charcoal/70">Specific initiatives that support corporate priorities, with BU-level metrics</p>
              </div>
              <div className="p-6 bg-base/5 rounded-xl">
                <h4 className="text-lg font-serif font-bold text-charcoal mb-2">Team Level</h4>
                <p className="text-charcoal/70">Quarterly objectives and key results (OKRs) aligned to BU initiatives</p>
              </div>
              <div className="p-6 bg-base/5 rounded-xl">
                <h4 className="text-lg font-serif font-bold text-charcoal mb-2">Individual Level</h4>
                <p className="text-charcoal/70">Personal goals and development plans connected to team OKRs</p>
              </div>
            </div>

            <h2 className="text-3xl font-serif font-bold text-charcoal mb-6">The Role of Leadership</h2>
            <p className="text-charcoal/80 leading-relaxed mb-6">
