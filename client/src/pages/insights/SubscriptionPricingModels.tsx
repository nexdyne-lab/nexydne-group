    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="bg-charcoal text-white py-16 md:py-24">
        <div className="container max-w-4xl mx-auto px-4">
          <Link href="/capabilities/growth-marketing-sales/pricing-monetization" className="inline-flex items-center gap-2 text-primary hover:text-primary mb-8 transition-colors">
      ...
      <article className="py-16">
        <div className="container max-w-3xl mx-auto px-4">
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <h2 className="text-3xl font-bold text-charcoal mt-12 mb-6">The Rise of Usage-Based Pricing (UBP)</h2>
            <p className="text-lg text-charcoal/80 leading-relaxed mb-6">
            ...
            <h2 className="text-3xl font-bold text-charcoal mt-12 mb-6">The Hybrid Model: Best of Both Worlds</h2>
            <p className="text-lg text-charcoal/80 leading-relaxed mb-6">
            ...
            <h2 className="text-3xl font-bold text-charcoal mt-12 mb-6">Good/Better/Best Tiering</h2>
            <p className="text-lg text-charcoal/80 leading-relaxed mb-6">
            ...
            <h2 className="text-3xl font-bold text-charcoal mt-12 mb-6">The Psychology of the "Per User" Seat</h2>
            <p className="text-lg text-charcoal/80 leading-relaxed mb-6">
