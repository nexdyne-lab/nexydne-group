        ...
        <div className="container relative z-10 px-4 md:px-12 max-w-4xl">
          ...
          >
            ...
            <h1 className="text-4xl md:text-6xl font-serif font-bold tracking-tight leading-[1.1] mb-4">
              Five Valuation Mistakes That <span className="text-[#0077B5]">Cost Founders Millions</span>
            </h1>
        ...
        <div className="container max-w-3xl px-4 md:px-12">
          <div className="prose prose-lg max-w-none">
            ...
            <div className="bg-[#0077B5]/10 border-l-4 border-[#0077B5] p-6 my-8 rounded-r-xl">
              <h3 className="text-xl font-serif font-bold text-[#051C2C] mb-4">Dilution Management Strategies</h3>
              <ul className="space-y-3 text-[#051C2C]/80">
            ...
            <div className="bg-[#051C2C]/5 border-l-4 border-[#051C2C]/30 p-6 my-8 rounded-r-xl">
              <h3 className="text-xl font-serif font-bold text-[#051C2C] mb-4">Exit Scenario Modeling Example</h3>
              <p className="text-[#051C2C]/70 mb-4">Company raises $30M total across three rounds with 1.5x average liquidation preference:</p>
              <ul className="space-y-3 text-[#051C2C]/80">
              ...
              <p className="text-[#051C2C]/70 mt-4">Notice how liquidation preferences devastate founder outcomes in modest exits but become irrelevant in large exits.</p>
            </div>
