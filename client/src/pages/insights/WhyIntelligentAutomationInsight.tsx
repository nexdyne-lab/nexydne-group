        ...
        <div className="container px-4 md:px-8 lg:px-12">
          <div className="grid lg:grid-cols-[1fr_300px] gap-12 max-w-6xl mx-auto">
            ...
            >
              ...
              <h2 className="text-2xl font-bold text-[#1A1A1A] mt-12 mb-6 font-serif">The New Competitive Reality</h2>
              ...
              <h2 className="text-2xl font-bold text-[#1A1A1A] mt-12 mb-6 font-serif">Three Forces Driving the Imperative</h2>

              <h3 className="text-xl font-bold text-[#1A1A1A] mt-8 mb-4">1. Labor Market Dynamics</h3>
              <p className="text-[#1A1A1A]/80 leading-relaxed mb-6">
              ...
              <h3 className="text-xl font-bold text-[#1A1A1A] mt-8 mb-4">2. Customer Expectations</h3>
              <p className="text-[#1A1A1A]/80 leading-relaxed mb-6">
              ...
              <h3 className="text-xl font-bold text-[#1A1A1A] mt-8 mb-4">3. Data Complexity</h3>
              <p className="text-[#1A1A1A]/80 leading-relaxed mb-6">
              ...
              {/* Statistics Box */}
              <div className="bg-[#F5F5F5] p-8 rounded-lg my-10 not-prose">
                <h4 className="text-lg font-bold text-[#1A1A1A] mb-6">The Automation Imperative: By the Numbers</h4>
                <div className="grid grid-cols-2 gap-6">
                  {[
                    ...
                    <div key={i}>
                      <div className="text-3xl font-bold text-[#0077B5]">{item.stat}</div>
                      <div className="text-sm text-[#1A1A1A]/70 mt-1">{item.desc}</div>
                    </div>
                  ))}
                </div>
              </div>

              <h2 className="text-2xl font-bold text-[#1A1A1A] mt-12 mb-6 font-serif">What Separates Leaders from Laggards</h2>
              ...
              <h2 className="text-2xl font-bold text-[#1A1A1A] mt-12 mb-6 font-serif">The Path Forward</h2>
              ...
              <div className="border-t border-gray-200 pt-8 mt-12 not-prose">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <div className="font-bold text-[#1A1A1A]">NexDyne Strategy Team</div>
