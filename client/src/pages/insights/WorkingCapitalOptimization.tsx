        ...
        <div className="container px-4 md:px-12 max-w-4xl">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }} className="prose prose-lg max-w-none">
            ...
            <ul className="space-y-4 text-charcoal/70 mb-8">
              ...
              <li className="flex items-start gap-3"><CheckCircle2 className="w-5 h-5 text-primary flex-shrink-0 mt-0.5" /><span><strong className="text-charcoal">Demand planning:</strong> Improve forecast accuracy to reduce the need for buffer stock.</span></li>
            ...
            <ul className="space-y-4 text-charcoal/70 mb-8">
              ...
              <li className="flex items-start gap-3"><CheckCircle2 className="w-5 h-5 text-primary flex-shrink-0 mt-0.5" /><span><strong className="text-charcoal">Collections process:</strong> Implement systematic dunning and escalation processes.</span></li>
