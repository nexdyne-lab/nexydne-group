...
export default function ConversionOptimization() {
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="py-20 bg-white">
        <div className="container max-w-4xl">
          ...
          <div className="mt-12 p-8 bg-rose-50 rounded-2xl border-l-4 border-rose-600">
            ...
            <p className="mt-4 text-slate-700 font-semibold">— Robert Martinez</p>
          </div>
        </div>
      </section>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div>
              ...
              <div className="mb-8">
                ...
                <p className="text-slate-600">CRO Director</p>
              </div>
        ...
        <div className="container">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white p-12 rounded-xl border border-slate-200 hover:shadow-lg transition-all duration-300 flex items-center justify-center">
              <h3 className="text-2xl font-bold text-slate-800">Bloomreach</h3>
            </div>
            <div className="bg-white p-12 rounded-xl border border-slate-200 hover:shadow-lg transition-all duration-300 flex items-center justify-center">
              <h3 className="text-2xl font-bold text-slate-800">Commercetools</h3>
            </div>
            <div className="bg-white p-12 rounded-xl border border-slate-200 hover:shadow-lg transition-all duration-300 flex items-center justify-center">
              <h3 className="text-2xl font-bold text-slate-800">Tweakwise</h3>
            </div>
            <div className="bg-white p-12 rounded-xl border border-slate-200 hover:shadow-lg transition-all duration-300 flex items-center justify-center">
              <h3 className="text-2xl font-bold text-slate-800">Sitecore</h3>
            </div>
            <div className="bg-white p-12 rounded-xl border border-slate-200 hover:shadow-lg transition-all duration-300 flex items-center justify-center">
              <h3 className="text-2xl font-bold text-slate-800">Optimizely</h3>
            </div>
            <div className="bg-white p-12 rounded-xl border border-slate-200 hover:shadow-lg transition-all duration-300 flex items-center justify-center">
              <h3 className="text-2xl font-bold text-slate-800">VWO</h3>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="group cursor-pointer">
              ...
              <div className="flex items-center gap-4 text-sm">
                ...
                <span className="text-slate-600">B2B SaaS</span>
              </div>
            </div>
            ...
            <div className="group cursor-pointer">
              ...
              <div className="flex items-center gap-4 text-sm">
                ...
                <span className="text-slate-400">|</span>
                <span className="text-slate-600">Financial Services</span>
              </div>
            </div>
          </div>
        </div>
      ...
      {/* CTA Section */}
      <section className="relative py-32 bg-gradient-to-br from-[#2D5BFF] via-blue-500 to-rose-600 text-white overflow-hidden">
        {/* Curved Divider Top */}
