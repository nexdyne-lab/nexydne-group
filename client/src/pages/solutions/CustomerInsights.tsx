    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="py-20 md:py-28 bg-white">
        <div className="container">
          <div className="grid md:grid-cols-[300px_1fr] gap-12 items-start">
            ...
            {/* Benefits Grid */}
            <div>
              <h2 className="text-4xl font-bold text-slate-900 mb-12">The benefits of Customer Insights</h2>
              ...
              <div className="space-y-8">
                <div className="flex gap-6">
                  ...
                  <div className="flex-1">
                    <h3 className="text-2xl font-bold text-slate-900 mb-3">More loyal visitors</h3>
                ...
                <div className="flex gap-6">
                  ...
                  <div className="flex-1">
                    <h3 className="text-2xl font-bold text-slate-900 mb-3">Insight into user behavior</h3>
                    <p className="text-slate-600 leading-relaxed">
                ...
                <div className="flex gap-6">
                  ...
                  <div className="flex-1">
                    <h3 className="text-2xl font-bold text-slate-900 mb-3">Decoding opportunities and risks</h3>
                    <p className="text-slate-600 leading-relaxed">
                ...
                <div className="flex gap-6">
                  ...
                  <div className="flex-1">
                    <h3 className="text-2xl font-bold text-slate-900 mb-3">Positive brand experience</h3>
                    <p className="text-slate-600 leading-relaxed">
      ...
      <section className="py-20 md:py-28 bg-slate-50">
        <div className="container max-w-4xl">
          <h2 className="text-4xl font-bold text-slate-900 mb-8">About Customer Insights</h2>
      ...
      <section className="py-20 md:py-28 bg-slate-50">
        <div className="container max-w-4xl">
          <h2 className="text-4xl font-bold text-slate-900 mb-8">Our approach to Customer Insights</h2>
          <p className="text-lg text-slate-600 leading-relaxed mb-6">
        ...
        <div className="container">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <p className="text-xl text-slate-700 mb-4">David Park</p>
              <p className="text-lg text-slate-600 mb-8">Analytics Director</p>
