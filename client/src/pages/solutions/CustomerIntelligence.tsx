...
export default function CustomerIntelligence() {
  ...
  const services = [
    ...
    },
    {
      ...
      description:
        "Build feedback systems that capture actionable insights, not just satisfaction scores. Close the loop with customers who respond.",
  ...
  return (
    <div className="min-h-screen bg-white font-sans text-charcoal">
      <SEO
        ...
        description="Unlock deep customer insights through advanced analytics. Predict behavior, personalize experiences, and drive loyalty at scale."
        canonical="/solutions/customer-intelligence"
      />
      <Navigation />
          ...
          >
            ...
            <div className="space-y-6">
              ...
              <p className="text-base md:text-lg text-charcoal/80 leading-[1.65] max-w-[60ch]">
                ...
                architect systems that turn data into competitive
                differentiation.
              </p>
            </div>
          </motion.div>
