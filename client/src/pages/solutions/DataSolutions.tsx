  ...
  const cases = [
    {
      ...
      title: "Industrial Manufacturer Cuts Reporting Cycle from 14 Days to 6 Hours",
      description:
        "A unified Snowflake warehouse and dbt-based metric layer collapsed monthly close reporting and unlocked daily operational dashboards.",
      image: "/images/case-data-manufacturing.jpg",
      link: "/cases/manufacturing-data-platform",
    },
    {
      industry: "Healthcare",
  ...
  return (
    <div className="min-h-screen bg-white font-sans text-charcoal">
      <SEO
        ...
        description="End-to-end data platform: ingestion, warehouse, governance, and BI that makes data trustworthy and decisive."
        canonical="/solutions/data-solutions"
      />
      <Navigation />
      ...
      <section className="bg-white py-24 md:py-32">
        <div className="container px-6 sm:px-8 md:px-12 lg:px-16">
          ...
          >
            ...
            >
              Most companies have data. Few have data they trust enough to bet
              on.
            </h3>
        ...
        <div className="container px-6 sm:px-8 md:px-12 lg:px-16">
          ...
          >
            ...
            <h3
              ...
              style={{ fontWeight: 500, letterSpacing: "-0.02em" }}
            >
              Six ways we make data trustworthy and decisive.
            </h3>
            <p className="text-base md:text-lg text-charcoal/80 leading-[1.65] max-w-[60ch] mt-6">
              We combine modern data engineering with disciplined governance
              to deliver platforms that stand up to executive scrutiny and
              compound in value as the business grows.
            </p>
          </motion.div>
            ...
            <div className="grid md:grid-cols-2 gap-12 lg:gap-16 items-start">
              ...
              >
                ...
                <h2
                  ...
                  style={{ fontWeight: 500, letterSpacing: "-0.02em" }}
                >
                  Stop reconciling the numbers. Start acting on them.
                </h2>
