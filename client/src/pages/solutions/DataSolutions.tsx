  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="py-20 bg-slate-50">
        <div className="container">
          <div className="mb-12">
            <span className="text-sm text-slate-600 uppercase tracking-wide font-semibold">Data & AI</span>
            <h2 className="text-4xl font-bold text-slate-900 mt-2 mb-8">Services</h2>
          </div>
            ...
            <Link href="/solutions/data-strategy">
              <div className="group border border-slate-200 rounded-lg p-8 hover:shadow-lg transition-all cursor-pointer bg-white">
                <div className="flex items-start justify-between">
                  ...
                  <ArrowRight className="w-6 h-6 text-slate-400 group-hover:text-blue-500 group-hover:translate-x-1 transition-all ml-4 flex-shrink-0" />
                </div>
              </div>
            </Link>
