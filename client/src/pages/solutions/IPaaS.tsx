    ...
    <div className="min-h-screen bg-white">
            ...
            <div className="order-1 lg:order-2">
              ...
              <div className="space-y-6">
                <div className="flex gap-4">
                  ...
                  <div>
                    <h3 className="text-xl font-bold text-slate-900 mb-2">Real-time synchronization</h3>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    <h3 className="text-xl font-bold text-slate-900 mb-2">Enterprise-grade reliability</h3>
                    <p className="text-slate-700">
      ...
      <section className="py-20 bg-slate-50">
        <div className="container max-w-4xl">
          <h2 className="text-4xl font-bold text-slate-900 mb-6">What is iPaaS?</h2>
      ...
      <section className="py-20 bg-slate-50">
        <div className="container max-w-4xl">
          <h2 className="text-4xl font-bold text-slate-900 mb-6">The iPaaS method works</h2>
          <div className="prose prose-lg max-w-none text-slate-700 space-y-4">
            <p>
      ...
      <section className="py-20">
        <div className="container">
          <div className="grid md:grid-cols-2 gap-12 items-center max-w-5xl mx-auto">
            ...
            <div>
              <h2 className="text-3xl font-bold text-slate-900 mb-4">Do you want to know more?</h2>
              <div className="mb-6">
                <p className="text-lg text-slate-700 mb-2">Floris Weegink</p>
                <p className="text-slate-600">Field CTO</p>
              </div>
              <div className="flex gap-4">
                <Link href="/contact">
        ...
        <div className="container">
          ...
          <div className="max-w-2xl">
            <div className="bg-white rounded-lg p-8 hover:shadow-lg transition-shadow">
              ...
              <h3 className="text-xl font-bold text-slate-900 mb-3">Workato</h3>
                ...
                <div className="p-6">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      ...
                      <div className="text-sm text-slate-600">Less manual work</div>
                    </div>
                    <div>
                      <div className="text-2xl font-bold text-blue-500">10K+</div>
                      <div className="text-sm text-slate-600">Records synced daily</div>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div className="p-6">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      ...
                      <div className="text-sm text-slate-600">Reduced overhead</div>
                    </div>
                    <div>
                      <div className="text-2xl font-bold text-blue-500">50%</div>
                      <div className="text-sm text-slate-600">Faster claims</div>
                    </div>
                  </div>
                </div>
              </div>
      ...
      <section className="py-20">
        <div className="container">
          <div className="mb-12">
            <span className="text-sm text-slate-600 uppercase tracking-wide font-semibold">Process Automation</span>
          ...
          <div className="text-center mt-12">
            <h3 className="text-2xl font-bold text-slate-900 mb-6">Do you want to know more?</h3>
