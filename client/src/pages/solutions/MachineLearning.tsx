          ...
          <div className="grid md:grid-cols-2 gap-16 items-start">
            <div className="sticky top-8">
              ...
              <div className="mt-8 p-6 bg-slate-900 text-white rounded-lg">
                ...
                <Button className="w-full bg-primary hover:bg-primary/90 text-white transition-colors duration-200 ease-in-out">
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              ...
              <div>
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  <Button className="bg-primary hover:bg-primary/90 text-white transition-colors duration-200 ease-in-out">
                    Get in touch
                  </Button>
                  <Button variant="outline" className="border-primary text-charcoal hover:bg-primary hover:text-white transition-colors duration-200 ease-in-out">
                    Schedule a meeting
      ...
      <section className="py-20 bg-slate-50">
        <div className="container">
          <div className="mb-12">
            ...
            <h2 className="text-4xl font-bold text-charcoal mt-2">ML Platforms & Tools</h2>
          </div>
            ...
            <Link href="/cases/retail-demand-forecasting">
              <div className="bg-white rounded-lg overflow-hidden shadow-lg hover:shadow-xl transition-all group cursor-pointer">
                ...
                <div className="p-6">
                  ...
                  <Button variant="ghost" className="text-primary hover:text-primary/90 p-0 transition-colors duration-200 ease-in-out">
                    Read more
                    <ArrowRight className="w-4 h-4 ml-2" />
                  </Button>
                </div>
        ...
        <div className="container">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="p-6 rounded-lg bg-blue-100 border-2 border-blue-500">
              <h3 className="text-xl font-bold text-charcoal mb-2">Machine Learning</h3>
              <p className="text-charcoal/80">Deploy predictive models that improve over time.</p>
            </div>
      ...
      <section className="py-20 bg-primary text-white">
        <div className="container text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button className="bg-white text-primary hover:bg-white/90 transition-colors duration-200 ease-in-out">
              Get in touch
            </Button>
            <Button variant="outline" className="border-white text-white hover:bg-white/10 transition-colors duration-200 ease-in-out">
              Schedule a meeting
              <ArrowRight className="w-4 h-4 ml-2" />
            </Button>
          </div>
