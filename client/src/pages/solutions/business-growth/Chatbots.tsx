...
export default function Chatbots() {
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Hero Section */}
      <section className="relative bg-gradient-to-br from-[#1a1f71] via-[#151a5f] to-[#0a0e3d] text-white py-24">
        ...
        <div className="container">
          <div className="grid lg:grid-cols-3 gap-12">
            ...
            <div className="lg:col-span-1">
              <Card className="p-8 bg-gradient-to-br from-[#00d4ff]/10 to-[#0066ff]/10 border-[#00d4ff]/20">
                <div className="mb-6">
                  <div className="w-48 h-48 mx-auto mb-6 rounded-full overflow-hidden bg-gradient-to-br from-[#00d4ff]/20 to-[#0066ff]/20 flex items-center justify-center">
                    <img 
                ...
                <h3 className="text-xl font-bold text-[#0a0e3d] mb-2">Want to learn more?</h3>
                <Button 
                  variant="outline" 
            ...
            <div className="lg:col-span-2">
              <h2 className="text-4xl font-bold text-[#0a0e3d] mb-12">The benefits of Chatbots</h2>
              ...
              <div className="space-y-8">
                {[
                  ...
                  <Card 
                    key={index}
                    className="p-8 hover:shadow-xl transition-all border-gray-200 hover:border-[#00d4ff]/30 group cursor-pointer bg-white relative overflow-hidden"
                  >
                    ...
                    <div className="flex gap-6 relative z-10">
                      <div className="flex-shrink-0 w-16 h-16 rounded-lg flex items-center justify-center text-[#00d4ff] group-hover:scale-110 transition-transform">
                        {benefit.icon}
                      </div>
                      <div className="flex-1">
                        <h3 className="text-2xl font-bold text-[#0a0e3d] mb-3">{benefit.title}</h3>
      ...
      <AnimatedSection delay={0.1} className="py-20 bg-gradient-to-br from-[#1a1f71] via-[#151a5f] to-[#0a0e3d] text-white">
        <div className="container max-w-4xl">
          ...
          <div className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-lg p-8">
            <blockquote className="text-2xl font-medium text-[#00d4ff] mb-4">
      ...
      <AnimatedSection delay={0.2} className="py-20 bg-white">
        <div className="container max-w-4xl">
          <h2 className="text-4xl font-bold text-[#0a0e3d] mb-8 text-center">Our chatbot solutions</h2>
          ...
          <Card className="p-12 bg-gradient-to-br from-[#00d4ff]/10 via-[#0066ff]/10 to-[#1a1f71]/10 border-[#00d4ff]/20">
            <div className="flex flex-col md:flex-row gap-8 items-center">
              <div className="flex-shrink-0">
                <div className="w-48 h-48 rounded-full overflow-hidden bg-gradient-to-br from-[#00d4ff]/20 to-[#0066ff]/20 flex items-center justify-center">
                  <img 
                    src="https://images.unsplash.com/photo-1560250097-0b93528c311a?w=400&h=400&fit=crop" 
                    alt="NEXDYNE Expert"
                    className="w-full h-full object-cover"
              ...
              <div className="flex-1">
                <h3 className="text-2xl font-bold text-[#0a0e3d] mb-2">Want to learn more?</h3>
                <p className="text-gray-600 mb-2">NEXDYNE Conversational AI Expert</p>
                <p className="text-gray-600 mb-6">Director of Digital Solutions</p>
                <div className="flex flex-wrap gap-4">
                  <Button className="bg-[#00d4ff] hover:bg-[#00b8e6] text-white">
                    Start a conversation
                  </Button>
                  <Button variant="outline" className="border-[#00d4ff] text-[#0a0e3d] hover:bg-[#00d4ff]/10">
                    Book a consultation
      ...
      {/* Why NEXDYNE Section */}
      <AnimatedSection delay={0.3} className="py-20 bg-gradient-to-br from-[#f5f5f5] to-[#e8e8e8]">
        <div className="container">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <img 
            ...
            <div>
              <h2 className="text-4xl font-bold text-[#0a0e3d] mb-6">Why NEXDYNE</h2>
      ...
      <AnimatedSection delay={0.4} className="py-20 bg-white">
        <div className="container">
          <div className="text-center mb-12">
            <p className="text-sm text-[#00d4ff] font-semibold mb-2 uppercase tracking-wider">Partners</p>
            <h2 className="text-4xl font-bold text-[#0a0e3d] mb-4">Awesome partners turn dreams into reality</h2>
            <p className="text-lg text-gray-600 mb-8">Together with these technology leaders, we deliver world-class e-commerce experiences.</p>
            <Button variant="outline" className="border-[#00d4ff] text-[#0a0e3d] hover:bg-[#00d4ff]/10">
              View all partners
            </Button>
          </div>
          ...
          <div className="grid grid-cols-4 gap-8">
            {[
              ...
              <Card key={partner} className="p-8 flex flex-col items-center justify-center hover:shadow-xl transition-all border-gray-200 hover:border-[#00d4ff]/30 group cursor-pointer bg-white relative overflow-hidden h-40">
                <div className="absolute inset-0 bg-gradient-to-br from-[#00d4ff]/0 to-[#00d4ff]/0 group-hover:from-[#00d4ff]/5 group-hover:to-[#00d4ff]/10 transition-all duration-300" />
                <h3 className="text-2xl font-bold text-[#0a0e3d] group-hover:text-[#00d4ff] transition-all duration-300 relative z-10">
                  {partner}
                </h3>
              </Card>
            ))}
      ...
      {/* CTA Section */}
      <section className="relative bg-gradient-to-br from-[#1a1f71] via-[#151a5f] to-[#0a0e3d] text-white py-20">
        <div className="container max-w-4xl text-center">
          ...
          <div className="flex flex-wrap gap-4 justify-center mb-8">
            <Button className="bg-[#00d4ff] hover:bg-[#00b8e6] text-white text-lg px-8 py-6">
              Start a conversation
            </Button>
