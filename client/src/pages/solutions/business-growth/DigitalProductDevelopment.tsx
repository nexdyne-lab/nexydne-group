      ...
      <main>
        <section className="bg-[#051C2C] text-white">
          <div className="container mx-auto grid md:grid-cols-2 gap-12 items-center py-24 px-4">
            <div className="space-y-6">
              ...
              <p className="text-lg text-gray-300">{page_description}</p>
              <div className="flex space-x-4">
                <Button asChild size="lg" className="bg-[#0077B5] hover:bg-[#005f8e] text-white">
        ...
        <section className="py-20 bg-gray-50">
          <div className="container mx-auto px-4 text-center">
            <h2 className="text-4xl font-bold text-[#051C2C] mb-4">From Concept to Code</h2>
            <div className="max-w-3xl mx-auto text-left text-gray-600 space-y-6">
        ...
        <section className="py-20 bg-white">
          <div className="container mx-auto px-4">
            <h2 className="text-4xl font-bold text-center text-[#051C2C] mb-12">How We Can Help</h2>
            <div className="grid md:grid-cols-3 gap-8 group">
              {[ 
                ...
                <div key={index} className="relative p-6 bg-gray-50 rounded-lg transition-all duration-300 hover:bg-white hover:shadow-xl hover:border-l-4 hover:border-[#CC0000]">
                  <h3 className="text-xl font-bold text-[#051C2C] transition-all duration-300 group-hover:text-lg">{item.title}</h3>
                  <p className="text-gray-600 opacity-0 max-h-0 transition-all duration-300 group-hover:opacity-100 group-hover:max-h-40 group-hover:mt-2">{item.description}</p>
                </div>
              ))}
            </div>
          </div>
        ...
        <section className="py-20 bg-[#051C2C] text-white">
          <div className="container mx-auto px-4 text-center">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="p-8 bg-[#0a2c47] rounded-lg">
                <h3 className="text-2xl font-bold text-[#00d4ff] mb-4">1. Discover & Define</h3>
                <p className="text-gray-300">We begin with a deep-dive discovery phase to understand your vision, business goals, and target audience. Through market research and competitive analysis, we define the core problem and outline a strategic product roadmap.</p>
              </div>
              <div className="p-8 bg-[#0a2c47] rounded-lg">
                <h3 className="text-2xl font-bold text-[#00d4ff] mb-4">2. Design & Develop</h3>
                <p className="text-gray-300">Our team translates strategy into tangible designs and functional prototypes. Following agile principles, we develop an MVP, focusing on delivering value quickly and incorporating feedback throughout the development sprints.</p>
              </div>
              <div className="p-8 bg-[#0a2c47] rounded-lg">
                <h3 className="text-2xl font-bold text-[#00d4ff] mb-4">3. Deploy & Iterate</h3>
                <p className="text-gray-300">Post-launch, we monitor key performance indicators and user behavior. We use this data to drive continuous improvement, prioritize new features, and ensure your product evolves to meet changing market demands.</p>
              </div>
            </div>
          </div>
        </section>

        <section className="py-20 bg-[#0a2c47] text-white">
          <div className="container mx-auto px-4">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="p-8 border border-gray-700 rounded-lg">
                <p className="text-sm text-[#00d4ff] font-semibold mb-2">FINTECH SAAS</p>
                <h3 className="text-2xl font-bold mb-4">Launching a Disruptive Investment Platform</h3>
                <p className="text-gray-400">Partnered with a startup to build and launch an AI-powered investment analytics platform from the ground up, achieving 10,000 active users within six months of MVP launch.</p>
              </div>
              <div className="p-8 border border-gray-700 rounded-lg">
                <p className="text-sm text-[#00d4ff] font-semibold mb-2">HEALTH-TECH</p>
                <h3 className="text-2xl font-bold mb-4">Modernizing Patient Engagement</h3>
                <p className="text-gray-400">Guided a healthcare provider in developing a mobile application for patient management, resulting in a 40% reduction in administrative overhead and improved patient satisfaction scores.</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="py-20 bg-gray-100">
          <div className="container mx-auto px-4">
            <h2 className="text-4xl font-bold text-center text-[#051C2C] mb-12">Related Capabilities</h2>
            <div className="grid md:grid-cols-3 gap-8">
              {[ 
                ...
                <Link key={index} href={item.href}>
                  <a className="block p-8 bg-white rounded-lg shadow-md hover:shadow-xl transition-shadow duration-300">
                    <h3 className="text-xl font-bold text-[#051C2C] mb-2">{item.title}</h3>
                    <div className="flex items-center text-[#0077B5] font-semibold">
        ...
        <section className="bg-[#0077B5] text-white">
          <div className="container mx-auto text-center py-20 px-4">
            ...
            <Button asChild size="lg" className="bg-white text-[#0077B5] hover:bg-gray-200">
