  ...
  return (
    <div className="min-h-screen bg-white font-sans text-charcoal">
      <SEO
        ...
        description="Selection and implementation of ecommerce platforms — Shopify, Magento, Salesforce Commerce, custom headless — anchored in written requirements, engineered for integration, and operated through a deliberate handoff."
