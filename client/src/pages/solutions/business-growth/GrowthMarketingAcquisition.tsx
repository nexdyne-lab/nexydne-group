  ...
  return (
    <div className="min-h-screen bg-white font-sans text-charcoal">
      <SEO
        ...
        description="Performance marketing programs that scale customer acquisition profitably — channel inventory, economics modeling, creative system, attribution architecture, and the optimization rhythm that compounds."
      ...
      <section className="bg-grey nx-section">
        <div className="container px-6 sm:px-8 md:px-12 lg:px-16">
          ...
          >
            ...
            >
              A five-phase approach from channel audit to compounding optimization rhythm.
            </h3>
            <p className="nx-lead text-charcoal/80 max-w-[60ch] mt-6">
              Each phase is timeboxed and produces a tangible artifact. Most engagements run twelve to twenty weeks from inventory to a measurement-grade program operating under the in-house team.
            </p>
          </motion.div>
        ...
        <div className="px-6 sm:px-8 md:px-12 lg:px-16 max-w-4xl mx-auto">
          ...
          >
            ...
            <p className="nx-lead text-white/85 max-w-[60ch] mb-8">
              The economics work because the dollars are getting reallocated against an evidence-based channel model rather than tenure, agency politics, or last-click attribution. We do not run more campaigns — we run better campaigns at the spend tier the unit economics actually justify.
            </p>
            <Link href="/cases">
        ...
        <div className="container px-6 sm:px-8 md:px-12 lg:px-16">
          ...
          >
            ...
            <h3
              className="nx-h2 text-charcoal"
            >
              When the channel model is honest, the reallocation pays.
            </h3>
          </motion.div>
            ...
            <div className="grid md:grid-cols-2 gap-12 lg:gap-16 items-start">
              ...
              >
                <p className="nx-lead text-white/80 mb-8 max-w-[52ch]">
                  We work with leaders who want their acquisition program reallocating capital on channel economics rather than agency tenure. The conversation starts with the model, not the campaign.
                </p>
