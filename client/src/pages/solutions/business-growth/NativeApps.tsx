...
export default function NativeApps() {
  return (
    <div className="min-h-screen bg-white">
              ...
              <Card className="p-6 md:p-8 bg-gradient-to-br from-[#00d4ff]/10 to-[#0066ff]/10 border-[#00d4ff]/20">
                <div className="flex flex-col items-center text-center">
                  <div className="relative mb-6">
                    <div className="absolute inset-0 bg-[#00d4ff] rounded-full blur-xl opacity-30"></div>
                    <div className="relative w-32 h-32 rounded-full overflow-hidden border-4 border-[#00d4ff]/30">
                      <img
                  ...
                  <h3 className="text-lg md:text-xl font-bold mb-4 text-[#0a0e3d]">Do you want to know more?</h3>
                  <Button className="bg-[#00d4ff] text-[#0a0e3d] hover:bg-[#00e5ff] rounded-full px-8 w-full sm:w-auto">
                    Ask Sarah Chen
                  </Button>
                </div>
              </Card>
            ...
            <div className="lg:col-span-2 grid grid-cols-1 sm:grid-cols-2 gap-6">
              {[
                ...
                <AnimatedSection
                  ...
                  animation="fade-up"
                  delay={index * 100}
                  className="p-5 md:p-6 rounded-xl border-2 border-gray-200 hover:border-[#00d4ff] hover:shadow-lg hover:shadow-[#00d4ff]/20 transition-all duration-300 bg-white group"
                >
                  <div className="text-[#00d4ff] mb-4 group-hover:scale-110 transition-transform">
                    {benefit.icon}
                  </div>
                  <h3 className="text-lg md:text-xl font-bold mb-2 text-[#0a0e3d] group-hover:text-[#00d4ff] transition-colors">
                    {benefit.title}
                  </h3>
      ...
      <AnimatedSection className="py-12 md:py-16 lg:py-20 bg-gradient-to-br from-[#0a0e3d] via-[#151a5f] to-[#1a1f71]">
        <div className="container">
      ...
      <AnimatedSection className="py-12 md:py-16 lg:py-20 bg-white">
        <div className="container">
          <div className="max-w-4xl mx-auto px-4">
            <blockquote className="text-xl md:text-2xl lg:text-3xl font-medium text-[#0a0e3d] mb-6 italic leading-relaxed">
      ...
      <AnimatedSection className="py-12 md:py-16 lg:py-20 bg-white">
        <div className="container">
          <div className="max-w-5xl mx-auto px-4">
            <h2 className="text-3xl md:text-4xl font-bold mb-6 md:mb-8 text-[#0a0e3d]">
              NEXDYNE's native app approach
            </h2>
            <p className="text-base md:text-lg lg:text-xl text-gray-700 leading-relaxed mb-8 md:mb-12">
            ...
            {/* Large Contact Card */}
            <Card className="p-6 md:p-10 lg:p-12 bg-white border-2 border-[#00d4ff]/20 hover:border-[#00d4ff] hover:shadow-2xl hover:shadow-[#00d4ff]/20 transition-all duration-300">
              <div className="flex flex-col md:flex-row items-center gap-8">
                <div className="relative flex-shrink-0">
                  <div className="absolute inset-0 bg-[#00d4ff] rounded-full blur-2xl opacity-30"></div>
                  <div className="relative w-32 h-32 md:w-40 md:h-40 lg:w-48 lg:h-48 rounded-full overflow-hidden border-4 border-[#00d4ff]/30">
                    <img
                      src="https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=400&h=400&fit=crop"
                      alt="Sarah Chen"
                      className="w-full h-full object-cover"
                ...
                <div className="flex-1 text-center md:text-left">
                  <h3 className="text-2xl md:text-3xl font-bold mb-4 text-[#0a0e3d]">
                    Do you want to know more?
                  </h3>
                  <p className="text-lg md:text-xl mb-2 font-semibold text-[#0a0e3d]">Sarah Chen</p>
                  <p className="text-base md:text-lg text-gray-600 mb-6">Mobile Solutions Director</p>
                  <div className="flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
                    <Button className="bg-[#00d4ff] text-[#0a0e3d] hover:bg-[#00e5ff] rounded-full px-8 w-full sm:w-auto">
                      Get in touch
                    </Button>
                    <Button variant="outline" className="border-2 border-[#0a0e3d] text-[#0a0e3d] hover:bg-[#0a0e3d] hover:text-white rounded-full px-8 w-full sm:w-auto">
                      Schedule a meeting
        ...
        <div className="container">
          <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center">
            <div className="relative group order-2 md:order-1">
              <div className="absolute inset-0 bg-[#00d4ff] rounded-2xl blur-2xl opacity-20 group-hover:opacity-30 transition-opacity"></div>
              <img
            ...
            <div className="order-1 md:order-2">
              <h2 className="text-3xl md:text-4xl font-bold mb-6 text-[#0a0e3d]">
                Why choose NEXDYNE
              </h2>
      ...
      <AnimatedSection className="py-12 md:py-16 lg:py-20 bg-white border-t border-gray-200">
        <div className="container">
          <div className="text-center mb-8 md:mb-12 px-4">
            <p className="text-xs md:text-sm font-semibold text-[#00d4ff] uppercase tracking-wide mb-2">PARTNERS</p>
            <h2 className="text-3xl md:text-4xl font-bold text-[#0a0e3d]">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6 max-w-4xl mx-auto px-4">
            {["React Native", "Flutter", "Swift", "Kotlin"].map((partner, index) => (
              <AnimatedSection
                ...
                delay={index * 100}
              >
                <Card className="p-4 md:p-6 lg:p-8 h-32 md:h-40 flex items-center justify-center bg-white border-2 border-gray-200 hover:border-[#00d4ff] hover:shadow-lg hover:shadow-[#00d4ff]/20 transition-all duration-300 group">
                  <span className="text-lg md:text-xl lg:text-2xl font-bold text-[#0a0e3d] group-hover:text-[#00d4ff] transition-colors text-center">
                    {partner}
                  </span>
                </Card>
              </AnimatedSection>
      ...
      <AnimatedSection className="py-16 md:py-20 lg:py-24 bg-gradient-to-br from-[#1a1f71] via-[#151a5f] to-[#0a0e3d] text-white">
        <div className="container text-center px-4">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button className="bg-[#00d4ff] text-[#0a0e3d] hover:bg-[#00e5ff] rounded-full px-8 text-base md:text-lg w-full sm:w-auto">
              Get Started
            </Button>
            <Button variant="outline" className="border-2 border-white text-white hover:bg-white hover:text-[#0a0e3d] rounded-full px-8 text-base md:text-lg w-full sm:w-auto">
              View Our Work
            </Button>
          </div>
        </div>
