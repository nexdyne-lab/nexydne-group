    ...
    >
        ...
        <div className="container mx-auto grid md:grid-cols-2 gap-12 items-center min-h-[600px] py-20">
          <div className="flex flex-col gap-6 items-start">
            ...
            <div className="flex gap-4 mt-4">
              <Button size="lg" className="bg-[#0077B5] hover:bg-[#005f8a] text-white">
      ...
      <div className="py-20 bg-white">
        <div className="container mx-auto">
          <h2 className="text-4xl font-bold text-center text-[#051C2C] mb-12">Our Pricing & Monetization Services</h2>
      ...
      {/* Our Approach */}
      <div className="py-20 bg-[#051C2C] text-white">
        <div className="container mx-auto">
          <h2 className="text-4xl font-bold text-center mb-12">Our Strategic Pricing Methodology</h2>
          <div className="grid md:grid-cols-3 gap-8 text-center">
            <div className="p-6">
              <div className="text-5xl font-bold text-[#00d4ff] mb-4">1</div>
              <h3 className="text-2xl font-bold mb-2">Market & Value Discovery</h3>
              <p className="text-gray-300">We conduct deep market research, customer segmentation, and value driver analysis to understand the economic impact of your solution and how customers perceive it.</p>
            </div>
            <div className="p-6">
              <div className="text-5xl font-bold text-[#00d4ff] mb-4">2</div>
              <h3 className="text-2xl font-bold mb-2">Monetization Model Design</h3>
              <p className="text-gray-300">Based on discovery insights, we design and model various pricing structures, from feature-based tiers to complex usage-based algorithms, to find the optimal fit for your business.</p>
            </div>
            <div className="p-6">
              <div className="text-5xl font-bold text-[#00d4ff] mb-4">3</div>
              <h3 className="text-2xl font-bold mb-2">Implementation & Optimization</h3>
              <p className="text-gray-300">We support the implementation of the new pricing strategy and establish a data-driven process for continuous monitoring, testing, and optimization to adapt to market changes.</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="container mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-gray-800 p-6 rounded-lg">
              <p className="text-sm text-[#00d4ff] mb-2">SaaS Platform</p>
              <h3 className="text-2xl font-bold">Revamping a B2B SaaS pricing model to increase ARPU by 40% while reducing churn.</h3>
            </div>
            <div className="bg-gray-800 p-6 rounded-lg">
              <p className="text-sm text-[#00d4ff] mb-2">E-Commerce Marketplace</p>
