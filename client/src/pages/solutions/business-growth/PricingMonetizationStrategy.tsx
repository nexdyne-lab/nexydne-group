  ...
  return (
    <div className="min-h-screen bg-white font-sans text-charcoal">
      <SEO
        ...
        description="Pricing architecture, packaging, and monetization models — anchored in willingness-to-pay evidence, engineered for rollout, and instrumented for the ongoing pricing discipline that compounds."
      ...
      <section className="bg-grey nx-section">
        <div className="container px-6 sm:px-8 md:px-12 lg:px-16">
          ...
          >
            ...
            >
              A five-phase approach from willingness-to-pay evidence to operating pricing discipline.
            </h3>
            <p className="nx-lead text-charcoal/80 max-w-[60ch] mt-6">
              Each phase is timeboxed and produces a tangible artifact. Most engagements run sixteen to twenty-four weeks from research to a rolled-out pricing surface running under the in-house team.
            </p>
          </motion.div>
        ...
        <div className="px-6 sm:px-8 md:px-12 lg:px-16 max-w-4xl mx-auto">
          ...
          >
            ...
            <p className="nx-lead text-white/85 max-w-[60ch] mb-8">
              The economics work because the change reaches the P&L. We do not hand off a pricing recommendation and walk away — we engineer the rollout, the sales enablement, and the customer-success migration so the new model actually shows up on the financial review.
            </p>
            <Link href="/cases">
        ...
        <div className="container px-6 sm:px-8 md:px-12 lg:px-16">
          ...
          >
            ...
            <h3
              className="nx-h2 text-charcoal"
            >
              When pricing is engineered, the lift reaches the P&L.
            </h3>
          </motion.div>
            ...
            <div className="grid md:grid-cols-2 gap-12 lg:gap-16 items-start">
              ...
              >
                <p className="nx-lead text-white/80 mb-8 max-w-[52ch]">
                  We work with leaders who treat pricing as a discipline rather than a project. The conversation starts with willingness-to-pay evidence, not a competitor screenshot.
                </p>
