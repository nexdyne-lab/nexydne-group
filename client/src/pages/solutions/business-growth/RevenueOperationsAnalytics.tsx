  ...
  return (
    ...
    >
      ...
      <main>
        <div className="bg-[#051C2C]">
          <div className="container mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 items-center py-16 md:py-24 px-4">
            <div className="text-white">
              ...
              <p className="text-lg md:text-xl mt-4 text-gray-300">{pageDescription}</p>
              <div className="mt-8 flex gap-4">
                <Button size="lg" className="bg-[#0077B5] hover:bg-[#005f8a] text-white">Schedule a Consultation</Button>
        ...
        <div className="bg-gray-50 py-16 md:py-24">
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-gray-700">
                <h2 className="text-3xl font-bold text-center text-[#051C2C]">The Engine of Predictable Growth</h2>
            ...
            <div className="container mx-auto px-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mt-12">
                    {capabilities.map((cap, index) => (
                        <div key={index} className="group relative p-6 border-t-4 border-gray-200 hover:border-[#CC0000] transition-all duration-300 bg-gray-50 shadow-lg rounded-lg overflow-hidden">
                            <h3 className="text-xl font-bold text-[#051C2C] transition-all duration-300 group-hover:text-base">{cap.title}</h3>
                            <div className="absolute inset-0 p-6 bg-gray-50 translate-y-full group-hover:translate-y-0 transition-transform duration-300 ease-in-out flex items-center">
                                <p className="text-gray-700">{cap.description}</p>
                            </div>
                        </div>
                    ))}
                </div>
        ...
        <div className="bg-[#051C2C] text-white py-16 md:py-24">
          <div className="container mx-auto px-4 text-center">
            ...
            <div className="grid md:grid-cols-3 gap-12 mt-12 max-w-5xl mx-auto">
              <div className="text-center">
                <div className="text-5xl font-bold text-[#00d4ff]">1</div>
                <h3 className="text-2xl font-semibold mt-4">Diagnose & Benchmark</h3>
                <p className="mt-2 text-gray-300">We conduct a comprehensive audit of your current people, processes, and technology stack, benchmarking your performance against industry best practices to identify key areas for improvement.</p>
              </div>
              <div className="text-center">
                <div className="text-5xl font-bold text-[#00d4ff]">2</div>
                <h3 className="text-2xl font-semibold mt-4">Design & Align</h3>
                <p className="mt-2 text-gray-300">Based on the diagnosis, we design a unified RevOps strategy and roadmap, aligning your sales, marketing, and service teams with shared goals, metrics, and a cohesive customer journey.</p>
              </div>
              <div className="text-center">
                <div className="text-5xl font-bold text-[#00d4ff]">3</div>
                <h3 className="text-2xl font-semibold mt-4">Implement & Optimize</h3>
                <p className="mt-2 text-gray-300">We manage the implementation of new processes and technologies, providing ongoing support and optimization to ensure your revenue engine is continuously learning and improving.</p>
              </div>
            </div>
          </div>
        </div>

        <div className="bg-[#051C2C] pt-4 pb-16 md:pb-24">
            <div className="container mx-auto px-4">
                <h2 className="text-3xl font-bold text-center text-white mb-12">Client Success Stories</h2>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
                    <div className="bg-gray-800 p-6 rounded-lg">
                        <p className="text-sm text-[#00d4ff] font-semibold">SaaS Unicorn</p>
                        <h4 className="text-xl font-bold text-white mt-2">Unified GTM motion leads to 200% increase in enterprise pipeline.</h4>
                    </div>
                    <div className="bg-gray-800 p-6 rounded-lg">
                        <p className="text-sm text-[#00d4ff] font-semibold">Fintech Scale-Up</p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-12">
              <Link href="/solutions/business-growth/go-to-market-acceleration">
                <a className="block bg-white p-6 rounded-lg shadow-md hover:shadow-xl transition-shadow group">
                  <h3 className="text-xl font-bold text-[#051C2C]">Go-to-Market Acceleration</h3>
                  <p className="mt-2 text-gray-600">Launch and scale with a powerful, data-driven GTM strategy that outpaces the competition.</p>
                  <div className="flex items-center mt-4 text-[#0077B5] font-semibold group-hover:underline">Explore <ArrowRight className="ml-2 h-5 w-5" /></div>
                </a>
              </Link>
              <Link href="/solutions/business-growth/growth-marketing-acquisition">
                <a className="block bg-white p-6 rounded-lg shadow-md hover:shadow-xl transition-shadow group">
                  ...
                  <p className="mt-2 text-gray-600">Acquire high-value customers through scalable, multi-channel marketing campaigns.</p>
                  <div className="flex items-center mt-4 text-[#0077B5] font-semibold group-hover:underline">Explore <ArrowRight className="ml-2 h-5 w-5" /></div>
                </a>
              </Link>
              <Link href="/solutions/business-growth/pricing-monetization-strategy">
                <a className="block bg-white p-6 rounded-lg shadow-md hover:shadow-xl transition-shadow group">
                  ...
                  <p className="mt-2 text-gray-600">Optimize your pricing models to maximize revenue and align value with customer outcomes.</p>
                  <div className="flex items-center mt-4 text-[#0077B5] font-semibold group-hover:underline">Explore <ArrowRight className="ml-2 h-5 w-5" /></div>
                </a>
              </Link>
            </div>
        ...
        <div className="bg-[#0077B5] text-white py-16 md:py-24">
          <div className="container mx-auto text-center px-4">
            ...
            <Button size="lg" variant="outline" className="mt-8 text-white border-white hover:bg-white hover:text-[#0077B5]">Contact Us Today</Button>
          </div>
        </div>
      </main>
      <Footer />
