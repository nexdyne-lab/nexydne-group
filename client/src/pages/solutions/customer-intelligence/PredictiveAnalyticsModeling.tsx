  ...
  return (
    <div className="min-h-screen bg-white font-sans text-charcoal">
      <SEO
        ...
        description="Build predictive ML models for churn, lifetime value, propensity, and next-best-action — with the MLOps and governance that keep them earning."
        ...
        <div className="container px-6 sm:px-8 md:px-12 lg:px-16">
          ...
          >
            ...
            <h3
              ...
              style={{ fontWeight: 500, letterSpacing: "-0.02em" }}
            >
              A five-phase approach from use-case to production model.
            </h3>
            <p className="text-base md:text-lg text-charcoal/80 leading-[1.65] max-w-[60ch] mt-6">
              Each phase is timeboxed and produces a tangible artifact. Most engagements run twelve to twenty weeks from prioritization to a production-grade model with monitoring in place.
            </p>
          </motion.div>
        ...
        <div className="px-6 sm:px-8 md:px-12 lg:px-16 max-w-4xl mx-auto">
          ...
          >
            ...
            <p className="text-base md:text-lg text-white/85 leading-[1.65] max-w-[60ch] mb-8">
              The economics work because the predictions reach the systems of action. We do not hand off a notebook and walk away — we engineer the surface that lets the operator act on the score, and the monitoring that catches the drift before the quarterly review does.
            </p>
            <Link href="/cases">
        ...
        <div className="container px-6 sm:px-8 md:px-12 lg:px-16">
          ...
          >
            ...
            <h3
              ...
              style={{ fontWeight: 500, letterSpacing: "-0.02em" }}
            >
              When the model reaches the operator, the program compounds.
            </h3>
          </motion.div>
            ...
            <div className="grid md:grid-cols-2 gap-12 lg:gap-16 items-start">
              ...
              >
                <p className="text-base md:text-lg text-white/80 leading-[1.65] mb-8 max-w-[52ch]">
                  We work with leaders who want their customer decisions made on evidence, not anecdote. Predictive modeling is how that conversation begins.
                </p>
