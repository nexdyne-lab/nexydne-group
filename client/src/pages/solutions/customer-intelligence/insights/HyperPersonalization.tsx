        ...
        <div className="container px-4 md:px-12 relative z-10">
          ...
          >
            ...
            <div className="flex items-center gap-4 mb-6">
              <span className="text-[#0077B5] text-xs font-bold uppercase tracking-[0.2em]">Marketing</span>
        ...
        <div className="container px-4 md:px-12">
          <div className="grid lg:grid-cols-12 gap-16">
            ...
            >
              ...
              <div className="bg-[#F8F9FA] p-8 rounded-xl my-8">
                <div className="space-y-6">
                  <div className="flex gap-4">
                    <div className="w-10 h-10 bg-[#0077B5]/20 rounded-full flex items-center justify-center text-[#0077B5] font-bold flex-shrink-0">1</div>
                    <div>
                      <h4 className="font-bold text-lg mb-1">Basic Personalization</h4>
                      <p className="text-[#051C2C]/70 text-sm">Name insertion, basic demographic targeting. "Hi John" emails.</p>
                    </div>
                  </div>
                  <div className="flex gap-4">
                    <div className="w-10 h-10 bg-[#0077B5]/40 rounded-full flex items-center justify-center text-[#0077B5] font-bold flex-shrink-0">2</div>
                    <div>
                      <h4 className="font-bold text-lg mb-1">Segment-Based Personalization</h4>
                      <p className="text-[#051C2C]/70 text-sm">Different content for different segments. "High-value customers get offer A."</p>
                    </div>
                  </div>
                  <div className="flex gap-4">
                    <div className="w-10 h-10 bg-[#0077B5]/60 rounded-full flex items-center justify-center text-[#0077B5] font-bold flex-shrink-0">3</div>
                    <div>
                      <h4 className="font-bold text-lg mb-1">Behavioral Personalization</h4>
                      <p className="text-[#051C2C]/70 text-sm">Triggered by individual actions. "You viewed X, here's related Y."</p>
                    </div>
                  </div>
                  <div className="flex gap-4">
                    <div className="w-10 h-10 bg-[#0077B5] rounded-full flex items-center justify-center text-white font-bold flex-shrink-0">4</div>
                    <div>
                      <h4 className="font-bold text-lg mb-1">Hyper-Personalization</h4>
                      <p className="text-[#051C2C]/70 text-sm">AI-driven, real-time, 1:1 experiences. "Based on everything we know about you, here's your optimal experience."</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-[#FEF2F2] border-l-4 border-red-500 p-6 my-8">
