          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8">
            {relatedCapabilities.map((item, index) => (
              <motion.div
                ...
                transition={{ duration: 0.5, delay: index * 0.1 }}
              >
                <Link to={item.link} className="block bg-white p-8 rounded-lg shadow-md hover:shadow-xl transition-shadow h-full">
                  <h3 className="text-2xl font-bold text-[#051C2C] mb-3">{item.title}</h3>
