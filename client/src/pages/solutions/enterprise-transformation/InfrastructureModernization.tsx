        ...
        <div className="container px-4 sm:px-6 md:px-12">
          ...
          >
            <h2 className="text-3xl sm:text-4xl eb-garamond font-bold mb-4">
              Our Approach to <span className="text-secondary">Infrastructure Transformation</span>
            </h2>
            ...
            >
              <Link href="/cases/retail-cloud-migration">
                ...
                <div className="absolute bottom-0 left-0 p-6 sm:p-8">
                  ...
                  <h3 className="text-2xl font-bold text-white mt-2">Global Retailer Achieves 30% Cost Savings with Cloud Migration</h3>
                </div>
              </Link>
            </motion.div>
            <motion.div
            ...
            >
              <Link href="/cases/finance-platform-engineering">
                ...
                <div className="absolute bottom-0 left-0 p-6 sm:p-8">
                  ...
                  <h3 className="text-2xl font-bold text-white mt-2">FinTech Leader Accelerates Innovation with a Modern Platform</h3>
                </div>
              </Link>
            </motion.div>
          </div>
