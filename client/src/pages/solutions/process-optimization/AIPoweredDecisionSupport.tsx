  ...
  return (
    <div className="min-h-screen bg-white font-sans text-charcoal">
      <SEO
        ...
        description="Embed ML and decision-AI into operational workflows with the governance, explanation, and override path enterprise operations require."
        ...
        <div className="container px-6 sm:px-8 md:px-12 lg:px-16">
          ...
          >
            ...
            <h3
              ...
              style={{ fontWeight: 500, letterSpacing: "-0.02em" }}
            >
              A five-phase approach from decision inventory to continuous learning.
            </h3>
            <p className="text-base md:text-lg text-charcoal/80 leading-[1.65] max-w-[60ch] mt-6">
              Each phase is timeboxed and produces a tangible artifact. Most engagements run twelve to twenty weeks end-to-end depending on data readiness, with the model performance dashboard live the day the model goes into production.
            </p>
          </motion.div>
        ...
        <div className="px-6 sm:px-8 md:px-12 lg:px-16 max-w-4xl mx-auto">
          ...
          >
            ...
            <p className="text-base md:text-lg text-white/85 leading-[1.65] max-w-[60ch] mb-8">
              The bar is not whether the model is accurate in a notebook. It is whether the operator's decision is faster and more consistent on a Tuesday, and whether risk and audit can defend the program at the next regulatory review. We design for both at the same time.
            </p>
            <Link href="/cases">
        ...
        <div className="container px-6 sm:px-8 md:px-12 lg:px-16">
          ...
          >
            ...
            <h3
              ...
              style={{ fontWeight: 500, letterSpacing: "-0.02em" }}
            >
              When the integration is right, the model earns its keep on real Tuesdays.
            </h3>
          </motion.div>
            ...
            <div className="grid md:grid-cols-2 gap-12 lg:gap-16 items-start">
              ...
              >
                <p className="text-base md:text-lg text-white/80 leading-[1.65] mb-8 max-w-[52ch]">
                  We work with leaders who want decision-AI that survives the operator's Tuesday and the regulator's review. The conversation starts with the decisions you would augment first.
                </p>
