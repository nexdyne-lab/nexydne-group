...
export default function ContinuousImprovementPrograms() {
  return (
    <SolutionCat6Template
      ...
      heroFocal="65% 50%"
      seoTitle="Continuous Improvement Programs"
      seoDescription="Build durable kaizen and continuous improvement capabilities — operating model, governance, idea pipeline, recognition, and measurement."
      ...
      deliverIntro="Each phase is timeboxed and produces a tangible artifact. Most engagements run six to nine months for the design and pipeline build; capability scaling extends across a multi-year program with quarterly governance checkpoints."
      phases={[
        {
      ...
      outcome={{
        ...
        body: "The leverage is not in adding people. It is in fixing the structural choices that throttle throughput today. When the operating model is right and the cadence is real, the same workforce produces a different program.",
      }}
      casesHeading="When the operating model is right, improvement compounds."
      cases={[
        {
      ...
      cta={{
        ...
        body: "We work with leaders who want continuous improvement to be a capability, not a campaign. The conversation starts with the structural choices throttling your program today.",
        industries: [
