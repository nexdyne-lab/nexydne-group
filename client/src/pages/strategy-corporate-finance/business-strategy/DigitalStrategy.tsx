// TODO: confirm with practice lead before publish — experience stats, challenge, opportunity, approach pillars, outcomes, related services, and CTA lead name for Digital Strategy.

import ServiceDetailTemplate from "@/components/ServiceDetailTemplate";

export default function StrategyCorporateFinanceBusinessStrategyDigitalStrategy() {
  return (
    <ServiceDetailTemplate
      ...
      heroSubtitle="Leverage technology for competitive advantage. Define your digital roadmap and prioritize investments that drive business value."
      ...
      challenge="Leaders know digital strategy can unlock material value, yet the gap between intent and execution is wide. Legacy processes, fragmented data, and unclear ownership keep performance well below potential — and small fixes rarely move the needle on their own."
      opportunity="A focused digital strategy program — grounded in Business Strategy & Transformation fundamentals and powered by modern analytics — can sharpen decisions, lift returns, and free working capital. The teams that win treat this as a multi-year capability build, not a one-off project."
      approachPillars={[
        {
          step: "01",
          title: "Diagnose and discover",
          body:
            "We assess your current digital strategy state — mapping processes, capabilities, data, and gaps. We benchmark against best-in-class peers and quantify the value at stake.",
        },
        {
          step: "02",
          title: "Design and decide",
          body:
            "We co-design a target operating model for digital strategy — balancing speed, cost, risk, and impact. The blueprint is grounded in your context and built to scale.",
        },
        {
          step: "03",
      ...
      outcomes={[
        "Clear, executive-ready strategy for digital strategy aligned to enterprise priorities",
      ...
      ctaLeadName="Talk to our Digital Strategy lead"
    />
  );
}
