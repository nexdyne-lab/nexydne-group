...
export default function StrategyCorporateFinanceMaPartnershipsTargetIdentification() {
  return (
    <ServiceDetailTemplate
      ...
      heroSubtitle="Systematic search for acquisition targets that fit your strategic criteria. Market mapping, competitor analysis, and opportunity screening."
      ...
      opportunity="A focused target identification program — grounded in M&A & Strategic Partnerships fundamentals and powered by modern analytics — can sharpen decisions, lift returns, and free working capital. The teams that win treat this as a multi-year capability build, not a one-off project."
      approachPillars={[
        {
          step: "01",
