...
export default function StrategyCorporateFinanceMergersAcquisitionsMaStrategy() {
  return (
    <ServiceDetailTemplate
      ...
      opportunity="A focused m&a strategy program — grounded in Mergers & Acquisitions fundamentals and powered by modern analytics — can sharpen decisions, lift returns, and free working capital. The teams that win treat this as a multi-year capability build, not a one-off project."
      approachPillars={[
        {
          step: "01",
