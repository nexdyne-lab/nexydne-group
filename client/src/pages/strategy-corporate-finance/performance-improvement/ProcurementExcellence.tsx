// TODO: confirm with practice lead before publish — experience stats, challenge, opportunity, approach pillars, outcomes, related services, and CTA lead name for Procurement Excellence.

import ServiceDetailTemplate from "@/components/ServiceDetailTemplate";

export default function StrategyCorporateFinancePerformanceImprovementProcurementExcellence() {
  return (
    <ServiceDetailTemplate
      ...
      serviceName="Procurement Excellence"
      serviceSlug="procurement-excellence"
      heroSubtitle="Strategic sourcing, supplier consolidation, and contract renegotiation. Reduce spend while maintaining quality."
      ...
      challenge="Leaders know procurement excellence can unlock material value, yet the gap between intent and execution is wide. Legacy processes, fragmented data, and unclear ownership keep performance well below potential — and small fixes rarely move the needle on their own."
      opportunity="A focused procurement excellence program — grounded in Performance Improvement fundamentals and powered by modern analytics — can sharpen decisions, lift returns, and free working capital. The teams that win treat this as a multi-year capability build, not a one-off project."
      approachPillars={[
        {
          step: "01",
          title: "Diagnose and discover",
          body:
            "We assess your current procurement excellence state — mapping processes, capabilities, data, and gaps. We benchmark against best-in-class peers and quantify the value at stake.",
        },
        {
          step: "02",
          title: "Design and decide",
          body:
            "We co-design a target operating model for procurement excellence — balancing speed, cost, risk, and impact. The blueprint is grounded in your context and built to scale.",
        },
        {
          step: "03",
      ...
      outcomes={[
        "Clear, executive-ready strategy for procurement excellence aligned to enterprise priorities",
      ...
      ctaLeadName="Talk to our Procurement Excellence lead"
    />
  );
}
